<a id="4977b86be8d92d81"></a>

# 27. PSM Packages

> Source: [GOLDILOCKS 26c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/en/4977b86be8d92d81)  
> Tag: `26c.1_0_tag`

[← 26. Using SQLs in PSM](26-using-sqls-in-psm.md) · [Table of contents](../README.md) · [28. External Routine →](28-external-routine.md)

This chapter describes how to modularize common data and PSM codes used in various applications into the package.

<a id="64dd3b922df30b76"></a>
## Definition
...
- The package body should be created in the schema which is the same as that of the package specification.
- The package body should have the name the same as that of the package specification.
...
- The variable, type, exception which are the same as those defined in a package specification can not be declared in the package body.
