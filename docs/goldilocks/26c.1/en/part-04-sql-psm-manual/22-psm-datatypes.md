<a id="2fe90d5805cc1b9e"></a>

# 22. PSM DataTypes

> Source: [GOLDILOCKS 26c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/en/2fe90d5805cc1b9e)  
> Tag: `26c.1_0_tag`
...
<a id="bf160f3c2a001622"></a>
### BOOLEAN Type

BOOLEAN

<a id="973c505e502e6e6a"></a>
### ROWID Type

ROWID

<a id="ac3bfe31f1db28ea"></a>
...
For more information, refer to [Built-in Data Type References](../part-03-sql-manual/16-built-in-data-type-references.md#1ef27eb5cccbe6f9).

<a id="4d5783e6ae6c1bd0"></a>
...
<a id="30d48525d672a9b3"></a>
### %ROWTYPE

It is used to specify the structure of a specific table, or the record type the same as the returned type of a specific cursor. It can refer to the following objects.
...
- &lt;element_data_type&gt; specifies a data type of a value that configures an array.
...
For more information, refer to [COLLECTION Variable Declaration](30-psm-language-element-references.md#81da60b6816d1d33).

<a id="af63455a6caab278"></a>
### Associative Array
...
For more information, refer to [Built-in Data Types](#bcab7d992b169c9e), [%TYPE](#92a737c30f71f954), [%ROWTYPE](#30d48525d672a9b3), [User Defined Record Type](#67c36e8a2d115d52).

<a id="f08b87f41ec8bccf"></a>
### Assign Values to Collection Variables

The following rules are applied when assigning values to collection valuables.

- The rules the same as &lt;Assign Statement&gt; is applied to an element assignment. 
...
For more information, refer to [Cursor Variable](24-psm-cursor-statements.md#9e834d6bb6278233), [Cursor Variable Declaration](30-psm-language-element-references.md#2b78435faeadac86), [OPEN FOR Statement](30-psm-language-element-references.md#326b0ac4f8704e21).
