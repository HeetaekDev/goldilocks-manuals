<a id="cca8ab23b64c44dd"></a>

# 24. PSM Cursor Statements

> Source: [GOLDILOCKS 26c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/en/cca8ab23b64c44dd)  
> Tag: `26c.1_0_tag`
...
<a id="fb3f851684b072d7"></a>
### Declaring and Defining Explicit Cursors

An explicit cursor should be declared and defined in PSM declare section to use it. The cursor name, the parameter information and the return type of when declaring the explicit cursor should be the same as when defining the explicit cursor. For more information about the syntax of the explicit cursor and others, refer to [Explicit Cursor Declaration and Definition](30-psm-language-element-references.md#465c051bfb78ee84).

<a id="07181705d4c0d430"></a>
...
<a id="ddfca5518f411618"></a>
### Opening and Closing Explicit Cursors

- Perform the cursor query by executing [OPEN Statement](30-psm-language-element-references.md#bf1f4e379445065f) after declaring and defining the explicit cursor.
...
- Close the explicit cursor by using [CLOSE Statement](30-psm-language-element-references.md#be3b8f9c4ae5e8b7) after using the cursor. It can not fetch the record from the result set after the explicit cursor is closed. 
- Once after the explicit cursor is OPENed it can not be reopened, CLOSE it first to OPEN it again.

<a id="bd918f845c428d8c"></a>
...
<a id="427e99c928334333"></a>
### Fetching Data With Explicit Cursors

- It fetches the row from the result set by executing [FETCH Statement](30-psm-language-element-references.md#eded620a01801e55) after OPENing the explicit cursor.
...
- PSM [FETCH Statement](30-psm-language-element-references.md#eded620a01801e55) does not throw an exception even when there is not a fetched ROW.
- When performing FETCH in [Basic LOOP Statement](30-psm-language-element-references.md#20e8e5a8347535a1), then use %NOTFOUND property to detect the terminating condition.

<a id="6ab08e135658736b"></a>
...
<a id="9e834d6bb6278233"></a>
## Cursor Variable

<a id="880047c346310a85"></a>
### Create Cursor Variables

Declare the variable by declaring predefined SYS_REFCURSOR type variable or by defining REF CURSOR TYPE so that the cursor variable is created. For more information, refer to [Cursor Variable Declaration](30-psm-language-element-references.md#2b78435faeadac86).
...
- REF CURSOR types are as follows.
    - Strong REF CURSOR type
        ...
        - The strong REF CURSOR type variable can connect only the query whose query set type is the same as the defined return_type to the query of CURSOR VARIABLE.
...
<a id="1dd2242c08f1f57f"></a>
### Opening and Closing Cursor Variables

- It connects the cursor variable and SELECT statement or DML statement to perform by performing [OPEN FOR Statement](30-psm-language-element-references.md#326b0ac4f8704e21) after declaring the cursor variable.
...
- Perform [CLOSE Statement](30-psm-language-element-references.md#be3b8f9c4ae5e8b7) after finish using the cursor variable. 
- It does not allow accessing the query result of CLOSEd cursor variable or referring to the cursor variable attributes.

<a id="4ecd1723c04e1903"></a>
...
<a id="402ba0809e289472"></a>
### Fetching Data with Cursor Variables

It can bring the row from the result set by executing [FETCH Statement](30-psm-language-element-references.md#eded620a01801e55) after OPENing the cursor variable. The result returned by the cursor variable should be compatible with into clause.

<a id="bf691da2d886f8aa"></a>
