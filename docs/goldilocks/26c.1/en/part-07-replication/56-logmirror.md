<a id="68ef4cdd96f98d3e"></a>

# 56. LOGMIRROR

> Source: [GOLDILOCKS 26c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/en/68ef4cdd96f98d3e)  
> Tag: `26c.1_0_tag`

[← 55. CYCLONE](55-cyclone.md) · [Table of contents](../README.md) · [57. CYFILE →](57-cyfile.md)

<a id="c71e561ceb9b5b7e"></a>
## LOGMIRROR
...
<a id="c1aef224d8c2490b"></a>
## Configuration

<a id="f0209d74d19b8fb4"></a>
### Configuration File
...
<a id="0b6388b1d0389fb8"></a>
### Configuration Options

<a id="7c562886b47e5e71"></a>
#### PORT
...
- If this value is used, then --key option should be used when executing logmirror. (In this case, the key value the same as that created with --encrypt should be used.

```
USER_ENCRYPT_PW = 't33KImiqvhqNyfN+uZmFrw=='
```

<a id="ea348ff4ed8b2dda"></a>
#### LOG_PATH
...
<a id="cc6c99f4935205d5"></a>
| Item | File |
| --- | --- |
| Master | $GOLDILOCKS_DATA/trc/LogMirror_master.trc |
| Slave | $GOLDILOCKS_DATA/trc/LogMirror_slave.trc |

> For more information about the error messages and handlings stored in the trace log, refer to [Troubleshooting of LOGMIRROR](../part-02-administration-manual/8-goldilocks-database-replication.md#740ea77938d89ea6).

<a id="c110567ea4c4d5d4"></a>
### Operating LOGMIRROR
...
<a id="0968c07156b3a50c"></a>
### Executing Option

**Execution options**

<a id="15451bc95cee58a1"></a>
...
> For examples of initializing LOGMIRROR, refer to [LOGMIRROR](../part-02-administration-manual/8-goldilocks-database-replication.md#bc4f225c6d7c7261).

<a id="91bd9ccef61b12e1"></a>
...
<a id="80e009b60c3a75ef"></a>
![Example of operating structure](../assets/images/f4e435d772dfb735.png)
...
<a id="bc11fde54d4694b0"></a>
#### Configuring CYCLONE and LOGMIRROR in Original GOLDILOCKS

Refer to the following.  
• CYCLONE configuration: [Requirements](55-cyclone.md#1e86ba68c6bff2c9)  
• LOGMIRROR configuration: [Requirements](#aaf96af532ba5e26)
...
- The PORT which is the same as LOGMIRROR MASTER should be entered.
