<a id="c0dd6c17daab1472"></a>

# 55. CYCLONE

> Source: [GOLDILOCKS 26c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/en/c0dd6c17daab1472)  
> Tag: `26c.1_0_tag`

[← 54. Overview](54-overview.md) · [Table of contents](../README.md) · [56. LOGMIRROR →](56-logmirror.md)

<a id="9197bf74276603f1"></a>
## CYCLONE

CYCLONE is a replication tool which uses the Change Data Capture (CDC) method.

<a id="87c90594eb2f5985"></a>
### Overview
...
- Tables participating in replication cannot use the column which has Generated Always As Identity property.
...
- When Data Definition Language (DDL) is performed on the table in which the replication is being operated, it could be given up. 
    - For more information, refer to [The occurrence of give up and whether to allow DDL statement according to DDL category](#cd8a6e3b782422b6) in table1. 
...
- In a replication setup, foreign key and trigger constraints are forcibly disabled on the slave database.
    - If replication is interrupted due to user-initiated shutdown or network disconnection, data inconsistency may occur between the master and the slave. In such cases, the slave database may contain data that violates constraints because foreign key and trigger constraints are disabled.
    - To re-enable the constraints on the slave database, the user must perform data cleansing.
        - For more information, refer to [Handling Foreign Key Constraint Violations on the Slave DB after Replication Termination](#41ecb9130cdcc0b8).

<a id="cd8a6e3b782422b6"></a>
...
allow 
DDL statement</div></th><th class="to_center to_middle"><div>DDL statement</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="8"><div>Table DDL</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>CREATE TABLE</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>DROP TABLE</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>TRUNCATE TABLE</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. RENAME</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. STORAGE</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. ADD SUPPLEMENTAL LOG</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. DROP SUPPLEMENTAL LOG</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. READ { ONLY | WRITE }</div></td></tr><tr><td class="to_middle" rowspan="10"><div>Column DDL</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_middle"><div>ALTER TABLE .. ADD COLUMN</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. SET UNUSED COLUMN</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. RENAME COLUMN</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. SET DEFAULT</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. DROP DEFAULT</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. SET NOT NULL</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. DROP NOT NULL</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. ALTER IDENTITY</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. DROP IDENTITY</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER COLUMN .. SET DATATYPE</div></td></tr><tr><td class="to_middle" rowspan="10"><div>Constraint DDL</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ADD CONSTRAINT .. PRIMARY KEY</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ADD CONSTRAINT .. UNIQUE KEY</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. ADD CONSTRAINT .. FOREIGN KEY ..</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. ADD CONSTRAINT .. CHECK ( .. )</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. DROP .. PRIMARY KEY</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. DROP .. UNIQUE KEY</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. DROP CONSTRAINT foreign_key</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. DROP CONSTRAINT</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>ALTER TABLE .. ALTER CONSTRAINT</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER TABLE .. RENAME CONSTRAINT</div></td></tr><tr><td class="to_middle" rowspan="6"><div>Index DDL</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>CREATE UNIQUE INDEX</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>CREATE INDEX</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>DROP INDEX unique_index</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>DROP INDEX non_unique_index</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER INDEX .. STORAGE</div></td></tr><tr><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>-</div></td><td class="to_middle"><div>ALTER INDEX .. RENAME</div></td></tr><tr><td class="to_middle" rowspan="3"><div>Superordinate
object of table</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>DROP USER</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>DROP SCHEMA</div></td></tr><tr><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_middle"><div>DROP TABLESPACE</div></td></tr></tbody></table>

> The server property [DISABLE_DDL_CDC_GIVEUP](../part-02-administration-manual/10-server-property.md#d5cef4fce2a220f8) can disable the DDL statement which causes the replication give up to avoid user created errors. Also, the server property [DISABLE_UPDATE_PK_CDC_GIVEUP](../part-02-administration-manual/10-server-property.md#0077b3010638de68) can disable primary key update.

<a id="7c4d87b5e0e4da2f"></a>
### Goldilocks–Cyclone Version Compatibility Constraints

1. The major and minor versions of Goldilocks and Cyclone must be identical.
** If the versions do not match, the following error message occurs:
*** ERR-HY000(46073): mismatched major & minor version - server(26.1.X), cyclone(26.2.X)
2. The master and slave of Cyclone must use the same version.
** In addition, cymon must use the same version as Cyclone.
** If the versions differ, the following error message occurs:
*** ERR-HY000(46019): Protocol error occurred (Master and Slave version information mismatch)
3. If the internal implementation changes due to feature modifications, protocol changes, or changes to the redo log structure, compatibility is not guaranteed even if all of the above conditions are satisfied.
** Compatibility is determined based on the CYCLONE_COMPATIBLE_NUMBER.
** If the versions are not compatible, the following error message is displayed.:
*** ERR-HY000(46075): Cyclone is not compatible with Server. Server Compatible Number(2001) Cyclone Compatible Number(2002)
*** The Server's CYCLONE_COMPATIBLE_NUMBER can be checked as follows.
*+ `gSQL> SELECT CYCLONE_COMPATIBLE_NUMBER() FROM DUAL`
*** The Cyclone CYCLONE_COMPATIBLE_NUMBER can be checked by using the --help option.
...
** For more information, refer to [The occurrence of give-up and whether to allow DDL statement according to DDL category](#cd8a6e3b782422b6) .
...
- When interworking with other DBMS, the supported DDL functionality is unavailable.

<a id="3e02b2071bcd3618"></a>
#### Oracle

**Datatype compatible with Oracle**

<a id="f9c7f40f980325fb"></a>
...
<a id="c59f7bcc3be58022"></a>
#### MySQL

**Datatype compatible with MySQL**

<a id="d69d69fe5bb46a3a"></a>
...
<a id="b82e8273bb5c5abe"></a>
#### DB2

**Datatype compatible with DB2**

<a id="226ac2d28e8cadf0"></a>
...
<a id="41ecb9130cdcc0b8"></a>
### Handling Foreign Key Constraint Violations on the Slave DB after Replication Termination

When replication is configured, CYCLONE forcibly disables foreign key and trigger constraints on the slave DB. As a result, if replication is abnormally terminated or interrupted due to reasons such as a network disconnection, the slave DB may contain data that violates these constraints.  
The following procedure describes how to resolve such situations:

1. Check whether there are any foreign key constraint violations on the slave DB.
...
2. Keep the foreign keys disabled.
...
3. If there is data that violates foreign key constraints, the corresponding foreign key cannot be enabled.
...
4. Identify the data that violates the foreign key constraints.
...
<a id="593cbc4359ef1647"></a>
### GOLDILOCKS Requirements

The following should be set in GOLDILOCKS before starting the replication using CYCLONE.

<a id="02069775d99d8b06"></a>
...
<a id="21c4c03ff9db9add"></a>
#### Database Privileges

<a id="4062bbd793fff645"></a>
...
<a id="d727f9b39c513a26"></a>
## Configuration

<a id="6868eae8115aee53"></a>
### Configuration File
...
| USER_ENCRYPT_PW | It sets the encrypted password for user. | Master/ slave |
...
| PROTOCOL | It sets the connection type. | Slave |
...
<a id="4f7a9eead4275b7e"></a>
### Configuration Option

<a id="b77e774aac8ff1da"></a>
#### COMM_CHUNK_COUNT
...
- If this value is used, then --key option should be used when executing cyclone. (In this case, the key value the same as that created with --encrypt should be used.
...
<a id="a1bb3c16bb84ade5"></a>
#### PROTOCOL

- It sets the connection type to use.
- When connecting to GOLDILOCKS, the protocol is fixed to TCP, and DA connections are not supported.
...
<a id="d649bb9800f33eb2"></a>
#### MASTER_IP

- It sets the IP address of the device which CYCLONE master operates.
- It can be set only in slave, and it should be set.
...
<a id="491b33f293666c32"></a>
#### APPLIER_TRACE_LOG_ID

- It can be set in slave.
- It sets the TRACE_LOG_ID value for the applier.
    - The default value is 0 (Disabled).
    - To enable trace logging, set an appropriate value according to the [flag information for TRACE_LOG_ID](../part-02-administration-manual/10-server-property.md#df673da80227954c). (Enabled)
...
<a id="8c15f41394f35695"></a>
## Operating

CYCLONE can only be operated in the C/S environment of GOLDILOCKS.

Depending on the operating environment, connections are made using either the CONFIG file or the ODBC.INI settings, with the CONFIG file settings taking precedence over those in ODBC.INI.

Operations performed during runtime can be monitored through the trace log.

<a id="bb626f220edfa4ae"></a>
| Item | File |
| --- | --- |
...
> For more information about error message and its handling method stored in trace log, refer to [Troubleshooting of CYCLONE](../part-02-administration-manual/8-goldilocks-database-replication.md#ac20cf143b39651b).

<a id="07d9e3a5933fd7a1"></a>
...
<a id="6c4a9c00b8e47299"></a>
#### Correct Examples

- The connection is made via TCP, and since the CONFIG settings take precedence, the USER_ID operates using the test account.

**The connection is made via TCP, and since the CONFIG settings take precedence, the USER_ID operates using the test account.**

<a id="a9d802fbca9b5982"></a>
| Item | File |
| --- | --- |
...
<a id="0e40d24ef90fdb63"></a>
#### Wrong Examples

- USER_PW is missing during connection.

**USER_PW is missing when connecting via DA.**

<a id="6f06e30b6e8d4228"></a>
| Item | File |
| --- | --- |
| CONFIG | HOST_EXTERNAL_IP=192.168.0.10 |
| GOLDILOCKS configuration of odbc.ini | PROTOCOL=TCP, USER_ID=test |

- HOST_IP is missing when connecting via TCP.

**HOST_IP is missing when connecting via TCP.**

<a id="26456514cc130596"></a>
| Item | File |
| --- | --- |
| CONFIG | HOST_EXTERNAL_IP=192.168.0.10, USER_ID=test |
| GOLDILOCKS configuration of odbc.ini | PROTOCOL=TCP, HOST_PORT=22581,USER_PW=test |

<a id="f00d2b0651b8970c"></a>
### Executing Option
...
> For more information about examples of adding/deleting node or group, refer to [Adding and Deleting Nodes](../part-02-administration-manual/8-goldilocks-database-replication.md#81ceaa96cceaf95c).  
> For more information about examples of initializing replication, refer to [Initializing Replication](../part-02-administration-manual/8-goldilocks-database-replication.md#567b3a43610f29bf).

<a id="69076e585c9dce59"></a>
## Operating Examples

The structure of operating CYCLONE is as follows.

<a id="a21bd9851cc59753"></a>
![The structure of operating CYCLONE](../assets/images/f78a138755a09425.png)
...
<a id="27b6afd9d6d2a335"></a>
### Original GOLDILOCKS Configuration

Execute all described [Requirements](#1e86ba68c6bff2c9).  
...
<a id="1421c1d40854d219"></a>
### Remote GOLDILOCKS Configuration

Execute [Registering User and Setting Privileges](#ad635ba07c9d09e3).

<a id="431e81ce73c3d233"></a>
...
1. When synchronizing all tables in all groups
...
2. When synchronizing all tables in a specific group
...
3. When synchronizing a specific table in a specific group
...
- Differences of between master and slave when performing the --reset option
    ...
    - The slave stores the information for recovery when restating the replication. *--reset All* or *--reset TABLE_NAME* should be described when executing slave the same as when executing master.
...
>     - The table name of when performing slave should be the same as that of when performing master.   
...
<a id="4465c0554d962da5"></a>
## Operating CYCLONE in Cluster

<a id="a0519627ed68b287"></a>
### Requirements
...
<a id="a9ef0a1cc7441e61"></a>
### Operating

<a id="e669f8e22185b0a4"></a>
...
<a id="a689a05ab270702b"></a>
### Executing

<a id="028b76de3988823b"></a>
#### Configuration File

The configuration file of master is the same as that of standalone.  
...
<a id="46bab7bb8ac30e0a"></a>
#### Executing Method

<a id="09ce0b715b867d42"></a>
##### Executing in Master
...
<a id="1c404fe00fdb2dd0"></a>
### SYNC Method

<a id="559cae48377fc887"></a>
#### Executing Master
...
<a id="b1d8998bcf0b438f"></a>
### Others

--reset option can be used the same as it is used in standalone environment.

<a id="015bb5bd7f1b9fb0"></a>
## Monitoring (CYMON)
...
<a id="1c7b73a09b8d177c"></a>
| File name | Description |
| --- | --- |
| cymon | Monitoring cyclone |

<a id="2c978645475b7661"></a>
### Configuration File
...
> CYMON should be run on the device which is the same as the device of which CYCLONE runs as master.

<a id="593603f6dcb66cb8"></a>
### Monitoring Contents

<a id="3024a281a6f509c0"></a>
#### CYMON
...
<a id="9d5d95246106ae8f"></a>
### Executing and Monitoring

<a id="deeb3f38fcc46dfe"></a>
#### Executing Option

**Executing option**

<a id="3ea912f43e5e70d4"></a>
| Option | Description | Remarks |
| --- | --- | --- |
| --conf \| -c | It sets the configuration file path. | It is input in --conf CONFIG FILE format. * It should set the file the same as the configuration file used when running CYCLONE as master. |
