<a id="7aa03d217c66fb65"></a>

# 44. gsql/gsqlnet (Interactive SQL Tool)

> Source: [GOLDILOCKS 26c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/en/7aa03d217c66fb65)  
> Tag: `26c.1_0_tag`

[← 43. glsnr](43-glsnr.md) · [Table of contents](../README.md) · [45. gloader/gloadernet (Upload/download Tool) →](45-gloader-gloadernet-upload-download-tool.md)

<a id="6d6e4ebf1e3f443d"></a>
## Overview of gsql

The following are execution files.

**Execution files**

<a id="c897c607ff752c09"></a>
...
Create a table by executing [CREATE TABLE](../part-03-sql-manual/19-sql-references-c-g.md#47f3ce328094503e) statement and commit the transaction as follows.
...
Insert the data into the created table by executing [INSERT INTO](../part-03-sql-manual/20-sql-references-h-z.md#feb637229fe4dc62) statement, then commit the transaction as follows. The second INSERT statement is an example of inserting two rows.
...
The column addr is added to the table and data is updated by executing [UPDATE](../part-03-sql-manual/20-sql-references-h-z.md#b8c5e51f7074a6a9) statement as follows.
...
The inserted data is queried by using [SELECT](../part-03-sql-manual/20-sql-references-h-z.md#d7ebf6af3421bb2f) query as follows. The query result consists of the header representing column names and the information of each row in a single line. NULL is expressed in lowercase null.
...
The SQL statement is prepared by using [`\prepare sql`](#8c25b1a4502bcba2) and the SELECT statement above is repeatedly performed by using [`\exec`](#d058ccb12a214a65), changing the value of host variable. ODBC and JDBC simulate prepare/ execute operation in gsql interactive mode as follows.
...
A scrollable cursor is declared in an embedded SQL, ODBC, JDBC, and the data retrieval using the cursor is simulated via gsql as follows. The cursor cur1 declared by using [DECLARE cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#ccb6dc5ecb7cf850) is the scrollable KEYSET cursor and various fetch orientations may be used by using [FETCH cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#b4d62d5536bcdf22).
...
<a id="bc29aa8f130ed323"></a>
## Executing gsql

<a id="5628043e93cea892"></a>
### Information of gsql
...
<a id="6f3f54c8b0ecf373"></a>
| Option | Description |
| --- | --- |
| [--help](#02d8fedf52af4a66) | Option list |
| [--version](#0e77920e7155c3d5) | gsql version information |

A user can view the gsql command options which are executable at the shell prompt via [--help](#02d8fedf52af4a66) option as follows.
...
gsql program has a version separate from GOLDILOCKS server version, and the version is viewed by using [--version](#0e77920e7155c3d5) option as follows. It is recommended to use the gsql program in the same version as the GOLDILOCKS server.
...
The version of GOLDILOCKS server can be view via [VERSION](../part-03-sql-manual/17-built-in-function-references.md#39bf4f4db2bd030c) function as follows.
...
<a id="59de38bf13252cb8"></a>
| Option | Description |
| --- | --- |
| [Username Password](#2505fe15781ebd3d) | It is the user and password of connection. |
| [--as {SYSDBA\|ADMIN}](#a9465ef5c0234fba) | It specifies the connection role. |
| [--conn-string](#257c66c0eb5b6bcf) | It specifies the connection string. |
| [--dsn](#bf5d1309b77b8964) | It specifies Data Source Name (DSN). |

<a id="841b0bf70c729429"></a>
#### User Connection
...
- [--conn-string](#257c66c0eb5b6bcf)
- [--dsn](#bf5d1309b77b8964)

<a id="6a1fcf0efaee3e91"></a>
#### SYSDBA Connection

The [--as {SYSDBA|ADMIN}](#a9465ef5c0234fba) option is used to drive the server or to connect to SYSDBA role which has full access privilege on the database.
...
For more information, refer to [Startup and Shutdown Server](#b41f927ffdfb2fb7).

<a id="aa36aadb6b827935"></a>
#### Quit gsql

gsql is quit by using `\quit` or `\q` command as follows.   
For more information, refer to `[\quit](#c275744d6be75f1e).`
...
<a id="9f76dc0aadc2954a"></a>
| Option | Description |
| --- | --- |
| [--prompt](#a83dd9480bf33ab1) | It specifies the prompt. |
| [--no-prompt](#1eb77ba32481f1b5) | It removes the prompt. |
| [--import](#332038835d051cc0) | It executes the SQL file with input. |
| [--silent](#a8160626cccef9e7) | When executing the SQL file, the command and the result are not displayed. |
| [--enable-color](#b7540d846e0e45f9) | The query result is displayed by grouping per row. |

<a id="074d9b71a659d9bd"></a>
#### Controlling Prompt
...
- [--prompt](#a83dd9480bf33ab1)
- [--no-prompt](#1eb77ba32481f1b5)

<a id="6183ac6bf310c828"></a>
#### Executing from File
...
- [--import](#332038835d051cc0)
- [--silent](#a8160626cccef9e7)
- [--enable-color](#b7540d846e0e45f9)

<a id="1cd36fc1dae780b3"></a>
### Storing gsql configuration

<a id="eb7ba52c9278fe3b"></a>
...
<a id="3108e803ddd5b811"></a>
| Option | Minimum value | Maximum value | Default value |
| --- | --- | --- | --- |
| [AUTOCOMMIT](#221f4964eb27e09f) | OFF | ON | OFF |
| [AUTOTRACE](#e19dce6dcc8e6cae) | OFF | ON/TRACEONLY | OFF |
| [LINESIZE](#a7004670c7795676) | 1 | 10000 | 80 |
| [PAGESIZE](#ae98de2c325dc879) | 1 | 10000 | 20 |
| [VERTICAL](#87d0d174acab6db9) | OFF | ON | OFF |
| [TIME](#86f46a4bf9865da4) | OFF | ON | OFF |
| [TIMING](#0fe9f4d794873701) | OFF | ON | OFF |
| [ERROR](#7af00f280e63c599) | ON | OFF | ON |
| [COLSIZE](#4e66fbba3816951e) | 1 | 10485760 | 8192 |
| [NUMSIZE](#d0d5655823bc9dd5) | 1 | 50 | 20 |
| [DDLSIZE](#b75e74d2155c734a) | 1 | 10485760 | 10000 |
| [HISTORY](#5ce1022ef443ca1b) | 0 | 100000 | 128 |

> If .gsql.ini does not exist or the option value is invalid, it is ignored.

<a id="9f6c1bbfe8adc643"></a>
#### glogin.sql
...
<a id="27e7a8816dd3deb0"></a>
## Using Interactive Command

<a id="0135b263b0caa956"></a>
...
<a id="71e9fcb3b3c73abc"></a>
| gsql command | Description |
| --- | --- |
| [`\help`](#5753a8c373223e55) | gsql command list |

gsql program operates in an interactive mode through [Server Connection](#c152a689d84aeb3d) as follows.
...
The following is an example of executing the same SELECT statement by using [`\exec sql`](#80549670d798cab8), gsql command. `\exec sql` command is a unique gsql command although the syntax of `\ exec sql `is the same as the syntax of EXEC SQL referring to the beginning of SQL statement in an [Embedded SQL](../part-05-developer-manual/36-embedded-sql.md#d0b481d9f0d1f541).
...
The current time can be output on the prompt by setting via [`\set time`](#86f46a4bf9865da4).
...
The unique commands of gsql interactive mode can be queried with the command [`\help`](#5753a8c373223e55) as follows.
...
\connect         userid password [{as role_name}]
```

<a id="b41f927ffdfb2fb7"></a>
...
<a id="9b361b421c3f0da4"></a>
| gsql Commad | Description |
| --- | --- |
| [`\startup`](#0d7e093005ada44e) | It starts up the server. |
| [`\shutdown`](#497f2d8b728ed1db) | It shuts down the server. |
| [`\cstartup`](#8c9f6e07b11b59e2) | It starts up the server for the cluster environment. |
| [`\cshutdown`](#2bd8ace72fea2617) | It shuts down the server for the cluster environment. |

<a id="f1e04f43aade1723"></a>
#### Standalone
...
gsql is connected to an idle instance in the state of when GOLDILOCKS server does not exist. gsql drives the GOLDILOCKS server on the specific step through [`\startup`](#0d7e093005ada44e) and connects to the server. The following is an example of driving the GOLDILOCKS server on NOMOUNT phase.
...
[`\startup`](#0d7e093005ada44e) command is used only when initially driving GOLDILOCKS. Each step of the GOLDILOCKS server is switched by using [ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04) after driving the GOLDILOCKS server and connecting to the server.
...
For more information about the server startup, refer to the following.

- Step of the server startup: [Multi-level Startup](../part-02-administration-manual/5-basic-management-of-goldilocks-database.md#d01e60d7c1eae7b0)
- Command for the initial server startup: [`\startup`](#0d7e093005ada44e)
- Altering the server step: [ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04)

`\shutdown` command is used as follows to shutdown the server. For more information about the server shutdown, refer to [`\shutdown`](#497f2d8b728ed1db).
...
The following is an example of defining LOCATOR_DSN property and LOCATOR DSN property in [odbc.ini file](../part-05-developer-manual/34-odbc.md#a37d4e15f0c71e92).
...
Commands excluding `\`CSTARTUP {LOCAL | GLOBAL} OPEN are applied only to the corresponding GOLDILOCKS server. Therefore, other servers should be started up to LOCAL OPEN phase for multi-level startup by using [ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04) after `\CSTARTUP NOMOUNT, MOUN` commands.
...
- Step of the server startup: [Multi-level Startup](../part-02-administration-manual/5-basic-management-of-goldilocks-database.md#d01e60d7c1eae7b0)
- Command for the initial server startup: [`\cstartup`](#8c9f6e07b11b59e2)
- Altering the server step: [ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04)

`\cshutdown` command is used as follows to shutdown the entire server. For more information about the entire server shutdown, refer to [`\cshutdown`](#2bd8ace72fea2617).
...
<a id="2fdd6046c8f19c32"></a>
| gsql commad | Description |
| --- | --- |
| [`\import`](#89b7cd3ca6312acb) | It executes SQL file. |
| [`\set autocommit`](#221f4964eb27e09f) | It automatically COMMITs whenever executing the SQL statement. |
| [SQL References](../part-03-sql-manual/18-sql-references-a-b.md#bc26bcceab15c938) | It is a type of SQL statement. |

<a id="43d44dc8d71126dd"></a>
...
<a id="f0e5d136b4070872"></a>
#### Entering SQL Statement from File

In an interactive mode, `\import` is used to execute the SQL statement from the file, not to execute it by directly entering the SQL statement. The following is an example of executing multiple SQL statements by reading the file sample.sql. For more information, refer to [`\import`](#89b7cd3ca6312acb).
...
<a id="382556e01f094ce5"></a>
#### gsql Comment

The comments in an interactive mode are the same as those in the SQL statement. The comments input from the file via the [--import](#332038835d051cc0) option is also the same as those in the SQL statement. For more information about comments on SQL statement, refer to [Comments](../part-03-sql-manual/11-sql-elements.md#a1b453895353bf95).
...
The comments which is available in gsql interactive mode are the same as those in the SQL statement. For more information about the comments, refer to [Comments](../part-03-sql-manual/11-sql-elements.md#a1b453895353bf95) of SQL statement.

<a id="f9f2d454dcd5c6d3"></a>
...
[Data Definition Language](../part-03-sql-manual/12-sql-languages.md#409f89727a0eb076), [Data Manipulation Language](../part-03-sql-manual/12-sql-languages.md#cdce1c4f271e24fd), [Control Language](../part-03-sql-manual/12-sql-languages.md#031335ad7a73b642) statements (except for SQL query) displays the summarized information of the execution result corresponding to the SQL statements characteristics.

The following are the examples of respectively executing the DDL, DML, Control Language, displaying the results.
...
The following is an example of preparing the SQL statement by using [`\prepare sql`](#8c25b1a4502bcba2)  and executing it by using [`\exec`](#d058ccb12a214a65).
...
The following is an example of an error occurred in the SQL statement when using [`\prepare sql`](#8c25b1a4502bcba2). It displays an error which is the same as that occurs when executing the SQL statement.
...
For more information about the performance result of the interactive command, refer to the description and example of the interactive command in [Interactive Command References](#b92cd000b89911dc).

<a id="66bb1ba59c00a8d8"></a>
#### Autocommitting SQL statement

The SQL statements in the gsql interactive mode may commit or roll back the transaction by using the [COMMIT](../part-03-sql-manual/19-sql-references-c-g.md#3beee453ea244831) or [ROLLBACK](../part-03-sql-manual/20-sql-references-h-z.md#a7f186a4dca1588e) statement.
...
If a user wants to automatically COMMIT every transaction whenever performing the SQL statements, it can be controlled by using the [`\set autocommit`](#221f4964eb27e09f) as follows. When performing the same SQL statement as the example above, each SQL statement is automatically committed, so the transaction of the second and the third INSERT statements are completed regardless of ROLLBACK.
...
For more information about controlling automatic COMMIT, refer to [`\set autocommit`](#221f4964eb27e09f).

<a id="d6629bfe3c235fcd"></a>
...
<a id="31d5dccdf0938b4f"></a>
| gsql command | Description |
| --- | --- |
| [`\set color`](#2bbe16af4ae6b336) | It identifies each row with different color. |
| [`\set colsize`](#4e66fbba3816951e) | It controls the maximum size of the column results. |
| [`\set error`](#7af00f280e63c599) | It controls whether an error message is displayed. |
| [`\set linesize`](#a7004670c7795676) | It controls the maximum output length of the row. |
| [`\set numsize`](#d0d5655823bc9dd5) | It controls the maximum number of digit of the numeric value. |
| [`\set pagesize`](#ae98de2c325dc879) | It controls the number of row to be included in a page. |
| [`\set timing`](#0fe9f4d794873701) | It outputs the execution time of the SQL statement. |
| [`\set vertical`](#87d0d174acab6db9) | It displays each column in a single line. |

<a id="d234ab66195630b1"></a>
#### Controlling Page Configuration

As described in [SQL Execution Result](#f9f2d454dcd5c6d3), the query results display the column names in the header, displays the data, then the summary information at the end.
...
The following is an example of the output of query results by changing the pagesize to 5. For more information about controlling the pagesize, refer to [`\set pagesize`](#ae98de2c325dc879).
...
The following is an example of the query result before and after the linesize is adjusted to 200. For more information about controlling linesize, refer to [`\set linesize`](#a7004670c7795676).
...
To increase the readability of each row on the terminal by differentiating rows, each row can be output by varying the color through [`\set color`](#2bbe16af4ae6b336) as described below. For more information, refer to [`\set color`](#2bbe16af4ae6b336).
...
To output the query result rows in the column unit on a single line, not in the line unit, `\set vertical on` is used. The following is an example of displaying the query results in a column unit. For more information, refer to [`\set vertical`](#87d0d174acab6db9).
...
<a id="4e8c8f8c34236a8f"></a>
#### Controlling Data Output

gsql converts all data included in the query result to a string, then outputs it.

For a numeric data type, numsize (default value is 20) is output in the digit unit, and a numeric value bigger than numsize is output in an exponent form. The following is an example of controlling the output by using the numsize. For more information, refer to [`\set numsize`](#d0d5655823bc9dd5).
...
The output of the numeric value may be controlled in various ways by using the [TO_CHAR( number )](../part-03-sql-manual/17-built-in-function-references.md#06e9d7b88a3c7d10) function as the following example.
...
- [NLS_DATE_FORMAT](../part-02-administration-manual/10-server-property.md#86120b98fe0558e4)
- [NLS_TIMESTAMP_FORMAT](../part-02-administration-manual/10-server-property.md#5129c923d9116f8d)
- [NLS_TIMESTAMP_WITH_TIME_ZONE_FORMAT](../part-02-administration-manual/10-server-property.md#8a228be667cdaef8)
- [NLS_TIME_FORMAT](../part-02-administration-manual/10-server-property.md#b303d4bd630c0388)
- [NLS_TIME_WITH_TIME_ZONE_FORMAT](../part-02-administration-manual/10-server-property.md#81aefd62dd9e1a5a)
...
The output of the date/ time value can be controlled by using [TO_CHAR( datetime )](../part-03-sql-manual/17-built-in-function-references.md#5f3a74b3e90ec4f6) function without altering property as follows.
...
<a id="2b03add636f95e17"></a>
#### Execution Time of SQL Statement

The execution time of the SQL statement is output by using `\set timing on` as follows. For more information, refer to [`\set timing`](#0fe9f4d794873701).
...
<a id="0a5584a0636c0443"></a>
| gsql command | Description |
| --- | --- |
| `\spool` | It logs the output result to a file. |

For more information about the features related to logging output results, refer to the commands of [`\spool`](#f66eb0c6ad743d0e).
...
<a id="557e1116e9444dc7"></a>
### Querying SQL Object Information

The information about SQL objects may be queried with the views of [DICTIONARY_SCHEMA](../part-02-administration-manual/9-database-information.md#7b4ef74c9b03cbc2), [INFORMATION_SCHEMA](../part-02-administration-manual/9-database-information.md#046547929481b3a3).

**Commands**

<a id="de4645d594354b5c"></a>
| gsql command | Description |
| --- | --- |
| [`\desc`](#c9c38608b0992844) | It queries the table information. |
| [`\idesc`](#fa5cb11bb51d07fa) | It queries the index information. |
...
gsql may easily query the information related to the table by using `\desc` as follows. For more information about the output, refer to [`\desc`](#c9c38608b0992844).
...
`\idesc` describes the information related to the index as the following example. For more information, refer to [`\idesc`](#fa5cb11bb51d07fa).
...
<a id="33eaa622568c0b87"></a>
| gsql command | Description |
| --- | --- |
| [`\ddl_cluster`](#4b69ad97b8a599f8) | It outputs the cluster-related DDL. |
| [`\ddl_db`](#72af0c4db34f7b3c) | It outputs the database-related DDL. |
| [`\ddl_tablespace`](#026dd09679b822ca) | It outputs the tablespace-related DDL. |
| [`\ddl_profile`](#911e27f9a9e73d09) | It outputs the profile-related DDL. |
| [`\ddl_audit_policy`](#e7d4d15c71453bc4) | It outputs the audit policy-related DDL. |
| [`\ddl_user`](#d656c1f06dab0b59) | It outputs the account-related DDL. |
| [`\ddl_role`](#ed2c1c9efa24cd42) | It outputs the role-related DDL. |
| [`\ddl_schema`](#71e410b4c291a31e) | It outputs the schema-related DDL. |
| [`\ddl_public_synonym`](#444545ef80a9d224) | It outputs the public synonym-related DDL. |
| [`\ddl_table`](#a49f7bd12dc80b5b) | It outputs the table-related DDL. |
| [`\ddl_constraint`](#219f65c5fbd6ceb9) | It outputs the constraint-related DDL. |
| [`\ddl_index`](#6b5af83dd8a49533) | It outputs the index-related DDL. |
| [`\ddl_view`](#8d26106fc8b5f4af) | It outputs the view-related DDL. |
| [`\ddl_sequence`](#be31a577b95e5d1d) | It outputs the sequence-related DDL. |
| [`\ddl_synonym`](#6817eb5b4e4c517f) | It outputs the synonym-related DDL. |
| [`\ddl_library`](#52089fde006adab6) | It outputs the library-related  DDL. |
| [`\ddl_procedure`](#e1b29eaaf5f1def8) | It outputs the procedure-related DDL. |
| [`\ddl_package`](#d09b7bf80619ae43) | It outputs the package-related DDL. |
| [`\ddl_trigger`](#468a1a5f912f53c6) | It outputs the trigger-related DDL. |
| [`\set ddlsize`](#b75e74d2155c734a) | It controls the size of the DDL output buffer. |
...
<a id="e6312507e041a1f2"></a>
| gsql command | Description |
| --- | --- |
| [`\\`](#6d6c52029506b7f0) | It executes the previous SQL. |
| [`\{n}`](#fc70ebfe00120207) | It executes the SQL statement corresponding to the history number. |
| [`\history`](#9f14049285550897) | It queries the SQL execution history. |
| [`\set history`](#5ce1022ef443ca1b) | It controls the number of history buffer. |
...
For more information about the history related features of gsql, refer to [Commands ](#e6312507e041a1f2).

<a id="66248ad7f34b158f"></a>
### Editing SQL
...
The following may be edited by using `\edit`.

- The most recently performed SQL statement
- The SQL statement stored in a file
- The SQL statement stored in the gsql history

For more information about the edit-related features in gsql, refer to [`\edit`](#8d3af67567b259ad).
...
<a id="bfa3651db112a90d"></a>
| gsql command | Description |
| --- | --- |
| [`\connect`](#efb18d51fa8b54ae) | It connects with a new user. |
| [`\quit`](#c275744d6be75f1e) | It quits the connection. |

It is connected with a new user by using `\connect` in an interactive mode as follows. The existing session is terminated and a new session is created by using `\connect`. For more information, refer to [`\connect`](#efb18d51fa8b54ae).
...
The user may be changed by using the [SET SESSION AUTHORIZATION user_identifier](../part-03-sql-manual/20-sql-references-h-z.md#42aca1fe6eac5234) statement as follows. `\`connect commits all transactions being executed and creates a new session whereas the SET SESSION AUTHORIZATION statement changes the user while keeping intact the existing sessions.
...
Interactive mode is terminated by using `\quit` as follows. For more information, refer to [`\quit`](#c275744d6be75f1e).
...
<a id="9528722c70533c60"></a>
| gsql command | Description |
| --- | --- |
| [`\var`](#87b5330091e86d09) | It declares the host variable. |
| [`\exec :var := value`](#c506e216f4f41829) | It assigns the value to the host variable. |
| [`\print`](#6eba5f8209df85e8) | It outputs the value of the host variable. |
| [`\dynamic sql :var`](#73b9dc00b6340c42) | It executes SQL statements stored in the host variable. |

The following is an example of declaring the host variable by using [`\var`](#87b5330091e86d09), and assigning the value to the host variable by using [`\exec :var := value`](#c506e216f4f41829), and querying the value of the host variable by using [`\print`](#6eba5f8209df85e8). For more information, refer to each command.
...
<a id="8b9446b4b8d783a9"></a>
| gsql command | Description |
| --- | --- |
| [`\exec sql`](#80549670d798cab8) | It directly executes the SQL statement. |
| [`\prepare sql`](#8c25b1a4502bcba2) | It prepares the SQL statement. |
| [`\exec`](#d058ccb12a214a65) | It executes the prepared SQL statement. |
| [`\dynamic sql :var`](#73b9dc00b6340c42) | It executes the SQL statement stored in the host variable. |
...
The implementation above which used the PreparedStatement class of Java code may be simulated by using [`\prepare sql`](#8c25b1a4502bcba2) and [`\exec`](#d058ccb12a214a65) as follows.
...
> The following statements are limitedly used in an embedded SQL in other DBMS. On the other hand, in GOLDILOCKS, the following are used not only in an embedded SQL but also can be used as an argument of SQL processing functions when developing the application of ODBC or JDBC.  
> 
> 
> - [SELECT .. INTO](../part-03-sql-manual/20-sql-references-h-z.md#2b53148bdab71da7)
> - [DECLARE cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#ccb6dc5ecb7cf850)
> - [OPEN cursor_name](../part-03-sql-manual/20-sql-references-h-z.md#f2fc3f30b9aedce3)
> - [FETCH cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#b4d62d5536bcdf22)
> - [CLOSE cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#a47858c9b07fa0f3)
> 

<a id="393fc68169a41d2b"></a>
...
<a id="dcd4ded9be36f4ff"></a>
| gsql Command | Description |
| --- | --- |
| [`\explain plan`](#b2aa3f6206da3de5) | It outputs the execution plan for the SQL statement. |
| [`\set autotrace`](#e19dce6dcc8e6cae) | It sets whether to output the execution plan. |

The execution plan of the SQL statement is viewed in an interactive mode by using `\explain plan` or `\set autotrace` as follows. For more information about the command, refer to [`\explain plan`](#b2aa3f6206da3de5) or [`\set autotrace`](#e19dce6dcc8e6cae), and for more information about the analysis of execution plan, refer to [SQL Execution Plan](../part-03-sql-manual/15-sql-tuning.md#47536ffbf1799f38).
...
<a id="a9465ef5c0234fba"></a>
### --as role_name

<a id="1948bb39420a270c"></a>
#### Description

It connects to GOLDILOCKS with role_name.

It connects to GOLDILOCKS with SYSDBA role or ADMIN role, and starts or terminates the server.  
For more information about the description of the role, refer to [Startup and Shutdown Server](#b41f927ffdfb2fb7).

```
% gsql sys gliese --as sysdba
```

<a id="9890ae3c9d2d63b1"></a>
#### Example
...
<a id="257c66c0eb5b6bcf"></a>
### --conn-string

<a id="1bf86403dce91979"></a>
#### Description

It connects to GOLDILOCKS by using the connection string.  
The details of the connection string to be described should used in a form the same as the input string of the ODBC function, [SQLDriverConnect](../part-05-developer-manual/34-odbc.md#e172f2fa8687781b). For more information about the connection string, refer to [SQLDriverConnect](../part-05-developer-manual/34-odbc.md#e172f2fa8687781b) function.

<a id="482e2658cea1af16"></a>
#### Example
...
<a id="bf5d1309b77b8964"></a>
### --dsn

<a id="1e468da1a72f1626"></a>
#### Description

It connects to GOLDILOCKS by using Data Source Name (DSN) defined in the file odbc.ini.  
DSN should be defined in the odbc.ini file. For more information about the odbc.ini file, refer to [DSN Configuration on UNIX](../part-05-developer-manual/34-odbc.md#f337888f6979aca6).  
If DSN is omitted, the default value is GOLDILOCKS.

<a id="9513e2eb14127c0d"></a>
#### Examples
...
<a id="b7540d846e0e45f9"></a>
### --enable-color

<a id="57d3ba6031ab1cd4"></a>
#### Description

It outputs each row of query results in a different color on the terminal to easily distinguish them.  
Each row of the query results is output with a different color in an interactive mode, and it is also applied to the results of the SELECT statement included in the file by using the [--import](#332038835d051cc0) option.

<a id="cc0395a313b38d58"></a>
#### Examples
...
<a id="02d8fedf52af4a66"></a>
### --help

<a id="3f3eba769577f7eb"></a>
#### Description

It briefly displays the option list of gsql program.

<a id="35eafa96ed1ddb3e"></a>
#### Example
...
<a id="332038835d051cc0"></a>
### --import

<a id="7715530a271fcf12"></a>
#### Description
...
<a id="1eb77ba32481f1b5"></a>
### --no-prompt

<a id="174d2049cef48f54"></a>
#### Description

It does not output the prompt when performing an interactive mode.

<a id="b0cef79590a8e47c"></a>
#### Example
...
<a id="a83dd9480bf33ab1"></a>
### --prompt

<a id="1e45b853ec3ba4e5"></a>
#### Description
...
<a id="a8160626cccef9e7"></a>
### --silent

<a id="c2995ace24cd30ad"></a>
#### Description

It does not output the results of SQL statement.  
It is useful when executing large amounts of SQL statements by reading the file with [--import](#332038835d051cc0) command.  
The --silent option is also applied when operating in an interactive mode.

<a id="48131f332c4d966b"></a>
#### Example
...
<a id="0e77920e7155c3d5"></a>
### --version

<a id="e24f3e92fcd1eaed"></a>
#### Description

It outputs the version information of the gsql program.  
It is recommended to use the gsql program with the version the same as the version of GOLDILOCKS. The GOLDILOCKS version can be viewed via the SQL function [VERSION](../part-03-sql-manual/17-built-in-function-references.md#39bf4f4db2bd030c) as follows.
...
<a id="efb18d51fa8b54ae"></a>
### `\connect`

<a id="c6edc9b4629155de"></a>
#### Syntax
...
<a id="8c9f6e07b11b59e2"></a>
### `\cstartup`

<a id="8b19e8df065e1b03"></a>
#### Syntax
...
<a id="9723307bdc8f8822"></a>
#### Description

It starts up GOLDILOCKS server in a cluster environment.

To execute `\cstartup` command, it should connect with SYSDBA role or ADMIN role. For more information about how to connect with SYSDBA role, refer to [startup and shutdown server](#b41f927ffdfb2fb7).
...
- `\cstartup open`
    - It is the same as `\cstartup global open`.
- `\cstartup`
    - It is the same as `\cstartup global open`.

`\cstartup local open`  command and `\cstartup global open` command startup the corresponding server and other servers to the corresponding phase. Other commands are applied only to the corresponding server, so the server should be started up to LOCAL OPEN phase for the multi-level startup using [ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04).

The server startup phases are classified as NOMOUNT, MOUNT, LOCAL OPEN, GLOBAL OPEN. For more information, refer to [multi-level startup](../part-02-administration-manual/5-basic-management-of-goldilocks-database.md#d01e60d7c1eae7b0).

[ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04) should be performed to move on to the next phase after executing `\cstartup` command.

`\cstartup` using glocator can be viewed via [CSTARTUP and CSHUTDOWN](51-glocator.md#2669a328626f7c4e).


> 
> - It is command used only in a C/S environment. It can be used only in gsqlnet.
> - Commands other than `\cstartup nomount/ mount` affects on the corresponding server and other servers. Therefore, if LOCATOR_DSN is not specified in [odbc.ini file](../part-05-developer-manual/34-odbc.md#a37d4e15f0c71e92), then an error occurs.
> 

<a id="fcd5660d9d9532ed"></a>
#### Example
...
<a id="2bd8ace72fea2617"></a>
### `\cshutdown`

<a id="cf68598d9976acdb"></a>
#### Syntax
...
<a id="4123f75ad7c53f1d"></a>
#### Description

It shuts down GOLDILOCKS server in a cluster environment.

To execute `\cshutdown` command, it should connect with SYSDBA role or ADMIN role. For more information about how to connect with SYSDBA role, refer to [startup and shutdown server](#b41f927ffdfb2fb7).
...
- `\`cshutdown
    - It is the same as `\`cshutdown normal.

`\cshutdown` using glocator can be viewed via [CSTARTUP and CSHUTDOWN](51-glocator.md#2669a328626f7c4e).

> • It is command used only in a C/S environment. It can be used only in gsqlnet.  
> • Commands other than `\cshutdown` affects on the corresponding server and other servers. Therefore, if LOCATOR_DSN is not specified in [odbc.ini file](../part-05-developer-manual/34-odbc.md#a37d4e15f0c71e92), then an error occurs.

<a id="619d37c0a326d507"></a>
#### Example
...
<a id="4b69ad97b8a599f8"></a>
### `\ddl_cluster`

<a id="61dc8377eab7d36a"></a>
#### Syntax
...
<a id="72af0c4db34f7b3c"></a>
### `\ddl_db`

<a id="4688df10b252395e"></a>
#### Syntax
...
- Synonym DDL
- Library DDL
- Library privilege DDL
- Stored procedure/ function DDL
- Stored procedure/ function privilege DDL
- Package DDL
...
The DDL statement for the schema above which includes the dictionary information can be output by using [`\ddl_schema`](#71e410b4c291a31e).

<a id="f51b2058663117a9"></a>
#### Examples
...
<a id="026dd09679b822ca"></a>
### `\ddl_tablespace`

<a id="5ddba32bf75fe08a"></a>
#### Syntax
...
<a id="911e27f9a9e73d09"></a>
### `\ddl_profile`

<a id="44e35c49d38e6a50"></a>
#### Syntax
...
<a id="e7d4d15c71453bc4"></a>
### `\ddl_audit_policy`

<a id="e1c70178b7c2fe2f"></a>
#### Syntax
...
<a id="d656c1f06dab0b59"></a>
### `\ddl_user`

<a id="eb56ccd16e74414b"></a>
#### Syntax

```
\ddl_user name
\ddl_user name CREATE
\ddl_user name SCHEMA PATH
\ddl_user name SCHEMA
\ddl_user name SEQUENCE
\ddl_user name TABLE
\ddl_user name CONSTRAINT
\ddl_user name INDEX
\ddl_user name VIEW
\ddl_user name SYNONYM
\ddl_user name LIBRARY
\ddl_user name PROCEDURE
\ddl_user name PACKAGE
\ddl_user name TRIGGER
\ddl_user name COMMENT
```

<a id="b3b40c2e7e64dc5c"></a>
#### Description

It outputs the DDL statements for the current state of the user object.

> The objects stored in the recycle bin are not output.

**`\ddl_user` commands**

<a id="b861fe247675f684"></a>
| Command | Description |
| --- | --- |
| `\ddl_user name` | It performs all options below. |
| `\ddl_user name CREATE` | It outputs the CREATE USER statement of the user object. |
| `\ddl_user name SCHEMA` | It outputs the CREATE SCHEMA statement of schemas owned by a user. |
| `\ddl_user name SCHEMA PATH` | It outputs the ALTER USER statement corresponding to the schema path of the user. |
| `\ddl_user name SEQUENCE` | It outputs the CREATE SEQUENCE statement of sequences owned by a user. |
| `\ddl_user name TABLE` | It outputs the CREATE TABLE statements of tables owned by a user. |
| `\ddl_user name CONSTRAINT` | It outputs the ALTER TABLE statements of constraints owned by a user. |
| `\ddl_user name INDEX` | It outputs the CREATE INDEX statements of indexes owned by a user. |
| `\ddl_user name VIEW` | It outputs the CREATE VIEW statements of views owned by a user. |
| `\ddl_user name SYNONYM` | It outputs the CREATE SYNONYM statements of synonyms owned by a user. |
| `\ddl_user name LIBRARY` | It outputs the CREATE LIBRARY statements of libraries owned by a user. |
| `\ddl_user name PROCEDURE` | It outputs the CREATE PROCEDURE/ FUNCTION statements of procedures and functions owned by a user. |
| `\ddl_user name PACKAGE` | It outputs the CREATE PACKAGE/PACKAGE BODY statements of packages owned by a user. |
| `\ddl_user name TRIGGER` | It outputs the CREATE TRIGGER statements for the triggers owned by the user. |
| `\ddl_user name COMMENT` | It outputs the COMMENT ON AUTHORIZATION statement corresponding to comments on the user. |

<a id="54e8ed488b68d746"></a>
#### Examples

The following is an example of executing `\ddl_user CREATE`.

```
gSQL> \ddl_user h_user CREATE
...
The following is an example of executing `\ddl_user SCHEMA`.

```
gSQL> \ddl_user h_user SCHEMA
...
The following is an example of executing `\ddl_user TABLE`.

```
gSQL> \ddl_user h_user TABLE
...
<a id="ed2c1c9efa24cd42"></a>
### `\ddl_role`

<a id="c831d4e89e5c7e38"></a>
#### Syntax

```
\ddl_role name
\ddl_role name CREATE
\ddl_role name GRANT
\ddl_role name COMMENT
```

<a id="b28de2a630f6a50a"></a>
#### Description

It outputs the DDL statements for the current state of the role object.

**`\ddl_role` commands**

<a id="4850b8bc649a82ad"></a>
| Command | Description |
| --- | --- |
| `\ddl_role name` | It performs all options below. |
| `\ddl_role name CREATE` | It outputs the CREATE ROLE statement of the role object. |
| `\ddl_role name GRANT` | It outputs the GRANT role statement which granted the role. |
| `\ddl_role name COMMENT` | It outputs the COMMENT ON AUTHORIZATION statement corresponding to comments on the role. |

<a id="1d644c6872fbe53d"></a>
#### Example

The following is an example of performing `\ddl_role name` command.
...
SET SESSION AUTHORIZATION "SYS"; 
COMMENT 
    ON AUTHORIZATION "ROLE1" 
    IS 'role test comment' 
;
COMMIT;
```

<a id="71e410b4c291a31e"></a>
### `\ddl_schema`

<a id="c93d69cb3ed119d9"></a>
#### Syntax
...
| `\ddl_schema name SEQUENCE` | It outputs the CREATE SEQUENCE statement of the sequences which belongs to the schema. |
...
| `\ddl_schema name LIBRARY` | It outputs the CREATE LIBRARY statements of the libraries which belongs to the schema. |
...
| `\ddl_schema name TRIGGER` | It outputs the CREATE TRIGGER statements for the triggers that belongs to the schema. |
...
<a id="444545ef80a9d224"></a>
### `\ddl_public_synonym`

<a id="dc51440efb2ff6e1"></a>
#### Syntax
...
<a id="52089fde006adab6"></a>
### `\ddl_library`

<a id="c81b1bc8234768fb"></a>
#### Syntax

```
\ddl_library name
\ddl_library name CREATE
\ddl_library name GRANT
\ddl_library name COMMENT
```

<a id="b7c41642c4947092"></a>
#### Description

It outputs the DDL statements for the current state of a library object.

**`\ddl_library` commands**

<a id="1e1bd52837352da4"></a>
| Command | Description |
| --- | --- |
| `\ddl_library name` | It performs all options below. |
| `\ddl_library name CREATE` | It outputs the CREATE LIBRARY statement for the library object. |
| `\ddl_library name GRANT` | It outputs the GRANT ... ON LIBRARY statements for the library’s privilege information. |
| `\ddl_library name COMMENT` | It outputs the COMMENT ON LIBRARY statement for the library’s comments. |

<a id="64161d96414d4034"></a>
#### Example

The following is an example of executing `\ddl_library CREATE`.

```
gSQL> \ddl_library lib1 CREATE
SET SESSION AUTHORIZATION "TEST";
CREATE OR REPLACE LIBRARY "PUBLIC"."LIB1" AS 'lib1.so';
/
COMMIT;
```

<a id="a49f7bd12dc80b5b"></a>
### `\ddl_table`

<a id="340ab534e16542cf"></a>
#### Syntax
...
| `\ddl_table name TRIGGER` | It outputs the CREATE TRIGGER statements of the triggers created in the table. |
...
<a id="219f65c5fbd6ceb9"></a>
### `\ddl_constraint`

<a id="5939ca56e8de2b4d"></a>
#### Syntax
...
<a id="6b5af83dd8a49533"></a>
### `\ddl_index`

<a id="7de00569eee7ef08"></a>
#### Syntax
...
<a id="8d26106fc8b5f4af"></a>
### `\ddl_view`

<a id="856522e5fb3f9ef7"></a>
#### Syntax
...
<a id="be31a577b95e5d1d"></a>
### `\ddl_sequence`

<a id="3d8726203fb23bfd"></a>
#### Syntax
...
<a id="6817eb5b4e4c517f"></a>
### `\ddl_synonym`

<a id="8ccf5cd38a526e9f"></a>
#### Syntax
...
<a id="e1b29eaaf5f1def8"></a>
### `\ddl_procedure`

<a id="f2d4cc3e453bbba6"></a>
#### Syntax

```
\ddl_procedure name
\ddl_procedure name CREATE
\ddl_procedure name GRANT
\ddl_procedure name COMMENT
```

<a id="8b60af3fa987303b"></a>
#### Description
...
| `\ddl_procedure name GRANT` | It outputs the GRANT ... ON PROCEDURE statements for the stored procedure or function. |
| `\ddl_procedure name COMMENT` | It outputs the COMMENT ON PROCEDURE statement for the stored procedure or function. |

<a id="ab0231b4e1adb5a3"></a>
#### Example
...
<a id="d09b7bf80619ae43"></a>
### `\ddl_package`

<a id="7c99de208fd69025"></a>
#### Syntax

```
\ddl_package name
\ddl_package name CREATE
\ddl_package name GRANT
\ddl_package name COMMENT
```

<a id="624d21fe0a518832"></a>
#### Description
...
| `\ddl_package name GRANT` | It outputs the GRANT .. ON PACKAGE statements for the package spec’s privilege information. |
| `\ddl_package name COMMENT` | It outputs the COMMENT ON PACKAGE statement for the package spec. |

<a id="9eb767cb8409bfeb"></a>
#### Examples
...
<a id="468a1a5f912f53c6"></a>
### `\ddl_trigger`

<a id="bf16a3dea47934fd"></a>
#### Syntax

```
\ddl_trigger name
\ddl_trigger name CREATE
\ddl_trigger name COMMENT
```

<a id="6a447cd07cbf5b91"></a>
#### Description

It outputs the DDL statement that reflects the current state of the trigger.

> The objects stored in the recycle bin are not output.

**`\ddl_trigger` commands**

<a id="3aa65f3cd87d44bf"></a>
| Command | Description |
| --- | --- |
| `\ddl_trigger` | It performs all options below. |
| `\ddl_trigger name CREATE` | It outputs the CREATE TRIGGER statement of the trigger object. |
| `\ddl_trigger name COMMENT` | It outputs the COMMENT ON TRIGGER statement corresponding to the comment on the trigger. |

<a id="69b2174b38e06052"></a>
#### Example

The following is an example of executing the `\ddl_trigger`.

```
gSQL> \ddl_trigger trg1 CREATE

SET SESSION AUTHORIZATION "TEST"; 
CREATE OR REPLACE TRIGGER "PUBLIC"."TRG1" 
    AFTER INSERT 
        ON "PUBLIC"."T1" 
    FOR EACH STATEMENT 
    ENABLE 
...
<a id="c9c38608b0992844"></a>
### `\desc`

<a id="4058f1c6be9189fc"></a>
#### Syntax
...
<a id="f58845fde7ad1643"></a>
#### Description

It queries the structure information of the table.

A table may be described only with the table name as follows or described together with the schema name. If the schema name is not specified, the schema name of the table is determined by the [Schema Path](../part-03-sql-manual/13-sql-objects.md#99f767e717d501b2) of the user.

- `\desc` t1
- `\desc` public.t1

If a table name is created by using [Identifiers](../part-03-sql-manual/11-sql-elements.md#e5afdf099617232e) when creating a table as follows, the double quotes (") is used to describe it.
...
<a id="73b9dc00b6340c42"></a>
### `\dynamic sql :var`

<a id="20e0bb51a7112286"></a>
#### Syntax
...
<a id="985f9380b7303070"></a>
#### Description

It executes the SQL statement stored in the host variable var.  
It is similar in concept to [Embedded Dynamic SQL](../part-05-developer-manual/36-embedded-sql.md#125731fd5648b0c7) which executes SQL statements that are not defined in an embedded SQL, but It is used when performing SQL statement which is not defined.

It is performed in the following order.

1. Declare a host variable. (Refer to [`\var`](#87b5330091e86d09).)  
   `\var` var_stmt VARCHAR(1024)
2. Assign an SQL statement as the value of the host variable. (Refer to [`\exec :var := value`](#c506e216f4f41829).)  
   `\exec` :var_stmt := 'SELECT # FROM t1'
3. Execute the dynamic SQL.  
   `\dynamic sql` :var_stmt

<a id="8c6304924a0aebbf"></a>
#### Examples
...
Two single quote (') are described like as the usage of the [`\exec :var := value`](#c506e216f4f41829) command when a string exists in an SQL statement as the INSERT statement below.
...
<a id="8d3af67567b259ad"></a>
### `\edit`

<a id="5f3c911c0ecd6baa"></a>
#### Description
...
The following can be edited by using `\edit.`
...
<a id="2eea8e01cbd9303e"></a>
#### `\edit`

<a id="e66d290bf59e66a9"></a>
##### Syntax
...
<a id="629a468efcb43a77"></a>
#### `\edit 'file_name'`

<a id="67f08bd75d146d6b"></a>
##### Syntax
...
<a id="571af76b48087fe6"></a>
#### `\edit [history] {n}`

<a id="0556aaaee049939f"></a>
##### Syntax
...
<a id="c7fea975a363d00d"></a>
##### Description

It edits the SQL statement corresponding to the number from the SQL execution history which can be queried by using [`\history`](#9f14049285550897).  
The value of number should be the ID value that is the result of executing [`\history`](#9f14049285550897).

<a id="a554b072864a2b6d"></a>
##### Example
...
<a id="d058ccb12a214a65"></a>
### `\exec`

<a id="162ba80e0a26fb8a"></a>
#### Syntax
...
<a id="d0184f37b6097634"></a>
#### Description

It executes the SQL statement which is prepared by [`\prepare sql`](#8c25b1a4502bcba2).  
`\exec` operates similarly to the  [SQLExecute](../part-05-developer-manual/34-odbc.md#0b76dab8dddaa8c1) function of ODBC and PreparedStatement::[execute](../part-05-developer-manual/35-jdbc.md#319a259508c2df77) function of JDBC.  
The prepared SQL statements can be repeatedly executed by using `\exec`.

<a id="b390ef7db51e6d20"></a>
#### Examples
...
<a id="c506e216f4f41829"></a>
### `\exec :var := value`

<a id="801a78899741adaa"></a>
#### Syntax
...
<a id="cb5e6763bacd2428"></a>
#### Description

It assigns the value to the host variable.  
This command assigns a value to the host variable in the same way as executing [SELECT .. INTO](../part-03-sql-manual/20-sql-references-h-z.md#2b53148bdab71da7) as follows.
...
The host variable must have been declared with [`\var`](#87b5330091e86d09).

The host variable must be used together with colon (:), and the assignment operator (:=) is not allowed to omit (:). Simple values or operators may appear in &lt;value expression&gt; entered to the host variable. For more information, refer to [Expressions](../part-03-sql-manual/11-sql-elements.md#f3a30ecf2e1cfcc4).

The value assigned to the host variable should be compatible with the data type of the host variable. For more information, refer to [Type Conversion](../part-03-sql-manual/11-sql-elements.md#fc718a805c53e7ba).

The value assigned to the host variable may be queried by using [`\print`](#6eba5f8209df85e8).
...
The following is an example of obtaining the value to the host variable via [SELECT .. INTO](../part-03-sql-manual/20-sql-references-h-z.md#2b53148bdab71da7).
...
<a id="80549670d798cab8"></a>
### `\exec sql`

<a id="ee16305ff972e1d9"></a>
#### Syntax
...
<a id="db0e7c15cda465e8"></a>
#### Description

It executes the SQL statement described in &lt;sql_statement&gt;.  
It operates the same as the execution of the SQL statement at the prompt as follows.
...
The SQL statement is executed with the PREPARE/EXECUTE method using [`\prepare sql`](#8c25b1a4502bcba2) and [`\exec`](#d058ccb12a214a65). On the other hand, `\exec sql` executes the SQL statement with the DIRECT EXECUTE method corresponding to [SQLExecDirect](../part-05-developer-manual/34-odbc.md#04841cd200e28204) function of ODBC and to Statement::[execute](../part-05-developer-manual/35-jdbc.md#39fd4ecf928685e7) function of JDBC.

<a id="bffe2f58cbdb9318"></a>
#### Example
...
<a id="b2aa3f6206da3de5"></a>
### `\explain plan`

<a id="2162110f4b99d5ec"></a>
#### Syntax
...
For more information about the execution plan, refer to [SQL Execution Plan](../part-03-sql-manual/15-sql-tuning.md#47536ffbf1799f38).

<a id="11910f701ff28934"></a>
#### Examples
...
<a id="5753a8c373223e55"></a>
### `\help`

<a id="44de795ad19c758d"></a>
#### Syntax
...
<a id="313b704687c451c0"></a>
### `\host`

<a id="000fe2e4654c2635"></a>
#### Syntax
...
<a id="9f14049285550897"></a>
### `\history`

<a id="dce14fcd9af4167a"></a>
#### Syntax
...
The previously executed SQL statements can be executed again referring to the list through [`\\`](#6d6c52029506b7f0)  or [`\{n}`](#fc70ebfe00120207).  
The number of manageable SQL statements is controlled by using [`\set history`](#5ce1022ef443ca1b).

<a id="29f3f73111f2ea84"></a>
#### Example
...
<a id="89b7cd3ca6312acb"></a>
### `\import`

<a id="e44b398fa57921e3"></a>
#### Syntax
...
<a id="fa5cb11bb51d07fa"></a>
### `\idesc`

<a id="82fc502726b421ca"></a>
#### Syntax
...
<a id="9525a73245a8204b"></a>
#### Description

It queries the structure information of the index.

An index can be described alone as follows or it can be described together with the schema name. If the schema name is not specified, the schema name of the index is determined by the user's [Schema Path](../part-03-sql-manual/13-sql-objects.md#99f767e717d501b2).
...
<a id="fc70ebfe00120207"></a>
### `\{n}`

<a id="9245b6184ba0bc1d"></a>
#### Syntax
...
<a id="e7b0257b7313b4ee"></a>
#### Description

It executes the SQL statement corresponding to the number from the SQL execution history which can be queried by using [`\history`](#9f14049285550897).  
The value of number should be the ID value that is the result of executing [`\history`](#9f14049285550897).

<a id="d6f02173c716d541"></a>
#### Examples
...
<a id="8c25b1a4502bcba2"></a>
### `\prepare sql`

<a id="b5d80b2aec52b20c"></a>
#### Syntax
...
<a id="28359ff8a05066f4"></a>
#### Description

It prepares the SQL statement described in &lt;sql_statement&gt;. The prepared SQL statement can be executed repeatedly with [`\exec`](#d058ccb12a214a65).

`\prepare sql` operates similarly to the [SQLPrepare](../part-05-developer-manual/34-odbc.md#683d49eae3436a63) functions of ODBC and Connection::[prepareStatement](../part-05-developer-manual/35-jdbc.md#a4764d7c8eecb1b7) function of JDBC.

<a id="93c9ed42351af1b0"></a>
#### Example
...
<a id="6eba5f8209df85e8"></a>
### `\print`

<a id="1a1973194be6a30f"></a>
#### Syntax
...
<a id="b2132494d15da101"></a>
#### Description

It queries the value of host variable declared with [`\var`](#87b5330091e86d09) as follows. If the value of host variable is not set, it is NULL.
...
<a id="c275744d6be75f1e"></a>
### `\quit`

<a id="00a0e15a9eac3f0c"></a>
#### Syntax
...
<a id="221f4964eb27e09f"></a>
### `\set autocommit`

<a id="c6d3af28bc9aa95e"></a>
#### Syntax
...
<a id="e19dce6dcc8e6cae"></a>
### `\set autotrace`

<a id="ef594dc1f3a9c10f"></a>
#### Syntax
...
For more information, refer to [SQL execution plan](../part-03-sql-manual/15-sql-tuning.md#47536ffbf1799f38).

<a id="4c2964b0254b77d2"></a>
#### Example
...
<a id="2bbe16af4ae6b336"></a>
### `\set color`

<a id="83842bf283a5929f"></a>
#### Syntax
...
<a id="4e66fbba3816951e"></a>
### `\set colsize`

<a id="3d52a67b44feb538"></a>
#### Syntax
...
<a id="b75e74d2155c734a"></a>
### `\set ddlsize`

<a id="5b6a18a26b7f0a7f"></a>
#### Syntax
...
<a id="7af00f280e63c599"></a>
### `\set error`

<a id="6ed59133d23f0c0c"></a>
#### Syntax
...
<a id="b16d59e4c8d5d339"></a>
### `\set heading`

<a id="c69621be5e6b2dfc"></a>
#### Syntax
...
<a id="5ce1022ef443ca1b"></a>
### `\set history`

<a id="07db52d28ff9e792"></a>
#### Syntax
...
The history information is used when executing the previously executed SQL statement again through [`\\`](#6d6c52029506b7f0) and [`\{n}`](#fc70ebfe00120207).

<a id="358e296d19ee9833"></a>
#### Example
...
<a id="a7004670c7795676"></a>
### `\set linesize`

<a id="c7f5f2ba355737b2"></a>
#### Syntax
...
<a id="d0d5655823bc9dd5"></a>
### `\set numsize`

<a id="0024ef55f820514b"></a>
#### Syntax
...
<a id="ae98de2c325dc879"></a>
### `\set pagesize`

<a id="fb6f927c48ba04c2"></a>
#### Syntax
...
<a id="e3d1affe26e273b8"></a>
### `\set serveroutput`

<a id="9f02a78dc385bf03"></a>
#### Syntax
...
<a id="861f5dfe76bdf17d"></a>
### `\set sqlprompt`

<a id="573124bda16f1cbc"></a>
#### Syntax
...
<a id="86f46a4bf9865da4"></a>
### `\set time`

<a id="f4134b4ce65852e1"></a>
#### Syntax
...
<a id="0fe9f4d794873701"></a>
### `\set timing`

<a id="3b3d77a2df2ac287"></a>
#### Syntax
...
<a id="87d0d174acab6db9"></a>
### `\set vertical`

<a id="88ba839da3bf345e"></a>
#### Syntax
...
<a id="497f2d8b728ed1db"></a>
### `\shutdown`

<a id="3b42d781b9c394c2"></a>
#### Syntax
...
<a id="cac1d843d12adf59"></a>
#### Description

It shuts down the GOLDILOCKS server.  
It should be connected as SYSDBA or ADMIN role to perform `\shutdown`. For more information about connecting as SYSDBA, refer to [Startup and Shutdown Server](#b41f927ffdfb2fb7).
...
- `\shutdown abort`
    - The server is forcibly shut down immediately regardless of the status of the currently connected session.
- `\shutdown`
    - It is the same as `\shutdown normal`.
...
<a id="f66eb0c6ad743d0e"></a>
### `\spool`

<a id="7336ab84b878b169"></a>
#### Description

It sets all results output by using gsql to be stored in the terminal and file.

<a id="b1afa9ee28264025"></a>
#### `\spool 'filename'`

<a id="5fefe15ebc34c632"></a>
##### Syntax
...
- REPLACE: It removes the contents of an existing file, and newly starts storing. If a file does not exist, it performs the same as CREATE.
- APPEND: It continues to store the contents from the end of an existing file. If a file does not exist, it performs the same as CREATE.
...
<a id="5ec21f3c4b8f189b"></a>
#### `\spool OFF`

<a id="5ac37cc618729f1d"></a>
##### Syntax
...
<a id="95a188b090cdb841"></a>
#### `\spool`

<a id="8f6faa5736d8dff9"></a>
##### Syntax
...
<a id="0d7e093005ada44e"></a>
### `\startup`

<a id="84feea7446f3d051"></a>
#### Syntax
...
<a id="14f3932fdaf649d5"></a>
#### Description

It starts up the GOLDILOCKS server.  
It should be connected as SYSDBA or ADMIN role to perform `\startup`.   
For more information about connecting as SYSDBA, refer to [Startup and Shutdown Server](#b41f927ffdfb2fb7).
...
- `\startup `
    - It is the same as `\startup open`.

The server start up is divided into NOMOUNT, MOUNT, OPEN phase. For more information, refer to [Multi-level Startup](../part-02-administration-manual/5-basic-management-of-goldilocks-database.md#d01e60d7c1eae7b0).  
Execute [ALTER SYSTEM {MOUNT | OPEN} DATABASE](../part-03-sql-manual/18-sql-references-a-b.md#3a13c91fdabdaa04) statement to move on to the next phase after executing `\startup`.

<a id="3882da884b66c481"></a>
#### Example
...
<a id="87b5330091e86d09"></a>
### `\var`

<a id="11b013340ac3e32b"></a>
#### Syntax
...
<a id="991a0f2bacbfa7ac"></a>
#### Description

It declares the host variable.  
When declaring the host variable which is the same as variable_name, the existing host variable is removed and a new one is declared. The maximum length of variable_name is 128 bytes.  
The data_type of host variable is the same as the data type of GOLDILOCKS.   
For more information, refer to [Data Type](../part-03-sql-manual/11-sql-elements.md#d31560e2b64a41fa).  
The host variable assigns the value by using [`\exec :var := value`](#c506e216f4f41829) , and its value is queried by using [`\print`](#6eba5f8209df85e8).
...
The host variable can be used as an input or output parameter in the SQL statement. When the host variable is used in the SQL statement or [`\exec :var := value`](#c506e216f4f41829), a colon (:) sign should be put in front of the host variable to indicate that it is a host variable.

<a id="9108fa7bf8e22466"></a>
#### Example
...
In the following [UPDATE name RETURNING .. INTO](../part-03-sql-manual/20-sql-references-h-z.md#dcfb5da7eb1383a2) statement, the host variable of SET clause and WHERE clause, :v_id, is used as an input argument and :v_id of INTO clause is used as an output argument.
