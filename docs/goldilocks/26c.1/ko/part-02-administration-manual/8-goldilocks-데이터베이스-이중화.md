<a id="7cc96a95ca07ac01"></a>

# 8. GOLDILOCKS 데이터베이스 이중화

> 원본: [GOLDILOCKS 26c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/ko/7cc96a95ca07ac01)  
> 태그: `26c.1_0_tag`
...
<a id="114cc5fc79063cc0"></a>
## 운영 방법

<a id="940f18f3c9e6ad5d"></a>
### CYCLONE

일반적인 운영 방법과 옵션에 대한 자세한 내용은 [CYCLONE](../part-07-replication/55-cyclone.md#6bfdb1f20080b551)을 참조한다.

<a id="de0742b5a3f5740a"></a>
#### 노드 추가와 삭제

CYCLONE은 group 단위로 수행되며 이는 이중화 노드와 동일하다. 만약 노드를 추가할 경우에는 group을 추가하고 삭제할 경우에는 group을 삭제하도록 한다.

<a id="f9fe4a2e02f9e1e8"></a>
##### 노드 추가 예
...
<a id="d45ae71d69fd7988"></a>
### LOGMIRROR

일반적인 운영 방법과 옵션에 대한 자세한 내용은 [LOGMIRROR](../part-07-replication/56-logmirror.md#acaaf24f833b2133)를 참조한다.

<a id="19963127de502809"></a>
#### LOGMIRROR 상태 확인
...
<a id="845e4c12660f7729"></a>
### CYFILE

일반적인 운영 방법과 옵션에 대한 자세한 내용은 [CYFILE](../part-07-replication/57-cyfile.md#e8ef64243ada8703)을 참조한다.

<a id="ad354ef7b3b6e630"></a>
#### Cyfile 시작과 종료, 상태 확인

<a id="c3063dfedb419c03"></a>
##### 운영 예
...
<a id="abf4d5dba0278374"></a>
## Trace Log

Trace log에 대한 자세한 정보는 다음과 같다.

<a id="cbd678895f00b8b8"></a>
