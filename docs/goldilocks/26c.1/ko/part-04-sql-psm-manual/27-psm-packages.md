<a id="459fd69c7c9bf4ae"></a>

# 27. PSM Packages

> 원본: [GOLDILOCKS 26c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/ko/459fd69c7c9bf4ae)  
> 태그: `26c.1_0_tag`

[← 26. Using SQLs in PSM](26-using-sqls-in-psm.md) · [전체 목차](../README.md) · [28. External Routine →](28-external-routine.md)

본 장에서는 package를 이용하여 여러 응용 프로그램에서 공통으로 사용되는 데이터와 PSM 코드를 모듈화하는 방법에 대해 설명한다.

<a id="e2166f3bc51b7686"></a>
## 정의
