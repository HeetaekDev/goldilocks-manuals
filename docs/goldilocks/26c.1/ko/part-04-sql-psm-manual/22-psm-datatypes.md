<a id="7f42b903621d52b1"></a>

# 22. PSM DataTypes

> 원본: [GOLDILOCKS 26c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/ko/7f42b903621d52b1)  
> 태그: `26c.1_0_tag`

[← 21. Overview of PSM](21-overview-of-psm.md) · [전체 목차](../README.md) · [23. PSM Control Statements →](23-psm-control-statements.md)

<a id="f76622f7fd2278a0"></a>
## Built-in Data Types

GOLDILOCKS PSM은 GOLDILOCKS SQL에서 제공되는 모든 기본 데이터 타입들을 동일하게 지원한다.   
기본 데이터 타입들의 종류는 다음과 같다.   
자세한 내용은 [Data Type](../part-03-sql-manual/11-sql-elements.md#0e511565dcb79955)을 참조한다.

<a id="5159b95ced7057b1"></a>
### 숫자 타입
...
<a id="804f305f58cdb229"></a>
### BOOLEAN 타입

BOOLEAN

<a id="727eb65c0438fd83"></a>
### ROWID 타입

ROWID

<a id="6d902d7b2e5c1eb0"></a>
...
자세한 내용은 [Built-in Data Type References](../part-03-sql-manual/16-built-in-data-type-references.md#fbbaddaf098ef635)를 참조한다.

<a id="0fb66e4214899a16"></a>
...
자세한 내용은 [COLLECTION Variable Declaration](30-psm-language-element-references.md#a4387f0fa0f4d9b3)을 참조한다.

<a id="6ca0e92433f7aad4"></a>
### Associative Array
...
자세한 내용은 [Built-in Data Types](#f76622f7fd2278a0), [%TYPE](#8e1584654c03dcb3), [%ROWTYPE](#4560dabeaf087598), [User-defined Record Type](#0d8015878f2dc30c)을 참조한다.

<a id="4cf5ed3556e0cd08"></a>
...
자세한 내용은 [Cursor Variable](24-psm-cursor-statements.md#e6ac2303663621ef), [Cursor Variable Declaration](30-psm-language-element-references.md#5c050768d81529dc), [OPEN FOR Statement](30-psm-language-element-references.md#eb4bf8bad6641506)를 참조한다.
