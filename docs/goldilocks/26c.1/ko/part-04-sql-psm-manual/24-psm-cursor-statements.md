<a id="0da497d379de37a3"></a>

# 24. PSM Cursor Statements

> 원본: [GOLDILOCKS 26c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/ko/0da497d379de37a3)  
> 태그: `26c.1_0_tag`
...
<a id="d11811e5e97dee0e"></a>
### Opening and Closing Explicit Cursors

- Explicit cursor를 선언 (declaration)하고 정의 (definition) 한 후에는 [OPEN Statement](30-psm-language-element-references.md#80c65120562ef0bf)를 실행하여 cursor query를 수행한다.
...
- Explicit cursor를 사용한 후에는 [CLOSE Statement](30-psm-language-element-references.md#c59c992edb95f702)를 실행하여 닫을 수 있다. Explicit cursor가 닫힌 후에는 결과 집합에서 레코드를 가져올 수 없다.
- Explicit cursor가 OPEN 된 후로는 다시 OPEN할 수 없으며, 다시 OPEN 하려면 CLOSE를 먼저 수행한 후에 OPEN 해야 한다.

<a id="d4d0e91f04765b55"></a>
...
<a id="3bd34ffa2473da46"></a>
### Fetching Data with Explicit Cursors

- Explicit cursor를 OPEN 한 후에 [FETCH Statement](30-psm-language-element-references.md#2be71b2c548c858e)를 실행하여 결과 집합의 row를 가져올 수 있다.
- Fetch statement는 결과 집합의 현재 ROW를 검색하고 해당 ROW 값을 PSM variable 또는 record type variable에 저장하고 커서를 다음 ROW로 이동시킨다.
- PSM [FETCH Statement](30-psm-language-element-references.md#2be71b2c548c858e)는 fetch 된 ROW가 없더라도 예외를 발생시키지 않는다.
- [Basic LOOP Statement](30-psm-language-element-references.md#1c43bddc54c05d9e)에서 FETCH를 수행할 경우 종료 조건을 감지하기 위해 %NOTFOUND 속성을 활용한다.

<a id="46f3ee235a4d920c"></a>
...
<a id="e6ac2303663621ef"></a>
## Cursor Variable

<a id="85adad30cddf6835"></a>
### Create Cursor Variables

Cursor variable을 생성하려면 미리 정의된 SYS_REFCURSOR type의 variable을 선언하거나 REF CURSOR TYPE을 정의하여 해당 유형의 variable을 선언한다. 자세한 내용은 [Cursor Variable Declaration](30-psm-language-element-references.md#5c050768d81529dc)을 참조한다.
...
<a id="01bdd9c426cab862"></a>
### Opening and Closing Cursor Variables

- Cursor variable을 선언한 후에 [OPEN FOR Statement](30-psm-language-element-references.md#eb4bf8bad6641506)를 수행하여 cursor variable과 수행할 SELECT 문 또는 DML 문을 연결한다.
...
- Cursor variable 사용이 끝난 경우, [CLOSE Statement](30-psm-language-element-references.md#c59c992edb95f702)를 수행하면 된다.
- CLOSE 된 cursor variable의 질의 결과에 접근하거나, cursor variable 속성을 참조할 수 없다.

<a id="2a650d39c82e2fd1"></a>
...
<a id="131892828909a2b3"></a>
### Fetching Data with Cursor Variables

Cursor variable을 OPEN 한 후에 [FETCH Statement](30-psm-language-element-references.md#2be71b2c548c858e)를 실행하여 결과 집합의 row를 가져올 수 있다. Cursor variable이 반환하는 결과는 into 절과 호환되어야 한다.

<a id="36e272a2a4cf5307"></a>
