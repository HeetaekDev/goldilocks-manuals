<a id="1cd4a912e327f04f"></a>

# 부록 A. SQLSTATE

> 원본: [GOLDILOCKS 26c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/26c_1/manual/ko/1cd4a912e327f04f)  
> 태그: `26c.1_0_tag`

[← 57. CYFILE](../part-07-replication/57-cyfile.md) · [전체 목차](../README.md) · [부록 B. Error Codes →](appendix-02-부록-b-error-codes.md)
