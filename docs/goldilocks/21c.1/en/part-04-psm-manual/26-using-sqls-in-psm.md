<a id="749e086e9f9574d3"></a>

# 26. Using SQLs in PSM

> Source: [GOLDILOCKS 21c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/en/749e086e9f9574d3)  
> Tag: `21c.1_35_tag`

[← 25. Using PSM Subprograms](25-using-psm-subprograms.md) · [Table of contents](../README.md) · [27. PSM Packages →](27-psm-packages.md)

<a id="e0315319d15584d4"></a>
## Static SQLs

Static SQLs are SQLs can be used in PSM, and it is classified are follows.

- [SELECT](#2d70c1ea21c1d54c)
- [INSERT](#9a5d9d2ab8457878)
- [UPDATE](#585acf789e1d83f8)
- [DELETE](#76ffe1a4be0aa80c)
- [RETURNING INTO](#4db9e97d86366313)
- [LOCK TABLE](../part-03-sql-manual/20-sql-references-h-z.md#3cab30ef4432268b)
- [COMMIT, ROLLBACK, SAVEPOINT](#c8fd5e3ec320e45f)
...
For more information, refer to [Data Query Language](../part-03-sql-manual/12-sql-languages.md#14e0ab3aad15e729).
...
For more information, refer to [Inserting Data](../part-03-sql-manual/12-sql-languages.md#fbe7e4e1c0a6f422).
...
For more information, refer to [%ROWTYPE](22-psm-datatypes.md#2d97dd2e13e6364c).
...
For more information, refer to [User Defined Record Type](22-psm-datatypes.md#6ffbb5b56611eb22).
...
For more information, refer to [Updating Data](../part-03-sql-manual/12-sql-languages.md#5b96773b7a4d8e4c).
...
- A dynamic SQL can be used in the following PSM statements.
    - [EXECUTE IMMEDIATE Statement](28-psm-language-element-references.md#ebc3b02f3a91e9a5)
    - [OPEN FOR Statement](28-psm-language-element-references.md#6d4cf3147f1dedd7)

<a id="0c3678322eb0034e"></a>
### EXECUTE IMMEDIATE
...
For more information. refer to [EXECUTE IMMEDIATE Statement](28-psm-language-element-references.md#ebc3b02f3a91e9a5).

<a id="6555a5edb8860bf8"></a>
...
For more information, refer to [OPEN FOR Statement](28-psm-language-element-references.md#6d4cf3147f1dedd7), [FETCH Statement](28-psm-language-element-references.md#9465148be3936598), [CLOSE Statement](28-psm-language-element-references.md#01dc464a2fb89d38).
