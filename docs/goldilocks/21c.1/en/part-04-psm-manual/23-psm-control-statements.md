...
- Variable (Refer to [PSM DataTypes](22-psm-datatypes.md#ba22b900ac4fc77d).)
- User defined type
- Cursor
...
- Control Statements (Refer to [PSM Control Statements](#ae97a326417f17b0).)
- Cursor Statements (Refer to [PSM Cursor Statements](24-psm-cursor-statements.md#e13895251cbeebda).)
- SQL Statements (static/ dynamic) (Refer to [Using SQLs In PSM](26-using-sqls-in-psm.md#749e086e9f9574d3).)

<a id="16ab5a2025449bca"></a>
...
For more information about declaration of user defined exception, built-in handler types or installing a handler, refer to [Error Handling](#08a6c25b108591b9).

<a id="03c3fea7457e2174"></a>
## NULL Statement

It is used to specify a statement which does not have any role in PSM such as no-op.  
For more information, refer to [NULL Statement](28-psm-language-element-references.md#6a84eba346868192).
...
For more information, refer to [IF Statement](28-psm-language-element-references.md#da8dce561b100a86).
...
For more information, refer to [CASE Statement](28-psm-language-element-references.md#b66bcb3b838b7ba0).
...
For more information, refer to [Basic LOOP Statement](28-psm-language-element-references.md#fd312ea63b41c8df).
...
For more information, refer to [EXIT Statement](28-psm-language-element-references.md#bcad655e91a81cf4).
...
<a id="942be232ed895352"></a>
### FOR Loop

FOR loop statement repeatedly performs a series of statements as many times as the number of integers of the given scope.  
For more information, refer to [FOR LOOP Statement](28-psm-language-element-references.md#b3eb5133530f8cd3).

A user creates an index variable with the name specified next to FOR keyword.  
Then, it sets the lower bound specified on the left side of a scope operator (..) which is next to IN keyword as an initial value of the index variable. Then, it performs a series of statements by increasing the index variable by 1 per each loop until it becomes as same as the higher bound specified on the right side of a scope operator (..).
...
<a id="5d0c646ca07e2aad"></a>
### WHILE Loop

WHILE loop statement repeatedly performs a series of statements while the given condition is TRUE.  
For more information, refer to [WHILE LOOP Statement](28-psm-language-element-references.md#057cf5db41935654).
...
For more information, refer to [GOTO Statement](28-psm-language-element-references.md#fa8dbf1bbd497d90).
...
For more information, refer to [CONTINUE Statement](28-psm-language-element-references.md#563c79564c66425f).
...
For more information, refer to [EXCEPTION Handling](#6444c51dbda0d674), [SQLCODE Function](28-psm-language-element-references.md#f983d26cbc71bfaa), [SQLERRM Function](28-psm-language-element-references.md#56ecea6ef4d591b9).

<a id="c4ea9007d8af5c38"></a>
### Cursor Attributes
...
> For more information about a predefined exception or a user defined exception provided by GOLDILOCKS, refer to [Exception Declaration](28-psm-language-element-references.md#a3204b1ac8bda008).

<a id="8e80f4fd27ee1550"></a>
