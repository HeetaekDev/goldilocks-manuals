<a id="71ca66a5b7a23af9"></a>

# 3. Cluster Tutorial

> Source: [GOLDILOCKS 21c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/en/71ca66a5b7a23af9)  
> Tag: `21c.1_35_tag`

[← 2. Tutorial](2-tutorial.md) · [Table of contents](../README.md) · [4. What's New →](4-what-s-new.md)

<a id="ac0f9e082e604b8d"></a>
...
[listener](../part-06-utility-manual/38-glsnr.md#97381bb2ec74e482) should be in operation if a user wants to start or end GOLDILOCKS cluster system in dedicated mode of C/S model(to use gsqlnet).
...
- [ALTER CLUSTER GROUP name ADD MEMBER](../part-03-sql-manual/18-sql-references-a-b.md#0a6879be2602f377)
- [CREATE CLUSTER GROUP](../part-03-sql-manual/19-sql-references-c-g.md#3f7a6957233a40f7)
...
For more information about creating table, refer to [CREATE TABLE](../part-03-sql-manual/19-sql-references-c-g.md#4c3b06d433f75b3d) and [Cluster Table and Shard](../part-03-sql-manual/14-cluster-objects.md#6a3c9da5975bc644).

When omitting the sharding strategy option, it is defined by [DEFAULT_SHARDING](../part-02-administration-manual/10-server-property.md#538c33a1508d31f9) property. The default value of DEFAULT_SHARDING is 0, and it creates cloned table.
...
- AT CLUSTER WIDE 
    ...
    - When adding a cluster group or cluster member, a user can rearranges clones by using [ALTER TABLE name REBALANCE](../part-03-sql-manual/18-sql-references-a-b.md#f7d09b5058d6293a) statement. 
- AT CLUSTER GROUP group_list 
    - It arranges clones in all cluster members of a defines cluster group.
    - When adding a cluster member to a defined cluster group, a user can rearranges clones by using [ALTER TABLE name REBALANCE](../part-03-sql-manual/18-sql-references-a-b.md#f7d09b5058d6293a) statement. 
...
Table rows are distributes to one of 24 shards based on hash value of id column, and 24 shards are equally arranged over the entire cluster system. For more information, refer to [Cluster Table and Shard](../part-03-sql-manual/14-cluster-objects.md#6a3c9da5975bc644).

<a id="cb748bfffb9acbdc"></a>
#### Range Sharding Strategy
...
<a id="459ebd88c7e7293b"></a>
### Managing Index

<a id="c522b059e910eb91"></a>
...
For more information, refer to [DEFAULT_GLOBAL_SECONDARY_INDEX_CREATION](../part-02-administration-manual/10-server-property.md#f05c08eb934d4a66).
