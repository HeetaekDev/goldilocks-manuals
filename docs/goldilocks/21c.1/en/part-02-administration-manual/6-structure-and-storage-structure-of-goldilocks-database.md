<a id="501186da0fdd0a54"></a>

# 6. Structure and Storage Structure of GOLDILOCKS Database

> Source: [GOLDILOCKS 21c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/en/501186da0fdd0a54)  
> Tag: `21c.1_35_tag`
...
<a id="ed8e3515d5e2291e"></a>
### Control File Contents

**GOLDILOCKS database system information**

<a id="a68f32718c085eec"></a>
| Item | Description |
| --- | --- |
...
A user can retrieve the correct information written in the control file using [gdump](../part-06-utility-manual/41-gdump.md#9edc53704c7af3cf) the dump tool of GOLDILOCKS.

<a id="df42badd98d33e64"></a>
...
<a id="2ce4baa45c6bbfd8"></a>
![GOLDILOCKS redo log file, log buffer structure](../assets/images/5c089edf0e47301e.png)

<a id="2f72529314b7777d"></a>
...
<a id="5a3438aadf36ecc7"></a>
#### Adding Log Group and Log Member

<a id="d2c0ce0639fa456e"></a>
##### Adding Log Group
...
For more information about incomplete media recovery, refer to [Incomplete Media Recovery](7-backup-and-recovery-of-goldilocks-database.md#3208f97f2d026c70).

<a id="3ba943150e5d83bb"></a>
...
For more information about GOLDILOCKS database's archive log mode, refer to [ARCHIVELOG Mode](7-backup-and-recovery-of-goldilocks-database.md#ae167901c145050a).

<a id="8e6dd5e3b6fe3ff3"></a>
...
<a id="fa9170274ca5dec9"></a>
### Managing Tablespace and Data File

<a id="edec469044c1a3bb"></a>
#### Managing Tablespace

<a id="92a6b7581eb6351b"></a>
...
<a id="2adc4b7dee7af32c"></a>
#### Tablespace Information

For more information about the tablespaces created in database, refer to [V$TABLESPACE](9-database-information.md#a585ad7bf4fd01e5).
...
<a id="ac43925a14cde11b"></a>
## Managing Data File

<a id="36d5b5d5c57ce646"></a>
### Data File Matching
...
<a id="471a8e0d7e3a373c"></a>
### Data File Information

For more information about data files being used in database, refer to [V$DATAFILE](9-database-information.md#44aae1269f5404b7).
...
<a id="6a8575f489117da1"></a>
## Buffer Cache

<a id="f43316d8242c9433"></a>
### Structure of GOLDILOCKS Buffer Cache

It caches pages required from the disk data file to access index pages and tables stored in the disk tablespace to the buffer. GOLDILOCKS allocates the buffer cache as big as the size set in [BUFFER_CACHE_SIZE](10-server-property.md#25de647e46b090d0) property, and it retrieves the pages requested from the page cached in the buffer cache by using a hash table as big as the size set in [BUFFER_HASH_BUCKETS](10-server-property.md#f6d27c5028546295) property. It increases the touch count whenever accessing to the page. If the available space does not exist in the buffer cache, then it uses LRU strategy which replaces the page whose touch count value is small.

<a id="4cad0933a0d4c955"></a>
![Structure of GOLDILOCKS buffer cache](../assets/images/3fbd8fc794282c05.png)

<a id="7268f339f392aa7f"></a>
### Buffer Cache List
