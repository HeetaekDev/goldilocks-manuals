<a id="1263b2ab442b97a9"></a>

# 51. LOGMIRROR

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/1263b2ab442b97a9)  
> 태그: `21c.1_35_tag`

[← 50. CYCLONE](50-cyclone.md) · [전체 목차](../README.md) · [52. CYFILE →](52-cyfile.md)

<a id="be7072cf195f7f24"></a>
## LOGMIRROR

LOGMIRROR는 GOLDILOCKS가 생성하는 redo log를 원격지에 복제하여 동일한 redo log file을 구성하는 redo log 이중화 툴이다.

<a id="fc94b91217d88cde"></a>
### 개요
...
<a id="8dda4f3a7f00fb43"></a>
## 준비사항

<a id="747f6cba43a3487e"></a>
### GOLDILOCKS 준비사항

LOGMIRROR를 수행하기 전에 GOLDILOCKS에 다음과 같은 사항이 설정되어 있어야 한다.

<a id="abf7dad15d0a6f33"></a>
#### LOG_MIRROR_MODE
...
<a id="7760de418592dc22"></a>
## 환경설정

<a id="0857dd94806a7345"></a>
### 환경설정 파일
...
<a id="50497755713bc3a6"></a>
### 환경설정 옵션

<a id="6e3c01ae5e7f09e7"></a>
#### PORT
...
<a id="59efa77c393caf64"></a>
| 구분 | 파일 |
| --- | --- |
| Master | $GOLDILOCKS_DATA/trc/LogMirror_master.trc |
| Slave | $GOLDILOCKS_DATA/trc/LogMirror_slave.trc |

> Trace log에 저장되는 에러 메시지와 처리방법은 [LOGMIRROR 에러 메시지와 처리 방법](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#bb6962abffd3d826)을 참조한다.

<a id="a615c1082c7f14d0"></a>
### LOGMIRROR 운영
...
<a id="9028fbc7395af6a2"></a>
### 실행 옵션

**실행 옵션**

<a id="1462948df7899da2"></a>
| 옵션 | 설명 | 비고 |
| --- | --- | --- |
...
> LOGMIRROR를 초기화하는 예는 [LOGMIRROR](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#4ffd2444e9f6dcfa)를 참조한다.

<a id="4ef1519f7489872a"></a>
## CYCLONE과 연동 예

CDC 이중화 툴인 CYCLONE을 redo log file 이중화 툴인 LOGMIRROR와 연동하여 사용할 경우 이중화 데이터 손실을 방지할 수 있다.

<a id="6ac4790ff08b6401"></a>
| TOOL | 기능 | 연동 |
| --- | --- | --- |
...
<a id="6ffc0bcb2c776506"></a>
![운영 구조도 예제](../assets/images/0f72553e3890bc1c.png)
...
<a id="f700705bb0f65bd0"></a>
#### 원본 GOLDILOCKS에 CYCLONE 및 LOGMIRROR 환경 설정

다음을 참조한다.  
• CYCLONE 환경설정: [준비사항](50-cyclone.md#a6fd21ff9afd2ef2)  
• LOGMIRROR 환경설정: [준비사항](#8dda4f3a7f00fb43)
