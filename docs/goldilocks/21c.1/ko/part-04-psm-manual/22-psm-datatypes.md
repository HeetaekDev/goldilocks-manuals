<a id="532cba9e7e8dd886"></a>

# 22. PSM DataTypes

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/532cba9e7e8dd886)  
> 태그: `21c.1_35_tag`

[← 21. Overview of PSM](21-overview-of-psm.md) · [전체 목차](../README.md) · [23. PSM Control Statements →](23-psm-control-statements.md)

<a id="33f3970d04ff55ce"></a>
## Built-in Data Types

GOLDILOCKS PSM은 GOLDILOCKS SQL에서 제공되는 모든 기본 데이터 타입들을 동일하게 지원한다.   
기본 데이터 타입들의 종류는 다음과 같다.   
자세한 내용은 [Data Type](../part-03-sql-manual/11-sql-elements.md#8bd9f5c161f4f4d1)을 참조한다.

<a id="870add905861929a"></a>
### 숫자 타입
...
<a id="046d82f3595ac4c8"></a>
### BOOLEAN 타입

BOOLEAN

<a id="e58e640e3dfe720d"></a>
### ROWID 타입

ROWID

<a id="8c2956a5468fa2d5"></a>
...
자세한 내용은 [Built-in Data Type References](../part-03-sql-manual/16-built-in-data-type-references.md#ad11873b56502b1a)를 참조한다.

<a id="eeef84a07460f008"></a>
...
<a id="859914c0a8dee3cf"></a>
### Constraint 속성 상속

Attribute 타입으로 선언된 변수들의 constraint 속성은 다음과 같이 참조 대상의 constraint 속성을 상속받는다.

<a id="ac3425683d92e501"></a>
<table class="table column_count_4"><caption>Attribute type의 constraint 상속 유무 </caption><thead><tr><th class="to_center"><div>Attribute type</div></th><th class="to_center"><div>참조 대상</div></th><th class="to_center"><div>NOT NULL</div></th><th class="to_center"><div>Default 값</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="7"><div>%TYPE</div></td><td class="to_middle"><div>Scalar 변수</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle"><div>레코드 타입 변수</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>O</div></td></tr><tr><td class="to_middle"><div>레코드 타입 변수의 특정 필드</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle"><div>Collection 타입 변수 - scalar element</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle"><div>Collection 타입 변수 - 레코드 element</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>O</div></td></tr><tr><td class="to_middle"><div>Collection 타입 변수의 특정 필드</div></td><td class="to_center to_middle"><div>O</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle"><div>테이블의 특정 column</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle" rowspan="3"><div>%ROWTYPE</div></td><td class="to_middle"><div>테이블</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle"><div>Cursor</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>X</div></td></tr><tr><td class="to_middle"><div>Cursor variable</div></td><td class="to_center to_middle"><div>X</div></td><td class="to_center to_middle"><div>X</div></td></tr></tbody></table>

<a id="d0360543e9ad5dbe"></a>
...
자세한 내용은 [COLLECTION Variable Declaration](28-psm-language-element-references.md#ae8c356ad7e16708)을 참조한다.

<a id="aa7e997263658120"></a>
### Associative Array
...
자세한 내용은 [Built-in Data Types](#33f3970d04ff55ce), [%TYPE](#bfab8522a61e0c86), [%ROWTYPE](#4914ee18c00761df), [User-defined Record Type](#d0360543e9ad5dbe)을 참조한다.

<a id="24e9297acb5b4334"></a>
...
| COUNT | Function | X | INTEGER | Element의 개수를 반환 |
...
자세한 내용은 [CURSOR VARIABLES](24-psm-cursor-statements.md#71c2283761c90530), [Cursor Variable Declaration](28-psm-language-element-references.md#f8e7f57ff1b9e79e), [OPEN FOR Statement](28-psm-language-element-references.md#3ba74406e2b4860c)를 참조한다.
