<a id="e4d5d2956d5136db"></a>

# 26. Using SQLs in PSM

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/e4d5d2956d5136db)  
> 태그: `21c.1_35_tag`

[← 25. Using PSM Subprograms](25-using-psm-subprograms.md) · [전체 목차](../README.md) · [27. PSM Packages →](27-psm-packages.md)

<a id="77750f7953189b06"></a>
## Static SQLs

Static SQL은 PSM에서 사용할 수 있는 SQL로써 다음과 같이 분류한다.

- [SELECT](#5fd3215bd6f14693)
- [INSERT](#ffd1a68ccfd7429e)
- [UPDATE](#2dde57484356eab9)
- [DELETE](#f60592cd20c43381)
- [RETURNING INTO](#15308856b61a6ae4)
- [LOCK TABLE](../part-03-sql-manual/20-sql-references-h-z.md#af492ba29ca9218f)
- [COMMIT, ROLLBACK, SAVEPOINT](#1b88aa8f357e352e)

Static SQL은 GOLDILOCKS에서 지원하는 SQL을 PSM 변수를 통해 실행할 수 있도록 확장된 SQL이다.   
본 장에서는 PSM에서만 사용할 수 있는 static SQL의 기능과 주의사항에 대해 설명한다.

<a id="5fd3215bd6f14693"></a>
### SELECT
...
자세한 내용은 [Data Query Language](../part-03-sql-manual/12-sql-languages.md#6a2dde5744a149d6)를 참조한다.
...
자세한 내용은 [데이터 추가](../part-03-sql-manual/12-sql-languages.md#e9c7ff4ea497b02b)를 참조한다.
...
자세한 내용은 [%ROWTYPE](22-psm-datatypes.md#4914ee18c00761df)을 참조한다.
...
자세한 내용은 [User-defined Record Type](22-psm-datatypes.md#d0360543e9ad5dbe)을 참조한다.
...
자세한 내용은 [데이터 갱신](../part-03-sql-manual/12-sql-languages.md#3cc32e83abcfd425)을 참조한다.
...
- Dynamic SQL은 다음과 같은 PSM statement에서 사용할 수 있다.
    - [EXECUTE IMMEDIATE Statement](28-psm-language-element-references.md#154f5ea8d80ada5a) 
    - [OPEN FOR Statement](28-psm-language-element-references.md#3ba74406e2b4860c)

<a id="d9954371caa7bd48"></a>
### EXECUTE IMMEDIATE
...
자세한 내용은 [EXECUTE IMMEDIATE Statement](28-psm-language-element-references.md#154f5ea8d80ada5a)를 참조한다.

<a id="c1aafa3f52a67db7"></a>
...
자세한 내용은 [OPEN FOR Statement](28-psm-language-element-references.md#3ba74406e2b4860c), [FETCH Statement](28-psm-language-element-references.md#f182af65649d3610), [CLOSE Statement](28-psm-language-element-references.md#69270ed5b2e896c8)를 참조한다.
