<a id="4b885340999f65b2"></a>

# 25. Using PSM Subprograms

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/4b885340999f65b2)  
> 태그: `21c.1_35_tag`

[← 24. PSM Cursor Statements](24-psm-cursor-statements.md) · [전체 목차](../README.md) · [26. Using SQLs in PSM →](26-using-sqls-in-psm.md)

<a id="8d3eb5a2b7d90b16"></a>
## Anonymous PL Block
...
자세한 내용은 [Block (BEGIN .. END)](28-psm-language-element-references.md#114b581211180b65)을 참조한다.
...
자세한 내용은 [Procedure Declaration and Definition](28-psm-language-element-references.md#89905a45623d1eaf)을 참조한다.
...
<a id="80c5906fecfcb675"></a>
## Nested Function

Nested function은 nested procedure와 동일하지만 함수 형태를 가지는 subprogram이다.  
자세한 내용은 [Function Declaration and Definition](28-psm-language-element-references.md#3b669706a58481d0)을 참조한다.
...
자세한 내용은 [ROUTINES](../part-02-administration-manual/9-database-information.md#83aaeb8114f4f365)를 참조한다.
...
자세한 내용은 [PARAMETERS](../part-02-administration-manual/9-database-information.md#477d53747871cdd4)를 참조한다.
...
자세한 내용은 [CALL Statement](29-psm-sql-references.md#3b527e0c9c507e62)를 참조한다.
...
<a id="58d72e14286b8e98"></a>
### 제거

Schema-level procedure는 다음 DROP PROCEDURE 구문으로 제거한다.  
자세한 내용은 [DROP PROCEDURE](29-psm-sql-references.md#ef39e4353f26ce85)를 참조한다.
...
<a id="9f990d431b3aeded"></a>
### 제거

Schema-level function은 다음 DROP FUNCTION 구문으로 제거한다.  
자세한 내용은 [DROP FUNCTION](29-psm-sql-references.md#302ce45389b0c042)을 참조한다.
