<a id="762b8117708f0896"></a>

# 34. PDO

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/762b8117708f0896)  
> 태그: `21c.1_35_tag`

[← 33. Embedded SQL](33-embedded-sql.md) · [전체 목차](../README.md) · [35. PyDBC →](35-pydbc.md)

<a id="afef8792a1a81bf2"></a>
## PDO 개요
...
<a id="59ecaae7ea52afcb"></a>
## 설치/구성

<a id="62f854fc5c880a76"></a>
### 요구 사항

PHP와 동일한 시스템에 GOLDILOCKS의 클라이언트 패키지를 설치해야 하고 $GOLDILOCKS_HOME 환경 변수도 설정해야 한다.

<a id="ba24add0147c7388"></a>
### 설치

<a id="37ddd87d3f8120cc"></a>
#### PECL을 이용한 설치
...
<a id="ccf937144ad92d72"></a>
#### 웹 서버 재시작

웹 서버를 다시 시작한다.

<a id="46327302c37b1b7c"></a>
...
<a id="fccbc6e70d557ce7"></a>
## 사용

<a id="e3500b18f9bcc5bd"></a>
### 데이터 원본 이름 (DSN)

PDO_GOLDILOCKS의 데이터 원본 이름 (DSN)은 다음과 같이 구성된다.

<a id="7c79c42bb9753842"></a>
| 속성 | 설명 |
| --- | --- |
