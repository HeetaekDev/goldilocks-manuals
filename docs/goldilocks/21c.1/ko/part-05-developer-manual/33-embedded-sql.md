<a id="29443ca8fc5ac910"></a>

# 33. Embedded SQL

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/29443ca8fc5ac910)  
> 태그: `21c.1_35_tag`

[← 32. JDBC](32-jdbc.md) · [전체 목차](../README.md) · [34. PDO →](34-pdo.md)

<a id="fa9dfef4da0b6331"></a>
## Precompiler

<a id="d7972c8e1372e41e"></a>
### 개요
...
<a id="b3ef67edbd59eba8"></a>
### Building Application

본 절에서는 GOLDILOCKS의 embedded SQL 소스 프로그램을 build하여 실행 형태의 응용 프로그램을 만드는 과정을 설명한다.

<a id="51009ec6a0ff43f6"></a>
#### Precompile

<a id="def3afee352eeaa1"></a>
##### 설명

사용자가 embedded SQL을 사용해서 작성한 C/ C++ 소스 코드를 precompile하여, 순수한 C/ C++ 소스 코드를 생성한다. 이 과정의 핵심은 사용자가 작성한 embedded SQL을 GOLDILOCKS에서 제공하는 library call로 변환하는 것이며, embedded SQL을 제외한 C/ C++ 소스 코드는 변환하지 않는다.

<a id="4dec67d270c0ac17"></a>
##### 사용 방법
...
gpec에 주어지는 옵션에 대한 자세한 내용은 [Precompiler Options](#ae4f951dd17e8061)을 참조한다.

<a id="96716eee289e2470"></a>
##### Example
...
<a id="ae4f951dd17e8061"></a>
### Precompiler Options

본 절에서는 gpec의 option들을 설명한다.

<a id="49dda7faaebb662d"></a>
#### --no-prompt, -n

<a id="0b507f4252499679"></a>
##### 설명

Version 정보를 출력하지 않는다.

<a id="9ee24bdbef4eb266"></a>
##### 사용 예
...
<a id="413ed3cd8e5030ee"></a>
#### --version, -v

<a id="e0c68606e2304b60"></a>
##### 설명

Version 정보만 출력하고 종료한다.

<a id="22baeb7d44a3aa15"></a>
##### 사용 예
...
<a id="619644b6b9753ee1"></a>
#### --help, -h

<a id="d2734622895ef5af"></a>
##### 설명

Help message를 출력한다. gpec에 아무런 option이나 &lt;input file&gt;을 주지 않을 때도 동일하게 동작한다.

<a id="4d372a2ac8651bbf"></a>
##### 사용 예
...
<a id="4c28895f9843152e"></a>
#### --include-path, -I

<a id="db7b45c29f009db5"></a>
##### 설명
...
<a id="aafbeb80c69888fd"></a>
#### --no-lineinfo

<a id="4f9adb3e519ff007"></a>
##### 설명
...
<a id="8c4cd884ce95bdb3"></a>
#### --char_map, -c

<a id="46f0ebddebd5513b"></a>
##### 설명
...
<a id="b94f154e9e6ea581"></a>
#### --define, -D

<a id="19cfe1c2e2ca697e"></a>
##### 설명

gpec에서 사용되는 define 이름으로써 1로 설정된다.

<a id="e38c14aef52e9c47"></a>
##### 사용 예
...
<a id="5293643de1872b3b"></a>
#### --cumulative

<a id="53610e23107c7259"></a>
##### 설명

FETCH CURSOR 구문에 대해서 sqlerrd[2]을 누적된 합으로 처리하도록 한다.

<a id="54e3ce497004e0b3"></a>
##### 사용 예
...
<a id="aed2414c2bfbe7a4"></a>
#### --autocommit

<a id="7aa9a223c715a492"></a>
##### 설명

모든 connection의 auto commit을 TRUE로 설정한다.

<a id="e0beb1c649ce2807"></a>
##### 사용 예
...
<a id="593831b12b079aa2"></a>
#### --parse

<a id="ab75a2931805f824"></a>
##### 설명
...
<a id="2ca1f3354e780c3a"></a>
## Embedded SQL

<a id="a6035f84293e981e"></a>
### Preprocessing

<a id="f3bd1a228ab6f040"></a>
#### 개요
...
<a id="78232f231cda370e"></a>
#### 유형

parse 옵션이 partial로 설정된 경우 적용되는 전처리 유형은 다음과 같다.

<a id="1f7f20ece390c848"></a>
##### #if
...
<a id="40ae50362421cd33"></a>
#### 제약사항

<a id="28c317bed468e229"></a>
##### 매크로 사용 위치 제약
...
<a id="0a258ddcf455a43a"></a>
### 연결

<a id="54cd1fdd62289185"></a>
#### Database 연결
...
GOLDILOCKS는 shared memory에 직접 attach하여 구동하는 D/A 모드와, TCP 통신을 사용하여 database에 접속하는 C/S 모드 둘 다 지원한다. D/A 모드로 동작할 때는 database의 동일한 호스트에서 직접 접근하게 되므로 위와 같이 별도의 서버 정보를 포함하지 않아도 사용할 수 있지만 C/S 모드로 동작하기를 원할 때는 Data Source Name (DSN)을 지정하여 접근하도록 해야 한다. DSN에 대한 자세한 내용은 [데이터 원본 구성](31-odbc.md#e877d5722faabf1c)을 참조한다.
...
<a id="b6f99528fee49085"></a>
#### Indicator Variable

<a id="af6d46a510806da6"></a>
##### Scalar Indicator
...
<a id="cdaa9ac8c2806d64"></a>
### Embedded SQL

<a id="908efe5ed0f157ac"></a>
#### Host Variable
...
<a id="efe40a4ff06f139e"></a>
#### Basic SQL statement

Embedded SQL에서는 GOLDILOCKS에서 제공하는 모든 SQL 문을 사용할 수 있는데 SQL 문에 대한 자세한 내용은 [SQL Manual](../part-03-sql-manual/README.md#4e08ee58ad55cc9a)을 참조한다. Embedded SQL에서 SQL 문을 사용할 때는 EXEC SQL 키워드 뒤에 SQL 문을 기술하는데 본 장에서는 Data Definition Language (DDL)이나 Data Manipulation Language (DML)에 대한 내용을 기술하고 query와 같이 반복적으로 data를 가져오는 구문에 대해서는 다음 장에서 설명한다.

SQL 문을 실행한 이후에는 SQLCA를 검사하여 실행한 SQL 문의 성공 여부를 판단할 수 있으며, 자세한 내용은 [Handling Run-time Error](#56003bae9fbe83be) 부분을 참조한다.

<a id="4006b16f621a92b3"></a>
##### DDL Statement
...
이에 대한 자세한 내용은 [Embedded Dynamic SQL](#3bcaf0db5a2e1afe)을 참조한다.

<a id="15c85da12146d27d"></a>
##### Select Into Statement

GOLDILOCKS에서 data를 가져 오기 위해서 query를 사용한다. 일반적인 경우에는 해당 결과의 개수를 알지 못하는 경우가 많기 때문에, query를 사용하기 위해서는 cursor라는 객체를 선언하여 open, fetch, close라는 복잡한 과정을 거치게 된다. 이러한 과정의 실행 방식은 다음 [Cursors](#3d6d0eb513c04992) 부분에서 기술할 것이다.
...
> Host array를 사용하면 select into 구문을 사용하여 여러 개의 결과를 가져올 수 있다. Host array 사용법은 [Host Arrays](#58b3508369c81610)를 참조한다.

<a id="7a4c2a4c0b881394"></a>
##### Insert Statement
...
> Host array를 사용하면 한 번에 여러 개의 row를 삽입할 수 있다. 자세한 내용은 [Host Arrays](#58b3508369c81610)를 참조한다.

<a id="89a2138646889eb5"></a>
##### Update Statement
...
> Host array를 사용하면 한 번에 여러 개의 row를 갱신할 수 있다. 자세한 내용은 [Host Arrays](#58b3508369c81610)를 참조한다.

<a id="1c241fef64d0e918"></a>
##### Delete Statement
...
> Host array를 사용하면 한 번에 여러 개의 row를 삭제할 수 있다. 자세한 내용은 [Host Arrays](#58b3508369c81610)를 참조한다.

<a id="6d6ec335e8757446"></a>
##### PSM Statement

PSM 구문은 서버 내부에 procedure나 function을 만들어서 사용한다.  
PSM에 대한 자세한 내용은 [PSM Manual](../part-04-psm-manual/README.md#ce52706b11e69826)을 참조한다.
...
커서를 open하면 선언된 커서의 질의를 수행한 결과 집합을 가져올 준비가 된다. 여기서는 실제로 결과를 가져오는 것은 아니기 때문에 실제 결과를 얻어오려면 [Fetch cursor](#44bf822894c15620)를 수행해야 한다.  
...
커서 정의 구문과 속성에 대한 자세한 내용은 [DECLARE cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#f41bd2e5b923c676)을 참조한다.

<a id="e54323db124cf038"></a>
##### Scrollable Cursor
...
Static cursor의 fetch 방법은 [Scrollable Cursor](#e54323db124cf038)를 참조한다

<a id="5a9c242016b277a2"></a>
...
Keyset driven 커서 역시 scroll 기능을 가지고 있으므로 fetch 방법은 [Scrollable Cursor](#e54323db124cf038)를 참조한다.

<a id="9676014d52c3c52f"></a>
#### Positioned DML
...
> 이 옵션은 precompiler의 command-line option을 통해서도 부여할 수 있다. 자세한 내용은 [Precompiler Options](#ae4f951dd17e8061)의 [--include-path, -I](#4c28895f9843152e)를 참조한다.

<a id="58b3508369c81610"></a>
### Host Array
...
<a id="1156becc15795923"></a>
#### Host Array 사용

<a id="4aff530bd96194ba"></a>
##### Host Array 접근
...
<a id="5c4c254acb4d4702"></a>
##### SELECT INTO에서의 Array

가져와야 할 row의 개수를 정확히 알고 있을 경우에는 [Select Into Statement](#15c85da12146d27d)를 사용하여 간단하게 구현할 수 있다. [Select Into Statement](#15c85da12146d27d)에서는 결과가 없거나 한 개일 경우에 대해서만 언급하였지만 여기에 host array를 사용하면 다수의 row를 가져올 수 있다.
...
<a id="740bc43cd3900366"></a>
##### Cursor 사용에서 Array

현재 질의에 대한 결과 집합 개수를 알 수 없는 경우에는 커서를 사용해야만 한다. 커서를 사용하는 방법은 [Cursor](#3d6d0eb513c04992) 부분을 참조한다. 커서를 선언한 이후에 FETCH 구문에서 INTO 절의 host 변수를 array로 사용하는 것만으로도 다수의 row를 한 번에 가져올 수 있다.
...
sqlca에 대한 자세한 내용은 [Handling Runtime Errors](#56003bae9fbe83be)를 참조한다.

<a id="f28acc8aa1e7ca97"></a>
#### Insert 구문에서 Array
...
<a id="098e43463a7437b9"></a>
#### 구조체 Array

일반적인 scalar 변수들을 배열로 사용하면 한 번에 다수의 row를 처리할 수 있어 편리하지만 한 개의 변수당 한 개의 column만 표시할 수 있다는 한계가 있다. 한 개의 host 변수에서 다수의 column에 접근하려면 [Host structure](#751a54505a4c2d7f)를 사용하면 되는데 이렇게 host 변수를 구조체로 선언하여 그 구조체를 array로 사용하면 다수의 column을 갖는 다수의 row를 한 번에 처리할 수 있다.
...
<a id="548ad729cf047077"></a>
##### 구조체 배열 Indicator

[Structure Indicator](#6ab68c4290449901)에 기술된 것과 같이 host 변수가 구조체이면 indicator 변수도 구조체이어야 한다. 따라서 host 변수가 구조체 배열일 경우 indicator 변수도 대응하는 구조체 배열이어야 한다.
...
<a id="56003bae9fbe83be"></a>
### Handling Run-time Error

<a id="011d6c99ace74e1d"></a>
#### 개요
...
<a id="ca5768f971a16afb"></a>
#### Run-time Error 감지

<a id="a601a17eeae403f5"></a>
##### SQLCA
...
GOLDILOCKS의 embedded SQL 응용 프로그램은 기본적으로 sqlca를 전역으로 가지고 있다. 따라서 single thread program에서는 별다른 선언 없이 sqlca를 사용할 수 있다. 그러나 multi thread program에서는 동시에 sqlca에 접근할 경우 동시성 문제가 발생하기 때문에 별도의 선언 방법을 가져야 한다. 이에 대한 내용은 [Multithread Applications](#eef463bf816a3d92)에서 설명한다.

<a id="fe10901873390107"></a>
##### SQLCA 구조
...
fetch 구문에 한하여 sqlca.sqlerrd[2]의 값을 누적된 row 개수로 처리할 수 있다. 이와 관련된 자세한 내용은 gpec(Precompiler)의 옵션 [--cumulative](#5293643de1872b3b)을 참조한다.

<a id="5664af980d797f42"></a>
###### **처리된 Row의 상태**
...
<a id="7c32798e7c699fd6"></a>
## Advanced Topic

<a id="3bcaf0db5a2e1afe"></a>
### Embedded Dynamic SQL

<a id="2db9d3a71189ee14"></a>
#### 개요
...
Cursor로부터 fetch한다. Dynamic cursor의 fetch는 [Standing cursor의 Fetch](#44bf822894c15620)와 동일하다.

- Close cursor

Cursor를 close한다. Dynamic cursor의 close는 [Standing cursor의 Close](#b33d473c86f38796)와 동일하다.

<a id="07d8d62652087b23"></a>
#### Example Program
...
<a id="4fd73c629794743e"></a>
![D/A 모드에서 각 thread가 각자의 connection을 가지는 경우](../assets/images/f187a00dd512b22c.png)

<a id="ba38dbfc02ce5e25"></a>
...
<a id="2918dfc1718ebdab"></a>
![다수의 thread가 한 개의 connection을 공유하는 경우](../assets/images/67928d460191746b.png)

<a id="e2887f3c70d5d286"></a>
![한 개의 thread가 다수의 connection을 갖는 경우](../assets/images/75921b54ba0bf8bb.png)

<a id="c8cec7f182eca2ac"></a>
#### Guideline
...
<a id="6582d36b66473ae1"></a>
### C++ Application

<a id="290e4a29fc78a5d2"></a>
...
<a id="c357515b8e963024"></a>
### XA

<a id="6e9feb909a3af526"></a>
#### xa_open string 정의

xa_open string은 Resource Manager (RM)에 접속하기 위한 정보를 포함하고 있는데 자세한 내용은 [SQLDriverConnect 인자설명](31-odbc.md#dd94a9a47db68e90)을 참조한다.
...
<a id="8b40f4507b4a7b96"></a>
### EXEC SQL AT

<a id="ed2b3d62a547afbd"></a>
#### 기능

Embedded SQL 문에 적용할 connection 이름을 지정한다.

<a id="4aa5a871e4144cf0"></a>
#### 구문
...
<a id="50757b1980ebec3a"></a>
#### 참조

관련 내용은 [연결](#0a258ddcf455a43a)을 참조한다.

<a id="d184395bc0aaea45"></a>
### EXEC SQL ATOMIC INSERT

<a id="c7d93e19c70c08bd"></a>
#### 기능

Atomic array insert를 수행한다.

<a id="dcb1d977387caee5"></a>
#### 구문
...
<a id="a676882326e09267"></a>
#### 참조

관련 내용은 [Atomic Insert](#4a7759b177ce6164)를 참조한다.

<a id="f370b57aa31d94f6"></a>
### EXEC SQL AUTOCOMMIT

<a id="8e04f3fb3143ffde"></a>
#### 기능

Autocommit 설정을 변경한다.

<a id="34d5bff516d3a438"></a>
#### 구문
...
<a id="481cec513d439a54"></a>
#### 참조

관련 내용은 [Auto Commit](#89e811b238e68ef0)을 참조한다.

<a id="4125bd224e0975db"></a>
### EXEC SQL BEGIN DECLARE SECTION

<a id="aa6fc5f16bd6a7c9"></a>
#### 기능

Precompiler의 지시자로써 host variable 선언 영역을 지정한다.

<a id="0240d1596a5aa8b0"></a>
#### 구문
...
<a id="db90f7686d23040d"></a>
#### 참조

관련 내용은 다음을 참조한다.

- [Host Variable의 선언](#b861aaecfd6a72f6)
- [EXEC SQL END DECLARE SECTION](#6cc0a44077a4c0ff)

<a id="e4f53f7e22a55840"></a>
### EXEC SQL COMMIT RELEASE

<a id="c28eb968c83e2434"></a>
#### 기능

트랜잭션을 완료한 후에 connection을 종료한다.

<a id="d44dcb6fd4e0d696"></a>
#### 구문
...
<a id="9e9c1abf99158913"></a>
#### 참조

관련 내용은 [RELEASE Option](#a08fa5074ee1b540)을 참조한다.

<a id="8802591a1a975fa9"></a>
### EXEC SQL CONNECT

<a id="e4e16599d1153ec3"></a>
#### 기능

GOLDILOCKS와 connection을 맺는다.

<a id="ad9803bbe91f8cb1"></a>
#### 구문
...
<a id="d2bbbeb4b39fbc4c"></a>
#### 설명

GOLDILOCKS에 연결을 설정한다.

<a id="871b400a56fcfc1b"></a>
#### 사용 예
...
<a id="92ea4a0b5fe19632"></a>
#### 참조

관련 내용은 [Database 연결](#54cd1fdd62289185)을 참조한다.

<a id="14f7bf3a91169727"></a>
### EXEC SQL CONTEXT ALLOCATE

<a id="cbe30a730b1ef1ce"></a>
#### 기능

Run-time context 메모리를 할당한다.

<a id="1299af3ee8d461f6"></a>
#### 구문
...
<a id="e868da1e0178ff4d"></a>
#### 참조

관련 내용은 [SQL_CONTEXT](#34401fd063b83995)를 참조한다.

<a id="d483ef98b3437f3e"></a>
### EXEC SQL CONTEXT FREE

<a id="c12b5a43a1f7a5ec"></a>
#### 기능

Run-time context 메모리를 해제한다.

<a id="36f956a8ff88f118"></a>
#### 구문
...
<a id="4ad8e95f62139d50"></a>
#### 참조

관련 내용은 [SQL_CONTEXT](#34401fd063b83995)를 참조한다.

<a id="cf239f959a354ffc"></a>
### EXEC SQL CONTEXT USE

<a id="e41a84c8f0847907"></a>
#### 기능

Run-time context 사용을 알린다.

<a id="4550165e61d83bff"></a>
#### 구문
...
<a id="e32951b6c8cebab4"></a>
#### 참조

관련 내용은 [SQL_CONTEXT](#34401fd063b83995)를 참조한다.

<a id="12b6b56f687c7033"></a>
### EXEC SQL DISCONNECT

<a id="a98a7de573bc920d"></a>
#### 기능

GOLDILOCKS와의 connection을 종료한다.

<a id="5670dfe6f9060984"></a>
#### 구문
...
<a id="582b8ab6fdf78362"></a>
#### 참조

관련 내용은 [Database 연결 해제](#7f136091a179db6f)를 참조한다.

<a id="6cc0a44077a4c0ff"></a>
### EXEC SQL END DECLARE SECTION

<a id="8c2f04c2627aca50"></a>
#### 기능

Precompiler 지시자로써 host variable 선언 영역을 지정한다.

<a id="df82a5557c89ce51"></a>
#### 구문
...
<a id="a043f656c4345e44"></a>
#### 참조

관련 내용은 다음을 참조한다.

- [Host Variable의 선언](#b861aaecfd6a72f6)
- [EXEC SQL BEGIN DECLARE SECTION](#4125bd224e0975db)

<a id="f56b17058adf7dcb"></a>
### EXEC SQL FOR

<a id="a92af7ee3f04b098"></a>
#### 기능

Array operation에서 array 개수를 지정한다.

<a id="1d500bc6961ba624"></a>
#### 구문
...
<a id="bdb43c8ddad997c7"></a>
#### 참조

관련 내용은 [FOR 절 사용](#cff46cb4710b3d31)을 참조한다.

<a id="74674d5f2b93c4e9"></a>
### EXEC SQL GET GROUPID INTO

<a id="598c05b22933eaa6"></a>
#### 기능

SQL statement의 group ID를 얻는다.

<a id="a450ce3e391df8f4"></a>
#### 구문
...
<a id="3e8082595487c2a4"></a>
### EXEC SQL INCLUDE

<a id="13e2168b19c09437"></a>
#### 기능

Embedded SQL header file을 포함시킨다.

<a id="357b333a0f8137a1"></a>
#### 구문
...
<a id="4f6cedb4f7102c9b"></a>
#### 참조

관련 내용은 [Precompiled Header File](#f77ac66a8718e1f8)을 참조한다.

<a id="6913f0a7221a8ebf"></a>
### EXEC SQL INCLUDE SQLCA

<a id="36f187f06a2148c7"></a>
#### 기능

*sqlca.h* header file을 포함시킨다.

<a id="9eab638ff0fdfd7e"></a>
#### 구문
...
<a id="faebff2cbad47185"></a>
#### 참조

관련 내용은 [Run-time Error 감지](#ca5768f971a16afb)를 참조한다.

<a id="82620e78cbfd6f7a"></a>
### EXEC SQL OPTION

<a id="d023f3f3e3f976fd"></a>
#### 기능

Embedded SQL 소스 코드를 precompile 하는 과정에서 option을 적용한다.

<a id="3fe31ad0c994d154"></a>
#### 구문
...
<a id="dd58dd9441fb58d8"></a>
#### 참조

관련 내용은 [Header File 경로 지정](#585fefcfdeaf7c4c)을 참조한다.

<a id="2b2a1a30815f0ce7"></a>
### EXEC SQL ROLLBACK RELEASE

<a id="e4e1a680521f138d"></a>
#### 기능

트랜잭션을 rollback 한 후에 현재 connection을 종료한다.

<a id="fd86d172e3d21f1a"></a>
#### 구문
...
<a id="cd36ef95285dde30"></a>
#### 참조

관련 내용은 [RELEASE Option](#a08fa5074ee1b540)을 참조한다.

<a id="44ae0e631c6402fe"></a>
### EXEC SQL WHENEVER

<a id="8aed97a39b3c97f2"></a>
#### 기능

Embedded SQL 응용 프로그램에서 run-time exception handling을 실행한다.

<a id="05b3db8662af7e0b"></a>
#### 구문
...
<a id="5daf0a2fec5b3535"></a>
#### 설명

Embedded SQL 응용 프로그램에서 run-time exception handling을 자동화하여 처리한다. 네 가지 condition이 있고 condition마다 한 개의 action을 지정할 수 있는데 이 action은 필요에 따라 다시 지정할 수도 있다. 자세한 사항은 [Handling Implicit Error](#281d48ee4603e4cf)를 참조한다.

<a id="afc0f5b80adb283d"></a>
#### 사용 예
...
<a id="1816da0c1096d7f1"></a>
#### 참조

관련 내용은 [Handling Implicit Error](#281d48ee4603e4cf)를 참조한다.
