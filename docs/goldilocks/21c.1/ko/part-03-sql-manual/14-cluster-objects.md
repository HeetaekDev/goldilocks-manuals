<a id="81b4d02c8a47a08a"></a>

# 14. Cluster Objects

> 원본: [GOLDILOCKS 21c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/21c_1/manual/ko/81b4d02c8a47a08a)  
> 태그: `21c.1_35_tag`

[← 13. SQL Objects](13-sql-objects.md) · [전체 목차](../README.md) · [15. SQL Tuning →](15-sql-tuning.md)

<a id="64114daa04519e15"></a>
## Cluster System

<a id="d6df1bbe1840dbd5"></a>
...
- Inactive cluster member 제어
    - [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references-a-b.md#4097c0f933c6e040)
    - [ALTER SYSTEM JOIN DATABASE](18-sql-references-a-b.md#a4c3515652081fcc)
...
<a id="037c4dcde85a0faf"></a>
<table class="table column_count_3"><caption>Cluster system 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#0e89087f2ecb973b">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Cluster를 구성하는 cluster group, cluster member의 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#89dfda8e2c3b2d5f">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Cluster group과 cluster member의 주석 정보</div></td></tr><tr><td class="to_middle"><div>PERFORMANCE_VIEW_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#59ff8470b68cd72f">V$CLUSTER_MEMBER</a></div></td><td class="to_middle"><div>Cluster member의 상태 정보</div></td></tr></tbody></table>

<a id="e488c6146cea502f"></a>
### Cluster System 개념
...
<a id="b46a1351a7e36e9a"></a>
![3 x 2 cluster system](../assets/images/fd4cf992853c5c7d.png)
...
<a id="1721b6c2bbc358a5"></a>
![Cluster의 분할 및 복제 개념](../assets/images/9ba94153335d1f44.png)
...
<a id="a7df4de946cec408"></a>
![Cluster availability](../assets/images/e465689a65ec26f6.png)
...
- [ALTER SYSTEM JOIN DATABASE](18-sql-references-a-b.md#a4c3515652081fcc)는 장애가 발생한 cluster member를 cluster system에 다시 참여시킬 때 사용되는 구문이다.

- [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references-a-b.md#4097c0f933c6e040)는 장애가 발생한 cluster member를 cluster system에서 제거하기 위해 사용되는 구문이다.

- [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references-a-b.md#2aa692a04102ad1a)는 고가용성을 위해 cluster group에 cluster member를 추가할 때 사용되는 구문이다.

- [ALTER DATABASE REBALANCE](18-sql-references-a-b.md#be8f993bb3ff62bc), [ALTER TABLE name REBALANCE](18-sql-references-a-b.md#1af19281915840f1)는 생성한 cluster member에 데이터를 재배치하기 위해 사용되는 구문들이다.

<a id="dec6ea8725f2bb93"></a>
### Cluster System 확장
...
<a id="bdd1cdb0927a920a"></a>
![Cluster system 확장](../assets/images/f3afd48cdcdaab84.png)
...
<a id="41ddda995297aeff"></a>
## Cluster Group

<a id="8a8690ca00965c32"></a>
### Cluster Group 관련 구문

Cluster group을 생성, 제거, 변경하기 위한 구문은 다음과 같다.

- Cluster group 생성: [CREATE CLUSTER GROUP](19-sql-references-c-g.md#8e2b3a3076fcfb3e)
- Cluster group 제거: [DROP CLUSTER GROUP](19-sql-references-c-g.md#8bcf309cea211dc8)
- Cluster group 변경: [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references-a-b.md#2aa692a04102ad1a)

Cluster group 과 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="2e13f2954657585d"></a>
<table class="table column_count_3"><caption>Cluster group 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#0e89087f2ecb973b">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Cluster를 구성하는 cluster group, cluster member의 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#89dfda8e2c3b2d5f">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Cluster group과 cluster member의 주석 정보</div></td></tr></tbody></table>

<a id="3c0e3bf88f4dc0db"></a>
### Cluster Group 개념

Cluster system을 운영하기 위해서는 최소 하나 이상의 cluster group을 생성해야 한다.

<a id="30d0e64d4e6957bf"></a>
#### Cluster group의 생성

최초로 생성하는 cluster group은 자기 자신을 cluster member로 포함해야 한다. Cluster group을 생성하는 구문은 [CREATE CLUSTER GROUP](19-sql-references-c-g.md#8e2b3a3076fcfb3e)을 참조한다.
...
<a id="687bfcf93feafb19"></a>
#### Cluster Group 제거

Cluster system에 참여하여 서비스 중인 cluster group은 여러가지 이유로 제거될 수 있다. Cluster group의 제거는 [DROP CLUSTER GROUP](19-sql-references-c-g.md#8bcf309cea211dc8)을 참조한다.
...
<a id="085262f4c8cbe058"></a>
## Cluster Member

<a id="241106f1471d50ab"></a>
### Cluster Member 관련 구문

자세한 내용은 다음 링크를 참조한다.

- Cluster member 추가: [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references-a-b.md#2aa692a04102ad1a)

- Cluster member 제거: [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references-a-b.md#4097c0f933c6e040)

- Cluster member 제어
    - [ALTER SYSTEM JOIN DATABASE](18-sql-references-a-b.md#a4c3515652081fcc)
    - [ALTER CLUSTER GROUP name OFFLINE MEMBER](18-sql-references-a-b.md#db0d7e893427ddd6)
    - [ALTER DATABASE RESET LOCAL CLUSTER MEMBER](18-sql-references-a-b.md#060da0c4f8e4ebb1)

Cluster member와 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="6b84d261fc5ce24e"></a>
<table class="table column_count_3"><caption>Cluster member 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#0e89087f2ecb973b">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Cluster를 구성하는 cluster group, cluster member의 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#89dfda8e2c3b2d5f">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Cluster group과 cluster member의 주석 정보</div></td></tr><tr><td class="to_middle"><div>PERFORMANCE_VIEW_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#59ff8470b68cd72f">V$CLUSTER_MEMBER</a></div></td><td class="to_middle"><div>Cluster member의 상태 정보</div></td></tr></tbody></table>

<a id="f7574059dcb5c2b8"></a>
### Cluster Member 개념
...
새로운 cluster member를 cluster group에 추가하려면 [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references-a-b.md#2aa692a04102ad1a) 구문을 수행한다.
...
- 전체 data를 재배치하는 경우: [ALTER DATABASE REBALANCE](18-sql-references-a-b.md#be8f993bb3ff62bc)
- 일부 테이블만 재배치하는 경우: [ALTER TABLE name REBALANCE](18-sql-references-a-b.md#1af19281915840f1)

Cluster member에 장애가 발생해도 서비스 운영에는 지장이 없지만 DDL을 수행할 수 없다. 정상적인 서비스 운영을 위해서는 장애가 발생한 cluster member에 대한 조치를 취해야 한다.

장애가 발생한 cluster member를 cluster system에 다시 참여시키려면 해당 cluster member에 접속하여 LOCAL OPEN 단계로 구동한 후에 [ALTER SYSTEM JOIN DATABASE](18-sql-references-a-b.md#a4c3515652081fcc)를 수행한다.

일부 cluster member를 구동하지 않거나 네트워크 단절 상태에서 cluster system을 구동한 경우에도 해당 cluster member를 LOCAL OPEN 단계로 구동한 후에 [ALTER SYSTEM JOIN DATABASE](18-sql-references-a-b.md#a4c3515652081fcc) 구문을 수행한다.

만약 장애가 발생한 cluster member의 장비를 복구할 수 없는 경우에는 cluster system에서 [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references-a-b.md#4097c0f933c6e040) 구문을 수행하여 장애가 발생한 cluster member들을 제거한다.

Cluster system에서 제거된 cluster member는 여전히 제거되기 이전의 정보를 가지고 있으며 다시 cluster system에 참여할 수 없다. Cluster member를 cluster system에 참여하기 이전의 상태로 초기화하기 위해서는 [ALTER DATABASE RESET LOCAL CLUSTER MEMBER](18-sql-references-a-b.md#060da0c4f8e4ebb1) 구문을 수행한다.
...
<a id="4f74a83b98384bc5"></a>
## Cluster Location

<a id="05eed0db347c1970"></a>
### Cluster Location 관련 구문

Cluster location을 생성, 제거, 변경하기 위한 구문은 다음과 같다.

- Cluster location 생성: [CREATE CLUSTER LOCATION](19-sql-references-c-g.md#677b16ec3653271c)
- Cluster location 제거: [DROP CLUSTER LOCATION](19-sql-references-c-g.md#28783969fbe8714a)
- Cluster location 변경: [ALTER CLUSTER LOCATION](18-sql-references-a-b.md#ba7b493d6f702d6f)

Cluster location과 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

**Cluster location 관련 정보**

<a id="03a0114e53fd8ef0"></a>
| 스키마 | View 이름 | 설명 |
| --- | --- | --- |
| PERFORMANCE_VIEW_SCHEMA | [V$CLUSTER_LOCATION](../part-02-administration-manual/9-database-information.md#4d8e620ac8732562) | Cluster location 정보 |

<a id="84931941a90f9e5c"></a>
### Cluster Location 개념
...
- Location control file이 삭제되어 cluster location 정보가 유실된 경우: [CREATE CLUSTER LOCATION](19-sql-references-c-g.md#677b16ec3653271c)
- 이미 등록된 cluster member의 접속 정보가 변경된 경우, 즉 hardware가 변경되거나 접속 ip, port가 변경된 경우: [ALTER CLUSTER LOCATION](18-sql-references-a-b.md#ba7b493d6f702d6f)

<a id="37c9553381994760"></a>
## Cluster Table과 Shard

<a id="9123e0d13ba0f643"></a>
### Shard 관련 구문

Shard 정의와 재배치를 위한 구문은 다음과 같다.

- Shard 정의: [CREATE TABLE](19-sql-references-c-g.md#66fde705300657e5) 구문의 &lt;table sharding strategy&gt; 절
- Shard 재배치: [ALTER TABLE name REBALANCE](18-sql-references-a-b.md#1af19281915840f1)

Cluster table의 shard 관련 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="13e017822a404d6a"></a>
<table class="table column_count_3"><caption>Cluster table과 shard 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="8"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#902ca70397528173">ALL_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#98da634ee197136e">ALL_SHARD_KEY_COLUMNS</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table의 shard key column 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#983b4475fb40b868">ALL_TAB_PLACE</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table의 배치 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#aa5b89965493f189">ALL_TAB_SHARDS</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table의 shard 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#d06962a15a1d2b79">USER_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#f6965572cff2023c">USER_SHARD_KEY_COLUMNS</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table의 shard key column 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#95a5231ea16425fb">USER_TAB_PLACE</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table의 배치 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#291f468168fe13da">USER_TAB_SHARDS</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table의 shard 정보</div></td></tr></tbody></table>

<a id="b0599b1fc19c0e09"></a>
### Cluster Table 유형
...
Sharded table은 row들을 수평으로 분할하여 shard 단위로 관리하며, sharding 정책은 [CREATE TABLE](19-sql-references-c-g.md#66fde705300657e5) 구문의 SHARDING BY 절을 이용해 정의한다. Sharding 정책에 의해 분류된 row들의 집합을 shard라고 한다.

각 shard는 사용자가 정의한 배치 정책에 따라 cluster group에 배치되는데 [CREATE TABLE](19-sql-references-c-g.md#66fde705300657e5) 구문의 AT CLUSTER WIDE를 통해 자동으로 배치하거나, AT CLUSTER GROUP 절을 이용해 배치할 cluster group을 지정할 수도 있다. AT CLUSTER WIDE를 사용해 자동으로 배치할 경우, [CREATE CLUSTER GROUP](19-sql-references-c-g.md#8e2b3a3076fcfb3e) 구문을 사용하여 cluster group을 생성한 후에 [ALTER TABLE name REBALANCE](18-sql-references-a-b.md#1af19281915840f1) 구문을 수행하는 반면에 AT CLUSTER GROUP을 사용해 shard가 배치될 cluster group을 지정하는 경우 새롭게 추가된 cluster group에 shard가 배치되지 않는다.

다음은 3 x 2 cluster 환경에서 cluster table의 유형에 따라 테이블을 생성하고 data를 배치하는 개념을 설명하기 위한 예이다.

<a id="9fa7e176be7df202"></a>
### Cloned Table
...
<a id="e3a0cb2f98d149d0"></a>
![Cluster-wide cloned table](../assets/images/500aad0f19deeb0f.png)
...
<a id="fb2dadcdacc88a8a"></a>
![Group-specific cloned table](../assets/images/fc5396f87e025d17.png)

<a id="458437f96ec16022"></a>
### Hash-sharded Table
...
<a id="496404fcfee7c046"></a>
![Cluster-wide hash-sharded table](../assets/images/e7b6c4ef63e4618c.png)
...
<a id="d57f63c317d2ce16"></a>
![Group-specific hash-sharded table](../assets/images/a38587f4329db6c3.png)

<a id="d65ea2e11a031b61"></a>
### Range-sharded Table
...
<a id="1ca1aecc6b5ea3d5"></a>
![Cluster-wide range-sharded table](../assets/images/d78aa67e946ec4e4.png)
...
<a id="0c882bd6b785e3a1"></a>
![Group-specific range-sharded table](../assets/images/673bea1f50aa5299.png)

<a id="ff6ae10421a2bbad"></a>
### List-sharded Table
...
<a id="f52c33bdb134b25f"></a>
![Cluster-wide list-sharded table](../assets/images/07a0ca719675aef3.png)
...
<a id="0ec3acf72e0c743a"></a>
![Group-specific list-sharded table](../assets/images/c9f759f9345ec012.png)

<a id="9493ec69733cb456"></a>
### Cluster Table 재배치

[ALTER TABLE name REBALANCE](18-sql-references-a-b.md#1af19281915840f1) 구문을 사용하여 cluster table의 데이터를 재배치한다.
...
<a id="29b6abe0b2da510f"></a>
![AT CLUSTER WIDE로 정의한 region 테이블의 재배치](../assets/images/797d14c24b9e5d32.png)
...
<a id="0ed4abdf61b1aae9"></a>
![AT CLUSTER GROUP으로 정의한 nation 테이블 재배치](../assets/images/c18c9db9c0895e9a.png)
...
<a id="499d80b5fd77ae70"></a>
![Cluster group 증가에 따른 shard 재배치](../assets/images/ce16f2db124b7693.png)
...
- [USER_TAB_SHARDS](../part-02-administration-manual/9-database-information.md#291f468168fe13da)
- [ALL_TAB_SHARDS](../part-02-administration-manual/9-database-information.md#aa5b89965493f189)
...
<a id="9fe4f1f3b8251f74"></a>
## Global Secondary Index

<a id="186a8e2ba34509f1"></a>
### Global Secondary Index 관련 구문

Global secondary index를 생성, 제거, 변경하기 위한 구문은 다음과 같다.

- Global secondary index 생성: [ALTER TABLE name ADD GLOBAL SECONDARY INDEX](18-sql-references-a-b.md#1c36bfba15f57bda)
- Global secondary index 제거: [ALTER TABLE name DROP GLOBAL SECONDARY INDEX](18-sql-references-a-b.md#4072f36ce518c112)
- Global secondary index 변경: [ALTER TABLE name ALTER GLOBAL SECONDARY INDEX](18-sql-references-a-b.md#61ebd0ca6a377889)

Global secondary index 와 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="c3a520a6c65a5acd"></a>
<table class="table column_count_3"><caption>Global secondary index 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="6"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#902ca70397528173">ALL_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 테이블의 global secondary index 존재 여부</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#b5e9759bfc4dc9d6">ALL_GLOBAL_SECONDARY_INDEXES</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 global secondary index 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#25d19c19a84c0430">ALL_GSI_PLACE</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 global secondary index의 배치 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#d06962a15a1d2b79">USER_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 소유한 테이블의 global secondary index 존재 여부</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#a8fbf232d8aaf3c6">USER_GLOBAL_SECONDARY_INDEXES</a></div></td><td class="to_middle"><div>사용자가 소유한 global secondary index 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#11d5f39e4505f6a4">USER_GSI_PLACE</a></div></td><td class="to_middle"><div>사용자가 소유한 global secondary index의 배치 정보</div></td></tr></tbody></table>

<a id="c1e5efd97a692955"></a>
...
<a id="a4cb958465bee620"></a>
![Global secondary index 구조](../assets/images/4706b0e205bcf145.png)
