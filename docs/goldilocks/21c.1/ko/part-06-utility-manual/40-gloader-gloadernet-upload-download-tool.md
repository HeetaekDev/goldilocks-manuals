...
<a id="6afaac7b95b188ad"></a>
#### Control File

Control file은 gloader가 동작하는데 필요한 파일로써 다음과 같은 정보를 가지고 있다. ([Control File 구문](#cddcb335f4764751)를 참조한다.)
...
<a id="e50059e6af2e8890"></a>
## gloader 사용

<a id="6a455e3809ed2f64"></a>
### Datafile Type

<a id="3d7b9b779d626389"></a>
#### Text Datafile
...
<a id="8023eac07bf7aa11"></a>
### 데이터 다운로드

<a id="5ae560888ae94e87"></a>
#### Text File로 다운로드

<a id="7369dd7dd47930d0"></a>
##### Simple Download
...
<a id="f5456248998f4c29"></a>
#### Binary File로 다운로드

<a id="d41a6338644bcb75"></a>
##### Simple Download
...
<a id="3c0f0f919f4ff4bd"></a>
### 데이터 업로드

<a id="78eae73ae957dc84"></a>
#### Text File 업로드

<a id="dc5914fab694f2be"></a>
##### Simple Upload
...
- Control 파일에서 OPTIONALLY ENCLOSED BY 구문을 사용하지 않고 다운로드한 데이터 파일
    ...
    - 다음은 control 파일에서 OPTIONALLY ENCLOSED BY 구문을 사용하지 않고 다운로드한 데이터 파일이다. ([Text File로 다운로드](#5ae560888ae94e87)를 참조한다.)
...
- Control 파일에서 OPTIONALLY ENCLOSED BY 구문을 사용하여 다운로드한 데이터 파일
    ...
    - 다음은 control 파일에서 OPTIONALLY ENCLOSED BY 구문을 사용하여 다운로드한 데이터 파일이다. ([Text File로 다운로드](#5ae560888ae94e87)를 참조한다.) 위의 결과와는 달리 아래 결과를 보면 New Line('`\n`')이 데이터의 일부로 취급되었다.
...
<a id="b84910eeb107fd48"></a>
#### Binary File 업로드

<a id="7752fce951a6a87d"></a>
##### Simple Upload
...
다음은 gloader를 이용하여 업로드 할 파일이다. test.dat는 [Binary File로 다운로드](#f5456248998f4c29) 할 때 미리 다운로드 하였다.
...
<a id="11e3a1e8bed22d59"></a>
#### Upload 처리 단위 제어

데이터를 업로드 할 때 성능과 관련된 옵션을 사용하면 더 빠르게 실행할 수 있다.  
[--array](#16b7d75e44028f29), [--commit](#26e9656a5ae7401c), [--atomic](#95eca885918188b9)을 참조한다.
...
<a id="f5820a2982304244"></a>
#### Parallel Upload

gloader가 업로드 작업을 수행할 때 작업을 부분별로 나누어 여러 thread로 처리할 수 있어 성능 향상에 도움이 된다. ([--parallel](#794f16bb7182ad06)을 참조한다.)
...
<a id="f50ab28bde3c3071"></a>
##### 문제 해결

테이블스페이스의 데이터 파일을 확장하거나 추가한다.   
자세한 내용은 [ALTER TABLESPACE](../part-03-sql-manual/18-sql-references-a-b.md#7c3ae65b4798a999)를 참조한다.

<a id="9a84f8c4991ae7fb"></a>
#### 데이터 파일 분석 실패
...
<a id="6275a9eca6f55327"></a>
### CHARACTERSET

<a id="818b2690b53746b6"></a>
#### 구문
...
<a id="fce23da73acadaf1"></a>
### TABLE

<a id="7a89805662ad3969"></a>
#### 구문
...
<a id="bb6b909e3040a379"></a>
### FIELDS TERMINATED BY

<a id="42b6a4e62c6cf978"></a>
#### 구문
...
<a id="c5b375bf5313e761"></a>
### OPTIONALLY ENCLOSED BY

<a id="a746396bfdc234c8"></a>
#### 구문
...
> OPTIONALLY ENCLOSED BY 구문이 없는 경우, 데이터 다운로드와 업로드 결과가 서로 다를 수 있다. ([Upload 문제 해결](#5b27d9a01429697b)을 참조한다.)

<a id="0ed38ca8ad749c95"></a>
#### 사용 예
...
<a id="b0bc7ee1524c4df8"></a>
### LINES TERMINATED BY

<a id="d2b9043a5b883943"></a>
#### 구문
...
<a id="328367821bf0369a"></a>
### LTRIM

<a id="61792a1abf433636"></a>
#### 구문
...
<a id="da13231a782272c4"></a>
### RTRIM

<a id="a5b1d52d742c5c73"></a>
#### 구문
...
<a id="9eb70ac1e6112652"></a>
### WHERE

<a id="25365b0c6bc31008"></a>
#### 구문
...
<a id="b0ccdf0205931869"></a>
#### 설명

데이터를 다운로드 할 경우 조건절을 사용한다.

<a id="2549d0ff10daf523"></a>
#### 사용 예
...
<a id="64af0e16fe19d3d9"></a>
## gloader Argument References

<a id="bae51f7fbd8cdcaa"></a>
### 사용법
...
<a id="ffe7c5565a6dbd99"></a>
#### --import

<a id="3eabb3d059fb9f12"></a>
##### 설명

gloader가 database에서 데이터를 업로드 하도록 기술한다.

<a id="6690f564fa78da43"></a>
##### 사용 예
...
<a id="9fcbddc3cc1f46a9"></a>
#### --control

<a id="c8042b497df180d9"></a>
##### 설명
...
<a id="1ed15ff67a824d1c"></a>
#### --data

<a id="bcc21696753939ae"></a>
##### 설명

다운로드/ 업로드 할 data file 경로를 기술한다.

<a id="338dfbe98a42f6b0"></a>
##### 사용 예
...
<a id="96cb8a623551b752"></a>
### 옵션 인자

<a id="8683c5f505ddcc5f"></a>
#### --tablename

<a id="696ade8db33bb07a"></a>
##### 설명
...
<a id="fc73ebb574682cb8"></a>
#### --log

<a id="6704f83fcfcd70aa"></a>
##### 설명
...
<a id="2ba2de7f36204abf"></a>
#### --bad

<a id="02dd390207122409"></a>
##### 설명
...
<a id="4c476bc7bc9a890a"></a>
#### --dsn

<a id="3d7defe7689ff656"></a>
##### 설명
...
자세한 내용은 [odbc.ini 파일](../part-05-developer-manual/31-odbc.md#a8dbbc9962ac8d3d)을 참조한다.

<a id="cfdc62152841a681"></a>
##### 사용 예
...
자세한 내용은 [날짜/시간 타입 포맷으로 인한 실패](#b91699ce8e5e8160)를 참조한다.

<a id="16b7d75e44028f29"></a>
#### --array

<a id="f2d9bc623a22e99f"></a>
##### 설명
...
<a id="72fcb0d27e2ce178"></a>
#### --filesize

<a id="e2570629377374b1"></a>
##### 설명
...
<a id="2a9d462aa203b210"></a>
#### --comment

<a id="c5f44c1640f0a05a"></a>
##### 설명

gloader가 트랜잭션 commit 할 때 트랜잭션에 주석을 지정한다.

<a id="cf980304c3dba38a"></a>
##### 사용 예
...
<a id="95eca885918188b9"></a>
#### --atomic

<a id="2ea60720bc6b5e55"></a>
##### 설명
...
<a id="794f16bb7182ad06"></a>
#### --parallel

<a id="41ca6f23d8c44e5f"></a>
##### 설명
...
<a id="0ef2257509592bf5"></a>
#### --propagation

<a id="8c2533233c725744"></a>
##### 설명

업로드 트랜잭션의 로그를 다른 복제 서버에 전파할지 여부를 결정한다.   
ON, OFF를 설정할 수 있다.

<a id="ea6056dbcf46ca30"></a>
##### 사용 예
...
<a id="43906df8c60b1da9"></a>
#### --errors

<a id="7409f14f08230c53"></a>
##### 설명
...
<a id="bd32fe283cc3fef3"></a>
#### --fieldterm

<a id="d46b53467774c59e"></a>
##### 설명
...
<a id="c5b225178b62e5de"></a>
#### --lineterm

<a id="96ab0252a1336b45"></a>
##### 설명
...
<a id="900f2ae0bbd9d814"></a>
#### --qualifier

<a id="e82cd1047655f526"></a>
##### 설명
...
<a id="112dcfc8ce4e8527"></a>
#### --group-id

<a id="e3b49a6f742d1178"></a>
##### 설명
...
--group-id 옵션은 ODBC의 [GLOBAL CONNECTION](../part-05-developer-manual/31-odbc.md#b1443971f8b3fd95)을 사용하므로 [데이터 원본 구성](../part-05-developer-manual/31-odbc.md#e877d5722faabf1c)에 관련 내용을 설정해야 한다.

<a id="5d61745b0382cc57"></a>
##### 사용 예
...
<a id="541bd2fb35d48b3c"></a>
#### --no-copyright

<a id="8040ccfeee92e09a"></a>
##### 설명

Copyright와 version을 출력하지 않는다.

<a id="8eff52208b675252"></a>
##### 사용 예
...
<a id="e7c41fc9d602c3c6"></a>
#### --silent

<a id="f4117fdc7a8865ab"></a>
##### 설명

gloader 수행 결과를 출력하지 않는다.

<a id="2c1a504e9f27a973"></a>
##### 사용 예
...
<a id="5e38d04fc2001d1b"></a>
#### --help

<a id="c34ebce272b08b9b"></a>
##### 설명

도움말을 출력한다.  
자세한 내용은 [사용법](#bae51f7fbd8cdcaa)을 참조한다.
