...
<a id="ce49d746192c5130"></a>
## Cluster System

<a id="2e2a17cb6716dc1b"></a>
### Cluster System 관련 구문

자세한 내용은 다음 링크를 참조한다.

- Cluster system 확장
    - [CREATE CLUSTER GROUP](18-sql-references.md#dd23e8e2eae3991d)
    - [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references.md#72ed23526a0c9e3b)

- Inactive cluster member 제어
    - [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references.md#4c6f8df475e24e0c)
    - [ALTER SYSTEM JOIN DATABASE](18-sql-references.md#5a78b6da246beb5a)

- 데이터 재배치
    - [ALTER DATABASE REBALANCE](18-sql-references.md#48a2899b3f507f9f)
    - [ALTER TABLE name REBALANCE](18-sql-references.md#1c3e42a41b2d2965)

Cluster system과 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="6795fab0e681ecec"></a>
<table class="table column_count_3"><caption>Cluster system 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#35e80503b8cf1c78">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Cluster를 구성하는 cluster group, cluster member의 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78f38dec7bb97b38">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Cluster group과 cluster member의 주석 정보</div></td></tr><tr><td class="to_middle"><div>PERFORMANCE_VIEW_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#f52ecd90758ef650">V$CLUSTER_MEMBER</a></div></td><td class="to_middle"><div>Cluster member의 상태 정보</div></td></tr></tbody></table>

<a id="b41cfe09ccabe3f1"></a>
### Cluster System 개념
...
- [ALTER SYSTEM JOIN DATABASE](18-sql-references.md#5a78b6da246beb5a)는 장애가 발생한 cluster member를 cluster system에 다시 참여시킬 때 사용되는 구문이다.

- [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references.md#4c6f8df475e24e0c)는 장애가 발생한 cluster member를 cluster system에서 제거하기 위해 사용되는 구문이다.

- [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references.md#72ed23526a0c9e3b)는 고가용성을 위해 cluster group에 cluster member를 추가할 때 사용되는 구문이다.

- [ALTER DATABASE REBALANCE](18-sql-references.md#48a2899b3f507f9f), [ALTER TABLE name REBALANCE](18-sql-references.md#1c3e42a41b2d2965)는 생성한 cluster member에 데이터를 재배치하기 위해 사용되는 구문들이다.

<a id="38d67dd54481fd59"></a>
### Cluster System 확장
...
<a id="26548dd4dda1245f"></a>
## Cluster Group

<a id="710f3da4af046055"></a>
### Cluster Group 관련 구문

Cluster group을 생성, 제거, 변경하기 위한 구문은 다음과 같다.

- Cluster group 생성: [CREATE CLUSTER GROUP](18-sql-references.md#dd23e8e2eae3991d)
- Cluster group 제거: [DROP CLUSTER GROUP](18-sql-references.md#e491103ba644ea1a)
- Cluster group 변경: [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references.md#72ed23526a0c9e3b)

Cluster group 과 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="db8ff35ae1141332"></a>
<table class="table column_count_3"><caption>Cluster group 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#35e80503b8cf1c78">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Cluster를 구성하는 cluster group, cluster member의 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78f38dec7bb97b38">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Cluster group과 cluster member의 주석 정보</div></td></tr></tbody></table>

<a id="74bce15d06a0f735"></a>
### Cluster Group 개념

Cluster system을 운영하기 위해서는 최소 하나 이상의 cluster group을 생성해야 한다.

<a id="7e266a7242c66ac6"></a>
#### Cluster group의 생성

최초로 생성하는 cluster group은 자기 자신을 cluster member로 포함해야 한다. Cluster group을 생성하는 구문은 [CREATE CLUSTER GROUP](18-sql-references.md#dd23e8e2eae3991d)을 참조한다.
...
<a id="ee3570488cff5c85"></a>
#### Cluster Group 제거

Cluster system에 참여하여 서비스 중인 cluster group은 여러가지 이유로 제거될 수 있다. Cluster group의 제거는 [DROP CLUSTER GROUP](18-sql-references.md#e491103ba644ea1a)을 참조한다.
...
<a id="3f478cd0504832e3"></a>
## Cluster Member

<a id="b8c47a65624c5baf"></a>
### Cluster Member 관련 구문

자세한 내용은 다음 링크를 참조한다.

- Cluster member 추가: [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references.md#72ed23526a0c9e3b)

- Cluster member 제거: [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references.md#4c6f8df475e24e0c)

- Cluster member 제어
    - [ALTER SYSTEM JOIN DATABASE](18-sql-references.md#5a78b6da246beb5a)
    - [ALTER CLUSTER GROUP name OFFLINE MEMBER](18-sql-references.md#52c14a825b5adc8f)
    - [ALTER DATABASE RESET LOCAL CLUSTER MEMBER](18-sql-references.md#00c55783ca905023)

Cluster member와 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="41fd3d08a69b777a"></a>
<table class="table column_count_3"><caption>Cluster member 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#35e80503b8cf1c78">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Cluster를 구성하는 cluster group, cluster member의 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78f38dec7bb97b38">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Cluster group과 cluster member의 주석 정보</div></td></tr><tr><td class="to_middle"><div>PERFORMANCE_VIEW_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#f52ecd90758ef650">V$CLUSTER_MEMBER</a></div></td><td class="to_middle"><div>Cluster member의 상태 정보</div></td></tr></tbody></table>

<a id="cd42463b1c85cd3e"></a>
### Cluster Member 개념
...
새로운 cluster member를 cluster group에 추가하려면 [ALTER CLUSTER GROUP name ADD MEMBER](18-sql-references.md#72ed23526a0c9e3b) 구문을 수행한다.
...
- 전체 data를 재배치하는 경우: [ALTER DATABASE REBALANCE](18-sql-references.md#48a2899b3f507f9f)
- 일부 테이블만 재배치하는 경우: [ALTER TABLE name REBALANCE](18-sql-references.md#1c3e42a41b2d2965)

Cluster member에 장애가 발생해도 서비스 운영에는 지장이 없지만 DDL을 수행할 수 없다. 정상적인 서비스 운영을 위해서는 장애가 발생한 cluster member에 대한 조치를 취해야 한다.

장애가 발생한 cluster member를 cluster system에 다시 참여시키려면 해당 cluster member에 접속하여 LOCAL OPEN 단계로 구동한 후에 [ALTER SYSTEM JOIN DATABASE](18-sql-references.md#5a78b6da246beb5a)를 수행한다.

일부 cluster member를 구동하지 않거나 네트워크 단절 상태에서 cluster system을 구동한 경우에도 해당 cluster member를 LOCAL OPEN 단계로 구동한 후에 [ALTER SYSTEM JOIN DATABASE](18-sql-references.md#5a78b6da246beb5a) 구문을 수행한다.

만약 장애가 발생한 cluster member의 장비를 복구할 수 없는 경우에는 cluster system에서 [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](18-sql-references.md#4c6f8df475e24e0c) 구문을 수행하여 장애가 발생한 cluster member들을 제거한다.

Cluster system에서 제거된 cluster member는 여전히 제거되기 이전의 정보를 가지고 있으며 다시 cluster system에 참여할 수 없다. Cluster member를 cluster system에 참여하기 이전의 상태로 초기화하기 위해서는 [ALTER DATABASE RESET LOCAL CLUSTER MEMBER](18-sql-references.md#00c55783ca905023) 구문을 수행한다.
...
<a id="32e155f49b4fb76b"></a>
## Cluster Location

<a id="15bf3843e30e8337"></a>
### Cluster Location 관련 구문

Cluster location을 생성, 제거, 변경하기 위한 구문은 다음과 같다.

- Cluster location 생성: [CREATE CLUSTER LOCATION](18-sql-references.md#c88dc891576217eb)
- Cluster location 제거: [DROP CLUSTER LOCATION](18-sql-references.md#8d977b885f9df018)
- Cluster location 변경: [ALTER CLUSTER LOCATION](18-sql-references.md#8193ea3b3b99d43b)

Cluster location과 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

**Cluster location 관련 정보**

<a id="6075b6e212f00ad8"></a>
| 스키마 | View 이름 | 설명 |
| --- | --- | --- |
| PERFORMANCE_VIEW_SCHEMA | [V$CLUSTER_LOCATION](../part-02-administration-manual/9-database-information.md#a8025c3fe4573e07) | Cluster location 정보 |

<a id="44af69f09c7e58c7"></a>
### Cluster Location 개념
...
- Location control file이 삭제되어 cluster location 정보가 유실된 경우: [CREATE CLUSTER LOCATION](18-sql-references.md#c88dc891576217eb)
- 이미 등록된 cluster member의 접속 정보가 변경된 경우, 즉 hardware가 변경되거나 접속 ip, port가 변경된 경우: [ALTER CLUSTER LOCATION](18-sql-references.md#8193ea3b3b99d43b)

<a id="87224b8141b8a713"></a>
## Cluster Table과 Shard

<a id="99373996e21499bb"></a>
### Shard 관련 구문

Shard 정의와 재배치를 위한 구문은 다음과 같다.

- Shard 정의: [CREATE TABLE](18-sql-references.md#9b82da6d66aabe8c) 구문의 &lt;table sharding strategy&gt; 절
- Shard 재배치: [ALTER TABLE name REBALANCE](18-sql-references.md#1c3e42a41b2d2965)

Cluster table의 shard 관련 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="ac44d9d61265ed2d"></a>
<table class="table column_count_3"><caption>Cluster table과 shard 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="8"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#38edbbfd5e7d7188">ALL_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#d0d6a053b9ab00c2">ALL_SHARD_KEY_COLUMNS</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table의 shard key column 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#c31af616ee8fbda6">ALL_TAB_PLACE</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table의 배치 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#c9d10446d1d54341">ALL_TAB_SHARDS</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 cluster table의 shard 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#025486f0679bc20d">USER_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#68e16a9f26c8d7b7">USER_SHARD_KEY_COLUMNS</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table의 shard key column 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#7956b3bddf26a80d">USER_TAB_PLACE</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table의 배치 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#a67b689710e46884">USER_TAB_SHARDS</a></div></td><td class="to_middle"><div>사용자가 소유한 cluster table의 shard 정보</div></td></tr></tbody></table>

<a id="0d2d3fa4703fff1e"></a>
### Cluster Table 유형
...
Sharded table은 row들을 수평으로 분할하여 shard 단위로 관리하며, sharding 정책은 [CREATE TABLE](18-sql-references.md#9b82da6d66aabe8c) 구문의 SHARDING BY 절을 이용해 정의한다. Sharding 정책에 의해 분류된 row들의 집합을 shard라고 한다.

각 shard는 사용자가 정의한 배치 정책에 따라 cluster group에 배치되는데 [CREATE TABLE](18-sql-references.md#9b82da6d66aabe8c) 구문의 AT CLUSTER WIDE를 통해 자동으로 배치하거나, AT CLUSTER GROUP 절을 이용해 배치할 cluster group을 지정할 수도 있다. AT CLUSTER WIDE를 사용해 자동으로 배치할 경우, [CREATE CLUSTER GROUP](18-sql-references.md#dd23e8e2eae3991d) 구문을 사용하여 cluster group을 생성한 후에 [ALTER TABLE name REBALANCE](18-sql-references.md#1c3e42a41b2d2965) 구문을 수행하는 반면에 AT CLUSTER GROUP을 사용해 shard가 배치될 cluster group을 지정하는 경우 새롭게 추가된 cluster group에 shard가 배치되지 않는다.

다음은 3 x 2 cluster 환경에서 cluster table의 유형에 따라 테이블을 생성하고 data를 배치하는 개념을 설명하기 위한 예이다.

<a id="fe251ddca641a486"></a>
### Cloned Table
...
[ALTER TABLE name REBALANCE](18-sql-references.md#1c3e42a41b2d2965) 구문을 사용하여 cluster table의 데이터를 재배치한다.
...
- [USER_TAB_SHARDS](../part-02-administration-manual/9-database-information.md#a67b689710e46884)
- [ALL_TAB_SHARDS](../part-02-administration-manual/9-database-information.md#c9d10446d1d54341)
...
<a id="d109e2b425454ea2"></a>
## Global Secondary Index

<a id="66b897cd369058db"></a>
### Global Secondary Index 관련 구문

Global secondary index를 생성, 제거, 변경하기 위한 구문은 다음과 같다.

- Global secondary index 생성: [ALTER TABLE name ADD GLOBAL SECONDARY INDEX](18-sql-references.md#c41a3550730b3ad2)
- Global secondary index 제거: [ALTER TABLE name DROP GLOBAL SECONDARY INDEX](18-sql-references.md#cad9ba4018feb93c)
- Global secondary index 변경: [ALTER TABLE name ALTER GLOBAL SECONDARY INDEX](18-sql-references.md#5936e806c49b1c04)

Global secondary index 와 관련된 정보는 다음과 같은 view를 통해 조회할 수 있다.

<a id="5efe5d191fd82187"></a>
<table class="table column_count_3"><caption>Global secondary index 관련 정보</caption><thead><tr><th class="to_center"><div>스키마</div></th><th class="to_center"><div>View 이름</div></th><th class="to_center"><div>설명</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="6"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#38edbbfd5e7d7188">ALL_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 테이블의 global secondary index 존재 여부</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#9f4ffcd8822ec1eb">ALL_GLOBAL_SECONDARY_INDEXES</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 global secondary index 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#7c404ebc35746bdd">ALL_GSI_PLACE</a></div></td><td class="to_middle"><div>사용자가 접근 가능한 global secondary index의 배치 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#025486f0679bc20d">USER_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>사용자가 소유한 테이블의 global secondary index 존재 여부</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#a97c353606a28f8b">USER_GLOBAL_SECONDARY_INDEXES</a></div></td><td class="to_middle"><div>사용자가 소유한 global secondary index 객체 정보</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#db68f89763672139">USER_GSI_PLACE</a></div></td><td class="to_middle"><div>사용자가 소유한 global secondary index의 배치 정보</div></td></tr></tbody></table>

<a id="f07cd8f2cde48010"></a>
