<a id="2ccf7a49f2a82f44"></a>

# 1. 시작하기

> 원본: [GOLDILOCKS 20c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/20c_1/manual/ko/2ccf7a49f2a82f44)  
> 태그: `20c.1_30_tag`

[전체 목차](../README.md) · [2. 튜토리얼 →](2-튜토리얼.md)

<a id="a0fa1824c4fc0b97"></a>
## 서문
...
- 본 문서는 GOLDILOCKS 20c.1 버전을 기준으로 작성되었다.
- 본 문서는 RedHat 계열 Linux 플랫폼을 기준으로 작성되었다.

<a id="354b4cea59afd7d9"></a>
### 대상
...
<a id="3e381e27af7f4172"></a>
![GOLDILOCKS architecture](../assets/images/56de7f87c002bd08.png)
...
- Client/ Server (C/S) model
    ...
    - Dedicated, shared 모드 설정은 [odbc.ini 파일](../part-05-developer-manual/29-odbc.md#f1a0bc8659eada10), [Listener Configuration](../part-06-utility-manual/36-glsnr.md#c72fb5e2d69e63d9)을 참고한다.
...
<a id="c0485cb1637a3bfd"></a>
![GOLDILOCKS cluster system architecture](../assets/images/0295072a25373ff7.png)

<a id="ff7c5bec66e8deee"></a>
## GOLDILOCKS Cluster의 특징

<a id="b7334b4d885fcee0"></a>
### Cluster 특장점
