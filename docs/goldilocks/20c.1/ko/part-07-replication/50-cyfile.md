...
> 사용자 실수를 방지하기 위해 [DISABLE_DDL_CDC_GIVEUP](../part-02-administration-manual/10-server-property.md#70417d25a12eef45) 서버 프로퍼티를 사용하여 이중화 give up을 유발하는 DDL을 수행하지 못하도록 제어할 수 있다. 또한, 서버 프로퍼티를 [DISABLE_UPDATE_PK_CDC_GIVEUP](../part-02-administration-manual/10-server-property.md#0ab93e6df7502ac6)사용하여 primary key의 갱신을 비활성화 할 수 있다.

<a id="509fb8ef4c814ee2"></a>
### 기타
...
<a id="fdc6d33b2de87762"></a>
#### 데이터베이스 권한

<a id="90119b27f03b04b4"></a>
##### 사용자 접속 권한 설정
...
<a id="89347c518487538e"></a>
## 환경설정

<a id="ae5a999aa99f6af1"></a>
### 환경설정 파일
...
<a id="58943df83ccab569"></a>
### 환경설정 옵션

<a id="710e1a4523f9d2e9"></a>
#### DSN
