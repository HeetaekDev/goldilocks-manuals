...
- 이중화가 진행 중인 table에 Data Definition Language (DDL)이 수행된 경우 give up 될 수 있다.
    - Table1의 [DDL 구문에 따른 give up 발생 및 절차에 따른 허용 여부](#9a83f84426f61a37)를 참조한다.
...
> 사용자의 실수를 방지하기 위해, 이중화 give up을 유발하는 DDL을 수행하지 못하도록 [DISABLE_DDL_CDC_GIVEUP](../part-02-administration-manual/10-server-property.md#70417d25a12eef45) 서버 프로퍼티를 이용해 제어할 수 있다. 또한 [DISABLE_UPDATE_PK_CDC_GIVEUP](../part-02-administration-manual/10-server-property.md#0ab93e6df7502ac6) 서버 프로퍼티를 사용하여 primary key의 갱신을 비활성화 할 수 있다.

<a id="831dca391807cb33"></a>
### 이중화 운영 중 DDL 처리
...
** 자세한 내용은 [DDL 구문에 따른 give up 발생 및 절차에 따른 허용 여부](#9a83f84426f61a37)를 참조한다.
...
- Oracle, MySQL과 연동할 수 있다.

<a id="6f3ef1dd6db60035"></a>
#### Oracle

**Oracle 연동 datatype**

<a id="8dcf8e7862fbfb6f"></a>
...
<a id="626667bafbaa0422"></a>
#### MySQL

**MySQL 연동 datatype**

<a id="126a7cc592f33c00"></a>
| GOLDILOCKS | MySQL | 비고 |
| --- | --- | --- |
...
<a id="e9ad0ba5e013e2df"></a>
#### 데이터베이스 권한

<a id="56654d603a9adf2f"></a>
##### 사용자의 접속 권한을 설정
...
<a id="f0c99b1e342a808d"></a>
## 환경설정

<a id="c6a1aca86a7ae128"></a>
### 환경설정 파일
...
<a id="b38d62df39fab5ce"></a>
### 환경설정 옵션

<a id="3411eb0829b9784b"></a>
#### COMM_CHUNK_COUNT
...
<a id="adfb57df4047dc01"></a>
#### MYSQL_DATABASE

- Slave에서 설정할 수 있다.
- 이중화하려는 MySQL의 DATABASE 이름을 기술한다.
 * MySQL의 DATABASE이름은 SCHEMA이름과 동일한 의미를 갖는다.
...
<a id="df5eca1a76ee8018"></a>
| 구분 | 파일 |
| --- | --- |
| Cyclone Master | $GOLDILOCKS_DATA/trc/cyclone_master.trc |
| Cyclone Slave | $GOLDILOCKS_DATA/trc/cyclone_slave.trc |

> Trace log에 저장되는 에러 메시지와 대처 방안은 [CYCLONE 에러 메시지와 처리 방법](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#e4c5e119351af26f)을 참조한다.

<a id="5c1ec05287fb7ee2"></a>
### GOLDILOCKS 접속 정책
...
> 그룹 또는 노드의 추가/삭제와 관련된 예는 [노드 추가와 삭제](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#c293084bbea58fc7)를 참조한다.  
> 이중화 초기화와 관련된 예는 [이중화 초기화](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#db430807df64b303)를 참조한다.

<a id="a461c1c93081fff4"></a>
## CYCLONE 운영 예
...
<a id="933225f08ad58d4b"></a>
### 원본 GOLDILOCKS 환경 설정

기술된 [준비사항](#7bdc143e1a810eb0)을 모두 수행한다.
...
<a id="d370691feab6cbfa"></a>
### 원격 GOLDILOCKS 환경 설정

[사용자 등록 및 권한 설정](#9cd2eefd56b692f3)을 수행한다.

<a id="07b1d9b31171a535"></a>
...
<a id="6653b016ddf7d10b"></a>
## Cluster 환경에서 CYCLONE 운영

<a id="772969afc8a0e22c"></a>
### 준비사항
...
<a id="615ed2fdcd1f1822"></a>
### 운영

<a id="798487623dd299a6"></a>
#### 실행과 종료
...
<a id="77cf61f07408adf7"></a>
### 수행

<a id="6304ca65b7fae7c5"></a>
#### 환경 설정 파일
...
<a id="26d33bb187ecf87e"></a>
#### 실행 방법

<a id="9c754704e7206412"></a>
##### Master에서 수행
...
<a id="883cd4120ddcec53"></a>
### SYNC

<a id="93dc62608207828d"></a>
#### Master에서 수행
...
<a id="6ae4100f7e7221ba"></a>
### 기타

--reset 옵션은 standalone 환경에서 쓰이는 것과 동일하게 사용할 수 있다.

<a id="24e9aa9df520205e"></a>
## 모니터링 (CYMON)
...
<a id="0cd23f83f45a25c4"></a>
| 파일 이름 | 구분 |
| --- | --- |
| cymon | cyclone용 monitor |

<a id="9bb209eb139c3c3c"></a>
### 환경 설정 파일
...
<a id="9cd76e787b010bbe"></a>
### 모니터링 내용

<a id="47cff61e0d43fac2"></a>
#### CYMON
...
<a id="cb24be33292e560c"></a>
### 실행 및 모니터링

<a id="3507a878e67b3698"></a>
#### 실행 옵션

**실행옵션**

<a id="f611c2346367fcde"></a>
| 옵션 | 설명 | 비고 |
| --- | --- | --- |
...
```
    ...
    - 위의 정보를 통해 CYCLONE MASTER만 동작하고 있고 SLAVE를 대기 중임을 확인할 수 있다.
