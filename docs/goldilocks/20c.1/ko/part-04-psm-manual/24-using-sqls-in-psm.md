<a id="eb428f705cf48593"></a>

# 24. Using SQLs in PSM

> 원본: [GOLDILOCKS 20c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/20c_1/manual/ko/eb428f705cf48593)  
> 태그: `20c.1_30_tag`

[← 23. Using PSM Subprograms](23-using-psm-subprograms.md) · [전체 목차](../README.md) · [25. PSM Packages →](25-psm-packages.md)

<a id="1cab02b035c77214"></a>
## Static SQLs

Static SQL은 PSM에서 사용할 수 있는 SQL로써 다음과 같이 분류한다.

- [SELECT](#f794db94712dfe82)
- [INSERT](#38cea8af5930c4d2)
- [UPDATE](#2d6893d281885737)
- [DELETE](#acc200ea18c1330e)
- [RETURNING INTO](#d6ab3981556ea6e0)
- [LOCK TABLE](../part-03-sql-manual/18-sql-references.md#b16d2620c2af8fbf)
- [COMMIT, ROLLBACK, SAVEPOINT](#2390dce6bf456ff6)

Static SQL은 GOLDILOCKS에서 지원하는 SQL을 PSM 변수를 통해 실행할 수 있도록 확장된 SQL이다.   
본 장에서는 PSM에서만 사용할 수 있는 static SQL의 기능과 주의사항에 대해 설명한다.

<a id="f794db94712dfe82"></a>
### SELECT
...
자세한 내용은 [Data Query Language](../part-03-sql-manual/12-sql-languages.md#05aeb974f6d4a0f0)를 참조한다.
...
자세한 내용은 [데이터 추가](../part-03-sql-manual/12-sql-languages.md#07719fe1186d8bb7)를 참조한다.
...
자세한 내용은 [%ROWTYPE](20-psm-datatypes.md#d83f60efe835740b)을 참조한다.
...
자세한 내용은 [User-defined Record Type](20-psm-datatypes.md#74fb126a1c2b9f42)을 참조한다.
...
자세한 내용은 [데이터 갱신](../part-03-sql-manual/12-sql-languages.md#f2d9641ff39e4d82)을 참조한다.
...
<a id="ee65a0e84fee8fa2"></a>
#### INSERT RETURNING INTO

INSERT RETURNING INTO 절은 데이터베이스에 저장된 결과값을 RETURING INTO에 기술된 PSM 변수로 저장한다.
...
- Dynamic SQL은 다음과 같은 PSM statement에서 사용할 수 있다.
    - [EXECUTE IMMEDIATE Statement](26-psm-language-element-references.md#acfad17b43646d05) 
    - [OPEN FOR Statement](26-psm-language-element-references.md#cacfe58629d4d394)

<a id="643092b8dbdc6dff"></a>
### EXECUTE IMMEDIATE
...
자세한 내용은 [EXECUTE IMMEDIATE Statement](26-psm-language-element-references.md#acfad17b43646d05)를 참조한다.

<a id="ed3e1350790dee80"></a>
...
자세한 내용은 [OPEN FOR Statement](26-psm-language-element-references.md#cacfe58629d4d394), [FETCH Statement](26-psm-language-element-references.md#28d6b09490d25cec), [CLOSE Statement](26-psm-language-element-references.md#b05f50404c599887)를 참조한다.
