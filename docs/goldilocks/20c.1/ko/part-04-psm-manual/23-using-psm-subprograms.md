...
자세한 내용은 [Block (BEGIN .. END)](26-psm-language-element-references.md#935e63becc4b4210)을 참조한다.
...
자세한 내용은 [Procedure Declaration and Definition](26-psm-language-element-references.md#c3ec1444b7c9768d)을 참조한다.
...
<a id="acc215374452b234"></a>
## Nested Function

Nested function은 nested procedure와 동일하지만 함수 형태를 가지는 subprogram이다.  
자세한 내용은 [Function Declaration and Definition](26-psm-language-element-references.md#2ed935a597ae9a78)을 참조한다.
...
자세한 내용은 [ROUTINES](../part-02-administration-manual/9-database-information.md#bb4f9bd0a6d079c9)를 참조한다.
...
자세한 내용은 [PARAMETERS](../part-02-administration-manual/9-database-information.md#09ba9816b762dfd3)를 참조한다.
...
자세한 내용은 [CALL Statement](27-psm-sql-references.md#7bcf573258b09647)를 참조한다.
...
<a id="0cf3abcba14696b0"></a>
### 제거

Schema-level procedure는 다음 DROP PROCEDURE 구문으로 제거한다.  
자세한 내용은 [DROP PROCEDURE](27-psm-sql-references.md#d133d98fe19742b0)를 참조한다.
...
<a id="6cfa62a036e696b9"></a>
### 제거

Schema-level function은 다음 DROP FUNCTION 구문으로 제거한다.  
자세한 내용은 [DROP FUNCTION](27-psm-sql-references.md#399ca1e28092268f)을 참조한다.
