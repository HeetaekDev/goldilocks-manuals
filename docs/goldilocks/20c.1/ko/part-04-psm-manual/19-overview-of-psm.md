...
<a id="043792ae35b3464e"></a>
## PSM의 특장점

<a id="9c0ba64be40ecfd4"></a>
### SQL과의 긴밀한 연동
...
<a id="938b282ea33223eb"></a>
### 관리의 용이성

GOLDILOCKS PSM은 개별 client에 각각 존재하는 유사 로직을 단 하나의 모듈로 서버에 구현하므로 관리가 용이하며 해당 모듈을 사용하는 도중에 필요에 따라 변경할 수도 있다.

<a id="23997097b89605de"></a>
## Language Elements

<a id="f5826caebd15432d"></a>
### Data Types

GOLDILOCKS PSM은 GOLDILOCKS SQL에서 제공하는 모든 built-in data type들을 제공하며, 사용자가 정의하는 record와 collection 타입까지 지원한다.    
자세한 내용은 [PSM DataTypes](20-psm-datatypes.md#cae2759761431d28)를 참조한다.

<a id="7cf28b446b3c9423"></a>
### Variables

GOLDILOCKS PSM에서 사용자가 필요에 의해 선언한 변수는 모든 expression에서 사용할 수 있다.

자세한 내용은 다음을 참조한다.  
• [선언부 (Declarative Part)](21-psm-control-statements.md#2f71c92e3fcf61f2)  
• [Assignment](21-psm-control-statements.md#3e7c8b1591fd3c0d)

<a id="40602d3f3ac2d965"></a>
### Control Structures

GOLDILOCKS PSM은 일반적인 script 언어들이 제공하는 판단 분기문, GOTO와 같은 무조건 분기문, 반복 수행을 위한 loop 구문들을 대부분 지원한다.   
자세한 내용은 [PSM Control Statements](21-psm-control-statements.md#2c96cd37c2f361c6)를 참조한다.

<a id="fea814720f68b20f"></a>
### Subprograms
...
자세한 내용은 [Using PSM Subprograms](23-using-psm-subprograms.md#40f719079d3d96d1)를 참조한다.

<a id="bb5f6f1998c49c6c"></a>
