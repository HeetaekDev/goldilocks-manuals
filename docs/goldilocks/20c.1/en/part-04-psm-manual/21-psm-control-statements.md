...
<a id="9b1607991d7cbf37"></a>
### PL Block Configuration

A single PL block is divided into the following three parts.   
For more information, refer to [Block (BEGIN .. END)](26-psm-language-element-references.md#27fce0c2a91f696a).
...
- Variable (Refer to [PSM DataTypes](20-psm-datatypes.md#8c878b276a789b32).)
- User defined type
- Cursor
...
- Control Statements (Refer to [PSM Control Statements](#bce0bc9bfd2028a5).)
- Cursor Statements (Refer to [PSM Cursor Statements](22-psm-cursor-statements.md#0735bbaf45e9ed47).)
- SQL Statements (static/ dynamic) (Refer to [Using SQLs In PSM](24-using-sqls-in-psm.md#bce1a07631b87953).)

<a id="cde949a1a19333d9"></a>
...
For more information about declaration of user defined exception, built-in handler types or installing a handler, refer to [Error Handling](#771cd46d7a48f38c).

<a id="cd844f0bf00b19fd"></a>
## NULL Statement

It is used to specify a statement which does not have any role in PSM such as no-op.  
For more information, refer to [NULL Statement](26-psm-language-element-references.md#d99e3499a1fdd177).
...
For more information, refer to [IF Statement](26-psm-language-element-references.md#6ec0fea929a8c872).
...
For more information, refer to [CASE Statement](26-psm-language-element-references.md#3c256bb60bdaf4da).
...
For more information, refer to [Basic LOOP Statement](26-psm-language-element-references.md#6d5c566be5857d96).
...
For more information, refer to [EXIT Statement](26-psm-language-element-references.md#720bf4f5443c1fb7).
...
<a id="366a8579d4494519"></a>
### FOR Loop

FOR loop statement repeatedly performs a series of statements as many times as the number of integers of the given scope.  
For more information, refer to [FOR LOOP Statement](26-psm-language-element-references.md#dab44995bc36b8f3).
...
<a id="3f48a1bf34e4b5d3"></a>
### WHILE Loop

WHILE loop statement repeatedly performs a series of statements while the given condition is TRUE.  
For more information, refer to [WHILE LOOP Statement](26-psm-language-element-references.md#34a1e3a9c8ec9595).
...
For more information, refer to [GOTO Statement](26-psm-language-element-references.md#bf2dbc5e809bdc36).
...
For more information, refer to [CONTINUE Statement](26-psm-language-element-references.md#36b9610f45b5b1ab).
...
For more information, refer to [EXCEPTION Handling](#51f44a35e375a284), [SQLCODE Function](26-psm-language-element-references.md#88e194880b00d785), [SQLERRM Function](26-psm-language-element-references.md#95c19edfa7029573).

<a id="b5d18de568d07594"></a>
### Cursor Attributes
...
> For more information about a predefined exception or a user defined exception provided by GOLDILOCKS, refer to [Exception Declaration](26-psm-language-element-references.md#c4071779e371468d).

<a id="c8d6449a096997fe"></a>
