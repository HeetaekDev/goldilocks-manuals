...
| JDBC | A CallableStatement class should be used if it has a bind parameter with IN-OUT or OUT attribute. (Refer to [CallableStatement](../part-05-developer-manual/30-jdbc.md#b2871943ab3def34).) |
...
For more information, refer to [Procedure Declaration and Definition](26-psm-language-element-references.md#222ac8bbdacc7f59).
...
<a id="ee1b7ba6249f9989"></a>
## Nested Function

A nested function is as same as a nested procedure, but it is a subprogram in function form.   
For more information, refer to [Function Declaration and Definition](26-psm-language-element-references.md#33a80d3472392324).
...
For more information, refer to [CREATE PROCEDURE](27-psm-sql-references.md#5d4ca7cc7bd25c89).
...
For more information, refer to [ROUTINES](../part-02-administration-manual/9-database-information.md#21b24c175ed69290).
...
For more information, refer to [PARAMETERS](../part-02-administration-manual/9-database-information.md#fe788c9404b54368).
...
For more information, refer to [CALL Statement](27-psm-sql-references.md#d2db260011a29f5b).
...
<a id="de283b6edeef4a7a"></a>
### Dropping Schema-level Procedure

A schema-level procedure is dropped by the following DROP PROCEDURE statement.  
For more information, refer to [DROP PROCEDURE](27-psm-sql-references.md#42a1923f875beab4).
...
For more information, refer to [CREATE FUNCTION](27-psm-sql-references.md#d8170858a1ff601a).
...
<a id="a5ee684925465483"></a>
### Dropping Schema-level Function

A schema-level function is dropped by the following DROP FUNCTION statement.  
For more information, refer to [DROP FUNCTION](27-psm-sql-references.md#7a369d8891ee7e56).
...
| DBMS_OUTPUT.PUT_LINE(  item IN VARCHAR(4000) ) | It stores a message created with a given expression on a buffer. |
