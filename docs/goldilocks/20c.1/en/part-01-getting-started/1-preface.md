...
- This document is based on GOLDILOCKS 20c.1 version.
- This document is based on RedHat linux - based platform.

<a id="1b79e3fdecf07144"></a>
### Target Reader
...
- Client/ Server (C/S) model
    ...
    - For more information about setting dedicated mode or shared mode, refer to [odbc.ini File](../part-05-developer-manual/29-odbc.md#ff97025ffdef9296) and [Listener Configuration](../part-06-utility-manual/36-glsnr.md#a2344449349927b4).
