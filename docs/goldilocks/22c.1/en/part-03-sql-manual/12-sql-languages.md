...
<a id="fe780c8e5922c3cf"></a>
## Data Definition Language

<a id="0f90bff05671f46f"></a>
### DDL Related Statements

For more information, refer to the followings.

- Non-schema object DDL
    - [Database Related Statements](13-sql-objects.md#90de9e4c859f31da)
    - [Profile Related Statements](13-sql-objects.md#bbcb50fb30b5d95a)
    - [Audit Policy Related Statement](13-sql-objects.md#0907f349d7527bb0)
    - [Authorization Related Statements](13-sql-objects.md#0c3ee440f8690db4)
    - [Schema Related Statements](13-sql-objects.md#8d9e7c08256301a2)
    - [Tablespace Related Statements](13-sql-objects.md#b23f620ab0fa283f)

- SQL schema object DDL
    - [Table Related Statements](13-sql-objects.md#30e99fb90f9ad801)
    - [Index Related Statements](13-sql-objects.md#e734b3d73b5c1a54)
    - [View Related Statements](13-sql-objects.md#f3f3e7e97973b51a)
    - [Sequence Related Statements](13-sql-objects.md#6fa96e8ff3e247c4)
    - [Synonym Related Statements](13-sql-objects.md#e1bd1ab69e341490)

- Cluster object DDL
    - [Cluster System Related Statements](14-cluster-objects.md#727acc970a3e8ff4)
    - [Cluster Group Related Statements](14-cluster-objects.md#6ddbf2e91ef6b748)
    - [Cluster Member Related Statements](14-cluster-objects.md#abff00a72294d593)
    - [Cluster Location Related Statements](14-cluster-objects.md#f528f3275f2993a6)
    - [Global Secondary Index Related Statements](14-cluster-objects.md#10c5bd38f6cb9219)

<a id="123d3c43e8b8a22b"></a>
### Concepts of DDL
...
object</div></td><td class="to_left to_middle"><div>Profile</div></td><td class="to_left to_middle"><div>It is an object which defines a password management policy.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#0bc624c971c6317f">Profile</a></div></td></tr><tr><td class="to_middle"><div>Audit policy</div></td><td class="to_middle"><div>It is an object which defines the SQL audit policy.</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#4bcae1c27e895d0f">Audit Policy</a></div></td></tr><tr><td class="to_left to_middle"><div>User</div></td><td class="to_left to_middle"><div>It is a user object which consists of a set of privileges.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#45af044d1866a050">Authorization</a></div></td></tr><tr><td class="to_left to_middle"><div>Schema</div></td><td class="to_left to_middle"><div>It is a logical position including SQL schema objects such as tables.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#e664abbca285ded7">Schema</a></div></td></tr><tr><td class="to_left to_middle"><div>Tablespace</div></td><td class="to_left to_middle"><div>It is a physical storage of objects such as tables, indexes, etc.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#31db328a3e995565">Tablespace</a></div></td></tr><tr><td class="to_left to_middle"><div>Public synonym</div></td><td class="to_left to_middle"><div>It is a public synonym.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#65bc778386ef3cef">Public Synonym</a></div></td></tr><tr><td class="to_left to_middle" rowspan="7"><div>SQL schema 
object</div></td><td class="to_left to_middle"><div>Table</div></td><td class="to_left to_middle"><div>It is a physical relation where the data is stored.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#0506efef1a284188">Table</a></div></td></tr><tr><td class="to_left to_middle"><div>View</div></td><td class="to_left to_middle"><div>It is a logical relation which consists of queries.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#7eb6660a3ff5ef8b">View</a></div></td></tr><tr><td class="to_left to_middle"><div>Index</div></td><td class="to_left to_middle"><div>It is an index object to improve query performance.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#e123f77e4b0843c2">Index</a></div></td></tr><tr><td class="to_left to_middle"><div>Sequence</div></td><td class="to_left to_middle"><div>It is an object which generate sequence number.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#efdf0f05e46e8203">Sequence</a></div></td></tr><tr><td class="to_left to_middle"><div>Synonym</div></td><td class="to_left to_middle"><div>It is an object which declares an alias for an object.</div></td><td class="to_left to_middle"><div><a class="reference text" href="13-sql-objects.md#64ec2603cc9dd03d">Synonym</a></div></td></tr><tr><td class="to_middle"><div>Stored procedure</div></td><td class="to_middle"><div>It is a user defined procedure object.</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#cdbd95ef6b3a527d">Stored Procedure</a></div></td></tr><tr><td class="to_middle"><div>Stored function</div></td><td class="to_middle"><div>It is a user defined function object.</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#6704a795b24bc7bb">Stored Function</a></div></td></tr><tr><td class="to_left to_middle" rowspan="5"><div>Cluster
object</div></td><td class="to_left to_middle"><div>Cluster group</div></td><td class="to_left to_middle"><div>It is a cluster member set.</div></td><td class="to_left to_middle"><div><a class="reference text" href="14-cluster-objects.md#f5ebdd4895e74e15">Cluster Group</a></div></td></tr><tr><td class="to_left to_middle"><div>Cluster member</div></td><td class="to_left to_middle"><div>It is a data server which configures a cluster system.</div></td><td class="to_left to_middle"><div><a class="reference text" href="14-cluster-objects.md#382c2e039592e9f2">Cluster Member</a></div></td></tr><tr><td class="to_left to_middle"><div>Cluster location</div></td><td class="to_left to_middle"><div>It is a location object of a cluster member.</div></td><td class="to_left to_middle"><div><a class="reference text" href="14-cluster-objects.md#f1a779d179af9a83">Cluster Location</a></div></td></tr><tr><td class="to_left to_middle"><div>Shard</div></td><td class="to_left to_middle"><div>It is a set of rows which horizontally divides a cluster table.</div></td><td class="to_left to_middle"><div><a class="reference text" href="14-cluster-objects.md#fc09584b2becfda9">Cluster Table and Shard</a></div></td></tr><tr><td class="to_left to_middle"><div>Global secondary
index</div></td><td class="to_left to_middle"><div>It is an index for the row identifier of a cluster.</div></td><td class="to_left to_middle"><div><a class="reference text" href="14-cluster-objects.md#4ff66200d323c646">Global Secondary Index</a></div></td></tr></tbody></table>

<a id="24e4e03925a82d14"></a>
### DDL and Transaction
...
This feature is useful when a user needs to atomically perform batch DDL such as database migration or tool installation, or to recover a mistake through ROLLBACK when statement such as DROP TABLE or TRUNCATE TABLE is executed by user mistake.

If the property of DDL statement is auto-commit, then it automatically commits when executing the statement. On the other hand, if it is not auto-commit, then it can rollback the transaction even after the statement was executed. Whether the DDL is auto-commit or not is queried by using [V$SQL_COMMAND](../part-02-administration-manual/9-database-information.md#cf58585cd193795c) view as follows.
...
<a id="4d76098f8bb537f0"></a>
## Data Manipulation Language

<a id="97bf8d50b485c439"></a>
### DML Related Statements

For more information, refer to the followings.

- INSERT related statements
    - [INSERT INTO](20-sql-references-h-z.md#c320b7c55cfa93d3)
    - [INSERT INTO name RETURNING](20-sql-references-h-z.md#c3df5773149aaa64)
    - [INSERT INTO name RETURNING .. INTO](20-sql-references-h-z.md#23ef94214962e563)

- UPDATE related statements
    - [UPDATE](20-sql-references-h-z.md#0fd4667c35dfb8f0)
    - [UPDATE name RETURNING](20-sql-references-h-z.md#00732f31c4861bc0)
    - [UPDATE name RETURNING .. INTO](20-sql-references-h-z.md#fbacf0fb95b1411a)
    - [UPDATE name WHERE CURRENT OF cursor_name](20-sql-references-h-z.md#ca5d550bc144f905)

- DELETE related statements
    - [DELETE FROM](19-sql-references-c-g.md#1e9fbeb78d1f6560)
...
This chapter describes only DML statements which change data. For more information about queries, refer to [Data Query Language](#ab3c8acb565b9dad).
...
Use [DECLARE cursor_name](19-sql-references-c-g.md#0871779c00d431a8) to declare FOR UPDATE cursor, and use [OPEN cursor_name](20-sql-references-h-z.md#a52c4df668fbd9cb) to open the cursor.  
Use [FETCH cursor_name](19-sql-references-c-g.md#c65c0d3544ea9773) to move the cursor to the specified position.  
Use [DELETE FROM name WHERE CURRENT OF cursor_name](19-sql-references-c-g.md#b7c6953ae9100bd3) to delete the row in the specified position.  
Use [UPDATE name WHERE CURRENT OF cursor_name](20-sql-references-h-z.md#ca5d550bc144f905) to update the row in the specified position.

FOR UPDATE cursor is closed using [CLOSE cursor_name](19-sql-references-c-g.md#e85469aa112b48af), or it is closed when committing transaction.

<a id="bc6a81f1f446ec85"></a>
### DML Query
...
The following is an example of using [INSERT INTO name RETURNING](20-sql-references-h-z.md#c3df5773149aaa64) syntax to insert data and retrieve the result. The join_date value which was input by using SYSDATE function can be retrieved by a single DML query.
...
The following is an example of using [DELETE FROM name RETURNING](19-sql-references-c-g.md#158f475a8288c432) syntax to delete data and retrieve the result. The result data can be manipulated by using operation in RETURNING clause.
...
The following is an example of using [UPDATE name RETURNING](20-sql-references-h-z.md#00732f31c4861bc0) syntax to update rows and retrieve the updated values. The value which is before updating can be retrieved by using OLD clause.
...
RETURNING clause of DML statements, like as SELECT query, can retrieve multiple query results. However, if the DML is executed only for a single row, then the host variable can be obtained by using RETURNING INTO clause. In this case, the number of changed rows should be one or less, like [SELECT .. INTO](20-sql-references-h-z.md#62c0547d8bd310b3) clause .
...
<a id="ab3c8acb565b9dad"></a>
## Data Query Language

<a id="d014966873f0e577"></a>
...
In addition to &lt;select list&gt;, &lt;hint clause&gt; and &lt;set quantifier&gt; can also be used between SELECT and FROM keywords. &lt;hint clause&gt; allows a user to directly adjust the query execution plan. For more information, refer to [SQL Hint](15-sql-tuning.md#e90c024d4bbaa9c2). &lt;set quantifier&gt; removes the duplicate data of the row which is returned as the result. For more information, refer to [query specification](20-sql-references-h-z.md#6aaa17f1023948e0).
...
For more information about SET operators, refer to [set operator](20-sql-references-h-z.md#fcd983bb04411568).

<a id="e4cf173caac50cc6"></a>
...
For more information, refer to [&lt;search clause&gt;](20-sql-references-h-z.md#3a8617c274349cd6).
...
For more information about the join operation, refer to [joined table](20-sql-references-h-z.md#7a83f7325c660026).

<a id="2a7f3c51562a5de7"></a>
### Hierarchical Query
...
Recursive CTE is used to express the hierarchical query. For more information, refer to [Recursive CTE](#0a1128d71bf29514).
...
<a id="fb367a00eb88961c"></a>
![](../assets/images/6915979b66cbc151.png)
...
For more information about the grouping, refer to [group by clause](20-sql-references-h-z.md#48642447161f23d4).

<a id="6ad9af2b84ee7d9e"></a>
### Window Query
...
For more information about the definition for the window, refer to [window clause](20-sql-references-h-z.md#6de1c122457d94b3).
...
For more information about &lt;window frame clause&gt;, refer to [&lt;window frame clause&gt;](20-sql-references-h-z.md#d952bf7571bae151).
...
For more information, refer to [Window Function](11-sql-elements.md#5e0cdfb173eec832) and [window clause](20-sql-references-h-z.md#6de1c122457d94b3).

<a id="135343bea5458b26"></a>
...
For more information about sorting, refer to [order by clause](20-sql-references-h-z.md#185c00ab8814a062).

<a id="7ab872ec65bf1cc2"></a>
### Subquery
...
For more information about unnesting the nested subquery, refer to [SQL Hint](15-sql-tuning.md#e90c024d4bbaa9c2).
...
For more information about subquery, refer to [subquery](20-sql-references-h-z.md#02b78dc8b1ddaeed).

<a id="801b6e594b7ede55"></a>
## Control Language

<a id="9d9169cddaaed8fe"></a>
...
- Transaction control related statements
    ...
    - [LOCK TABLE](20-sql-references-h-z.md#6e83ddd4743dccc6)
    - [SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#cfed0ae47f211495)
    - [RELEASE SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#50c25d62c97eabd7)

- Session control related statements: Refer to the followings.
    - [ALTER SESSION SET property_name](18-sql-references-a-b.md#92680bbe05326073)
    - [SET SESSION AUTHORIZATION user_identifier](20-sql-references-h-z.md#753627e383c21539)
    - [SET SESSION CHARACTERISTICS AS transaction_mode](20-sql-references-h-z.md#5cc19c50e3509ab6)
    - [SET TIME ZONE](20-sql-references-h-z.md#080836d36a906317)
    - [SET TRANSACTION transaction_mode](20-sql-references-h-z.md#945ea7930fe7715e)
...
- System control related statements: Refer to the followings.
    ...
    - [ALTER SYSTEM {MOUNT | OPEN} DATABASE](18-sql-references-a-b.md#6b3352cd0d97f557)
    - [ALTER SYSTEM [KILL | DISCONNECT] SESSION](18-sql-references-a-b.md#cc44dbf387497630)
    - [ALTER SYSTEM SET property_name](18-sql-references-a-b.md#77b4edc18193b02e)
    - [ALTER SYSTEM RESET property_name](18-sql-references-a-b.md#7cc5bfe3ca49cd27)
    - [ALTER SYSTEM SWITCH LOGFILE](18-sql-references-a-b.md#5e8b29238f8f7d5b)

<a id="105bac14c0ee194d"></a>
### Transaction Control
...
<a id="4b965c0920760e94"></a>
| Statement | Description | Refer to |
| --- | --- | --- |
| COMMIT | It terminates the transaction normally. | [COMMIT](19-sql-references-c-g.md#4f7ae244eb8d32e6) |
| ROLLBACK | It undoes the transaction. | [ROLLBACK](20-sql-references-h-z.md#126809f09298a063) |
| SAVEPOINT | It creates the savepoint. | [SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#cfed0ae47f211495) |
| RELEASE SAVEPOINT | It removes the savepoint. | [RELEASE SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#50c25d62c97eabd7) |
| LOCK TABLE | It sets the table-level lock. | [LOCK TABLE](20-sql-references-h-z.md#6e83ddd4743dccc6) |
| SET TRANSACTION | It controls the transaction properties. (Read/write, isolation level) | [SET TRANSACTION transaction_mode](20-sql-references-h-z.md#945ea7930fe7715e) |
| SET CONSTRAINTS | It controls the checkpoint of the deferrable constraints. | [SET CONSTRAINTS](20-sql-references-h-z.md#fb01c5504ccb45bb) |
...
<a id="1f89cac25d58da03"></a>
| Statement | Description | Refer to |
| --- | --- | --- |
| SET SESSION CHARACTERISTICS | It controls the transaction properties in the session. | [SET SESSION CHARACTERISTICS AS transaction_mode](20-sql-references-h-z.md#5cc19c50e3509ab6) |
| SET TIME ZONE | It alters the time zone of the session. | [SET TIME ZONE](20-sql-references-h-z.md#080836d36a906317) |
| SET SESSION AUTHORIZATION | It alters the user of the session. | [SET SESSION AUTHORIZATION user_identifier](20-sql-references-h-z.md#753627e383c21539) |
| SET SCHEMA | It alters the session schema. | [SET SCHEMA schema_name](20-sql-references-h-z.md#aac06995785019f0) |
| ALTER SESSION SET | It alters the session property. | [ALTER SESSION SET property_name](18-sql-references-a-b.md#92680bbe05326073) |
...
<a id="711d5c99a498fa32"></a>
| Statement | Description | Refer to |
| --- | --- | --- |
| ALTER SYSTEM {OPEN\|MOUNT} DATABASE | It starts up the database. | [ALTER SYSTEM {MOUNT \| OPEN} DATABASE](18-sql-references-a-b.md#6b3352cd0d97f557) |
| ALTER SYSTEM CHECKPOINT | It performs the checkpoint. | [ALTER SYSTEM CHECKPOINT](18-sql-references-a-b.md#7ca34d4cf3fdf9da) |
| ALTER SYSTEM KILL SESSION | It forcibly terminates the specific session. | [ALTER SYSTEM [KILL \| DISCONNECT] SESSION](18-sql-references-a-b.md#cc44dbf387497630) |
| ALTER SYSTEM SWITCH LOGFILE | It switches the log file. | [ALTER SYSTEM SWITCH LOGFILE](18-sql-references-a-b.md#5e8b29238f8f7d5b) |
| ALTER SYSTEM SET | It sets the system properties. | [ALTER SYSTEM SET property_name](18-sql-references-a-b.md#77b4edc18193b02e) |
| ALTER SYSTEM RESET | It removes the system properties. | [ALTER SYSTEM RESET property_name](18-sql-references-a-b.md#7cc5bfe3ca49cd27) |
...
<a id="215c31807f524860"></a>
![Processing DDL in cluster](../assets/images/b7858797a7c4738e.png)
...
There are a sharded table and a cloned table (refer to [Cluster Table and Shard](14-cluster-objects.md#fc09584b2becfda9)) in a cluster environment, and each table data is stored in a local server and a remote server. The sharded table data is dividedly stored in a group, and its duplicated data is stored in members of the same group. The data is duplicated and stored in every group and member of a cloned table.

The following figure describes a 3 x 2 GOLDILOCKS cluster and tables stored in that cluster.

<a id="60a32951a164c05f"></a>
![3 x 2 cluster configuration and tables](../assets/images/65d199f3462a0cb3.png)
...
<a id="32469bf8f3dfd6e7"></a>
![Performing cluster puller](../assets/images/68c06bd28dbd59a6.png)
...
A generated query is configured to collect or update the data while performing a query provided by a user. For more information, refer to [Generated Query](#d9b077478cc4ea75).
...
- [Cluster Domain](#ba9e8be0267e2bb9)
- [Reducing Target Domain of Cluster Puller](#30e9c685792a5131)
...
The following is a summary of the replication placement strategy of defined tables to describe [Generated Query](#d9b077478cc4ea75).
...
<a id="2a98e59af16d77c2"></a>
#### Cluster Puller Plan Node

The cluster puller plan node is classified according to the data collection method from a local server and a remote server. For more information about the classification of cluster puller plan nodes according to the data collection, refer to [Cluster Puller Plan Node](#2a98e59af16d77c2).

<a id="e3d4bc24e79493ec"></a>
##### Plan Based Cluster
...
<a id="91a8b7c0a96cc0c3"></a>
![Plan based cluster](../assets/images/90e5922ce46d7eb3.png)

<a id="53dc674653a38a0c"></a>
##### Single Cluster
...
<a id="deb55702e7d74bc2"></a>
![Single cluster](../assets/images/198fc1dbb86262a9.png)

<a id="8fdf4ed6c9328ff1"></a>
##### Multiple Clusters
...
<a id="be929ff2f716a39f"></a>
![Multiple clusters](../assets/images/d7e18c4e0595c002.png)

<a id="ba9e8be0267e2bb9"></a>
#### Cluster Domain
...
Cluster domain is defined by targeting a table or a view specified in [from clause](20-sql-references-h-z.md#06d7af5c2e9e0d55) and referring to [&lt;cluster domain&gt;](20-sql-references-h-z.md#4c526f937d245390), and one of the followings can be selected.
...
- [Cluster Domain](#ba9e8be0267e2bb9): It reduces the target domain by specifying the domain.
...
When the retrieving target domain is specified, then TARGET DOMAIN is reduced to G2 as in the example above. For more information about domain, refer to [Cluster Domain](#ba9e8be0267e2bb9).
...
TARGET DOMAIN can also be reduced by providing the [Pseudo Columns](11-sql-elements.md#7ffd98bd5eda90c9) condition related to the table. It can be used as a domain filter only when using equal (=) condition for the pseudo column.

**Pseudo column which can be used as the domain filter**

<a id="490ea5049333f4c2"></a>
...
Each cluster puller plan node configures the generated query for [data collection method](#aa969ac3ac696f8a) according to [Utilizing Cluster Puller](#7fe59e492aa5e755).

<a id="6de076901e1a544d"></a>
...
The cluster puller plan node is determined according to [data collection method](#aa969ac3ac696f8a) grouped per group. When the data is collected in the way of by pass, a single cluster is used. When the data is collected in the way of merge sort, multiple clusters are used.
...
<a id="86d21c643ecc66d9"></a>
#### Constraints of Generated Query Configuration

The generated query configuration is constrained in the following cases.

- [Offset & limit](#03d0d72ad8e163b8)
- [Using non-deterministic expression](#3ced0d4d657daf9c)
- [When unable to unnest subquery](#4945bd2a7afb2208)

<a id="03d0d72ad8e163b8"></a>
##### Offset & limit

> The information about [offset limit clause](20-sql-references-h-z.md#c771472d1efdac51) is not included in a generated query.
...
For more information about unnesting a subquery, refer to [Subquery](#7ab872ec65bf1cc2).
...
<a id="ae342103e5fcd6dc"></a>
![Performing cluster pusher](../assets/images/e7b42dfa5427bb10.png)
...
<a id="60986c6f231d7b38"></a>
#### Processing Cluster Query per SELECT Statement

The chapters above describe the [Cluster Puller](#114e5e2b22744c6a) and [Cluster Pusher](#eb4fe1b6d56f080f) plan node to process SELECT in cluster. This chapter describes how to process cluster query per SELECT statement by using them.

<a id="55ecfaeb31745f65"></a>
...
<a id="28d6ce5a4bcfc8b9"></a>
##### FROM Statement (Outer Join)

The query process in outer join is divided into the data collection from a single group and the data collection from multiple groups like as [FROM Statement (Join)](#27b89ccb98ecdb8b).
...
In case 3, the total sum of the results of the generated query including the outer join from each group becomes the duplicate entire anti join result like as case 1. It manipulates the data in intersect key group method to delete the duplicate anti join results. For more information about the intersect key group, refer to [Generated Query for Intersect Key Group](#ae5e18ded70e9960).
...
<a id="c60b5acb7f79adfa"></a>
| Join operation | Operator including the subquery |
| --- | --- |
| INNER JOIN | All operators except for [&lt;Group Comparison Conditions&gt;](11-sql-elements.md#1b863bfa01f24d47) |
| OUTER JOIN | All operators except for [&lt;Group Comparison Conditions&gt;](11-sql-elements.md#1b863bfa01f24d47) |
| SEMI JOIN | [&lt;Group Comparison Conditions&gt;](11-sql-elements.md#1b863bfa01f24d47) having EXISTS, IN, ANY quantifier |
| ANTI-SEMI JOIN | [&lt;Group Comparison Conditions&gt;](11-sql-elements.md#1b863bfa01f24d47) having NOT EXISTS, NOT IN, ALL quantifier |

For more information about the join operation, refer to [Join](15-sql-tuning.md#8a67cc626bf99bf8).
...
<a id="2f1e9453df16be33"></a>
![Processing DML in cluster](../assets/images/b0a9a064616693dd.png)

A master server and a slave server per each group are defined for the DML processing in cluster.

<a id="e65cf489f02659f8"></a>
...
- [Data Modification Using a Generated Query](#f36328f1536e0fe5)
- [Data Modification Using Rowid (Rowid Pseudo Column)](#b0d21fde6bac8219)

<a id="f36328f1536e0fe5"></a>
#### Query Based DML
...
For more information, refer to [Generated Query](#d9b077478cc4ea75).
...
<a id="92104c76c927f50e"></a>
![Updating data using generated query (Altering the entire cluster group target)](../assets/images/859807a752deccde.png)
...
<a id="9536ca7c79db94ec"></a>
![Updating data using generated query (Altering a specific cluster group)](../assets/images/3c199f63ab9f6db4.png)
...
The plan node called as DML cluster performs the query based DML. For more information, refer to [DML Cluster](#2a107c980cdfb6fe).
...
- If the generated query which guarantees the same result when performing the generated query on each cluster member of a cluster group can be generated
    - Refer to [Constraints of Generated Query Configuration](#86d21c643ecc66d9).
...
- [SELECT .. FOR UPDATE](20-sql-references-h-z.md#31d3c3781474d469)
- [SELECT .. INTO .. FOR UPDATE](20-sql-references-h-z.md#73f0ef48d01d2843)
- [DELETE FROM](19-sql-references-c-g.md#1e9fbeb78d1f6560)
- [DELETE FROM name RETURNING](19-sql-references-c-g.md#158f475a8288c432)
- [DELETE FROM name RETURNING .. INTO](19-sql-references-c-g.md#d25c79c37d14d79b)
- [UPDATE](20-sql-references-h-z.md#0fd4667c35dfb8f0)
...
The data manipulation using the generated query is available even when the [Global Secondary Index](14-cluster-objects.md#4ff66200d323c646) is not configured.

<a id="2a107c980cdfb6fe"></a>
##### DML Cluster
...
<a id="d93018344affc4ac"></a>
###### **Join Operation in DML Cluster**

The statement including a subquery can be converted into a join operation by the query processor like as [Join including subquery](#c60b5acb7f79adfa). The subquery for DML statement can also be converted to a join operation. DML cluster plan node supports the generated query including a join.
...
<a id="b0d21fde6bac8219"></a>
#### Global Rowid Based DML

Global rowid based DML is a method to manipulates the same records stored in different cluster members by using the rowid. This method is used when adding a new record or when [Query Based DML](#f36328f1536e0fe5) is not available.
...
For more information about the rowid, refer to [ROWID Pseudo Column](11-sql-elements.md#1be00498c6fd4676) .
...
Data manipulation using the rowid information supports the following two methods depending on whether to use the [Global Secondary Index](14-cluster-objects.md#4ff66200d323c646).

- [Global rowid Based DML without Using Global Secondary Index](#50fc26c15df74433)
- [Global rowid Based DML Using Global Secondary Index](#1548dec942fc8056)

<a id="50fc26c15df74433"></a>
...
<a id="8b17a56a3b3ae952"></a>
![Global rowid based DML without using global secondary index](../assets/images/616c774224a9e026.png)
...
The following is a result of performing user query of [Global rowid based DML without using global secondary index](#8b17a56a3b3ae952). As a result, there is not any result output for global rowid based DML.
...
<a id="622bab1ac71d6a58"></a>
![Data manipulation using the rowid using the global secondary index](../assets/images/4f56142b0477ca3e.png)
...
The following is a result of performing user query of [Data manipulation using the rowid using the global secondary index](#622bab1ac71d6a58). As a result, there is not any result output for global rowid based DML.
