<a id="de3ebd6ccc0baa38"></a>

# 36. Hibernate

> Source: [GOLDILOCKS 22c.1 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/22c_1/manual/en/de3ebd6ccc0baa38)  
> Tag: `22c.1_10_tag`

[← 35. PyDBC](35-pydbc.md) · [Table of contents](../README.md) · [37. gcreatedb →](../part-06-utility-manual/37-gcreatedb.md)

<a id="84e14b0c14b38340"></a>
## Overview
...
<a id="d796b4fef63e4d6f"></a>
## Interworking with Hibernate

<a id="c9de8bd2a736ff7f"></a>
...
3. Move GoldilocksDialect.class file and GoldilocksDialect$1.class file to the decomprressed org/hibernate/dialect directory.
