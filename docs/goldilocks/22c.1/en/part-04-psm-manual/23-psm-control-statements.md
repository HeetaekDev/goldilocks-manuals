...
<a id="109c67f5c921297d"></a>
### PL Block Configuration

A single PL block is divided into the following three parts.   
For more information, refer to [Block (BEGIN .. END)](28-psm-language-element-references.md#bfc0253756ad95ed).
...
- Variable (Refer to [PSM DataTypes](22-psm-datatypes.md#a7ec470a254f78dc).)
- User defined type
- Cursor
...
- Control Statements (Refer to [PSM Control Statements](#8ca9394e12d6159d).)
- Cursor Statements (Refer to [PSM Cursor Statements](24-psm-cursor-statements.md#e3727cfc601c6344).)
- SQL Statements (static/ dynamic) (Refer to [Using SQLs In PSM](26-using-sqls-in-psm.md#80a6cfe35e19dffa).)

<a id="a1919c1bcd7186f7"></a>
...
For more information about declaration of user defined exception, built-in handler types or installing a handler, refer to [Error Handling](#6372427c789309ca).

<a id="0d16160ff2e29805"></a>
## NULL Statement

It is used to specify a statement which does not have any role in PSM such as no-op.  
For more information, refer to [NULL Statement](28-psm-language-element-references.md#42b981c977c01fc9).
...
For more information, refer to [IF Statement](28-psm-language-element-references.md#95c54108dc4cf989).
...
For more information, refer to [CASE Statement](28-psm-language-element-references.md#7a39888c5a3daa75).
...
For more information, refer to [Basic LOOP Statement](28-psm-language-element-references.md#6e3a459559169fc8).
...
For more information, refer to [EXIT Statement](28-psm-language-element-references.md#f1a5fed0de1b0405).
...
<a id="387824c762cc4b2c"></a>
### FOR Loop

FOR loop statement repeatedly performs a series of statements as many times as the number of integers of the given scope.  
For more information, refer to [FOR LOOP Statement](28-psm-language-element-references.md#239fec6f701bcbbb).
...
<a id="eafa1973e7806de9"></a>
### WHILE Loop

WHILE loop statement repeatedly performs a series of statements while the given condition is TRUE.  
For more information, refer to [WHILE LOOP Statement](28-psm-language-element-references.md#44c28880f619fe96).
...
For more information, refer to [GOTO Statement](28-psm-language-element-references.md#b3e3463415bb3900).
...
For more information, refer to [CONTINUE Statement](28-psm-language-element-references.md#fc7c304903d810ca).
...
For more information, refer to [EXCEPTION Handling](#7916a094633726d4), [SQLCODE Function](28-psm-language-element-references.md#92d716ab6afcf9a6), [SQLERRM Function](28-psm-language-element-references.md#ecd55bc501078e69).

<a id="e66bbfccf690ae88"></a>
### Cursor Attributes
...
> For more information about a predefined exception or a user defined exception provided by GOLDILOCKS, refer to [Exception Declaration](28-psm-language-element-references.md#6cdd0dd0a7487a48).

<a id="2a09503d863e1633"></a>
