...
| JDBC | A CallableStatement class should be used if it has a bind parameter with IN-OUT or OUT attribute. (Refer to [CallableStatement](../part-05-developer-manual/32-jdbc.md#dd031589b01ced22).) |
...
For more information, refer to [Procedure Declaration and Definition](28-psm-language-element-references.md#879066156947c860).
...
<a id="858dcceed9727b46"></a>
## Nested Function

A nested function is as same as a nested procedure, but it is a subprogram in function form.   
For more information, refer to [Function Declaration and Definition](28-psm-language-element-references.md#166b421531809f75).
...
For more information, refer to [CREATE PROCEDURE](29-psm-sql-references.md#acd5825880480a80).
...
For more information, refer to [ROUTINES](../part-02-administration-manual/9-database-information.md#2ede67988561424a).
...
For more information, refer to [PARAMETERS](../part-02-administration-manual/9-database-information.md#99f0ac33886a3993).
...
For more information, refer to [CALL Statement](29-psm-sql-references.md#6fc0291e0821a481).
...
<a id="6a5bdeff80f5db5d"></a>
### Dropping Schema-level Procedure

A schema-level procedure is dropped by the following DROP PROCEDURE statement.  
For more information, refer to [DROP PROCEDURE](29-psm-sql-references.md#e555d2b555faabee).
...
For more information, refer to [CREATE FUNCTION](29-psm-sql-references.md#40ab839511f9caec).
...
<a id="07da3f208945aeb4"></a>
### Dropping Schema-level Function

A schema-level function is dropped by the following DROP FUNCTION statement.  
For more information, refer to [DROP FUNCTION](29-psm-sql-references.md#3f3a2b64579299ef).
...
| DBMS_SQL.RETURN_RESULT( rc IN SYS_REFCURSOR ) | It returns the result of the query executed through *ref cursor* to the client application. |
