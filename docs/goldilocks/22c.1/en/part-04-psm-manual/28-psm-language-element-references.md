...
<a id="c4cf9174ebee6d17"></a>
### For More Information

Refer to the followings.

- [Scalar Variable Declaration](#cb32f36dd8a4eb38)
- [Record Variable Declaration](#efaaca37c0f0ffd9)
- [COLLECTION Variable Declaration](#c5f937f223b65612)
- [Cursor Variable Declaration](#32070bc40fcbdd69)

<a id="6e3a459559169fc8"></a>
## Basic LOOP Statement

<a id="e7f74de0210361f8"></a>
### Function

It repeatedly performs statements within LOOP until the LOOP is terminated by performing GOTO or EXIT.

<a id="d31062761c5d6162"></a>
### Syntax
...
<a id="a09099dfba364c93"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="72e79661f67c4007"></a>
### Syntax Rules and Parameters
...
<a id="5d990757a0a553b4"></a>
| Feature ID | Description | Compatibility |
| --- | --- | --- |
| P002 | Computational completeness | O |

<a id="5a692ebd85818b1d"></a>
### For More Information

Refer to the followings.

- [CONTINUE Statement](#fc7c304903d810ca)
- [EXIT Statement](#f1a5fed0de1b0405)
- [GOTO Statement](#b3e3463415bb3900)

<a id="bfc0253756ad95ed"></a>
## Block (BEGIN .. END)

<a id="5831c6db857821ec"></a>
### Function

It creates a new scope and defines a variable, a cursor, a type and an exception.

<a id="2cdb108383135819"></a>
### Syntax
...
<a id="998b25d6336d5846"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="4c70154ed6d7a853"></a>
### Syntax Rules and Parameters
...
<a id="17d3902a9a4063fd"></a>
### Examples

<a id="1e9880852c55b4ea"></a>
#### Using a Simple CASE
...
<a id="01a3ed87cb2dd917"></a>
## CLOSE Statement

<a id="49607104908fbce7"></a>
### Function

It closes an open cursor.

<a id="48b87f50d100870f"></a>
### Syntax
...
<a id="cd67b245cb8c21ca"></a>
### Compatibility

The SQL standard does not define it.

<a id="e15979dda07bc6c4"></a>
### For More Information

Refer to the followings.

- [FETCH Statement](#913b57099867758a)
- [OPEN Statement](#0b103b7706cdb5b9)

<a id="88933ceaba584628"></a>
## Collection Method Invocation

<a id="4c342fe6809136a3"></a>
### Function

It provides a method which can explores a collection type variable.

<a id="62f8f2cf4f9bea25"></a>
### Syntax
...
<a id="2ffc6575ddf4fc79"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="5ef3d0c236706b3c"></a>
### Syntax Rules and Parameters
...
<a id="098d8e4b7b4585c1"></a>
### For More Information

Refer to [COLLECTION Variable Declaration](#c5f937f223b65612).

<a id="c5f937f223b65612"></a>
## COLLECTION Variable Declaration

<a id="a2bf2e8cf45ab7f6"></a>
### Function

It declares a collection variable.

<a id="ed0adf56de01d045"></a>
### Syntax
...
<a id="b5bf227153df2e97"></a>
### Description

It declares a collection type.

<a id="cdaaa6cccee4380c"></a>
### Examples
...
<a id="0fd89537232f710b"></a>
### Compatibility

The SQL standard does not define it.

<a id="2f971b717048d90f"></a>
### For More Information

Refer to [Collection Method Invocation](#88933ceaba584628).

<a id="fc7c304903d810ca"></a>
## CONTINUE Statement

<a id="cbd6472eb7e1d071"></a>
### Function

It stops currently performing statement list, and performs the next iteration of a superordinate loop statement.

<a id="4b471ce4929b32dd"></a>
### Syntax
...
<a id="6dc4cd42ad6627ec"></a>
## Cursor FOR LOOP Statement

<a id="533200abf72d3896"></a>
### Function
...
<Cursor> ::=
     ...
     | < Explict_Cursor_Name > [ ( [ <actual param> ] ) ]
...
<a id="3cf561b125d3d87f"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body of PSM.

<a id="ffd4d49d114e7460"></a>
### Syntax Rules and Parameters
...
<a id="e60e612ccd88f6b7"></a>
#### When Using Cursor Name

A cursor should already have been declared before performing LOOP by using a cursor name.   
For more information about an actual param, refer to [OPEN Statement](#0b103b7706cdb5b9).

<a id="33232e7526849c36"></a>
...
<a id="48f88c0d8c8658fc"></a>
### Examples

<a id="d65157ce9a1d4fd4"></a>
...
<a id="d55f5dd6ce0a7c3c"></a>
### For More Information

Refer to the followings.

- [Explicit Cursor Declaration and Definition](#62d5cee16d9ec063)
- [GOTO Statement](#b3e3463415bb3900)
- [EXIT Statement](#f1a5fed0de1b0405)

<a id="32070bc40fcbdd69"></a>
## Cursor Variable Declaration

<a id="21479492932c11d5"></a>
### Function

It declares a cursor variable in DECLARE section of PSM.

<a id="124c443f4df5af40"></a>
### Syntax
...
<a id="bb08875afc41054d"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of PSM.

<a id="c5582e6bfee70244"></a>
### Syntax Rules and Parameters
...
<a id="968e12f9c32667ab"></a>
### Description

It can store the result in RETURNING INTO clause by using a record type variable of PSM.

<a id="8e66dc8727df321d"></a>
### Examples
...
<a id="42e7bbc6bb2da763"></a>
### For More Information

Refer to [Deleting Data](../part-03-sql-manual/12-sql-languages.md#8df52949291da973).

<a id="5b91369f7cc544c0"></a>
## EXCEPTION_INIT Pragma

<a id="ece179b7452ca394"></a>
### Function

It sets the error code which is to be processed by a user-defined exception.

<a id="a09f6978eafb84b2"></a>
### Syntax
...
<a id="e83d5d731fa4143f"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the declaration section of PSM.

<a id="6343b7b59d453061"></a>
### Syntax Rules and Parameters
...
<a id="34f15489105334dc"></a>
### Compatibility

Error codes are different each other according to a vendor, so it is not compatible each other.

<a id="bd202388a7da77d9"></a>
### For More Information

Refer to the followings.

- [Exception Declaration](#6cdd0dd0a7487a48)
- [Exception Handler](#7ee21a0091f59d45)

<a id="6cdd0dd0a7487a48"></a>
## Exception Declaration

<a id="437e5c81b3f9fb96"></a>
### Function

It declares an exception name within a PL block.

<a id="937801130bae4320"></a>
### Syntax
...
<a id="4c1ad90b30f0b46d"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the declaration section of PSM.

<a id="c43ba21d4021f327"></a>
### Syntax Rules and Parameters
...
<a id="f4d540089e13979f"></a>
### Description

A user explicitly declares an exception.

<a id="387b6f1c30190fa7"></a>
### Examples
...
<a id="118b3efcbd636a83"></a>
### For More Information

Refer to the followings.

- [Exception Declaration](#6cdd0dd0a7487a48)
- [EXCEPTION_INIT Pragma](#5b91369f7cc544c0)

<a id="7ee21a0091f59d45"></a>
## Exception Handler

<a id="a76aba59d802c2ea"></a>
### Function
...
<a id="a10bfcbc5e0907a2"></a>
### Invocation and Access Rules

It can be used within a PL block.

<a id="fffc0872f017f8a7"></a>
### Syntax Rules and Parameters
...
<a id="e64c2b6a6abf0e3d"></a>
### Description

<a id="5dca05ec877f32a0"></a>
#### Exception Types

<a id="a6ce6114531f20b2"></a>
...
<a id="ee1a96f3551fb4b3"></a>
#### Predefined Exception

**Predefined exception type**

<a id="87d3c5c9f7bb2111"></a>
| Name | Description |
| --- | --- |
...
<a id="85222273481296da"></a>
### Compatibility

It does not support the SQL standard grammar.

<a id="2e8de4b5ad23d3f7"></a>
### For More Information
...
<a id="8434846cd8a55ef4"></a>
## EXECUTE IMMEDIATE Statement

<a id="9cbca2692f36c4b6"></a>
### Function

It executes a dynamic SQL within PSM.

<a id="3a30ccae5a5e6aea"></a>
### Syntax
...
<a id="e548a981dc0fd2d0"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)   
It can be used only in the body section of a PL block.

<a id="417660eb811fbe1a"></a>
### Syntax Rules and Parameters

<a id="0d2669a5ceea9407"></a>
#### Dynamic SQL
...
<a id="4b525a83ad10cbfc"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="6d4a10ef5ccc35ad"></a>
### Syntax Rules and Parameters
...
<a id="169878890480ec72"></a>
### Invocation and Access Rules

It can be used only in the body section of PSM.

<a id="4442eb86effd6a02"></a>
### Syntax Rules and Parameters

- Cursor_name
    - It is the name of a cursor whose status value is to be obtained.

<a id="0453167a7af11df5"></a>
### Description
...
<a id="c374c74cb1505fd8"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the declaration section of a PL block.

<a id="6b759414db27dc57"></a>
### Syntax Rules and Parameters

<a id="79fda480b46c5e6a"></a>
#### Cursor Name
...
<a id="7f0e875f9b1300ee"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="ae5dd7a9516a5dbe"></a>
### For More Information

Refer to the followings.

- [OPEN FOR Statement](#0e5039afeb0434a1)
- [FETCH Statement](#913b57099867758a)
- [CLOSE Statement](#01a3ed87cb2dd917)

<a id="913b57099867758a"></a>
## FETCH Statement

<a id="c29f07c398dd8b8a"></a>
### Function

It fetches a single record of OPEN cursor.

<a id="215442eca4fca73f"></a>
### Syntax
...
<a id="9135820a6a218e1f"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)   
It can be used only in the body section of a PL block.

<a id="e1399ff3a6fc4667"></a>
### Syntax Rules and Parameters
...
<a id="47660f35ecd4df42"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="49eb7bd84782b522"></a>
### For More Information
...
<a id="239fec6f701bcbbb"></a>
## FOR LOOP Statement

<a id="2c4d838f0be713ea"></a>
### Function
...
<a id="649965b1b89a6c0a"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)   
It can be used only in the body section of a PL block.

<a id="d698dc3831018d5e"></a>
### Syntax Rules and Parameters
...
<a id="901bf184ce8dc6c6"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="94ae9135a80877c3"></a>
### For More Information
...
<a id="166b421531809f75"></a>
## Function Declaration and Definition

<a id="6ac7efd40b123370"></a>
### Function

It declares and defines a function.

<a id="e042d407ba2c6b01"></a>
### Syntax
...
<a id="9da99d8b73afbedc"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the declaration section of a PL block.

<a id="a63ba80a762e9598"></a>
### Syntax Rules and Parameters

<a id="6f995d08a0fa72d6"></a>
#### function name
...
<a id="b809f0f99927c486"></a>
### Compatibility

It is as same as a schema-level function.

<a id="2f8848ce61689486"></a>
### For More Information

Refer to [CREATE FUNCTION](29-psm-sql-references.md#40ab839511f9caec).

<a id="b3e3463415bb3900"></a>
## GOTO Statement

<a id="be95aaac41a3ca02"></a>
### Function
...
<a id="a672404e090d7c75"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)   
It can be used only in the body section of a PL block.

<a id="833fd7100fce1249"></a>
### Syntax Rules and Parameters
...
<a id="db85f0df6bfff8e6"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="833d82f8ab8473c5"></a>
### For More Information
...
<a id="3bf246554b2c0748"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)   
It can be used only in the body section of a PL block.

<a id="c2f64ed5e62d1529"></a>
### Syntax Rules and Parameters
...
<a id="a4a7757c7e692571"></a>
| Feature ID | Description | Compatibility |
| --- | --- | --- |
| P002 | Computational completeness | O |

<a id="0902e293d5f0c365"></a>
## Implicit Cursor Attribute

<a id="07532490b025746d"></a>
### Function

It returns the status value of an implicit cursor defined in PSM.

<a id="a76ccd44f1a04c8f"></a>
### Syntax
...
<a id="46efef3a08f7f8a3"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="36c7ca1186b399f1"></a>
### Description
...
<a id="9aa80f2d403e83e3"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="870034c2a11e0d3d"></a>
## INSERT Statement Extension

<a id="a04ce2599986c086"></a>
### Function
...
<a id="9ee45b653f7daef3"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="3c57706d3e55552d"></a>
## INSERT INTO ... UPDATE Statement Extension

<a id="e9b0ba84aba8248b"></a>
### Function
...
<a id="972c56570835d57d"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="42b981c977c01fc9"></a>
## NULL Statement

<a id="e5f97083df2c7702"></a>
### Function

It is a statement without any feature.

<a id="0901570719e3f9a7"></a>
### Syntax
...
<a id="885f8ad284d51fe1"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="0b103b7706cdb5b9"></a>
## OPEN Statement

<a id="7c00382d4d963f28"></a>
### Function

It executes SELECT statement of a cursor defined in PSM.

<a id="bd97e01a65f3f4cc"></a>
### Syntax
...
<a id="0e1b8c8d7bba2da0"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="271fcc447b0187df"></a>
### Syntax Rules and Parameters

- Cursor_name
    - It is the name of a cursor to be opened.

<a id="efed8236c85908a5"></a>
### Description
...
<a id="257e44755549f98c"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="2b98e53c39c77f62"></a>
### For More Information
...
<a id="fb24ab2c7a9de461"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="f91a8b23209944c9"></a>
### Syntax Rules and Parameters
...
<a id="0ebf22019a180ec0"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="12fd19d04cb085a4"></a>
### For More Information
...
<a id="3f13859537709d64"></a>
### Compatibility

The SQL standard requires to use &lt;call statement&gt;.

<a id="879066156947c860"></a>
## Procedure Declaration and Definition

<a id="5f1265ff7364f9e7"></a>
### Function

It declares and defines a procedure.

<a id="57f2b7ecb80a0612"></a>
### Syntax
...
<a id="226e2d3bd8ded1f7"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)   
It can be used only in the declaration section of a PL block.

<a id="fe789a670f8de122"></a>
### Syntax Rules and Parameters

<a id="f93855837f306f76"></a>
#### procedure name
...
<a id="730414250f2ada5a"></a>
### Compatibility

It is as same as a schema-level procedure.

<a id="18ad207f7aeb28fa"></a>
### For More Information

Refer to [CREATE PROCEDURE](29-psm-sql-references.md#acd5825880480a80).

<a id="9720c8904db350ff"></a>
## RAISE Statement

<a id="ac11706b5f0c0526"></a>
### Function

It explicitly generates a user-defined exception.

<a id="fe05596d0275b472"></a>
### Syntax
...
<a id="34dc5cb779dccc89"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="78eacacc74edac4a"></a>
### Syntax Rules and Parameters
...
<a id="efaaca37c0f0ffd9"></a>
## Record Variable Declaration

<a id="743f824a53eada38"></a>
### Function

It declares a record type variable in DECLARE section.

<a id="00302e838f575287"></a>
### Syntax
...
<a id="ada35f8a5abba950"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the declaration section of a PL block.

<a id="1372fcac3993080a"></a>
### Syntax Rules and Parameters
...
- Record_type
    ...
    - For more information about the declaration of recordType, refer to [User Defined Record Type](22-psm-datatypes.md#5a7eaab50bb68241).

<a id="4d8b994b3290766e"></a>
### Description
...
<a id="421ef97511e351c8"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="92c386759a2489b2"></a>
## RETURN Statement

<a id="bce19098ed08c23f"></a>
### Function
...
<a id="dc21de4ccd45365e"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="cf3e5ac96e8ef79a"></a>
## %ROWTYPE Attribute

<a id="7c2bdb1d462c183b"></a>
### Function
...
<a id="548e8c472dfde1d6"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="cb32f36dd8a4eb38"></a>
## Scalar Variable Declaration

<a id="b78203314f81ea0d"></a>
### Function

It declares a scalar variable in the declaration section.

<a id="1d7647a99efdbddf"></a>
### Syntax
...
<a id="14019115ac26eab4"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the declaration section of a PL block.

<a id="a4919b438eadb89f"></a>
### Syntax Rules and Parameters
...
- Variable_name
    ...
    - When using a variable of duplicated declaration without specifying the scope name, then a variable of the nearest scope is automatically used. 
- Data_Type
    - It can use all built-in [Data Type](../part-03-sql-manual/11-sql-elements.md#545971a2288a7b29) provided in GOLDILOCKS.
- Value_expression
...
<a id="c7134ed010fec591"></a>
## SELECT INTO Statement

<a id="2fa3433f16e2476f"></a>
### Function

A single row is returned through SELECT.

<a id="8abc27d9e73774f7"></a>
### Syntax
...
<a id="5644bf79cdeb88c3"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="92d716ab6afcf9a6"></a>
## SQLCODE Function

<a id="1f785040fd31f6a6"></a>
### Function

It returns an error code of a statement which was performed just before in PSM.

<a id="5e695c4a1c48b05e"></a>
### Syntax
...
<a id="9c5405a3b6af24ec"></a>
### Invocation and Access Rules

It can be used only within PSM.

<a id="7083f85fe5a4aaf2"></a>
### Syntax Rules and Parameters

It does not have a separate argument.

<a id="35ad818ed26f12b9"></a>
### Description
...
<a id="cab696c947d21789"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="ecd55bc501078e69"></a>
## SQLERRM Function

<a id="b6db23a9ca651784"></a>
### Function

It returns an error message of a statement which was performed just before in PSM.

<a id="5a176a25ed92171e"></a>
### Syntax
...
<a id="051ef2d56ada4868"></a>
### Invocation and Access Rules

It can be used only within PSM.

<a id="ae876659eca7b376"></a>
### Syntax Rules and Parameters

It does not have a separate argument.

<a id="842975e5f4281a45"></a>
### Description
...
<a id="ebb7044a913111de"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="c30a0f2d6a03c15e"></a>
## %TYPE Attribute

<a id="391ac38ab3b06a8f"></a>
### Function
...
<a id="f35794da59c065d0"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="08443d405d73d3b4"></a>
## UPDATE Statement Extension

<a id="b818f2c80ae54633"></a>
### Function
...
<a id="d783a47e3187d1ba"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="0b125aaa7eae883d"></a>
### Syntax Rules and Parameters
...
<a id="7ffdf6283660da6c"></a>
### Compatibility

It is not defined in the SQL standard.

<a id="44c28880f619fe96"></a>
## WHILE LOOP Statement

<a id="4a9f876ad4c3cd86"></a>
### Function

It performs internal statements during &lt;search condition&gt; returns TRUE value.

<a id="813a46c9ad3db27b"></a>
### Syntax
...
<a id="ad283b58e902f841"></a>
### Invocation and Access Rules

It can be used only within PSM. (e.g. package, procedure, function)  
It can be used only in the body section of a PL block.

<a id="f2511e03d2886e4b"></a>
### Syntax Rules and Parameters
