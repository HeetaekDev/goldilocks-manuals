...
[listener](../part-06-utility-manual/38-glsnr.md#bcb878d48ad1518c) should be in operation if a user wants to start or end GOLDILOCKS cluster system in dedicated mode of C/S model(to use gsqlnet).
...
- [ALTER CLUSTER GROUP name ADD MEMBER](../part-03-sql-manual/18-sql-references-a-b.md#7aeb1944a8c55e03)
- [CREATE CLUSTER GROUP](../part-03-sql-manual/19-sql-references-c-g.md#57c6f6ae1e01e560)
...
> ABORT is the only shutdown mode available when terminating only the single node in GOLDILOCKS cluster system. ABORT mode immediately terminates gmaster regardless of the state of connected sessions, and unloads the instance.
...
For more information about creating table, refer to [CREATE TABLE](../part-03-sql-manual/19-sql-references-c-g.md#78614830d4f324f4) and [Cluster Table and Shard](../part-03-sql-manual/14-cluster-objects.md#fc09584b2becfda9).

When omitting the sharding strategy option, it is defined by [DEFAULT_SHARDING](../part-02-administration-manual/10-server-property.md#02a4c03462986f52) property. The default value of DEFAULT_SHARDING is 0, and it creates cloned table.
...
- AT CLUSTER WIDE 
    ...
    - When adding a cluster group or cluster member, a user can rearranges clones by using [ALTER TABLE name REBALANCE](../part-03-sql-manual/18-sql-references-a-b.md#a5e30678f94e116b) statement. 
- AT CLUSTER GROUP group_list 
    - It arranges clones in all cluster members of a defines cluster group.
    - When adding a cluster member to a defined cluster group, a user can rearranges clones by using [ALTER TABLE name REBALANCE](../part-03-sql-manual/18-sql-references-a-b.md#a5e30678f94e116b) statement. 
...
Table rows are distributes to one of 24 shards based on hash value of id column, and 24 shards are equally arranged over the entire cluster system. For more information, refer to [Cluster Table and Shard](../part-03-sql-manual/14-cluster-objects.md#fc09584b2becfda9).

<a id="e5af13c89f696bcd"></a>
#### Range Sharding Strategy
...
<a id="8d5b16f43a9fae26"></a>
### Managing Index

<a id="485c183d1782d8c2"></a>
...
For more information, refer to [DEFAULT_GLOBAL_SECONDARY_INDEX_CREATION](../part-02-administration-manual/10-server-property.md#e5a7a42edbaa6a76).
