...
<a id="361bdc0ee7c96aab"></a>
### Client Process

<a id="75d5f6c0e322729d"></a>
#### Client/ Server Model
...
A user should run [listener](../part-06-utility-manual/38-glsnr.md#bcb878d48ad1518c) before startup or shutdown the GOLDILOCKS instance in dedicated mode of C/S model.  
...
For more information about listener control, refer to [glsnr](../part-06-utility-manual/38-glsnr.md#bcb878d48ad1518c).  
For more information about how to start or end cluster system refer to [Start and End of Cluster System](3-cluster-tutorial.md#d2c641a03ffd9fe8).

<a id="b762b772a358bc0d"></a>
...
<a id="46ee9610960d5c8d"></a>
| File name | Description |
| --- | --- |
| README | read me |

<a id="9ee9b80afe2ae3c7"></a>
...
<a id="bbaaa1fc21ab9fcc"></a>
#### Kernel Parameters

<a id="dd5478fc94f9f672"></a>
##### Shared Memory
...
For more information about directory created by decompression, refer to [GOLDILOCKS Package Configuration](#dba85d0337b2e76d)

<a id="ca2211a569a932f9"></a>
...
<a id="4500a133f1cd0774"></a>
## Managing Database Memory Structure

This chapter describes the database components which compose GOLDILOCKS instance.

<a id="fa8fb7b6afc8a92c"></a>
### Database Memory Structure

GOLDILOCKS database is divided into memory area and disk area. Memory area is a collection of tablespace consisting of one or more shared memories. GOLDILOCKS database never goes down to the disk by replace operation.
...
<a id="b7b41f15a3f72625"></a>
## Managing Schema Object

<a id="8c5674082a3d918f"></a>
### Schema Object
...
Table data can be stored and retrieved being distributed to multiple nodes according to the user's desiring distribution policy when using GOLDILOCKS configuring it as cluster system. For more information, refer to [Managing Table](3-cluster-tutorial.md#078ad043ff5c2f3c)

<a id="a39f25fdcb7a9969"></a>
### Managing Index

This chapter describes index overview and creating/deleting index.

<a id="7e44bc31d50b61ea"></a>
#### Overview
...
For more information, refer to [Global Sequence](3-cluster-tutorial.md#d4a9a585d760db09).

<a id="389f680a90175b31"></a>
## Managing User

<a id="1fefe5ec9088cf18"></a>
### Creating User
...
<a id="711d9af166b8b430"></a>
### Properties When Creating Database

**Properties when creating database**

<a id="7f24035dc0aadaf6"></a>
| Name | Description |
| --- | --- |
...
<a id="96c92cf427ae665f"></a>
## GOLDILOCKS Utility

<a id="d659a55ab7783684"></a>
### gcreatedb
