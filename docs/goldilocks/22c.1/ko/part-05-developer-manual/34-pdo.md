<a id="4c431b9aab75cff9"></a>

# 34. PDO

> 원본: [GOLDILOCKS 22c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/22c_1/manual/ko/4c431b9aab75cff9)  
> 태그: `22c.1_10_tag`

[← 33. Embedded SQL](33-embedded-sql.md) · [전체 목차](../README.md) · [35. PyDBC →](35-pydbc.md)

<a id="cde7391ce315edac"></a>
## PDO 개요
...
<a id="d0f6cf28d5f79064"></a>
## 설치/구성

<a id="ae6c91eebd520a7a"></a>
### 요구 사항

PHP와 동일한 시스템에 GOLDILOCKS의 클라이언트 패키지를 설치해야 하고 $GOLDILOCKS_HOME 환경 변수도 설정해야 한다.

<a id="6b5b13e9d21d1458"></a>
### 설치

<a id="fb11261a39124d06"></a>
#### PECL을 이용한 설치
...
PDO_GOLDILOCKS 패키지 파일이 있을 경우 pecl를 이용해 패키지를 설치한다.

```
% sudo -E pecl install PDO_GOLDILOCKS-3.2.0.tgz
```

<a id="2204ee9fa833c256"></a>
#### 소스 빌드를 통한 설치
...
<a id="720ac24398b2d2a9"></a>
#### 웹 서버 재시작

웹 서버를 다시 시작한다.

<a id="e4403a2e2e086013"></a>
...
<a id="3000e2d33ee0e297"></a>
## 사용

<a id="95de93e445323608"></a>
### 데이터 원본 이름 (DSN)

PDO_GOLDILOCKS의 데이터 원본 이름 (DSN)은 다음과 같이 구성된다.

<a id="4876cf88be36db9c"></a>
| 속성 | 설명 |
| --- | --- |
