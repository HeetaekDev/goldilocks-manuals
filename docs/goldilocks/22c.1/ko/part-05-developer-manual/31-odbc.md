...
<a id="347b910b5eab4d43"></a>
## GOLDILOCKS ODBC Driver 개요

<a id="9aba08e04ed9cb00"></a>
...
<a id="97047ec0fa5f55be"></a>
### ODBC 구성요소 개요

<a id="285a13eb78db1f26"></a>
#### 드라이버 관리자를 포함하는 GOLDILOCKS ODBC Driver

다음은 드라이버 관리자가 시스템에 포함된 소프트웨어 아키텍처이다. 이 경우, 응용 프로그램은 드라이버 관리자 라이브러리로 링크해야 한다.

<a id="6c1eb32a03b68a38"></a>
![드라이버 관리자를 포함하는 GOLDILOCKS ODBC driver](../assets/images/6d4c741788d10cca.png)

<a id="17156b989411296b"></a>
...
<a id="6dc187f357ad22ed"></a>
![드라이버 관리자를 포함하지 않는 GOLDILOCKS ODBC driver](../assets/images/971692932df8d859.png)

<a id="f979012003051db1"></a>
### GOLDILOCKS ODBC Driver 사용

<a id="2f6e5d687271604c"></a>
#### 헤더 파일
...
<a id="38509fa109f62339"></a>
## 데이터 원본 구성

<a id="60e717e6b809217d"></a>
### UNIX에서 DSN 구성

<a id="2bd4d11699f1be9d"></a>
#### odbcinst.ini 파일
...
> 
> - LOCATOR_DSN에 FILE과 HOST, PORT 속성이 모두 설정된 경우, FILE 속성을 우선적으로 적용한다. FILE에 대한 자세한 내용은 [Location File](../part-06-utility-manual/48-gloctl.md#5ba0729f4f76e0fd) 을 참조한다.
> 
> 
> 
...
>   자세한 내용은 [glocator](../part-06-utility-manual/46-glocator.md#04d10f2d8e562928)와 [gloctl](../part-06-utility-manual/48-gloctl.md#aa199b40ad865d19)를 참조한다.
> 
...
<a id="462bef373de579ba"></a>
### Windows에서 DSN 구성

Windows에서는 ODBC 데이터 원본 관리자를 통해 DSN을 추가하거나 설정할 수 있다.

<a id="03899f37192e568b"></a>
![Creating new data source](../assets/images/cbe32d282d6e25c7.png)

<a id="4e8b0441cdbf4703"></a>
![ODBC driver configuration](../assets/images/16a0713d0035bd78.png)
...
<a id="d561ca99bdb08be6"></a>
### GLOBAL CONNECTION 처리 과정

<a id="e1a367ebfa42c0aa"></a>
![Basic steps of applying GLOBAL CONNECTION](../assets/images/b1bfe6f4a0c15371.png)
...
<a id="f3c6bfb827097c10"></a>
![Sales orders 구조체](../assets/images/f595904c7f81f62a.png)
...
<a id="d89bf0c13549af48"></a>
#### 카탈로그 함수의 인자

<a id="e8dd5cbd71ead4e3"></a>
##### 패턴값 인자
...
<a id="cb789db6f58b921d"></a>
## 비표준 데이터 타입

본 절에서는 ODBC 표준에 정의되지 않은 GOLDILOCKS 데이터 타입에 대해 설명한다.

<a id="9d159dca8006e458"></a>
### C 데이터 타입

**GOLDILOCKS C 데이터 타입**

<a id="b536c5b894ed8d8c"></a>
...
<a id="4ae6213d0b614491"></a>
### SQL 데이터 타입

**GOLDILOCKS SQL 데이터 타입**

<a id="3c7629e84212ebdb"></a>
...
<a id="893f0142a6d4430f"></a>
#### SQL_BOOLEAN

GOLDILOCKS의 BOOLEAN 타입이다.

<a id="1d60307b8684478e"></a>
#### SQL_REFCURSOR

GOLDILOCKS PSM의 REF CURSOR 타입이다.

<a id="3e579e539a6ce092"></a>
#### SQL_TYPE_TIME_WITH_TIMEZONE
...
<a id="1a023618c027ef3c"></a>
## ODBC API References

<a id="6ed234314266fa3a"></a>
### SQLAllocConnect

<a id="b4a71d709bc1340e"></a>
#### 적합성

도입된 버전: ODBC 1.0

<a id="9a8eb9ed2ab20edb"></a>
#### 개요

SQLAllocConnect 함수는 ODBC 3.x에서 SQLAllocHandle 함수로 대체되었다.   
자세한 내용은 [SQLAllocHandle](#04494751d26a9fdc) 함수를 참조한다.

<a id="325d10a9ea0da828"></a>
#### 구문
...
<a id="8b81e0278287537f"></a>
#### 인자

- **EnvironmentHandlePtr:** [출력] 새로 할당받을 환경 핸들의 포인터이다.

<a id="04494751d26a9fdc"></a>
### SQLAllocHandle

<a id="b720e11ee21e8fcf"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="f8a574cf06ff3582"></a>
#### 개요

SQLAllocHandle은 환경, 연결, 또는 명령문 핸들을 할당한다.

<a id="b023e186777b9a59"></a>
#### 구문
...
<a id="fb36c952f4371b36"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_INVALID_HANDLE, SQL_ERROR

<a id="140b81fc56a4d2ca"></a>
#### 진단

<a id="b99ab5c15e35a960"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="fc42f957891e2443"></a>
### SQLAllocStmt

<a id="b4a5dc6a9796dada"></a>
#### 적합성

도입된 버전: ODBC 1.0

<a id="ba3718ac1c9d6a5f"></a>
#### 개요

SQLAllocStmt 함수는 ODBC 3.x에서 SQLAllocHandle 함수로 대체되었다.   
자세한 내용은 [SQLAllocHandle](#04494751d26a9fdc) 함수를 참조한다.

<a id="acafc832eda7428c"></a>
#### 구문
...
<a id="bc567c9e6e10c240"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_INVALID_HANDLE, SQL_ERROR

<a id="995845729602e041"></a>
#### 진단

<a id="f3f2fefff63ec634"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="8f1c8a9d510ceaa3"></a>
##### Column 재 바인딩

응용 프로그램은 바인딩을 변경하기 위해 다음 두 연산 중 하나를 수행할 수 있다.

- SQLBindCol을 호출하여 이미 바인딩 된 column에 대해 새로운 바인딩을 명시한다.
- SQLBindCol을 호출하여 명시된 버퍼 주소에 offset을 추가한다. 자세한 정보는 다음 문단인 [바인딩 Offset](#bdee52cdef9544d7)을 참조한다.

<a id="bdee52cdef9544d7"></a>
##### 바인딩 Offset
...
- 각 column에 배열을 바인딩한다. 이는 각 데이터 구조체 (배열)가 하나의 column에 대한 데이터를 포함하기 때문에 [열방향 바인딩](#1e141fde3a74c3ac)처럼 참조한다.
- Row 데이터 전체를 포함할 수 있는 구조체를 정의하고 이 구조체들의 배열을 바인딩한다. 이것은 각 데이터 구조체가 row 하나에 대한 데이터를 포함하기 때문에 [행방향 바인딩](#483c0576721b6d66)처럼 참조한다.

각 버퍼 배열은 적어도 row 집합 크기 만큼의 원소들을 가지고 있어야 한다.

<a id="1e141fde3a74c3ac"></a>
##### Column 방향 바인딩
...
<a id="396e03fa5f1d5560"></a>
### SQLBindParameter

<a id="dd854bc5ce84445e"></a>
#### 적합성

도입된 버전: ODBC 2.0   
표준 준수: ODBC

<a id="c5ce5d8e66378473"></a>
#### 개요

SQLBindParameter는 SQL 문의 매개 변수 마커에 버퍼를 바인딩한다.

<a id="711afd9cee247121"></a>
#### 구문
...
<a id="f2c44bfc4954ebd9"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="c57b6f37c58b8d07"></a>
#### 진단

<a id="cb78a5ae6d939358"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
자세한 내용은 [SQLGetInfo](#ff70845becec3b11)를 참조한다.
...
> APD에 있는 SQL_DESC_ARRAY_STATUS_PTR 헤더 필드는 매개 변수들을 무시하는데 사용된다. 매개 변수 무시에 대한 자세한 내용은 [매개변수 집합 무시](#832b504349d50b14)를 참조한다.
...
<a id="57c29b832daee822"></a>
### SQLBrowseConnect

지원되지 않는다.

<a id="67dc51aead7d708e"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="667805a934617634"></a>
#### 개요

SQLBrowseConnect는 데이터 소스에 연결하는데 필요한 속성과 속성값을 발견하고, 반복적 나열 방법을 지원한다.

<a id="aedce93ae77b430d"></a>
#### 구문
...
<a id="ef30cb2c6c575da2"></a>
### SQLBulkOperations

지원되지 않는다.

<a id="7c10cd82ea368415"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ODBC

<a id="e0280e1820202ab4"></a>
#### 개요

SQLBulkOperations는 대량 삽입 및 북마크를 통한 갱신, 삭제, 가져오기 같은 대량 북마크 연산을 수행한다.

<a id="97513b0ccac1a80a"></a>
#### 구문
...
<a id="c3934e890e2f9593"></a>
### SQLCancel

<a id="d23a98895c75aa55"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="5aa8baaf67385d48"></a>
#### 개요

SQLCancel은 처리 중인 명령문을 취소한다.

<a id="e7aceeb9dee1afee"></a>
#### 구문
...
<a id="6c3ad93e26d55224"></a>
#### 인자

- **StatementHandle:** [입력] 명령문 핸들이다.

<a id="2c93a3d9615278e0"></a>
#### 반환

SQL_SUCCESS, SQL_ERROR 또는 SQL_INVALID_HANDLE

<a id="562587cdf812a3b8"></a>
#### 진단

<a id="4d1e1b271e78624d"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| HY000 | General error | 특정 SQLSTATE가 없는 에러이다. |
| HY001 | Memory allocation error | 메모리 할당 에러이다. |
...
<a id="bd4807b31cc7d859"></a>
### SQLCancelHandle

<a id="ee3db05e0685fd3f"></a>
#### 적합성

도입된 버전: ODBC 3.8   
표준 준수: 없음

<a id="4bb1c64a4c9a70c8"></a>
#### 개요

SQLCancelHandle은 명령문의 처리를 취소한다.   
자세한 내용은 [SQLCancel](#c3934e890e2f9593)을 참조한다.

<a id="907c3fa3f7f04e59"></a>
#### 구문
...
<a id="f9ce6ead47d556ee"></a>
#### 인자

- **HandleType:** [입력] 핸들 타입이다. SQL_HANDLE_STMT만 지원한다.
- **Handle:** [입력] 명령문 핸들이어야 한다.

<a id="768b16310082b30e"></a>
#### 반환

SQL_SUCCESS, SQL_ERROR 또는 SQL_INVALID_HANDLE

<a id="bc73c2df0caf3372"></a>
#### 진단

<a id="c8882aba3a58113d"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| HY000 | General error | 특정 SQLSTATE가 없는 에러이다. |
| HY001 | Memory allocation error | 메모리 할당 에러이다. |
...
<a id="8c2c7ed51054e559"></a>
### SQLCloseCursor

<a id="e66f37ee31e2298b"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="e516051c55b43fb4"></a>
#### 개요

SQLCloseCursor는 명령문에서 열린 커서를 닫고, 남아 있는 결과들을 폐기한다.

<a id="a0c543653a8a1dcd"></a>
#### 구문
...
<a id="c276014dcd0d2116"></a>
#### 인자

- **StatementHandle:** [입력] 명령문 핸들이다.

<a id="8d1835f716d97a46"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="caa05709e2ef380d"></a>
#### 진단

<a id="79b98dbb7efb7f36"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="f1bf2021c482051f"></a>
### SQLColAttribute

<a id="25d186a7b78eb8d6"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="ed08b2b94e1e38f7"></a>
#### 개요

SQLColAttribute는 결과 집합 column에 대한 설명자 정보를 반환한다. 설명자 정보는 문자열이나 정수값으로 반환된다.

<a id="2b3f2941364b1c68"></a>
#### 구문
...
<a id="e66f162f74fa77c2"></a>
### SQLColAttributes

<a id="bbe64e01b61d9fcd"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="754c337b0667bb7d"></a>
#### 개요

ODBC 2.0의 SQLColAttributes 함수는 ODBC 3.x에서 SQLColAttribute 함수로 대체되었다.   
자세한 내용은 [SQLColAttribute](#f1bf2021c482051f) 함수를 참조한다.

<a id="a880489203c1da56"></a>
### SQLColumnPrivileges

<a id="f793eacc1a1b0e18"></a>
#### 적합성

도입된 버전: ODBC 1.0  
표준 준수: ODBC

<a id="f1cf21954e81f851"></a>
#### 개요

SQLColumnPrivileges는 지정된 테이블에 대한 column과 관련 권한의 목록을 결과 집합으로 반환한다.

<a id="47225fc6112b2658"></a>
#### 구문
...
<a id="5be1b782b573bb0c"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="606063b7ee970bd1"></a>
#### 진단

<a id="470da24e9dfaa91d"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="ef2fc0dda783516c"></a>
### SQLColumns

<a id="cbb3776ed6377033"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: Open Group

<a id="c8341055df375fb3"></a>
#### 개요

SQLColumns는 지정된 테이블의 column 이름 목록을 결과 집합으로 반환한다.

<a id="7ee3ad327d14ea53"></a>
#### 구문
...
<a id="4d996e59986d12ff"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="617c70d45b85a620"></a>
#### 진단

<a id="178e2b369b443771"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스간 연결에 실패했다. |
| 24000 | Invalid cursor state | SQLFetch, SQLFetchScroll을 호출해 열린 커서가 있다. |
...
<a id="ccdb8bb8af8e4f54"></a>
### SQLConnect

<a id="66d76b7847de6508"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="14a690efe1d051b4"></a>
#### 개요

SQLConnect는 드라이버와 데이터 소스에 대한 연결을 설정한다. 연결 핸들은 상태, 트랜잭션 상태, 에러 정보를 포함하는 연결에 관한 모든 정보를 참고한다.

<a id="a3596adad821d68d"></a>
#### 구문
...
<a id="619ff38e0872bfb4"></a>
### SQLCopyDesc

지원되지 않는다.

<a id="5a1249a43896ee99"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="de07db5ebd1eb3f1"></a>
#### 개요

SQLCopyDesc는 설명자 정보를 하나의 설명자 핸들에서 다른 설명자 핸들로 복사한다.

<a id="025aff9a5d73514c"></a>
#### 구문
...
<a id="a8154732c117d8f0"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="d09fbc1318cce488"></a>
#### 진단

<a id="5f67332e4c91f8fb"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="843d21692ea036f0"></a>
### SQLDescribeParam

<a id="c3a134873e0da34a"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="4e20f5e296d65f0e"></a>
#### 개요

SQLDescribeParam은 준비된 SQL 문과 관련된 매개 변수 마커의 설명을 반환한다. 이 정보는 IPD의 필드들에서 사용할 수 있다.

<a id="4cf6acea1b50b0be"></a>
#### 구문
...
<a id="ebf1c2e63d135616"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="4c54d34f45f92503"></a>
#### 진단

<a id="7d66adebbaf2c247"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="a22bb5c906a726fb"></a>
### SQLDisconnect

<a id="33d5070f39e93e3b"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="a4d9215734e5e86f"></a>
#### 개요

SQLDisconnect는 특정 연결 핸들과 관련된 연결을 닫는다.

<a id="1a8c220ba2f77133"></a>
#### 구문
...
<a id="0073ef398b2ac0b3"></a>
#### 인자

- **ConnectionHandle:** [입력] 연결 핸들이다.

<a id="6485c5b90a38e79c"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE, SQL_STILL_EXECUTING

<a id="0c8575efb1997818"></a>
#### 진단

<a id="260d91805f0f4899"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="2dedcce93dd1cd79"></a>
### SQLDriverConnect

<a id="721cc4d46e8b91cb"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="18d0ef0d387ff2a9"></a>
#### 개요
...
<a id="e79bd81074b4868a"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE, SQL_STILL_EXECUTING

<a id="09ab9be454db4978"></a>
#### 진단

<a id="404e6c866d214053"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="bf88e7ff2ff19f3d"></a>
### SQLError

<a id="ebc6f000b47d393a"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="bbaebcb3bdbfc570"></a>
#### 개요

SQLError는 에러나 상태 정보를 반환한다.

<a id="e1d064b9e4e58f23"></a>
### SQLExecDirect

<a id="6c808aad35bf651f"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="3d9ca70e2365f245"></a>
#### 개요

SQLExecDirect는 명령문에 매개 변수가 있을 경우, 매개 변수 마커의 현재 값을 사용하여 명령문을 수행한다. SQLExecDirect는 한 번만 실행되는 명령문을 위한 가장 빠른 방법이다.

<a id="34c9f1587ea30c3a"></a>
#### 구문
...
<a id="d0fd5c9ad0b747d0"></a>
#### 진단

<a id="b412733fde0cfd8c"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="9035943039d83504"></a>
### SQLExecute

<a id="0f5cac6316d6e44a"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="b31af3075cd7cc77"></a>
#### 개요

SQLExecute는 명령문에 매개 변수가 있을 경우, 매개 변수 마커의 현재 값을 사용하여 준비된 명령문을 수행한다.

<a id="c32852759bbc6bb8"></a>
#### 구문
...
<a id="d1376816b6ebed26"></a>
#### 인자

- **StatementHandle:** [입력] 명령문 핸들이다.

<a id="3bb7c64c719cc882"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NEED_DATA, SQL_STILL_EXECUTING, SQL_ERROR, SQL_NO_DATA, SQL_INVALID_HANDLE, SQL_PARAM_DATA_AVAILABLE

<a id="a4670d11043d5642"></a>
#### 진단

<a id="5b3a88b88a809afe"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="0d89ef471af4fb1e"></a>
### SQLExtendedFetch

<a id="5db1640c8315611e"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="6bef0308ffea273f"></a>
#### 개요

SQLExtendedFetch는 결과 집합으로부터 지정된 데이터 집합을 가져와서 바인딩된 모든 column에 반환한다.

<a id="45dd7d7f6fa11d8f"></a>
#### 구문
...
<a id="08ca731e3710aebe"></a>
### SQLFetch

<a id="7117fd8376b0a75b"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="7990e36719154335"></a>
#### 개요

SQLFetch는 결과 집합에서 다음 row 집합을 가져와서 바인딩 된 모든 column에 반환한다.

<a id="0683cfdfd246d84a"></a>
#### 구문
...
5. 데이터 버퍼에 변환된 (가능하다면 절삭된) 데이터를 입력한다. 데이터 버퍼의 주소 결정에 대한 자세한 내용은 SQLBindCol의 [버퍼 주소](#fd89c82b24cfa56e)를 참조한다.
...
<a id="8ceb2de4a8e7085d"></a>
##### 설명자와 SQLFetch

SQLFetch는 다음 설명자 필드를 사용한다.

<a id="9d336dab29bdcc2f"></a>
...
<a id="7802d3a4499a0898"></a>
### SQLFetchScroll

<a id="f68d930f82ed9a0a"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="6b8c5b0391a22b80"></a>
#### 개요

SQLFetchScroll은 결과 집합에서 지정된 데이터 집합을 가져와서 바인딩 된 모든 column에 반환한다.

<a id="a7be94390d2dbafa"></a>
#### 구문
...
<a id="7edd74fb55435cff"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NO_DATA, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="92c83e401530c35e"></a>
#### 진단

<a id="04aa1207680dade1"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01004 | String data, right truncated | Column에 대해 반환된 문자열이나 이진 데이터가 잘렸다. 문자열이 잘린 경우, 오른쪽이 잘렸다. |
| 01S07 | Fractional truncation | Column에 대해 반환된 데이터가 잘렸다. 숫자 데이터 타입이 잘린 경우, 소수 부분이 잘렸다. 기간 구성 요소를 포함하는 time, timestamp, interval 데이터 타입이 잘린 경우, 시간의 소수 부분이 잘렸다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
<a id="68142a6ba63b4ada"></a>
##### 버퍼 주소

SQLFetchScroll은 데이터의 주소와 길이/ 지시자 버퍼의 주소를 SQLFetch와 동일하게 결정한다. 자세한 내용은 SQLBindCol의 [버퍼 주소](#fd89c82b24cfa56e)를 참조한다.

<a id="23d107440c68cbdd"></a>
##### Row 상태 배열

SQLFetchScroll은 row 상태 배열을 SQLFetch와 동일하게 설정한다. 자세한 내용은 SQLFetch의 [Row 상태 배열](#0bff2bef14d06d0a)을 참조한다.

<a id="96296f43361df8ca"></a>
##### Row 반입 버퍼

SQLFetchScroll은 가져온 row의 개수를 SQLFetch와 동일하게 반환한다. 자세한 내용은 SQLFetch의 [Row 반입 버퍼](#40fa05b25e6e3fdb)를 참조한다.

<a id="f9e64e6e0814fa45"></a>
##### 에러 처리

SQLFetchScroll은 에러와 경고를 SQLFetch와 동일하게 반환한다. 자세한 내용은 SQLFetch의 [에러 처리](#3a1fa791b643c723)를 참조한다.

<a id="f489d57e96481820"></a>
### SQLForeignKeys

<a id="57e613a7b86952c6"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="9d2e604c60c0bbae"></a>
#### 개요
...
<a id="fa6a3cd73831a89c"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="a366baba7a966d6e"></a>
#### 진단

<a id="fcb15ff9e9f0cdeb"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
| 24000 | Invalid cursor state | SQLFetch, SQLFetchScroll을 호출해 열린 커서가 있다. |
...
<a id="6df307334e5ff876"></a>
### SQLFreeConnect

<a id="89fb147f87fd2514"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="8830ca8acb2195c2"></a>
#### 개요

SQLFreeConnect 함수는 ODBC 3.x에서 SQLFreeHandle 함수로 대체되었다.   
자세한 내용은 [SQLFreeHandle](#31f05039f3809e7b) 함수를 참조한다.

<a id="0a45757b9c3afa23"></a>
### SQLFreeEnv

<a id="c6227d9afaabd926"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="367295a6fe622e05"></a>
#### 개요

SQLFreeEnv 함수는 ODBC 3.x에서 SQLFreeHandle 함수로 대체되었다.   
자세한 내용은 [SQLFreeHandle](#31f05039f3809e7b) 함수를 참조한다.

<a id="31f05039f3809e7b"></a>
### SQLFreeHandle

<a id="cdddd2100840ac61"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="f2023a7b0d11023e"></a>
#### 개요

SQLFreeHandle은 지정된 환경, 연결, 명령문, 설명자 핸들과 관련된 자원을 해제한다.

<a id="f88161b7dce96ec7"></a>
#### 구문
...
<a id="f70c9d507cf90997"></a>
### SQLFreeStmt

<a id="7c25bd7194de479f"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="b5267d7b14e02b66"></a>
#### 개요

SQLFreeStmt는 지정된 명령문과 관련된 처리를 중단하고, 열린 커서를 닫고, 남아 있는 결과를 버리거나 선택적으로 명령문 핸들과 관련된 모든 자원을 해제한다.

<a id="bff8f19a5ca0566b"></a>
#### 구문
...
<a id="0f3a768837c54146"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="4f2aec6155f35928"></a>
#### 진단

<a id="03d745e4303236f1"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| HY000 | General error | 특정 SQLSTATE가 없는 에러이다. |
| HY001 | Memory allocation error | 메모리 할당 에러이다. |
...
<a id="91c74b7c53d67c48"></a>
### SQLGetConnectAttr

<a id="15ce2a030544ebd7"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="0c206a35bc38261a"></a>
#### 개요

SQLGetConnectAttr은 연결 속성의 현재 설정을 반환한다.

<a id="075f1a9315b3d7d8"></a>
#### 구문
...
<a id="f8564f72ada5b55c"></a>
### SQLGetConnectOption

<a id="61b1e22c00c7e501"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="5d8a476d393f590d"></a>
#### 개요

SQLGetConnectOption 함수는 ODBC 3.x에서 SQLGetConnectAttr 함수로 대체되었다.  
자세한 내용은 [SQLGetConnectAttr](#91c74b7c53d67c48) 함수를 참조한다.

<a id="e20516679ab942c9"></a>
### SQLGetCursorName

<a id="c4dddf3d7c50bff5"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="973e9b5fd1e401ef"></a>
#### 개요

SQLGetCursorName은 지정된 명령문과 관련된 커서 이름을 반환한다.

<a id="1811beb6547cae78"></a>
#### 구문
...
<a id="6b655d896318527a"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="c6ca46b5abc8691c"></a>
#### 진단

<a id="71b7352f9022cebf"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="ea9dec03255c6a1c"></a>
### SQLGetData

<a id="4618ebc0f4b4cda0"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="165f5a32ace47834"></a>
#### 개요

SQLGetData는 결과 집합에서 하나의 column 데이터를 검색하며 가변 길이 데이터를 검색하기 위해 여러 번 호출될 수 있다.

<a id="f9a5c5c2952578ba"></a>
#### 구문
...
<a id="919ed99925b3b802"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NO_DATA, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="14fe3e687dd4a1e8"></a>
#### 진단

<a id="746cdd8f090c6082"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="9591ff6a339a8f3e"></a>
### SQLGetDescField

<a id="693998f877f52833"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="037fc8d877c1adba"></a>
#### 개요

SQLGetDescField는 설명자 레코드의 단일 필드의 현재 설정 또는 값을 반환한다.

<a id="9738c87dd86974b7"></a>
#### 구문
...
<a id="405d4f16f964bdb2"></a>
#### 진단

<a id="c4e8b615f052ee4e"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
| HY117 | Connection is suspended due to unknown transaction state. Only disconnect and read-only functions are allowed. | 유예 상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba) 함수를 참조한다. |
...
- **SQL_DESC_BIND_OFFSET_PTR[Application descriptors]:** SQLLEN* 인 이 헤더 필드는 바인딩의 offset을 가리킨다. 이것은 기본적으로 NULL 포인터로 설정된다. 이 필드가 NULL 포인터가 아닐 경우, 드라이버는 포인터와 회수 시점 설명자 레코드 ( SQL_DESC_DATA_PTR_, SQL_DESC_INDICATOR_PTR 및 SQL_DESC_OCTET_LENGTH_PTR)의 NULL 아닌 값을 가지는 지연된 필드 각각의 값을 역참조하고 바인딩될 때 새로운 포인터의 값을 사용한다.  
  ...
  자세한 내용은 [SQLFetchScroll](#7802d3a4499a0898)이나 [SQLBindParameter](#396e03fa5f1d5560)를 참조한다.
...
<a id="9157effa9993b5f1"></a>
#### 진단

<a id="a79d763840720c6a"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 01004 | String data, right truncated | *ValuePtr의 버퍼 길이가 설명자 필드값의 길이보다 작아서 잘렸다. 남아 있는 설명자 필드의 길이는 *StringLengthPtr에 반환된다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
응용 프로그램이 특정 설명자 타입으로 정의되었지만 기본값으로 설정되지 않은 필드의 값을 검색하기 위해 SQLGetDescRec를 호출하였을 때, 함수는 SQL_SUCCESS를 반환하지만 필드값은 정의하지 않는다. 자세한 내용은 SQLSetDescField의 [설명자 필드의 초기화](#64046b36a8832f80)를 참조한다.

SQLGetDescField를 호출하면 필드값들을 각각 별도로 검색할 수 있다. 설명자 헤더 또는 레코드 안의 필드에 대한 자세한 내용은 [SQLSetDescField](#47f63aa180518a7b)를 참조한다.

<a id="43eefbd70958e542"></a>
### SQLGetDiagField

<a id="926bbae48d1df67e"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="599a44e5a5ce1bc1"></a>
#### 개요

SQLGetDiagField는 에러, 경고, 상태 정보를 포함하는 진단 데이터 구조에서 레코드 필드의 현재 값을 반환한다.

<a id="99da904b4f9a104f"></a>
#### 구문
...
- **DiagIdentifier :** [입력] 값이 반환되는 진단 필드를 가리킨다. 자세한 내용은 설명 섹션의 [DiagIdentifier 인자](#9de88f0fe608227e)를 참조한다.
...
<a id="243e6a3cf8806425"></a>
##### 헤더 필드

<a id="741660c41c543141"></a>
...
<a id="221c47420f9cca0c"></a>
##### 레코드 필드

<a id="01b990e934db21eb"></a>
| DiagIdentifier | 반환 타입 | 반환 |
| --- | --- | --- |
...
<a id="c4a6f31ff6aac00e"></a>
##### 동적 함수 필드의 값

<a id="edc1b11e5bdd5dec"></a>
...
<a id="82c4446d2b40009d"></a>
### SQLGetDiagRec

<a id="6903d357d21a2231"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="5663740622033980"></a>
#### 개요

SQLGetDiagRec는 에러, 경고, 상태 정보가 포함되는 (지정된 핸들과 관련된) 진단 데이터 소스의 레코드 필드의 현재 값을 반환한다.

<a id="2a16af7691e0cbd3"></a>
#### 구문
...
<a id="990d0d631454c19d"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="0836e7b2868370af"></a>
#### 개요

SQLGetEnvAttr은 환경 속성의 현재 설정을 반환한다.

<a id="45cc519aa76b596b"></a>
#### 구문
...
<a id="4d7118911da524bc"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NO_DATA, SQL_ERROR, SQL_INVALID_HANDLE

<a id="2f357a644614c42d"></a>
#### 진단

<a id="74a34fe1e3870625"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
<a id="c7cf03cda26a6359"></a>
### SQLGetFunctions

<a id="8ac159f7969a4935"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="7574437487d6f691"></a>
#### 개요
...
<a id="819da830588bea30"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="2266d936bcfbfe58"></a>
#### 진단

<a id="dea0b4d0eb402dc9"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="937ce2a2e3b70164"></a>
### SQLGetGroupCount

<a id="344047131b176db2"></a>
#### 적합성

표준 준수: 없음

<a id="5086a3d289bc64e4"></a>
#### 개요

SQLGetGroupCount는 클러스터 그룹의 개수를 반환한다.

<a id="b2e9750d8b823975"></a>
#### 구문
...
<a id="7a2560b91a2c9f9f"></a>
#### 인자

- **ConnectionHandle :** [입력] 연결 핸들이다.
- ** GroupCountPtr :** [출력] 클러스터 그룹의 개수이다.

<a id="1641c3815c019b95"></a>
#### 반환

SQL_SUCCESS, SQL_NO_DATA, SQL_ERROR, SQL_INVALID_HANDLE

<a id="510ddb4b8fb15f32"></a>
#### 진단

<a id="08b7506187574af5"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="57dad178486c1938"></a>
#### 설명

SQLGetGroupCount는 SQL_ATTR_LOCALITY_AWARE_TRANSACTION 연결 속성이 설정된 상태에서만 호출할 수 있다.

<a id="df7aedd5224e285e"></a>
### SQLGetGroupIDs

<a id="562c6e5ca4440111"></a>
#### 적합성

표준 준수: 없음

<a id="5ead2dea5fb86304"></a>
#### 개요

SQLGetGroupIDs는 클러스터 그룹들의 ID를 반환한다.

<a id="e4e8929908ac7bdd"></a>
#### 구문
...
<a id="9931b4f4ec03f93f"></a>
#### 인자

- **ConnectionHandle :** [입력] 연결 핸들이다.
- ** GroupIDArray :** [출력] 클러스터 그룹 ID의 배열이다.

<a id="982a1a85f80c755f"></a>
#### 반환

SQL_SUCCESS, SQL_NO_DATA, SQL_ERROR, SQL_INVALID_HANDLE

<a id="01f4f54c668a8edf"></a>
#### 진단

<a id="0599e120ee78eb9f"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 08003 | Connection not open | ConnectionHandle이 연결된 상태가 아니다. |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스간 연결에 실패했다. |
...
<a id="ddbf036ed13f723a"></a>
### SQLGetGroupName

<a id="dff338d05b3781d0"></a>
#### 적합성

표준 준수: 없음

<a id="5a2601c3551aba54"></a>
#### 개요

SQLGetGroupName는 GroupID에 해당하는 클러스터 그룹의 이름을 반환한다.

<a id="c06f81121a4369e8"></a>
#### 구문
...
<a id="0aeb840b462f1f09"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NO_DATA, SQL_ERROR, SQL_INVALID_HANDLE

<a id="9e67492702037f57"></a>
#### 진단

<a id="38012539fd0d165f"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="1c23f5fef0d4071e"></a>
#### 설명

SQLGetGroupIDs는 SQL_ATTR_LOCALITY_AWARE_TRANSACTION 연결 속성이 설정된 상태에서만 호출할 수 있다.

<a id="ff70845becec3b11"></a>
### SQLGetInfo

<a id="d04bdb402cd6c8e6"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="cf47d2317ccef69d"></a>
#### 개요

SQLGetInfo는 드라이버 및 데이터 소스와 관련된 연결에 대한 일반적인 정보를 반환한다.

<a id="21b85e8af23d1127"></a>
#### 구문
...
<a id="1816c89f6c66d216"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, 또는 SQL_INVALID_HANDLE

<a id="79503b6389d003c0"></a>
#### 진단

<a id="2aaa089c65d22d9b"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
<a id="f606dfb3c39a242f"></a>
### SQLGetStmtAttr

<a id="b7ae744a3dec70e0"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="2623399588cb83bf"></a>
#### 개요

SQLGetStmtAttr은 명령문 속성의 현재 설정을 반환한다.

<a id="0d8ff2980edb9914"></a>
#### 구문
...
<a id="73d76858dc2e239c"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, 또는 SQL_INVALID_HANDLE

<a id="63c18a70d00146d7"></a>
#### 진단

<a id="cfa0bc3b21043221"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
<a id="ebf6d084314c787f"></a>
#### 인자

- **ConnectionHandle :** [입력] 연결 핸들이다.
- ** GroupIDPtr :** [출력] 클러스터 그룹의 ID이다.

<a id="453708fb06322d23"></a>
#### 반환

SQL_SUCCESS, SQL_ERROR, SQL_INVALID_HANDLE

<a id="2219408565b0bbff"></a>
#### 진단

<a id="4bccd3264483503e"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스간 연결에 실패했다. |
...
<a id="bdcadc6a3ccdab53"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="70972c58bbfdcb7f"></a>
#### 진단

<a id="fef2605c21a84d6c"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
<a id="1490df4c58a67f2e"></a>
#### 인자

- **StatementHandle :** [입력] 명령문 핸들이다.

<a id="dbeba8cd3625a2e9"></a>
#### 반환
...
<a id="08ba055bdc341988"></a>
#### 진단

<a id="88042c1f47a9c39f"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
| HY013 | Memory management error | 인자로 사용된 버퍼의 크기 값이 0보다 작거나 메모리에 접근할 수 없다. |
| HY117 | Connection is suspended due to unknown transaction state. Only disconnect and read-only functions are allowed. | 유예 상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba)을 참조한다. |
| HYT01 | Connection timeout expired | 데이터 소스가 요청에 응답하기 전에 연결이 만료되었다. 이 제한 시간은 SQLSetStmtAttr의 SQL_ATTR_CONNECTION_TIMEOUT을 통해 설정할 수 있다. |
| IM001 | Driver does not support this function | DescriptorHandle과 관련된 드라이버가 함수를 지원하지 않는다. |
| IM017 | Polling is disabled in asynchronous notification mode | 알림 모델을 사용할 때마다 폴링을 사용할 수 없다. |
...
<a id="ae29693b46321121"></a>
### SQLNativeSql

지원하지 않는다.

<a id="639ea87d3b3b5596"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="9f7c5b6266044860"></a>
#### 개요

SQLNativeSql은 드라이버가 수정한 SQL 문자열을 반환한다. SQLNativeSql은 SQL 명령문을 실행하지 않는다.

<a id="0a8e74842cbe9e8a"></a>
#### 구문
...
<a id="7433eb19520b988d"></a>
### SQLNumParams

<a id="e27d0fa8f72d565d"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="3345563c18e6320e"></a>
#### 개요

SQLNumParams는 SQL 명령문에서 매개 변수의 개수를 반환한다.

<a id="5dc6e1f87d4c8550"></a>
#### 구문
...
<a id="5fd09f7583322734"></a>
#### 인자

- **StatementHandle :** [입력] 명령문 핸들이다.
- **ParameterCountPtr :**  [출력] 명령문의 매개 변수 개수가 반환될 버퍼의 포인터이다.

<a id="0a6e6514fe1ad9f8"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="fbf6e32d39b88450"></a>
#### 진단

<a id="c1029a6d406da36f"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="f76bd71a02907a55"></a>
### SQLNumResultCols

<a id="7a43b883055ce2b2"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="14c59a76e88f6e98"></a>
#### 개요

SQLNumResultCols 결과 집합에서 column의 개수를 반환한다.

<a id="4f78560738efaff0"></a>
#### 구문
...
<a id="575884ac2a045495"></a>
#### 인자

- **StatementHandle :** [입력] 명령문 핸들이다.
- **ColumnCountPtr :** [출력] 결과 집합에서 column의 개수가 반환될 버퍼의 포인터이다. 이 개수는 북마크 column을 포함하지 않는다.

<a id="256dfd7ecccd3147"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="42ae004f6dfd6992"></a>
#### 진단

<a id="2ae4167476314a12"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="0fa4eae5a8776641"></a>
### SQLParamData

<a id="d8ba855bdd55e8e5"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="32119d6ba6191750"></a>
#### 개요

SQLParamData는 명령문이 수행될 때 매개 변수를 제공하기 위해 SQLPutData와 함께 사용된다.

<a id="aafc8a3249d9b057"></a>
#### 구문
...
<a id="db694a8e1240f389"></a>
#### 진단

<a id="f7fbc5760a8634cd"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="9f6b23f62ce298d1"></a>
### SQLParamOptions

<a id="2049518196d583af"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="a079773b2bfbd827"></a>
#### 개요

ODBC 2.0의 함수 SQLParamOptions는 ODBC 3.x에서 [SQLSetStmtAttr](#bf383d50bc808da4)로 대체되었다.

<a id="eec09ac331cba1eb"></a>
### SQLPrepare

<a id="3c95861ed4a27be6"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="681ca80c55b9b581"></a>
#### 개요

SQLPrepare는 실행할 SQL 문자열을 준비한다.

<a id="6fb90311e77f6352"></a>
#### 구문
...
<a id="2b98d86478e0d108"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="1e86db58572ddfe9"></a>
#### 진단

<a id="fbdd713bd0d82c5b"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
> 명시적으로 SQLEndTran을 호출하거나 자동 commit 모드로 작동하여 트랜잭션을 commit할 경우, 데이터 소스가 연결과 관련된 모든 명령문에 대한 접근 플랜을 삭제할 수 있다. 자세한 내용은 [SQLGetInfo](#ff70845becec3b11) 의 정보 타입 SQL_CURSOR_COMMIT_BEHAVIOR와 SQL_CURSOR_ROLLBACK_BEHAVIOR를 참조한다.

<a id="487e2f6112d08230"></a>
### SQLPrimaryKeys

<a id="75cc85ad556f0e5c"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="f3f9de76ade348c1"></a>
#### 개요

SQLPrimaryKeys는 테이블의 기본 키로 구성된 column의 이름을 반환한다. 드라이버는 결과 집합으로 정보를 반환한다. 이 함수는 단일 호출을 통해 여러 테이블로부터 기본 키를 반환하는 것을 지원하지 않는다.

<a id="70d8ed0db1b2274a"></a>
#### 구문
...
<a id="904d9146c92e6a1e"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="3dd6787086785e17"></a>
#### 진단

<a id="a185ec87fee479dc"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="5f85e47ab1fa4d1b"></a>
#### 설명

SQLPrimaryKeys는 결과를 TABLE_CAT, TABLE_SCHEM, TABLE_NAME, 그리고 KEY_SEQ로 정렬된 표준 결과 집합으로 반환한다. 이 정보를 사용하는 방법은 [카탈로그 데이터 사용](#5a0fa997a22b1179)을 참조한다.

다음 column은 ODBC 3.x에서 이름이 변경되었다. 응용 프로그램은 column 번호로 바인딩하기 때문에 column 이름 변경은 이전 버전과의 호환성에 영향을 미치지 않는다.

<a id="048054767a563c4f"></a>
...
> ODBC 카탈로그 함수의 일반적인 사용, 인자 그리고 반환되는 데이터에 대한 자세한 내용은 [카탈로그 함수](#10b0008e403a6130)를 참조한다.

다음 표는 결과 집합의 column 목록이다. Column 6 이후에 추가되는 column은 드라이버가 정의할 수 있다. 응용 프로그램은 명시적으로 위치를 지정하는 대신, 결과 집합의 끝에서부터 카운트다운하여 관련 column에 접근해야 한다. 자세한 내용은 [카탈로그 함수의 데이터 반환](#6b2db24bb80897ac)을 참조한다.

<a id="122f35cf28e84eaa"></a>
...
<a id="aa1898a1c8e3b2a9"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="62758b5e52d40b42"></a>
#### 진단

<a id="65943bf7f018c617"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="77cd8b42bb283b7f"></a>
### SQLProcedures

<a id="81371abc04ac6e48"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="8637afdccecc223b"></a>
#### 개요
...
<a id="2cbbcee8aac32525"></a>
#### 인자

- **StatementHandle :** [입력] 명령문 핸들이다.
- **CatalogName:** [입력] Procedure 카탈로그 이름이다. 드라이버가 카탈로그를 지원하지 않을 경우 빈 문자열 ("")을 반환하며 그 procedure들은 카탈로그를 가지지 않는다. 카탈로그 이름은 문자열 검색 패턴을 포함할 수 없다. SQL_ATTR_METADATA_ID를 SQL_TRUE로 설정할 경우, CatalogName은 식별자로 취급되고 대소문자를 구분하지 않는다. 만약 SQL_FALSE로 설정할 경우, CatalogName은 통상의 문자열 인자로 취급되고 대소문자를 구분한다. 자세한 내용은 [카탈로그 함수의 인자](#d89bf0c13549af48)를 참조한다.
- **NameLength1:** [입력] *CatalogName 문자열의 길이이다.
...
<a id="db7a6c12d7bb9307"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="0ae2c1d9ab09fd7f"></a>
#### 진단

<a id="49295dcce3e9508e"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="f7e0755d1f470e49"></a>
### SQLPutData

<a id="98db3f8c5a3d7548"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="454b8647c8d354d0"></a>
#### 개요
...
<a id="fa5e28ae6915f61d"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="c613aaaa059c9380"></a>
#### 진단

<a id="7d8c0ac64e666aa5"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 01004 | String data, right truncated | 입력/ 출력 또는 출력 매개 변수에 반환된 문자열이나 이진 데이터가 잘렸다. 문자열이 잘린 경우, 오른쪽이 잘렸다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
<a id="8ee38b63498c4966"></a>
### SQLRowCount

<a id="2aac96fd9b0877a9"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="6eddba79fc7a67ac"></a>
#### 개요
...
<a id="a1b8a98d6dee2f4b"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, 또는 SQL_INVALID_HANDLE

<a id="0c1118c3e93633e7"></a>
#### 진단

<a id="08e8e45c911a3956"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| HY000 | General error | 특정 SQLSTATE가 없는 에러이다. |
...
<a id="a643d0267375e839"></a>
### SQLSetConnectAttr

<a id="3320db11c35d1ef6"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="b44cdeb3bbed1c4b"></a>
#### 개요

SQLSetConnectAttr은 연결을 제어하는 속성을 설정한다.

<a id="6d58dab6018cecf4"></a>
#### 구문
...
<a id="07de7e3381967284"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE, SQL_STILL_EXECUTING

<a id="ce8ac90b2b0fd21c"></a>
#### 진단

<a id="47d4bfff771e6d0a"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
| SQL_ATTR_TXN_ISOLATION (ODBC 1.0) | 현재 연결에 대한 트랜잰셕 고립 레벨을 설정하는 32-bit 비트마스크이다. 응용 프로그램은 연결에서 열린 모든 트랜잭션을 commit 하거나 rollback 하기 위해 SQLSetConnectAttr을 호출하기 전에 이 옵션을 사용하여 SQLEndTran을 호출해야 한다.  ValuePtr에 유효한 값은 InfoType이 SQL_TXN_ISOLATION_OPTIONS인 SQLGetInfo를 호출하여 결정할 수 있다.  트랜잭션 고립 레벨에 대한 자세한 내용은 [SQLGetInfo](#ff70845becec3b11)의 SQL_DEFAULT_TXN_ISOLATION 정보 타입을 참조한다. |

<small>[1] </small>이러한 함수는 설명자가 응용 프로그램 설명자가 아닌 구현 설명자인 경우에만 비동기적으로 호출될 수 있다.

<a id="05a6a936d6b8272b"></a>
### SQLSetConnectOption

<a id="594d4e7e315f2b09"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="0cdfa81aca04975f"></a>
#### 개요

ODBC 2.0의 SQLSetConnectOption 함수는 ODBC 3.x에서 SQLSetConnectAttr로 대체되었다.   
자세한 내용은 [SQLSetConnectAttr](#a643d0267375e839)을 참조한다.

<a id="f091d0a2894b5c1e"></a>
### SQLSetCursorName

<a id="2a734253fa89be35"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="4d1605f1d77ef203"></a>
#### 개요

SQLSetCursorName은 활성화된 명령문에 커서 이름을 연결한다. 응용 프로그램이 SQLSetCursorName을 호출하지 않으면 드라이버는 SQL 명령문 처리에 필요한 커서 이름을 생성한다.

<a id="d42345ee5e635271"></a>
#### 구문
...
<a id="c3e2a47f34f4d20d"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="72642e669415d491"></a>
#### 진단

<a id="3cad55bdc4896ebd"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
| HY117 | Connection is suspended due to unknown tracsaction state. Only disconnect and read-only functions are allowed. | 유예 상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba) 함수를 참조한다. |
...
<a id="47f63aa180518a7b"></a>
### SQLSetDescField

<a id="ca9e482433465c48"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="ee682b86801626e4"></a>
#### 개요

SQLSetDescField는 설명자 레코드의 한 개 필드값을 설정한다.

<a id="078390c3d89b3c6a"></a>
#### 구문
...
<a id="ffb103abe847c989"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="85d749a5cc9b0a7a"></a>
#### 진단

<a id="c004d298cb7d8658"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
| HY105 | Invalid parameter type | SQL_DESC_PARAMETER_TYPE 필드에 명시된 값이 유효하지 않다. (자세한 내용은 SQLBindParameter의 [InputOutputType 인자](#bf236753a48a26bc)를 참조한다.) |
| HY117 | Connection is suspended due to unknown transaction state. Only disconnect and read-only functions are allowed. | 유예 상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba) 함수를 참조한다. |
...
- **SQL_DESC_BIND_OFFSET_PTR[Application descriptors]:** SQLLEN*인 이 헤더 필드는 바인딩의 offset을 가리킨다. 이것은 기본적으로 NULL 포인터로 설정된다. 이 필드가 NULL 포인터가 아닐 경우 드라이버는 fetching 할 때 포인터를 역참조하고 역참조된 값을 설명자 레코드 (SQL_DESC_DATA_PTR_, SQL_DESC_INDICATOR_PTR 및 SQL_DESC_OCTET_LENGTH_PTR)의 NULL이 아닌 값을 갖는 지연된 필드에 추가하고 바인딩 할 때 새 포인터 값을 사용한다.  
  ...
  자세한 내용은 [SQLFetchScroll](#7802d3a4499a0898) 또는 [SQLBindParameter](#396e03fa5f1d5560)를 참조한다.
...
자세한 내용은  [SQLSetDescRec](#3ce8e9bc665bdf41)의 [일관성 검사](#ade161d749caeff6)를 참조한다.

<a id="3ce8e9bc665bdf41"></a>
### SQLSetDescRec

<a id="8f74e9293e5bddbf"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="80d892b220093e7f"></a>
#### 개요

SQLSetDescRec 함수는 데이터 형식이나 column 또는 매개 변수 데이터에 바인딩된 버퍼에 영향을 주는 다중 설명자 필드들을 설정한다.

<a id="b0a8ddb9ad71ada5"></a>
#### 구문
...
<a id="737fbb8e31c5e14a"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="a27dfc2ce46531d2"></a>
#### 진단

<a id="e4e81d1f9a7642e4"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
- SQL_DESC_TYPE 레코드 필드가 SQL_DATETIME 또는 SQL_INTERVAL일 경우, SQL_DESC_DATETIME_INTERVAL_CODE 필드는 반드시 유효한 datetime 또는 interval 코드들 중 하나이어야 한다. ([SQLSetDescField](#47f63aa180518a7b)의 SQL_DESC_DATETIME_INTERVAL_CODE 필드의 설명을 참조한다.)
...
<a id="313ad23b97c4d503"></a>
### SQLSetEnvAttr

<a id="98c3018f59dd76d4"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="656e4a8d55b261f6"></a>
#### 개요

SQLSetEnvAttr은 환경 관리 속성을 설정한다.

<a id="2dd222ea58f6e920"></a>
#### 구문
...
<a id="2cd50d46668e971e"></a>
#### 인자

- **EnvironmentHandle:** [입력] 환경 핸들이다.
- **Attribute:** [입력] [설명](#bb3a443f68555662) 부분에 나열되어 있다.
...
<a id="5456338395f9e360"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="064bdc3bf2b89afe"></a>
#### 진단

<a id="79f29efa6685fede"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
| HY117 | Connection is suspended due to unknown trasaction state. Only disconnect and read-only functions ard allowed | 유예상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba)을 참조한다. |
...
<a id="bfd6cf0fc42521fb"></a>
### SQLSetParam

<a id="be5434f79f008c90"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="0dbe28a9e31edeec"></a>
#### 개요

ODBC 1.0의 함수 SQLSetParam은 ODBC 2.0에서 [SQLBindParameter](#396e03fa5f1d5560)로 대체되었다.

<a id="1155226b2909c3c6"></a>
### SQLSetPos

<a id="671eeb8bdc625cc2"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="aa8056b922f3b22c"></a>
#### 개요

SQLSetPos는 row 집합에서 커서의 위치를 설정하고 응용 프로그램이 row 집합의 데이터를 갱신하거나 결과 집합 안의 데이터를 갱신 또는 삭제하도록 허용한다.

<a id="d42e91197b7d736b"></a>
#### 구문
...
<a id="d5e83db253f5230a"></a>
#### 설명

<a id="a8ae8c4b294e653b"></a>
##### RowNumber 인자
...
SQL_ATTR_CONCURRENCY 명령문 속성에 대한 자세한 내용은 [SQLSetStmtAttr](#bf383d50bc808da4)을 참조한다.

<a id="f046a6cba0f245d5"></a>
##### 상태 및 연산 배열
...
Row 상태 배열에 대한 자세한 내용은 [SQLFetch](#08ca731e3710aebe)를 참조하고 row 연산 배열에 대한 자세한 내용은 [벌크 연산에서의 행 무시](#ae87de69c35e6165)를 참조한다.

<a id="d99d4caa59809b70"></a>
##### SQLSetPos 사용
...
<a id="000f6b6a2d642964"></a>
##### 벌크 연산에서 column 무시

하나 이상의 읽기 전용 column들에 갱신을 시도하여 생기는 불필요한 처리 진단을 방지하기 위해 응용 프로그램은 바인딩된 길이/ 지시자 버퍼의 값을 SQL_COLUMN_IGNORE로 설정할 수 있다.   
자세한 내용은 [SQLBindCol](#00ef0a3c23080563)을 참조한다.

<a id="e887cea6a85a2a71"></a>
### SQLSetScrollOptions

<a id="a822626ebe9c3f4d"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="ff7aa3d737ee3a3e"></a>
#### 개요
...
<a id="bf383d50bc808da4"></a>
### SQLSetStmtAttr

<a id="47bf685e96833713"></a>
#### 적합성

도입된 버전: ODBC 3.0   
표준 준수: ISO 92

<a id="7fc3e20ae22175dd"></a>
#### 개요

SQLSetStmtAttr은 명령문과 관련된 속성을 설정한다.

<a id="e937889c8c8aea48"></a>
#### 구문
...
<a id="d11f0eaade2df66b"></a>
#### 인자

- **StatementHandle:** [입력] 명령 핸들이다.
- **Attribute:** [입력] 설정할 옵션이다. [설명](#c6bfd57e66121b91) 부분을 참조한다.
...
<a id="9e26002b8d1cadcd"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE

<a id="3998a6d2057e9960"></a>
#### 진단

<a id="73ca18fa07b9a810"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
...
| HY117 | Connection is suspended due to unknown tracsaction state. Only disconnect and read-only functions are allowed | 유예 상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba)을 참조한다. |
...
- **CatalogName:** [입력] 테이블 카탈로그이다. 드라이버가 카탈로그를 지원하지 않을 경우 빈 문자열 ("")을 반환하며 그 테이블들은 카탈로그를 가지지 않는다. 카탈로그 이름은 문자열 검색 패턴을 포함할 수 없다.  
  SQL_ATTR_METADATA_ID를 SQL_TRUE로 설정할 경우, CatalogName은 식별자로 취급되고, 대소문자를 구분하지 않는다. 만약 SQL_FALSE로 설정할 경우, CatalogName은 통상의 문자열 인자로 취급되며, 대소문자를 구분한다. 자세한 내용은 [카탈로그 함수의 인자](#d89bf0c13549af48)를 참조한다.
- **NameLength1:** [입력] *CatalogName 문자열의 길이이다.
...
<a id="b82f2d9dba706014"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="7bdd2d9eac53c966"></a>
#### 진단

<a id="35ba87ae5f7f2572"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
| HY117 | Connection is suspended due to unknown transaction state. Only disconnect and read-only functions are allowed. | 유예상태에 대한 자세한 내용은 [SQLEndTran](#db4564230de635ba)을 참조한다. |
...
<a id="5fa5f2ab7563c531"></a>
#### 설명

IdentifierType 인자가 SQL_BEST_ROWID인 경우, SQLSpecialColumns는 column 또는 테이블 각각의 row를 고유하게 구분할 수 있는 column을 반환한다. 이 column들은 select-list나 WHERE 절에 사용할 수 있다. SQLColumns는 테이블 column의 다양한 정보를 반환하지만, 트랜잭션이 row 값을 갱신할 때 자동으로 갱신되는 column이나 각 row를 고유하게 식별하는 column을 반환할 필요는 없다. 예를 들어, SQLColumns는 Oracle pseudo column인 ROWID는 반환하지 않는다. 이것이 SQLSpecialColumns가 특별한 column들의 정보 반환에 사용되는 이유이다. 자세한 내용은 [카탈로그 데이터의 사용](#5a0fa997a22b1179)을 참조한다.

> ODBC 카탈로그 함수의 일반적인 사용법, 인자, 반환 데이터에 대해 자세한 내용은 [카탈로그 함수](#10b0008e403a6130)를 참조한다.
...
SQL_ATTR_METADATA_ID 속성이 SQL_TRUE로 설정될 경우, CatalogName, SchemaName, TableName 인자는 식별자로 취급되어 NULL 포인터를 사용할 수 없게 된다. (자세한 내용은 [카탈로그 함수의 인자](#d89bf0c13549af48) 를 참조한다.)
...
다음 표는 결과 집합의 column을 나열한 것이다. Column 8 (PSEUDO_COLUMN) 이후 추가되는 column은 드라이버가 정의할 수 있다. 응용 프로그램은 드라이버에서 정의한 column에 접근하기 위해 명시적인 위치를 지정하는 대신 결과 집합의 뒤에서부터 순차적으로 카운트다운 해야한다. 자세한 내용은 [카탈로그 함수의 데이터 반환](#6b2db24bb80897ac)을 참조한다.

<a id="8244926bc24ca233"></a>
| Column 이름 | Column 번호 | 데이터 형식 | 설명 |
| --- | --- | --- | --- |
| SCOPE (ODBC 1.0) | 1 | Smallint | ROWID의 실제 범위이다. SQL_SCOPE_CURROW, SQL_SCOPE_TRANSACTION 또는 SQL_SCOPE_SESSION 값 중 하나를 포함한다. IdentifierType이 SQL_ROWVER이면 NULL을 반환한다. 각 값에 대한 자세한 내용은 [구문](#52bdc2d4a14be2ff)의 scope에 대한 설명을 참조한다. |
...
<a id="963f950aca63eeb6"></a>
### SQLStatistics

<a id="06b4560064be527e"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ISO 92

<a id="7772f17e79d76692"></a>
#### 개요

SQLStatistics 함수는 한 개의 테이블과 테이블에 관련된 인덱스에 대한 통계 목록을 검색한다. 드라이버는 결과 집합으로 결과를 반환한다.

<a id="60ede70b8fb33756"></a>
#### 구문
...
<a id="d1a47623bf036edb"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="54c8294c5f55d448"></a>
#### 진단

<a id="2064418dcd7be355"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
<a id="16d6ce50ec722d41"></a>
#### 설명

SQLStatistics는 단일 테이블 정보를 NON_UNIQUE, TYPE, INDEX_QUALIFIER, INDEX_NAME, ORDINAL_POSITION의 순서로 표준 결과 집합으로 반환한다. 결과 집합은 각각의 인덱스에 대한 정보와 테이블 통계정보 (결과 집합의 CARDINALITY와 PAGES row)를 결합한다. 이 정보가 어떻게 쓰이는 지에 대한 자세한 내용은 [카탈로그 데이터 사용](#5a0fa997a22b1179)을 참조한다.
...
다음 표는 결과 집합의 column을 나열한 것이다. Column 13 (FILTER_CONDITION) 이후에 추가되는 column은 드라이버가 정의할 수 있다. 응용 프로그램은 드라이버에서 정의한 column에 접근하기 위해 명시적인 위치를 지정하는 대신 결과 집합의 뒤에서부터 순차적으로 카운트다운 해야한다. 자세한 내용은 [카탈로그 함수의 데이터 반환](#6b2db24bb80897ac)을 참조한다.

<a id="23d927cce9318389"></a>
...
<a id="a102806845948097"></a>
### SQLTablePrivileges

<a id="da2b411a91b0405b"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: ODBC

<a id="6d7b835ec6cad483"></a>
#### 개요

SQLTablePrivileges는 테이블의 목록 및 각 테이블과 관련된 권한들을 반환한다. 드라이버는 명시된 구문에 결과 집합 형식의 정보를 반환한다.

<a id="c5302dfaf4df006c"></a>
#### 구문
...
<a id="3cd242d9d8de9e7b"></a>
#### 인자

- **StatementHandle:** [입력] 검색 결과에 대한 명령어 핸들이다.
- **CatalogName:** [입력] 테이블 카탈로그이다. 드라이버가 카탈로그를 지원하지 않을 경우 빈 문자열 ("")을 반환하며 그 테이블들은 카탈로그를 가지지 않는다. 카탈로그 이름은 문자열 검색 패턴을 포함할 수 없다.  
  SQL_ATTR_METADATA_ID를 SQL_TRUE로 설정할 경우, CatalogName은 식별자로 취급되고, 대소문자를 구분하지 않는다. 만약 SQL_FALSE로 설정할 경우, CatalogName은 통상의 인수 문자열로 취급되며, 대소문자를 구분한다. 자세한 내용은 [카탈로그 함수의 인자](#d89bf0c13549af48)를 참조한다.
...
<a id="396deb8592f15e1c"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="b9c2be926090f15d"></a>
#### 진단

<a id="555547e6f7b5298b"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
| 01000 | General warning | 드라이버별 정보 메시지이다. (함수는 SQL_SUCCESS_WITH_INFO를 반환한다.) |
| 08S01 | Communication link failure | 함수 처리가 완료되기 전에 드라이버와 데이터 소스 간의 연결에 실패했다. |
...
<a id="ea1682f315ea1918"></a>
#### 설명

SchemaName과 TableName 인자는 검색 패턴을 허용한다.   
유효한 검색 패턴에 대한 자세한 내용은 [패턴값 인자](#e8dd5cbd71ead4e3)를 참조한다.
...
<a id="b708a11a869a3d86"></a>
| ODBC 2.0 column | ODBC 3.x column |
| --- | --- |
| TABLE_QUALIFIER | TABLE_CAT |
| TABLE_OWNER | TABLE_SCHEM |

다음 표는 결과 집합의 column을 나열한 것이다. Column 7 (IS_GRANTABLE) 이후에 추가되는 column은 드라이버가 정의할 수 있다. 응용 프로그램은 드라이버에서 정의한 column에 접근하기 위해 명시적인 위치를 지정하는 대신 결과 집합의 뒤에서부터 순차적으로 카운트다운 해야한다. 자세한 내용은 [카탈로그 함수의 데이터 반환](#6b2db24bb80897ac)을 참조한다.

<a id="80262a61660ff2d6"></a>
| Column 이름 | Column 번호 | 데이터 타입 | 설명 |
| --- | --- | --- | --- |
...
<a id="c5e194e88c5c7677"></a>
### SQLTables

<a id="f8695530ac259c82"></a>
#### 적합성

도입된 버전: ODBC 1.0  
표준 준수: Open group

<a id="1ec435bfbb8fee02"></a>
#### 개요

SQLTables는 지정된 데이터 소스에 저장된 테이블의 목록, 카탈로그 또는 스키마 이름, 테이블 타입을 반환한다. 드라이버는 결과 집합으로 정보를 반환한다.

<a id="cfef1c553424a76d"></a>
#### 구문
...
- **CatalogName :** [입력] 카탈로그 이름이다. SQL_ODBC_VERSION 환경 속성이 SQL_OV_ODBC3이면, CatalogName 인자는 검색 패턴을 허용한다. 드라이버가 일부 테이블의 카탈로그만 지원하면, 예를 들어서 드라이버가 다른 DBMS로부터 데이터를 검색하는 경우, 빈 문자열 ("")은 카탈로그를 갖지 않는 테이블들을 나타낸다.  
  SQL_ATTR_METADATA_ID 명령문 속성이 SQL_TRUE로 설정된 경우, CatalogName은 식별자로 취급되고 대소문자를 구분하지 않는다. SQL_FALSE로 설정된 경우, CatalogName은 패턴값 인자이다. 즉 그것은 문자 그대로 처리되고, 대소문자를 구분한다. 자세한 내용은 [카탈로그 함수의 인자](#d89bf0c13549af48)를 참조한다.
...
<a id="21a211d2d5e1a543"></a>
#### 반환

SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR, SQL_INVALID_HANDLE

<a id="88aaf7a6f80b4dac"></a>
#### 진단

<a id="a492733eb4eb9e07"></a>
| SQLSTATE | Error | 설명 |
| --- | --- | --- |
...
SQLTables는 결과를 TABLE_TYPE, TABLE_CAT, TABLE_SCHE, TABLE_NAME의 순서로 표준 결과 집합으로 반환한다. 이 정보가 어떻게 사용되는지에 대한 자세한 내용은 [카탈로그 데이터 사용](#5a0fa997a22b1179)을 참조한다.
...
자세한 내용은 [카탈로그 함수의 데이터 반환](#6b2db24bb80897ac)을 참조한다.

<a id="2945658289078daf"></a>
| Column 이름 | Column 번호 | 데이터 타입 | 설명 |
| --- | --- | --- | --- |
...
<a id="a55f3f50a046a62b"></a>
### SQLTransact

<a id="e24f64a9694547a7"></a>
#### 적합성

도입된 버전: ODBC 1.0   
표준 준수: 없음

<a id="15abcb74ee649957"></a>
#### 개요

ODBC 2.x의 SQLTransact 함수는 ODBC 3.x에서 SQLEndTran 함수로 대체되었다.    
자세한 내용은 [SQLEndTran](#db4564230de635ba) 함수를 참조한다.

<a id="76e0d569c46dee9c"></a>
## XA API References

<a id="7827f009748b5202"></a>
### 개요
...
<a id="afaa3b52cf3e35cc"></a>
![](../assets/images/e52f15144c1f729c.png)
...
<a id="3e85d23d4bba1ead"></a>
#### XA 관련 ODBC 함수

표준 ODBC 외에 XA 인터페이스를 사용하기 위해서 추가된 함수를 설명한다.

<a id="98d59fcb7bac39a2"></a>
##### SQLGetXaSwitch
...
<a id="2c3de3b65ea13ff4"></a>
#### XA 함수

xa_switch_t 구조체의 XA 관련 함수들에 대한 자세한 내용을 기술한다.

<a id="169af8cdc95561b5"></a>
##### xa_open
...
- **xa_info :** [입력] 접속 정보를 포함하는 문자열이며, 최대 길이는 256 바이트이다. 자세한 내용은 [SQLDriverConnect](#2dedcce93dd1cd79)의 InConnectionString을 참조한다.
- **rmid :** [입력] 접속할 RM의 고유한 아이디이다. 해당 인자는 무시된다.
- **flags:** [입력] 접속 플래그이다. TMNOFLAGS로 설정되어야 한다.

- **진단:** 

<a id="90a708aed43ebe79"></a>
| 반환값 | 설명 |
| --- | --- |
