...
<a id="49ab3a21c0a34940"></a>
## Precompiler

<a id="f57359184bf97a0b"></a>
### 개요
...
gpec에 주어지는 옵션에 대한 자세한 내용은 [Precompiler Options](#25346805deec375e)을 참조한다.

<a id="1c8af72b79696198"></a>
##### Example
...
<a id="25346805deec375e"></a>
### Precompiler Options

본 절에서는 gpec의 option들을 설명한다.

<a id="b9a9b80597309d41"></a>
#### --no-prompt, -n

<a id="d505c0b6565b6cb2"></a>
##### 설명

Version 정보를 출력하지 않는다.

<a id="45bae6bb464c4ced"></a>
##### 사용 예
...
<a id="1eae63338774dfd4"></a>
#### --version, -v

<a id="8492c2c1bf62eff9"></a>
##### 설명

Version 정보만 출력하고 종료한다.

<a id="21143b12dc90392e"></a>
##### 사용 예
...
<a id="a332cd91a8f567fb"></a>
#### --help, -h

<a id="131298a44a7758fa"></a>
##### 설명

Help message를 출력한다. gpec에 아무런 option이나 &lt;input file&gt;을 주지 않을 때도 동일하게 동작한다.

<a id="3a2de414290c57f5"></a>
##### 사용 예
...
<a id="0d338086e8c2d322"></a>
#### --include-path, -I

<a id="7f4171cae0402e32"></a>
##### 설명
...
<a id="1268e87f4623cf8b"></a>
#### --no-lineinfo

<a id="c3f62f9a94d61583"></a>
##### 설명
...
<a id="343ac8efadf4bcb0"></a>
#### --char_map, -c

<a id="a06c832fb5699a79"></a>
##### 설명
...
<a id="8f2f39594276fdbb"></a>
#### --define, -D

<a id="e9816af76c164503"></a>
##### 설명

gpec에서 사용되는 define 이름으로써 1로 설정된다.

<a id="67dddc9f758f3a8a"></a>
##### 사용 예
...
<a id="ea8e01d688fa143b"></a>
#### --cumulative

<a id="2123571fa4aede24"></a>
##### 설명

FETCH CURSOR 구문에 대해서 sqlerrd[2]을 누적된 합으로 처리하도록 한다.

<a id="5b04fab0b6024594"></a>
##### 사용 예
...
<a id="ffbe288cfa93e194"></a>
#### --autocommit

<a id="73b8ccd1106d6ee5"></a>
##### 설명

모든 connection의 auto commit을 TRUE로 설정한다.

<a id="ecf2e727b8281038"></a>
##### 사용 예
...
<a id="e5309daff797b6e7"></a>
#### --parse

<a id="6e91f17e45246b8f"></a>
##### 설명
...
<a id="9a40ec13e74d51a8"></a>
## Embedded SQL

<a id="66302391512cc57a"></a>
### Preprocessing

<a id="21f5f6b84e6ab480"></a>
#### 개요
...
<a id="bb81d9187565fb09"></a>
#### 유형

parse 옵션이 partial로 설정된 경우 적용되는 전처리 유형은 다음과 같다.

<a id="4f5d00763e6eb6d0"></a>
##### #if
...
<a id="46e6fb4fecfcaa5a"></a>
#### 제약사항

<a id="cbb507529a09f906"></a>
##### 매크로 사용 위치 제약
...
<a id="2ee8ccd2a9c8f602"></a>
### 연결

<a id="7d7e6e8873ed5f20"></a>
#### Database 연결
...
GOLDILOCKS는 shared memory에 직접 attach하여 구동하는 D/A 모드와, TCP 통신을 사용하여 database에 접속하는 C/S 모드 둘 다 지원한다. D/A 모드로 동작할 때는 database의 동일한 호스트에서 직접 접근하게 되므로 위와 같이 별도의 서버 정보를 포함하지 않아도 사용할 수 있지만 C/S 모드로 동작하기를 원할 때는 Data Source Name (DSN)을 지정하여 접근하도록 해야 한다. DSN에 대한 자세한 내용은 [데이터 원본 구성](31-odbc.md#38509fa109f62339)을 참조한다.
...
Cursor 변수는 사용하기 전에 할당해야 한다. Cursor 변수를 선언한 후에 [ALLOCATE](#38007312d60435b0) 명령을 사용하여 이 작업을 수행한다. 다음은 위 예제의 alloc_cursor 함수에서 사용한 ret_cursor를 할당하는 예이다.

```
EXEC SQL ALLOCATE :ret_cursor;
```

Cursor 변수를 할당하면 run-time 도중에 메모리가 할당되기 때문에 [FREE](#2f5a7c72539e82ee) 명령을 통해 해제해야 한다. Cursor 변수가 할당될 때 생성된 메모리는 cursor가 닫힐 때 해제되지 않고 명시적으로 CLOSE 명령을 사용하거나 연결이 닫힐 때 해제된다.
...
<a id="0cc58fdfec60f8a1"></a>
#### Indicator Variable

<a id="47fee922196a4287"></a>
##### Scalar Indicator
...
<a id="f4fcd81de7ca1e5d"></a>
### Embedded SQL

<a id="54b16bc51bdb5b27"></a>
#### Host Variable
...
<a id="7730c7e0d00a6908"></a>
#### Basic SQL statement

Embedded SQL에서는 GOLDILOCKS에서 제공하는 모든 SQL 문을 사용할 수 있는데 SQL 문에 대한 자세한 내용은 [SQL Manual](../part-03-sql-manual/README.md#628893b28b986b28)을 참조한다. Embedded SQL에서 SQL 문을 사용할 때는 EXEC SQL 키워드 뒤에 SQL 문을 기술하는데 본 장에서는 Data Definition Language (DDL)이나 Data Manipulation Language (DML)에 대한 내용을 기술하고 query와 같이 반복적으로 data를 가져오는 구문에 대해서는 다음 장에서 설명한다.

SQL 문을 실행한 이후에는 SQLCA를 검사하여 실행한 SQL 문의 성공 여부를 판단할 수 있으며, 자세한 내용은 [Handling Run-time Error](#79b853d4c14a7002) 부분을 참조한다.

<a id="eb95125338ecfaa6"></a>
##### DDL Statement
...
이에 대한 자세한 내용은 [Embedded Dynamic SQL](#8a6b778c3ec6ed54)을 참조한다.

<a id="c286c73914db840d"></a>
##### Select Into Statement

GOLDILOCKS에서 data를 가져 오기 위해서 query를 사용한다. 일반적인 경우에는 해당 결과의 개수를 알지 못하는 경우가 많기 때문에, query를 사용하기 위해서는 cursor라는 객체를 선언하여 open, fetch, close라는 복잡한 과정을 거치게 된다. 이러한 과정의 실행 방식은 다음 [Cursors](#46667223f6d24a93) 부분에서 기술할 것이다.
...
> Host array를 사용하면 select into 구문을 사용하여 여러 개의 결과를 가져올 수 있다. Host array 사용법은 [Host Arrays](#d975123f69edaa5d)를 참조한다.

<a id="500040a9e777d3c3"></a>
##### Insert Statement
...
> Host array를 사용하면 한 번에 여러 개의 row를 삽입할 수 있다. 자세한 내용은 [Host Arrays](#d975123f69edaa5d)를 참조한다.

<a id="8932a19c911c8dd0"></a>
##### Update Statement
...
> Host array를 사용하면 한 번에 여러 개의 row를 갱신할 수 있다. 자세한 내용은 [Host Arrays](#d975123f69edaa5d)를 참조한다.

<a id="ebc8e53d078da8a2"></a>
##### Delete Statement
...
> Host array를 사용하면 한 번에 여러 개의 row를 삭제할 수 있다. 자세한 내용은 [Host Arrays](#d975123f69edaa5d)를 참조한다.

<a id="abbb47c6e45d6da7"></a>
##### PSM Statement

PSM 구문은 서버 내부에 procedure나 function을 만들어서 사용한다.  
PSM에 대한 자세한 내용은 [PSM Manual](../part-04-psm-manual/README.md#1552b9b5aeb1b468)을 참조한다.
...
커서를 open하면 선언된 커서의 질의를 수행한 결과 집합을 가져올 준비가 된다. 여기서는 실제로 결과를 가져오는 것은 아니기 때문에 실제 결과를 얻어오려면 [Fetch cursor](#0fe08b24fcb3df55)를 수행해야 한다.  
...
커서 정의 구문과 속성에 대한 자세한 내용은 [DECLARE cursor_name](../part-03-sql-manual/19-sql-references-c-g.md#f94895843614f7cc)을 참조한다.

<a id="ab3ac64e958ee4bd"></a>
##### Scrollable Cursor
...
Static cursor의 fetch 방법은 [Scrollable Cursor](#ab3ac64e958ee4bd)를 참조한다

<a id="63e13a903b7dbe03"></a>
...
Keyset driven 커서 역시 scroll 기능을 가지고 있으므로 fetch 방법은 [Scrollable Cursor](#ab3ac64e958ee4bd)를 참조한다.

<a id="a791fb7ea14e6c4c"></a>
#### Positioned DML
...
> 이 옵션은 precompiler의 command-line option을 통해서도 부여할 수 있다. 자세한 내용은 [Precompiler Options](#25346805deec375e)의 [--include-path, -I](#0d338086e8c2d322)를 참조한다.

<a id="d975123f69edaa5d"></a>
### Host Array
...
<a id="0305e83b59632347"></a>
#### Host Array 사용

<a id="b3fba6f2284fb4c8"></a>
##### Host Array 접근
...
<a id="955f5ae6155b0e18"></a>
##### SELECT INTO에서의 Array

가져와야 할 row의 개수를 정확히 알고 있을 경우에는 [Select Into Statement](#c286c73914db840d)를 사용하여 간단하게 구현할 수 있다. [Select Into Statement](#c286c73914db840d)에서는 결과가 없거나 한 개일 경우에 대해서만 언급하였지만 여기에 host array를 사용하면 다수의 row를 가져올 수 있다.
...
<a id="a54522b41b789845"></a>
##### Cursor 사용에서 Array

현재 질의에 대한 결과 집합 개수를 알 수 없는 경우에는 커서를 사용해야만 한다. 커서를 사용하는 방법은 [Cursor](#46667223f6d24a93) 부분을 참조한다. 커서를 선언한 이후에 FETCH 구문에서 INTO 절의 host 변수를 array로 사용하는 것만으로도 다수의 row를 한 번에 가져올 수 있다.
...
sqlca에 대한 자세한 내용은 [Handling Runtime Errors](#79b853d4c14a7002)를 참조한다.

<a id="a99b8272ffa6b95f"></a>
#### Insert 구문에서 Array
...
<a id="8f406801fd792d89"></a>
#### 구조체 Array

일반적인 scalar 변수들을 배열로 사용하면 한 번에 다수의 row를 처리할 수 있어 편리하지만 한 개의 변수당 한 개의 column만 표시할 수 있다는 한계가 있다. 한 개의 host 변수에서 다수의 column에 접근하려면 [Host structure](#c0930d2e276b3caa)를 사용하면 되는데 이렇게 host 변수를 구조체로 선언하여 그 구조체를 array로 사용하면 다수의 column을 갖는 다수의 row를 한 번에 처리할 수 있다.
...
<a id="d319e50b2c2d8174"></a>
##### 구조체 배열 Indicator

[Structure Indicator](#8706a80d484af487)에 기술된 것과 같이 host 변수가 구조체이면 indicator 변수도 구조체이어야 한다. 따라서 host 변수가 구조체 배열일 경우 indicator 변수도 대응하는 구조체 배열이어야 한다.
...
<a id="79b853d4c14a7002"></a>
### Handling Run-time Error

<a id="56636552df80b29b"></a>
#### 개요
...
<a id="4797d4db6b00dd46"></a>
#### Run-time Error 감지

<a id="91fe59b177c21cb4"></a>
##### SQLCA
...
GOLDILOCKS의 embedded SQL 응용 프로그램은 기본적으로 sqlca를 전역으로 가지고 있다. 따라서 single thread program에서는 별다른 선언 없이 sqlca를 사용할 수 있다. 그러나 multi thread program에서는 동시에 sqlca에 접근할 경우 동시성 문제가 발생하기 때문에 별도의 선언 방법을 가져야 한다. 이에 대한 내용은 [Multithread Applications](#5c0234e066cbb32e)에서 설명한다.

<a id="db9d294657d37d49"></a>
##### SQLCA 구조
...
fetch 구문에 한하여 sqlca.sqlerrd[2]의 값을 누적된 row 개수로 처리할 수 있다. 이와 관련된 자세한 내용은 gpec(Precompiler)의 옵션 [--cumulative](#ea8e01d688fa143b)을 참조한다.

<a id="f47aa62864680691"></a>
###### **처리된 Row의 상태**
...
<a id="2d6c5422ff357e48"></a>
## Advanced Topic

<a id="8a6b778c3ec6ed54"></a>
### Embedded Dynamic SQL

<a id="40bde12497911420"></a>
#### 개요
...
Cursor로부터 fetch한다. Dynamic cursor의 fetch는 [Standing cursor의 Fetch](#0fe08b24fcb3df55)와 동일하다.

- Close cursor

Cursor를 close한다. Dynamic cursor의 close는 [Standing cursor의 Close](#b591e678249b50e7)와 동일하다.

<a id="57b2bba64c05273e"></a>
#### Example Program
...
<a id="d5efd54a0545eb49"></a>
![D/A 모드에서 각 thread가 각자의 connection을 가지는 경우](../assets/images/71467e1fee292a31.png)

<a id="a8dc67feb44fdb98"></a>
...
<a id="d301a4ab5be4e99b"></a>
![다수의 thread가 한 개의 connection을 공유하는 경우](../assets/images/6ee2bc3787b95caf.png)

<a id="2e0ec28982a18638"></a>
![한 개의 thread가 다수의 connection을 갖는 경우](../assets/images/57b7ab0e3b7d797c.png)

<a id="c19c2b91d255ba2a"></a>
#### Guideline
...
<a id="e19de0a31bef2506"></a>
### C++ Application

<a id="0ef91612b00efa8b"></a>
...
<a id="3c38c8aec489220c"></a>
### XA

<a id="fcbb9cdc6ad136e3"></a>
#### xa_open string 정의

xa_open string은 Resource Manager (RM)에 접속하기 위한 정보를 포함하고 있는데 자세한 내용은 [SQLDriverConnect 인자설명](31-odbc.md#473477ef611cf227)을 참조한다.
...
<a id="38007312d60435b0"></a>
### EXEC SQL ALLOCATE

<a id="b4aaae835b424534"></a>
#### 기능

Embedded SQL에서 cursor 변수를 할당한다.

<a id="4c4ae2f4256c1bf4"></a>
#### 구문
...
<a id="16fc526d170075ed"></a>
### EXEC SQL AT

<a id="18dc5c041deac951"></a>
#### 기능

Embedded SQL 문에 적용할 connection 이름을 지정한다.

<a id="fa91545506789dd3"></a>
#### 구문
...
<a id="0bea8bd37ff00136"></a>
#### 참조

관련 내용은 [연결](#2ee8ccd2a9c8f602)을 참조한다.

<a id="a9de960da03be389"></a>
### EXEC SQL ATOMIC INSERT

<a id="281ff8706b40a598"></a>
#### 기능

Atomic array insert를 수행한다.

<a id="9984df9134ea9cb1"></a>
#### 구문
...
<a id="cc0da1fa37d58824"></a>
#### 참조

관련 내용은 [Atomic Insert](#fdf4d7a232095230)를 참조한다.

<a id="d3f6049ad975e38d"></a>
### EXEC SQL AUTOCOMMIT

<a id="496657d4b1af7cd0"></a>
#### 기능

Autocommit 설정을 변경한다.

<a id="4378fee03eced5ab"></a>
#### 구문
...
<a id="b4d278adeb0ec8d4"></a>
#### 참조

관련 내용은 [Auto Commit](#3cde21d6cf6e3cae)을 참조한다.

<a id="e895e421348685d7"></a>
### EXEC SQL BEGIN DECLARE SECTION

<a id="2125e0db99b3b513"></a>
#### 기능

Precompiler의 지시자로써 host variable 선언 영역을 지정한다.

<a id="f6e74853d63d967c"></a>
#### 구문
...
<a id="ca77882d4518eba9"></a>
#### 참조

관련 내용은 다음을 참조한다.

- [Host Variable의 선언](#2257080661c3669f)
- [EXEC SQL END DECLARE SECTION](#763f8b0ec8c89ec6)

<a id="9300204d7f1e6851"></a>
### EXEC SQL COMMIT RELEASE

<a id="e6cdbf29304dec0c"></a>
#### 기능

트랜잭션을 완료한 후에 connection을 종료한다.

<a id="abdda1b7216bb9b9"></a>
#### 구문
...
<a id="b1551d5688c1dfac"></a>
#### 참조

관련 내용은 [RELEASE Option](#95c5d16d35da339d)을 참조한다.

<a id="c7073a95781a7220"></a>
### EXEC SQL CONNECT

<a id="5ebd577e053c8648"></a>
#### 기능

GOLDILOCKS와 connection을 맺는다.

<a id="e8b762df4cc97e2c"></a>
#### 구문
...
<a id="c01a26af4c15ca7e"></a>
#### 설명

GOLDILOCKS에 연결을 설정한다.

<a id="a5c06599aba30ba6"></a>
#### 사용 예
...
<a id="0a1c617c98385626"></a>
#### 참조

관련 내용은 [Database 연결](#7d7e6e8873ed5f20)을 참조한다.

<a id="de510b45a1eada72"></a>
### EXEC SQL CONTEXT ALLOCATE

<a id="66ee0c1f0c915a8c"></a>
#### 기능

Run-time context 메모리를 할당한다.

<a id="1733c9943bbda594"></a>
#### 구문
...
<a id="020126e2e58557a5"></a>
#### 참조

관련 내용은 [SQL_CONTEXT](#53aad248a71f00a6)를 참조한다.

<a id="aaf16fee78efacd2"></a>
### EXEC SQL CONTEXT FREE

<a id="d4923452cd6c73be"></a>
#### 기능

Run-time context 메모리를 해제한다.

<a id="11280e4721c5a1be"></a>
#### 구문
...
<a id="2cea78c48ee6812e"></a>
#### 참조

관련 내용은 [SQL_CONTEXT](#53aad248a71f00a6)를 참조한다.

<a id="8c814759c634376b"></a>
### EXEC SQL CONTEXT USE

<a id="43c1bdb2143232ed"></a>
#### 기능

Run-time context 사용을 알린다.

<a id="8774128ec5d59cfb"></a>
#### 구문
...
<a id="44d31d4a4772a5a2"></a>
#### 참조

관련 내용은 [SQL_CONTEXT](#53aad248a71f00a6)를 참조한다.

<a id="7419a294c92ffc77"></a>
### EXEC SQL DISCONNECT

<a id="7deb117669ba9866"></a>
#### 기능

GOLDILOCKS와의 connection을 종료한다.

<a id="c23bf5db932797d8"></a>
#### 구문
...
<a id="6228c0dafaa27cb2"></a>
#### 참조

관련 내용은 [Database 연결 해제](#aa820a2304cfd66d)를 참조한다.

<a id="763f8b0ec8c89ec6"></a>
### EXEC SQL END DECLARE SECTION

<a id="3b0b82e6cf37f909"></a>
#### 기능

Precompiler 지시자로써 host variable 선언 영역을 지정한다.

<a id="76451f5ff0f5b99d"></a>
#### 구문
...
<a id="4afe2ff74dc3b7e6"></a>
#### 참조

관련 내용은 다음을 참조한다.

- [Host Variable의 선언](#2257080661c3669f)
- [EXEC SQL BEGIN DECLARE SECTION](#e895e421348685d7)

<a id="748f1de4da8abd3e"></a>
### EXEC SQL FOR

<a id="629c1fd01919e68a"></a>
#### 기능

Array operation에서 array 개수를 지정한다.

<a id="6fb5d0a277170df6"></a>
#### 구문
...
<a id="e126306e14f231f4"></a>
#### 참조

관련 내용은 [FOR 절 사용](#91e9dd68987eb237)을 참조한다.

<a id="2f5a7c72539e82ee"></a>
### EXEC SQL FREE

<a id="9b5f97767dc4f00c"></a>
#### 기능

Embedded SQL에서 cursor 변수를 해제한다.

<a id="c220616778664d37"></a>
#### 구문
...
<a id="91d1835b8ef9b4a5"></a>
### EXEC SQL GET GROUPID INTO

<a id="b23de01df2088c00"></a>
#### 기능

SQL statement의 group ID를 얻는다.

<a id="9cf50ddcb803304b"></a>
#### 구문
...
<a id="b38e1d1d6fac724f"></a>
### EXEC SQL INCLUDE

<a id="9804fc69e87e2823"></a>
#### 기능

Embedded SQL header file을 포함시킨다.

<a id="1ab4a645b24ac796"></a>
#### 구문
...
<a id="8603af9314638cf2"></a>
#### 참조

관련 내용은 [Precompiled Header File](#3a332872fecd2d66)을 참조한다.

<a id="7569a4ec0fe27375"></a>
### EXEC SQL INCLUDE SQLCA

<a id="da1c7888a2a1cd83"></a>
#### 기능

*sqlca.h* header file을 포함시킨다.

<a id="fa6046a7727c396d"></a>
#### 구문
...
<a id="630d04a46c42e1d4"></a>
#### 참조

관련 내용은 [Run-time Error 감지](#4797d4db6b00dd46)를 참조한다.

<a id="4efa4663a861235f"></a>
### EXEC SQL OPTION

<a id="c1dd6f4b72cec8f9"></a>
#### 기능

Embedded SQL 소스 코드를 precompile 하는 과정에서 option을 적용한다.

<a id="d3d42100e8e785c7"></a>
#### 구문
...
<a id="9b59e41e4ed4c467"></a>
#### 참조

관련 내용은 [Header File 경로 지정](#4ade33e7da1bab14)을 참조한다.

<a id="dfd8d82be5dacb43"></a>
### EXEC SQL ROLLBACK RELEASE

<a id="8b4fac7fa9ea9a0f"></a>
#### 기능

트랜잭션을 rollback 한 후에 현재 connection을 종료한다.

<a id="a198134b2e5ae436"></a>
#### 구문
...
<a id="72835294f4641885"></a>
#### 참조

관련 내용은 [RELEASE Option](#95c5d16d35da339d)을 참조한다.

<a id="7327c5457441535f"></a>
### EXEC SQL WHENEVER

<a id="ed27a5c924415108"></a>
#### 기능

Embedded SQL 응용 프로그램에서 run-time exception handling을 실행한다.

<a id="3bb4157f2fdeaa7d"></a>
#### 구문
...
<a id="356b00c1bf7eb2e4"></a>
#### 설명

Embedded SQL 응용 프로그램에서 run-time exception handling을 자동화하여 처리한다. 네 가지 condition이 있고 condition마다 한 개의 action을 지정할 수 있는데 이 action은 필요에 따라 다시 지정할 수도 있다. 자세한 사항은 [Handling Implicit Error](#7e105e5fa5d4ece9)를 참조한다.

<a id="a1e1279148142a39"></a>
#### 사용 예
...
<a id="728e36b5a7193e1d"></a>
#### 참조

관련 내용은 [Handling Implicit Error](#7e105e5fa5d4ece9)를 참조한다.
