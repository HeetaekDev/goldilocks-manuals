<a id="62e118512d69c410"></a>

# 26. Using SQLs in PSM

> 원본: [GOLDILOCKS 22c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/22c_1/manual/ko/62e118512d69c410)  
> 태그: `22c.1_10_tag`

[← 25. Using PSM Subprograms](25-using-psm-subprograms.md) · [전체 목차](../README.md) · [27. PSM Packages →](27-psm-packages.md)

<a id="6aab5074f55de98e"></a>
## Static SQLs

<a id="1e04f804ab371105"></a>
### 개요
...
- SELECT INTO Statement
    - 자세한 내용은 PSM Language Element References의 [SELECT INTO Statement](28-psm-language-element-references.md#d790084581eca95a)를 참조한다.
- Data Manipulation Language( DML )
    - INSERT Statement Extension
        - 자세한 내용은 PSM Language Element References의 [INSERT Statement Extension](28-psm-language-element-references.md#f9fbc266581bb1f6)를 참조한다.
    - INSERT INTO ... UPDATE Statement Extension
        - 자세한 내용은 PSM Language Element References의 [INSERT INTO ... UPDATE Statement Extension](28-psm-language-element-references.md#bdd5b4ce584ed976)를 참조한다.
    - UPDATE Statement Extension
        - 자세한 내용은 PSM Language Element References의 [UPDATE Statement Extension](28-psm-language-element-references.md#e8c6244dda7d9d79)를 참조한다.
    - DELETE Statement Extension
        - 자세한 내용은 PSM Language Element References의 [DELETE Statement Extension](28-psm-language-element-references.md#4f4e2bad79373eab)를 참조한다.
- Transaction Control Language
    - COMMIT
        - 자세한 내용은 SQL References의 [COMMIT](../part-03-sql-manual/19-sql-references-c-g.md#584ccbb69a281847)을 참조한다.
    - ROLLBACK
        - 자세한 내용은 SQL References의 [ROLLBACK](../part-03-sql-manual/20-sql-references-h-z.md#6ca73e32555cc74b)을 참조한다.
    - SAVEPOINT
        - 자세한 내용은 SQL References의 [SAVEPOINT savepoint_specifier](../part-03-sql-manual/20-sql-references-h-z.md#e01fdff113a62fc1)를 참조한다.
    - LOCK TABLE
        - 자세한 내용은 SQL References의 [LOCK TABLE](../part-03-sql-manual/20-sql-references-h-z.md#4146c53ea59a538c)을 참조한다.

<a id="f6369bb5fdd03f77"></a>
#### 사용 예
...
자세한 사항은 [Explicit Cursor](24-psm-cursor-statements.md#343c3f287fc9d6d7)를 참조한다.

<a id="c7b87f0b08fc3f04"></a>
## Dynamic SQL
...
- Dynamic SQL은 다음과 같은 PSM statement에서 사용할 수 있다.
    - [EXECUTE IMMEDIATE Statement](28-psm-language-element-references.md#698879b5ba0a0056) 
    - [OPEN FOR Statement](28-psm-language-element-references.md#a04f79d8641839a1)

<a id="433f7d988427f634"></a>
### EXECUTE IMMEDIATE
...
자세한 내용은 [EXECUTE IMMEDIATE Statement](28-psm-language-element-references.md#698879b5ba0a0056)를 참조한다.

<a id="30724fdb0613bab7"></a>
...
자세한 내용은 [OPEN FOR Statement](28-psm-language-element-references.md#a04f79d8641839a1), [FETCH Statement](28-psm-language-element-references.md#31aa8d8b5c8ba1f0), [CLOSE Statement](28-psm-language-element-references.md#5dd511f3fe54ad01)를 참조한다.
