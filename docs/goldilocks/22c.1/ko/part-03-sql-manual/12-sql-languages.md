...
<a id="6745f166e8e4bf6e"></a>
## Data Definition Language

<a id="169450e94672074b"></a>
### DDL 관련 구문

관련 내용은 다음을 참조한다.

- Non-schema object DDL
    - [데이터베이스 관련 구문](13-sql-objects.md#75d0ca9e298fcb1d)
    - [Profile 관련 구문](13-sql-objects.md#071f67ff2cbe8674)
    - [Audit Policy 관련 구문](13-sql-objects.md#aa0fb96d61051db0)
    - [Authorization 관련 구문](13-sql-objects.md#6361f3f00f52080d)
    - [Schema 관련 구문](13-sql-objects.md#8ba9a9e3d1b9632e)
    - [Tablespace 관련 구문](13-sql-objects.md#a161d1fe41ff2b5b)

- SQL schema object DDL
    - [테이블 관련 구문](13-sql-objects.md#d613156fbdf424d6)
    - [Index 관련 구문](13-sql-objects.md#352306fc4b6c90bb)
    - [View 관련 구문](13-sql-objects.md#929245e5eea01fd5)
    - [Sequence 관련 구문](13-sql-objects.md#42c9466e644694e5)
    - [Synonym 관련 구문](13-sql-objects.md#7e5cd65576ab98f7)

- Cluster object DDL
    - [Cluster System 관련 구문](14-cluster-objects.md#9e7d0c729d41fab8)
    - [Cluster Group 관련 구문](14-cluster-objects.md#e487ead27d549e47)
    - [Cluster Member 관련 구문](14-cluster-objects.md#a0af1f81bf639f65)
    - [Cluster Location 관련 구문](14-cluster-objects.md#999b8435839685cd)
    - [Global Secondary Index 관련 구문](14-cluster-objects.md#2d7665a6fb8a11a5)

<a id="8e4969dc9851d3d4"></a>
### DDL 개념
...
객체</div></td><td class="to_middle"><div>Profile</div></td><td class="to_middle"><div>Password 관리 정책을 정의한 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#1bcca84e94f8a0c0">Profile</a></div></td></tr><tr><td class="to_middle"><div>Audit policy</div></td><td class="to_middle"><div>SQL 감사 정책을 정의한 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#d8c3854f3ea9b8c0">Audit Policy</a></div></td></tr><tr><td class="to_middle"><div>User</div></td><td class="to_middle"><div>권한의 집합으로 이루어진 사용자 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#23c1808f66da9107">Authorization</a></div></td></tr><tr><td class="to_middle"><div>Schema</div></td><td class="to_middle"><div>테이블 등 SQL schema 객체를 포함하는 논리적 위치</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#5de18556b770398e">Schema</a></div></td></tr><tr><td class="to_middle"><div>Tablespace</div></td><td class="to_middle"><div>테이블, 인덱스 등의 객체를 저장하는 물리적 저장소</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#bc6eba443a6fe39c">Tablespace</a></div></td></tr><tr><td class="to_middle"><div>Public synonym</div></td><td class="to_middle"><div>공용 synonym</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#2815d401e1b398c0">Public Synonym</a></div></td></tr><tr><td class="to_left to_middle" rowspan="7"><div>SQL schema 
객체</div></td><td class="to_middle"><div>Table</div></td><td class="to_middle"><div>데이터가 저장되는 물리적 릴레이션</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#9270fac263dbfd2d">Table</a></div></td></tr><tr><td class="to_middle"><div>View</div></td><td class="to_middle"><div>질의로 구성된 논리적 릴레이션</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#7f054e00a97199ba">View</a></div></td></tr><tr><td class="to_middle"><div>Index</div></td><td class="to_middle"><div>질의 성능을 향상시키기 위한 색인 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#4e953a94e88faf38">Index</a></div></td></tr><tr><td class="to_middle"><div>Sequence</div></td><td class="to_middle"><div>순차 번호를 생성하는 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#e70fa754bef606b9">Sequence</a></div></td></tr><tr><td class="to_middle"><div>Synonym</div></td><td class="to_middle"><div>객체에 대한 대체명을 선언한 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#3cd367663dd2630b">Synonym</a></div></td></tr><tr><td class="to_middle"><div>Stored procedure</div></td><td class="to_middle"><div>사용자 정의 procedure 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#5815544185fd0457">Stored Procedure</a></div></td></tr><tr><td class="to_middle"><div>Stored function</div></td><td class="to_middle"><div>사용자 정의 function 객체</div></td><td class="to_middle"><div><a class="reference text" href="13-sql-objects.md#aaae4341578724f4">Stored Function</a></div></td></tr><tr><td class="to_left to_middle" rowspan="5"><div>Cluster 
객체</div></td><td class="to_middle"><div>Cluster group</div></td><td class="to_middle"><div>Cluster member의 집합</div></td><td class="to_middle"><div><a class="reference text" href="14-cluster-objects.md#2f360e3996df0025">Cluster Group</a></div></td></tr><tr><td class="to_middle"><div>Cluster member</div></td><td class="to_middle"><div>Cluster system을 구성하는 data server</div></td><td class="to_middle"><div><a class="reference text" href="14-cluster-objects.md#9b240ad087c10223">Cluster Member</a></div></td></tr><tr><td class="to_middle"><div>Cluster location</div></td><td class="to_middle"><div>Cluster member의 위치 정보 객체</div></td><td class="to_middle"><div><a class="reference text" href="14-cluster-objects.md#80f54c845ec74546">Cluster Location</a></div></td></tr><tr><td class="to_middle"><div>Shard</div></td><td class="to_middle"><div>Cluster table을 수평으로 분할한 row들의 집합</div></td><td class="to_middle"><div><a class="reference text" href="14-cluster-objects.md#12dec8f0c006d72b">Cluster Table과 Shard</a></div></td></tr><tr><td class="to_middle"><div>Global secondary
index</div></td><td class="to_middle"><div>Cluster의 row 식별자를 위한 색인</div></td><td class="to_middle"><div><a class="reference text" href="14-cluster-objects.md#de47ce26ba7a870d">Global Secondary Index</a></div></td></tr></tbody></table>

<a id="daa8c4cc1b19463c"></a>
### DDL과 트랜잭션
...
DDL 구문의 속성이 auto-commit인 경우, 구문을 수행할 때 자동으로 commit을 수행하며 auto-commit 이 아닌 경우에는 구문을 수행한 후에도 트랜잭션을 rollback 할 수 있다. DDL의 auto-commit 여부는 [V$SQL_COMMAND](../part-02-administration-manual/9-database-information.md#476cd60a8e253b43) view를 사용하여 다음과 같이 조회할 수 있다.
...
<a id="39d94142e5b88fcf"></a>
## Data Manipulation Language

<a id="d0fdafad0c06ad9c"></a>
### DML 관련 구문

관련 내용은 다음을 참조한다.

- INSERT 관련 구문
    - [INSERT INTO](20-sql-references-h-z.md#f4243f3f6804b1d1)
    - [INSERT INTO name RETURNING](20-sql-references-h-z.md#fa1c045c9265d800)
    - [INSERT INTO name RETURNING .. INTO](20-sql-references-h-z.md#1aa03bfe5a515887)

- UPDATE 관련 구문
    - [UPDATE](20-sql-references-h-z.md#abc2bb1bde84db44)
    - [UPDATE name RETURNING](20-sql-references-h-z.md#454971ec810f0e4a)
    - [UPDATE name RETURNING .. INTO](20-sql-references-h-z.md#b858394cda16a8dc)
    - [UPDATE name WHERE CURRENT OF cursor_name](20-sql-references-h-z.md#8f0ce6ab5d0f07b3)

- DELETE 관련 구문
    - [DELETE FROM](19-sql-references-c-g.md#7f39572a92faf235)
...
<a id="2404d92c11bdc354"></a>
### DML 개념

Data Manipulation Language (DML)는 추가 (INSERT), 삭제 (DELETE), 갱신 (UPDATE)과 같이 테이블 데이터를 조작하거나 질의하는 SQL 언어이다.

질의에 대해서는 [Data Query Language](#0cf16f5d957903e5) 장에서 다루며, 본 장에서는 데이터를 변경하는 DML 구문만 다룬다.
...
위의 예와 같이 [DECLARE cursor_name](19-sql-references-c-g.md#f94895843614f7cc) 구문을 이용하여 FOR UPDATE 커서를 선언하고 [OPEN cursor_name](20-sql-references-h-z.md#afdd7cb54cc78da0) 구문을 이용하여 해당 커서를 연다. [FETCH cursor_name](19-sql-references-c-g.md#47babe65e4397c2a) 구문을 이용해 커서를 원하는 위치로 이동시키고 [DELETE FROM name WHERE CURRENT OF cursor_name](19-sql-references-c-g.md#cdf1bbc13ec2cca1) 구문을 이용하여 해당 위치의 row를 삭제하거나 [UPDATE name WHERE CURRENT OF cursor_name](20-sql-references-h-z.md#8f0ce6ab5d0f07b3) 구문을 이용하여 row를 갱신할 수 있다.

FOR UPDATE 커서는 [CLOSE cursor_name](19-sql-references-c-g.md#b130e0aa9376fe9d) 구문을 이용하여 닫거나 commit을 수행할 때 트랜잭션 종료와 함께 닫힌다.

<a id="fe8705e2acbed81f"></a>
### DML Query
...
다음은 [INSERT INTO name RETURNING](20-sql-references-h-z.md#fa1c045c9265d800) 구문을 이용하여 데이터를 추가하고 해당 결과를 조회하는 예이다. 다음 예와 같이 SYSDATE 함수를 통해 입력된 join_date 값을 하나의 구문으로 조회할 수 있다.
...
다음은 [DELETE FROM name RETURNING](19-sql-references-c-g.md#a590c1dc7a8fa0b1) 구문을 이용하여 데이터를 삭제하고 삭제된 row를 조회하는 예이다. RETURNING 절에 연산을 사용하여 데이터를 가공할 수 있다.
...
다음은 [UPDATE name RETURNING](20-sql-references-h-z.md#454971ec810f0e4a) 구문을 이용하여 갱신된 row 값을 기준으로 조회하는 예이다. OLD 절을 이용할 경우 변경되기 이전의 값을 조회할 수 있다.
...
DML에 사용하는 RETURNING 절은 SELECT query와 마찬가지로 다수의 질의 결과를 조회할 수 있는 반면에 row 하나에 대해서만 DML을 수행할 경우에는 RETURNING INTO 절을 이용하여 호스트 변수 값을 얻어올 수 있다. 이 경우, [SELECT .. INTO](20-sql-references-h-z.md#a2e4ae21f0050887) 구문과 마찬가지로 갱신된 row의 개수가 한 건 이하여야 한다.
...
<a id="0cf16f5d957903e5"></a>
## Data Query Language

<a id="e19ad3bf68ee0e27"></a>
### Query 관련 구문
...
SELECT 키워드와 FROM 키워드 사이에는 &lt;select list&gt; 이외에 &lt;hint clause&gt;와 &lt;set quantifier&gt;가 올 수 있다. [SQL Hint](15-sql-tuning.md#fc621439f343c8bd)는 query 실행 계획을 사용자가 직접 제어하는 구문이다. &lt;set quantifier&gt;는 결과로 반환되는 row들간에 중복되는 데이터를 제거하는 구문으로써 자세한 내용은 [query specification](20-sql-references-h-z.md#4f8a1890773e5aad) 절을 참조한다.
...
SET 연산자에 대한 자세한 내용은 [set operator](20-sql-references-h-z.md#b7c70208318c5c56) 절을 참조한다.

<a id="a41a6aac4ca9dc9e"></a>
...
자세한 내용은 [&lt;search clause&gt;](20-sql-references-h-z.md#839c746976247edc)를 참조한다.
...
조인 연산에 대한 자세한 내용은 [joined table](20-sql-references-h-z.md#8e57f6f9b3e343ab) 절을 참조한다.

<a id="41297ea794dca3bc"></a>
...
Recursive CTE를 이용하여 계층 질의를 표현할 수 있다. 자세한 내용은 [recursive CTE](#0b875876937c57c9)을 참조한다.
...
&lt;connect by&gt;에 기술된 expression 중에 PRIOR 연산자의 인자로 사용된 모든 expression들은 현재 계층에 대한 결과로 구성된다. 결과로 구성되는 expression들만 cycle 발생 여부를 확인하기 위한 대상으로 사용된다. 이렇게 구성된 결과들은 [&lt;hierarchy expression&gt;](20-sql-references-h-z.md#bd62ecc2acfd0bfd)을 통해 참조할 수 있다.
...
<a id="addac58e25573af1"></a>
![](../assets/images/ca5d40fdface374d.png)
...
그룹에 대한 자세한 내용은 [group by clause](20-sql-references-h-z.md#509ede962c0d47cc) 절을 참조한다.

<a id="0bc598b9ee2cdeb0"></a>
### Window Query
...
Window 정의에 대한 자세한 내용은 [window clause](20-sql-references-h-z.md#9676d213f7da2ef0)를 참조한다.
...
&lt;window frame clause&gt; 에 대한 자세한 내용은 [&lt;window frame clause&gt;](20-sql-references-h-z.md#b3db349fe7f94d8b)를 참조한다.
...
관련 내용은 [Window Function](11-sql-elements.md#93c30dc4e927cb60)과 [window clause](20-sql-references-h-z.md#9676d213f7da2ef0)를 참조한다.

<a id="02c4c57e321a01fc"></a>
### 결과 집합 정렬 (order by)
...
정렬에 대한 자세한 내용은 [order by clause](20-sql-references-h-z.md#d399c5a88158a3ad) 절을 참조한다.

<a id="65d86e7dd01a55b1"></a>
### 부질의 (Subquery)
...
자세한 내용은 nested subquery의 unnest에 대한 [SQL Hint](15-sql-tuning.md#fc621439f343c8bd) 절을 참조한다.
...
부질의에 대한 자세한 내용은 [subquery](20-sql-references-h-z.md#171bd6accfaee746) 절을 참조한다.

<a id="ff8b207f83b8f7f8"></a>
## Control Language

<a id="3ca18c43c41d7a43"></a>
...
- Transaction control 관련 구문
    ...
    - [LOCK TABLE](20-sql-references-h-z.md#4146c53ea59a538c)
    - [SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#e01fdff113a62fc1)
    - [RELEASE SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#d7c3b6530acb0403)

- Session control 관련 구문
    - [ALTER SESSION SET property_name](18-sql-references-a-b.md#4923f8bcbf518f9e)
    - [SET SESSION AUTHORIZATION user_identifier](20-sql-references-h-z.md#63397f0e3cc2c1c4)
    - [SET SESSION CHARACTERISTICS AS transaction_mode](20-sql-references-h-z.md#300d67c27b128f80)
    - [SET TIME ZONE](20-sql-references-h-z.md#d8103bbe8fd39ba1)
    - [SET TRANSACTION transaction_mode](20-sql-references-h-z.md#820f143ead68fee0)

- System control 관련 구문
    - [ALTER SYSTEM CHECKPOINT](18-sql-references-a-b.md#a8b0bfb6c2dcbf1a)
    - [ALTER SYSTEM {MOUNT | OPEN} DATABASE](18-sql-references-a-b.md#02b4e61c7b426491)
    - [ALTER SYSTEM [KILL | DISCONNECT] SESSION](18-sql-references-a-b.md#9c45cb464b6ff803)
    - [ALTER SYSTEM SET property_name](18-sql-references-a-b.md#677a2c760cc67fbc)
    - [ALTER SYSTEM RESET property_name](18-sql-references-a-b.md#08c8f4e9776944d0)
    - [ALTER SYSTEM SWITCH LOGFILE](18-sql-references-a-b.md#52da9ec67518ca8f)

<a id="e314521e17b6e648"></a>
### Transaction Control
...
<a id="b2e5a843d509a9ed"></a>
| 구문 | 설명 | 참조 |
| --- | --- | --- |
| COMMIT | 트랜잭션 정상 종료 | [COMMIT](19-sql-references-c-g.md#584ccbb69a281847) |
| ROLLBACK | 트랜잭션 철회 | [ROLLBACK](20-sql-references-h-z.md#6ca73e32555cc74b) |
| SAVEPOINT | 저장점 생성 | [SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#e01fdff113a62fc1) |
| RELEASE SAVEPOINT | 저장점 제거 | [RELEASE SAVEPOINT savepoint_specifier](20-sql-references-h-z.md#d7c3b6530acb0403) |
| LOCK TABLE | Table-level lock 설정 | [LOCK TABLE](20-sql-references-h-z.md#4146c53ea59a538c) |
| SET TRANSACTION | 트랜잭션 속성 제어  (읽기/ 쓰기, isolation level) | [SET TRANSACTION transaction_mode](20-sql-references-h-z.md#820f143ead68fee0) |
| SET CONSTRAINTS | 지연가능한 제약 조건의 검사시점 제어 | [SET CONSTRAINTS](20-sql-references-h-z.md#b39019fd3808ec13) |
...
<a id="98cb6d9c3c894e16"></a>
| 구문 | 설명 | 참조 |
| --- | --- | --- |
| SET SESSION CHARACTERISTICS | 세션 내의 트랜잭션 속성을 제어한다. | [SET SESSION CHARACTERISTICS AS transaction_mode](20-sql-references-h-z.md#300d67c27b128f80) |
| SET TIME ZONE | 세션 time zone을 변경한다. | [SET TIME ZONE](20-sql-references-h-z.md#d8103bbe8fd39ba1) |
| SET SESSION AUTHORIZATION | 세션 사용자를 변경한다. | [SET SESSION AUTHORIZATION user_identifier](20-sql-references-h-z.md#63397f0e3cc2c1c4) |
| SET SCHEMA | 세션 schema를 변경한다. | [SET SCHEMA schema_name](20-sql-references-h-z.md#42a64b921c216d5c) |
| ALTER SESSION SET | 세션 프로퍼티 값을 변경한다. | [ALTER SESSION SET property_name](18-sql-references-a-b.md#4923f8bcbf518f9e) |
...
<a id="1026d03717a419b7"></a>
| 구문 | 설명 | 참조 |
| --- | --- | --- |
| ALTER SYSTEM {OPEN\|MOUNT} DATABASE | 데이터베이스를 구동한다. | [ALTER SYSTEM {MOUNT \| OPEN} DATABASE](18-sql-references-a-b.md#02b4e61c7b426491) |
| ALTER SYSTEM CHECKPOINT | 체크포인트를 수행한다. | [ALTER SYSTEM CHECKPOINT](18-sql-references-a-b.md#a8b0bfb6c2dcbf1a) |
| ALTER SYSTEM KILL SESSION | 특정 세션을 강제로 종료한다. | [ALTER SYSTEM [KILL \| DISCONNECT] SESSION](18-sql-references-a-b.md#9c45cb464b6ff803) |
| ALTER SYSTEM SWITCH LOGFILE | 로그 파일을 전환한다. | [ALTER SYSTEM SWITCH LOGFILE](18-sql-references-a-b.md#52da9ec67518ca8f) |
| ALTER SYSTEM SET | 시스템 프로퍼티를 설정한다. | [ALTER SYSTEM SET property_name](18-sql-references-a-b.md#677a2c760cc67fbc) |
| ALTER SYSTEM RESET | 시스템 프로퍼티를 제거한다. | [ALTER SYSTEM RESET property_name](18-sql-references-a-b.md#08c8f4e9776944d0) |
...
<a id="418525612042711a"></a>
## Cluster의 SQL 처리

본 장에서는 cluster 환경에서의 다양한 SQL 구문의 처리 과정에 대해 설명한다.

<a id="284f96e2eecfe9fc"></a>
### Cluster의 DDL 처리

<a id="0eafb5233782037e"></a>
#### Cluster의 DDL 처리 과정
...
<a id="3a47bed6bd649097"></a>
![Cluster의 DDL 처리 과정](../assets/images/93e2a000c852f861.png)
...
Cluster 환경에는 sharded table과 cloned table ([Cluster Table과 Shard](14-cluster-objects.md#12dec8f0c006d72b) 참조) 이 있는데 각각의 테이블 데이터는 local server와 remote server에 저장된다. Sharded table의 데이터는 group에 분할 저장되는데 이 때 동일한 group의 member들에는 데이터가 복제되어 저장된다. Cloned table에는 모든 group과 member에 데이터가 복제되어 저장된다.

다음 그림은 3 x 2로 구성된 GOLDILOCKS의 cluster와 해당 cluster에 저장된 table들이다.

<a id="22469e6c2327058d"></a>
![3 x 2 cluster 구성과 table](../assets/images/d64b2a0354039e4e.png)
...
<a id="45883cad3bbf9512"></a>
![Cluster puller 수행](../assets/images/e9e3ac1a6bc35e94.png)
...
Generated query는 사용자가 제공한 query를 수행하는 과정에서 데이터의 수집이나 갱신을 위해 구성된 query이다. 자세한 내용은 [Generated Query](#0aba1fe9b190344d)를 참조한다.

다음 절에서 각 cluster puller node에서 지원하는 기능별 데이터 수집 방법과 데이터 조작 방법에 대해 설명한다.

<a id="358352385d2fbf00"></a>
##### 데이터 수집 방법

- By pass: 전달 받은 순서대로 수행 결과를 취합한다.
- Merge sort: 주어진 정렬 순서에 따라 수행 결과를 순차적으로 취합한다.

<a id="d1650420cb5906f7"></a>
##### 취합된 데이터 조작 방법
...
<a id="dbce8cc319a39774"></a>
##### Cluster Puller에서 수행 대상 Server 선정

다음 정보들을 분석하여 generated query를 수행하기 위한 대상을 결정한다.

- 테이블 복제본 (replica) 배치 정책
- [Cluster Domain](#41190e0e2cebac8e)
- [Cluster Puller의 Target Domain 줄이기](#68e639a3ce7d0dff)
...
다음은 [Generated Query](#0aba1fe9b190344d)를 설명하기 위해 정의된 테이블들의 복제본 (replica) 배치 정책을 요약한 것이다.
...
<a id="2834cf9b2860bd7e"></a>
#### Cluster Puller Plan Node

Cluster puller plan node는 local server와 remote server로부터 데이터를 가져오는 방법에 따라 분류된다. 데이터 수집에 따른 cluster puller plan node의 분류는 [Cluster puller plan nodes](#df31b2d0298c3a34)를 참조한다.

<a id="01a9e2299178b5c5"></a>
##### Plan Based Cluster
...
<a id="8135897226fe8b5c"></a>
![Plan based cluster](../assets/images/866c209bd9071255.png)

<a id="719b4ef08cda4183"></a>
##### Single Cluster
...
<a id="8a560b11f4b92241"></a>
![Single cluster](../assets/images/0df696d122faf484.png)

<a id="869c444b12ca82b4"></a>
##### Multiple Cluster
...
<a id="1b032710d049c2f6"></a>
![Multiple cluster](../assets/images/0e48e6f40e8c2c98.png)

<a id="41190e0e2cebac8e"></a>
#### Cluster Domain
...
Cluster domain은 [from clause](20-sql-references-h-z.md#e3dedc5dda5dbad1)에 기술된 table이나 view를 대상으로 [&lt;cluster domain&gt;](20-sql-references-h-z.md#fc22ba972aa66105)을 참고하여 정의하는데 이 때 다음 중 하나를 선택할 수 있다.
...
조회 대상 domain을 명시한 경우, TARGET DOMAIN이 G2로 줄어든 것을 확인할 수 있다. Domain에 대한 자세한 설명은 [Cluster Domain](#41190e0e2cebac8e)을 참조한다.
...
TARGET DOMAIN을 줄이는 방법으로 table과 관련된 [Pseudo Columns](11-sql-elements.md#909e65320d46cbf4) 조건을 부여하는 방법도 있다. Pseudo column에 대한 equal (=) 조건을 사용하는 경우에만 domain filter로 사용할 수 있다.

**Domain filter로 사용할 수 있는 pseudo column**

<a id="b06d522dd29514e5"></a>
...
[Cluster Puller 활용](#961d2f02d002fee6)에 따라 각 cluster puller plan node는 [데이터 수집 방법](#358352385d2fbf00)에 대한 generated query를 구성한다.

<a id="7c9527c1c751765d"></a>
...
Group 별로 grouping한 [데이터 수집 방법](#358352385d2fbf00)에 따라 cluster puller plan node가 결정된다. By pass 방식으로 데이터 수집이 이루어지는 경우 single cluster를 이용한다. Merge sort 방식으로 데이터 수집이 이루어지는 경우 multiple cluster를 이용한다.
...
<a id="f5977c967e004647"></a>
#### Generated Query 구성 제약 사항

다음과 같은 경우에는 generated query 구성에 제약을 받는다.

- [Offset & Limit](#770b88d7f8ad35f6)
- [Non-deterministic expression 사용](#049a700756fe116f)
- [부질의 (subquery)를 unnest 할 수 없는 경우](#7d49d6fd1dfb5706)

<a id="770b88d7f8ad35f6"></a>
##### Offset & Limit

> [offset limit clause](20-sql-references-h-z.md#fe18ee55c139acb6) 정보는 generated query에 포함되지 않는다.
...
부질의 unnest에 대한 자세한 내용은 [부질의(Subquery)](#65d86e7dd01a55b1)를 참조한다.
...
<a id="57998c7b145dbbcf"></a>
#### Cluster Pusher

Cluster pusher node는 cluster puller node의 효율적 질의 수행을 위해 가상의 table을 생성하고 관리한다.

<a id="c6001208653a290b"></a>
![Cluster puller vs cluster pusher](../assets/images/e7f558eaccc8d0ab.png)
...
<a id="75a0f7c97638811d"></a>
![Cluster pusher 수행](../assets/images/aa0646276d8204cc.png)
...
<a id="93285fc235859393"></a>
#### SELECT 구문별 Cluster 질의 처리

위에서는 cluster의 SELECT를 처리하기 위해 [Cluster Puller](#c8190dda3a22e0bf)와 [Cluster Pusher](#57998c7b145dbbcf) plan node에 대해 설명했다. 이제부터는 이들을 이용한 SELECT의 구문별 cluster 질의 처리에 대해 설명한다.

<a id="cb3739908ab95bbd"></a>
...
Cloned strategy를 AT CLUSTER WIDE 정책으로 cloned table을 생성한 경우 모든 node에 복제본을 가지고 있기 때문에 대부분의 local server에서 cloned table에 대한 질의를 처리할 수 있다. 다만, 새로운 group이나 member가 추가되는 경우에는 해당 group이나 member에 cloned table에 대한 데이터가 없기 때문에 remote server로부터 데이터를 가져와야 하며, 이 때 cluster puller를 구성한다. Cloned strategy에 대한 자세한 설명은 [Cloned Strategy](../part-01-getting-started/3-cluster-튜토리얼.md#bf7dee7e61e77bc5)를 참조한다.
...
<a id="148e1da62791d7ad"></a>
##### FROM 구문 (Outer Join)

Outer join에서의 질의 처리는 [FROM 구문 (Join)](#a6cb729f05be2060)과 동일하게 하나의 group에서 데이터 수집하는 방법과 다수의 group에서 데이터 수집하는 방법으로 나누어진다.
...
Case 3의 경우 case 1과 마찬가지로 각 group에서 outer join을 포함한 generated query 수행 결과를 취합하면 중복된 anti join 결과를 얻을 수 있다. 중복된 anti join 결과를 제거하기 위해 intersect key group 방식의 데이터 조작을 사용한다. Intersect key group에 대한 자세한 내용은 [Intersect Key Group을 위한 Generated Query](#280c4aa8fbeff52d)를 참조한다.
...
<a id="817f2beb3cc7854a"></a>
| Join 연산 | 부질의를 포함한 연산자 |
| --- | --- |
| INNER JOIN | [&lt; Group Comparison Conditions &gt;](11-sql-elements.md#0d4d3aef97479ecf)를 제외한 모든 연산자 |
| OUTER JOIN | [&lt; Group Comparison Conditions &gt;](11-sql-elements.md#0d4d3aef97479ecf)를 제외한 모든 연산자 |
| SEMI JOIN | EXISTS, IN, ANY quantifier를 가지는 [&lt; Group Comparison Conditions &gt;](11-sql-elements.md#0d4d3aef97479ecf) |
| ANTI-SEMI JOIN | NOT EXISTS, NOT IN, ALL quantifier를 가지는 [&lt; Group Comparison Conditions &gt;](11-sql-elements.md#0d4d3aef97479ecf) |

조인 연산에 대한 자세한 설명은 [Join](15-sql-tuning.md#d849805f57b05050)을 참조한다.
...
<a id="2920ec135cf44e15"></a>
![Cluster에서의 DML 처리](../assets/images/c4bf98a0c6bbcb92.png)

Cluster에서 DML을 처리하기 위해 각 group의 master server와 slave server를 정의한다.

<a id="351d95f793538c74"></a>
...
- [Query 기반 DML](#0bb46d2996e574b1)
- [Global Rowid 기반 DML](#b9bc1da4224f3cfc)

<a id="0bb46d2996e574b1"></a>
#### Query 기반 DML
...
자세한 내용은 [Generated Query](#0aba1fe9b190344d)를 참조한다.
...
<a id="7afe7cbb18c00415"></a>
![Generated query를 이용한 데이터 변경 (전체 cluster group 대상 변경)](../assets/images/301457158b0aadfb.png)
...
<a id="ed51e210f2585f86"></a>
![Generated query를 이용한 데이터 변경 (특정 cluster group 대상 변경)](../assets/images/5ce0fd0a7778e6cd.png)
...
Query 기반 DML 수행은 DML cluster라고 불리는 plan node에서 담당한다. 자세한 내용은 [DML Cluster](#88a7f7800d91bf69)를 참조한다.
...
- 한 cluster group의 각 cluster member에서 generated query를 수행한 결과가 서로 동일함을 보장할 수 있는 generated query를 생성할 수 있는 경우
    - [Generated Query 구성 제약 사항](#f5977c967e004647)을 참조한다.
...
- [SELECT .. FOR UPDATE](20-sql-references-h-z.md#408bf76827c0124d)
- [SELECT .. INTO .. FOR UPDATE](20-sql-references-h-z.md#6cd38041a4c8422d)
- [DELETE FROM](19-sql-references-c-g.md#7f39572a92faf235)
- [DELETE FROM name RETURNING](19-sql-references-c-g.md#a590c1dc7a8fa0b1)
- [DELETE FROM name RETURNING .. INTO](19-sql-references-c-g.md#aa5058d5295cd427)
- [UPDATE](20-sql-references-h-z.md#abc2bb1bde84db44)
...
Generated query를 이용한 데이터 조작은 [Global Secondary Index](14-cluster-objects.md#de47ce26ba7a870d)가 구성되어 있지 않아도 수행할 수 있다.

<a id="88a7f7800d91bf69"></a>
##### DML Cluster
...
<a id="55452d9c096be3df"></a>
###### **DML Cluster에서의 조인 연산**

부질의 (subquery)를 포함하는 구문은 [부질의 (subquery)를 포함하는 join](#817f2beb3cc7854a)과 마찬가지로 질의처리기에 의해 조인 연산으로 변경될 수 있다. DML 구문에 대한 부질의도 조인 연산으로 변경될 수 있다. DML cluster plan node은 조인을 포함하는 generated query 구성을 지원한다.
...
<a id="b9bc1da4224f3cfc"></a>
#### Global Rowid 기반 DML

Global rowid 기반 DML은 rowid를 사용하여 서로 다른 cluster member에 저장된 동일한 레코드들을 조작하는 방법이다. 이 방법은 새로운 레코드를 추가하거나 [Query 기반 DML](#0bb46d2996e574b1)이 불가능할 때 사용한다.
...
Rowid에 대한 자세한 내용은 [ROWID Pseudo Column](11-sql-elements.md#ef8e53c0cae0ee26)를 참조한다.
...
Rowid 정보를 이용한 데이터 조작은 [Global Secondary Index](14-cluster-objects.md#de47ce26ba7a870d) 사용 여부에 따라 다음 두 가지 방법을 지원한다.

- [Global Secondary Index를 사용하지 않는 global rowid 기반 DML](#bb58e7163ef2c5eb)
- [Global Secondary Index를 사용한 global rowid 기반 DML](#3caba77481864938)

<a id="bb58e7163ef2c5eb"></a>
...
<a id="0c5d6f8796dc4f55"></a>
![Global secondary index를 사용하지 않는 global rowid 기반 DML](../assets/images/a664eba6cfc27e90.png)
...
다음은 [Global secondary index를 사용하지 않는 global rowid 기반 DML](#0c5d6f8796dc4f55)의 사용자 질의를 수행한 결과이다. 수행 결과, global rowid 기반 DML을 위해 출력되는 정보는 없다.
...
<a id="7e61471e234d2734"></a>
![Global secondary index를 사용하는 rowid를 이용한 데이터 조작](../assets/images/c07dc0bb7d0a7a09.png)
...
다음은 [Global secondary index를 사용하는 rowid를 이용한 데이터 조작](#7e61471e234d2734)의 사용자 질의를 수행한 결과이다. 수행 결과, global rowid 기반 DML을 위해 출력되는 정보는 없다.
