<a id="6f50ff3922357908"></a>

# 부록 B. Error Codes

> 원본: [GOLDILOCKS 22c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/22c_1/manual/ko/6f50ff3922357908)  
> 태그: `22c.1_10_tag`

[← 부록 A. SQLSTATE](appendix-01-부록-a-sqlstate.md) · [전체 목차](../README.md) · [부록 C. Wait Event →](appendix-03-부록-c-wait-event.md)

GOLDILOCKS에서 제공하는 error code는 다음과 같다. 해당 내용은 [V$ERROR_CODE](../part-02-administration-manual/9-database-information.md#14b9318771c06663) view로 조회할 수 있다.

<a id="5da42f1301a13409"></a>
## OS 관련 에러
...
| 11067 | HY000 | fail to connect to a host with a socket |
...
| 13061 | HY008 | child operation canceled |
| 13062 | 42000 | the statement is disallowed |
| 13063 | 42000 | output value too large (maximum: %d %s) |
| 13064 | 42000 | name input to JSON generation function cannot be null |
| 13065 | 42000 | duplicate key names '%s' in JSON object |

<a id="ce1bbb4a8c8e52b2"></a>
## 저장 관리 관련 에러
...
<a id="79574d4f5f0ffed0"></a>
| Error code | SQLSTATE | Message code |
| --- | --- | --- |
...
| 16357 | 42R01 | must be accessible to at least one member of group '%s' |
| 16358 | 42R01 | accessible member does not exist |
| 16359 | 42000 | no inactive members |
| 16360 | 42R02 | cloned table "%s"."%s" must be accessible to at least one member |
| 16361 | 42R02 | sharded table "%s"."%s" must be accessible to at least one member of group '%s' |
...
| 16412 | 42R02 | all of shards in a table must be online. |
...
| 16482 | 42R02 | database is not accessible; '%s' has detached from the cluster |
...
**SQL 구문 처리 관련 에러 (16500 ~ 16599)**

<a id="ddcd945ae6a0589d"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
...
| 16545 | 42R02 | cloned table "%s"."%s" must have at least one online replica |
| 16546 | 42R02 | sharded table "%s"."%s" must have at least one online replica of group '%s' |
...
| 16585 | 42000 | cannot drop cluster group that includes a global coordinator |
| 16586 | 42000 | role name '%s' conflicts with another user or role name |
| 16587 | 28000 | role '%s' does not exists |
| 16588 | 42000 | cannot GRANT to a role/public WITH GRANT OPTION |
| 16589 | 0P000 | circular role grant detected |
| 16590 | 42000 | duplicate role name in role granted/revoked list |
| 16591 | 28000 | cannot GRANT/REVOKE built-in role(SYSDBA, ADMIN) to/from authorization |
| 16592 | 0P000 | invalid role specification |
| 16593 | 25001 | invalid transaction state: active transaction exists |
| 16594 | 42000 | role '%s' not granted or need ADMIN OPTION |
| 16595 | 42000 | role '%s' not granted to '%s' |
| 16596 | 42000 | transactional service temporarily unavailable |
| 16597 | 42000 | too many grouping sets present (maximum %d) |
| 16598 | 42000 | GROUPING function requires GROUP BY clause |
| 16599 | 42000 | not a GROUP BY expression |

**SQL 구문 처리 관련 에러 (16600 ~ 16699)**

<a id="3bfbf4f93ed73bfb"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
| 16600 | 42000 | The number of columns in a column group must be in the range (%d ~ %d) |
| 16601 | 42000 | specified column group statistics already exists |
| 16602 | 42000 | specified column group statistics not exists |
| 16603 | 42000 | system session cannot be canceled |
| 16604 | 42000 | pivot operations are not supported on lateral views |
| 16605 | 42000 | unpivot operations are not supported on lateral views |
| 16606 | 42000 | the number of elements in pivot values mismatch the pivot columns |
| 16607 | 42000 | the number of elements in unpivot values mismatch the unpivot columns |
| 16608 | 42000 | non-constant expression is not allowed for pivot\|unpivot values |
| 16609 | 42000 | lacks privilege (EXECUTE ON LIBRARY "%s"."%s") |
| 16610 | 42000 | library does not exist |
| 16611 | 42000 | the number of pieces is out of range( 1 to %d ) |
| 16612 | 42000 | invalid backup format ( %s ) |
| 16613 | 42000 | cannot backup; tablespace(%s) is temporary |
| 16614 | 42000 | unreachable WHEN clause specified after unconditional WHEN clause |
| 16615 | 01000 | Warning: failed to make sequences online |
| 16616 | 01000 | Warning: failed to make tables online |
| 16617 | 01000 | Warning: failed to drop offline segments |
| 16618 | 01000 | of the total '%d' members, it was executed only on '%d' members |
| 16619 | 42000 | AT DOMAIN can be specified in the GLOBAL OPEN phase of the cluster database |
| 16620 | 42000 | The domain option cannot be specified together with ONLINE, TABLESPACE, or index attributes options |
| 16621 | 42000 | a transaction can insert into only one table in append manner |
| 16622 | 42000 | append insert attributes mismatch |
| 16623 | 42000 | cannot execute DDL - append inserts unfinished |
| 16624 | 42000 | cannot execute DML - append inserts unfinished |
...
**Embedded SQL pre-compile 관련 에러**

<a id="4dd7c037d1a3c868"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
...
| 41033 | 42000 | preprocessor with no expression |

<a id="eef9d65956bb59a2"></a>
## Communication 관련 에러
...
**Server library 관련 에러**

<a id="3bd88e480abd417d"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
...
<a id="6087461debf20701"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
| 51000 | HY000 | overflow fd |

<a id="f2fe1909cac21c1a"></a>
## gsyncher 관련 에러
...
| 56022 | HY000 | failed to connect to a host |
...
| 56031 | HY000 | startup of remote database '%s' is in progress |

<a id="29455dd10c795a9e"></a>
## cserver 관련 에러
...
<a id="bed7b21ceeabee00"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
| 57000 | HY000 | sample error |

<a id="e2b7154e0a554611"></a>
## cdispatcher 관련 에러
