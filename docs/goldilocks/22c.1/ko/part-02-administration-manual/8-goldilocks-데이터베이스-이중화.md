<a id="747aba7bf53f2c61"></a>

# 8. GOLDILOCKS 데이터베이스 이중화

> 원본: [GOLDILOCKS 22c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/22c_1/manual/ko/747aba7bf53f2c61)  
> 태그: `22c.1_10_tag`
...
<a id="0328f14474fb6c11"></a>
## 운영 방법

<a id="62211be87b0d1fb9"></a>
### CYCLONE

일반적인 운영 방법과 옵션에 대한 자세한 내용은 [CYCLONE](../part-07-replication/50-cyclone.md#bbb051eb10e35775)을 참조한다.

<a id="a6193653ed8aa74c"></a>
#### 노드 추가와 삭제

CYCLONE은 group 단위로 수행되며 이는 이중화 노드와 동일하다. 만약 노드를 추가할 경우에는 group을 추가하고 삭제할 경우에는 group을 삭제하도록 한다.

<a id="64e0e5cb6c942627"></a>
##### 노드 추가 예
...
<a id="fed9d405fe758cc9"></a>
### LOGMIRROR

일반적인 운영 방법과 옵션에 대한 자세한 내용은 [LOGMIRROR](../part-07-replication/51-logmirror.md#1a71a8aa23bf6382)를 참조한다.

<a id="32ef9a8d2c778818"></a>
#### LOGMIRROR 상태 확인
...
<a id="59478e3c29d42bc6"></a>
### CYFILE

일반적인 운영 방법과 옵션에 대한 자세한 내용은 [CYFILE](../part-07-replication/52-cyfile.md#c22afeb579e634f6)을 참조한다.

<a id="0fd03bfbe8f68b7c"></a>
#### Cyfile 시작과 종료, 상태 확인

<a id="1e97c547638f3915"></a>
##### 운영 예
...
<a id="8e2d8f1f739d92c7"></a>
## Trace Log

Trace log에 대한 자세한 정보는 다음과 같다.

<a id="bee26bb14d0f1abc"></a>
