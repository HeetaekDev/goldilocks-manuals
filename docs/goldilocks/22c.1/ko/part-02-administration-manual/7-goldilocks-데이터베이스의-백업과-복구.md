...
<a id="d6a5b30ff0c6621a"></a>
## 백업과 복구

<a id="04277cdac66e2904"></a>
### 백업

<a id="3d66313cbc254b9c"></a>
#### 백업/ 복구 목적
...
<a id="cfc1998ccf07dd78"></a>
![Incremental backup](../assets/images/f213883e941a82a8.png)

<a id="1f5dcbe75e32bc89"></a>
##### 데이터베이스 증분 백업
...
체인지 트래킹이 enable 되면 체인지 트래킹 파일과 공유 메모리를 생성한다. 체인지 트래킹 파일과 공유 메모리의 구조는 동일하고 [CHANGE_TRACKING_EXTENT_SIZE](10-server-property.md#d1e11165dc6a8dd2) 프로퍼티에 설정된 개수만큼의 페이지 묶음에 대한 변경 플래그를 저장하는 블록들로 구성된다.
...
체인지 트래킹이 enable 되면 기본적으로 [CHANGE_TRACKING_FILE](10-server-property.md#0c3a4f7c8eb7f939) 프로퍼티에 설정된 위치에 파일이 생성된다. enable 할 때 체인지 트래킹을 위한 파일 이름이나 저장 위치까지 설정하면 설정된 위치에 파일이 생성되고, 저장 위치가 설정되지 않은 경우에는 BACKUP_DIR 프로퍼티에 설정된 위치에 체인지 트래킹 파일이 생성된다.
...
<a id="153f109d6323639b"></a>
![Recovery를 위한 최소 checkpoint LSN을 구하는 과정](../assets/images/3c5226ec5e268f8e.png)

<a id="d292c38f66a6084a"></a>
...
<a id="c497849d078415f7"></a>
#### 복구 예

<a id="609c7b41d1684191"></a>
##### 제어 파일 훼손
