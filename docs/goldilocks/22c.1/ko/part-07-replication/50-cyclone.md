...
** 자세한 내용은 [DDL 구문에 따른 give up 발생 및 절차에 따른 허용 여부](#aeeaad848e48138c)를 참조한다.
...
<a id="963617cacab29705"></a>
#### Oracle

**Oracle 연동 datatype**

<a id="3aa4629d16da0dfa"></a>
...
<a id="8f22326e42251df7"></a>
#### MySQL

**MySQL 연동 datatype**

<a id="4cfb03fbd27a51b9"></a>
| GOLDILOCKS | MySQL | 비고 |
| --- | --- | --- |
...
<a id="a649b0ea19020d5c"></a>
#### DB2

**DB2 연동 datatype**

<a id="5e8a77c37eb816af"></a>
| GOLDILOCKS | DB2 | 비고 |
| --- | --- | --- |
...
<a id="2d8b00d080ca6958"></a>
#### 데이터베이스 권한

<a id="464abd29a26c8303"></a>
##### 사용자의 접속 권한을 설정
...
<a id="cfe66c6c1ee9d273"></a>
## 환경설정

<a id="a8872fb783516f88"></a>
### 환경설정 파일
...
| SEPARATE_CONFLICT_LOG | Conflict 로그를 trace 로그와 분리하여 기록할지 여부를 설정한다. (기본값은 0이다.) * 0: 분리하지 않는다. * 1: 분리하여 저장하도록 한다. (파일 이름은 cyclone_conflict_GROUPNAME.log이다.) | Slave |
...
```
TIBERO_DRIVER = '/usr/lib64/libtbodbc.so'
...
<a id="817f84c951284fd8"></a>
| 구분 | 파일 |
| --- | --- |
| Cyclone Master | $GOLDILOCKS_DATA/trc/cyclone_master.trc |
| Cyclone Slave | $GOLDILOCKS_DATA/trc/cyclone_slave.trc |

> Trace log에 저장되는 에러 메시지와 대처 방안은 [CYCLONE 에러 메시지와 처리 방법](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#3ed043dcb7faf498)을 참조한다.

<a id="21f6ed6818260046"></a>
### GOLDILOCKS 접속 정책
...
> 그룹 또는 노드의 추가/삭제와 관련된 예는 [노드 추가와 삭제](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#a6193653ed8aa74c)를 참조한다.  
> 이중화 초기화와 관련된 예는 [이중화 초기화](../part-02-administration-manual/8-goldilocks-데이터베이스-이중화.md#3b21204618ea6337)를 참조한다.

<a id="248e8123f066fe06"></a>
## CYCLONE 운영 예

CYCLONE 운영 구조는 다음과 같다.

<a id="4925642f21f17fcf"></a>
![CYCLONE 운영 구조도](../assets/images/f0d09707a5c3c68b.png)
...
<a id="e3b71c29b25b1a78"></a>
### 원본 GOLDILOCKS 환경 설정

기술된 [준비사항](#8d3959d0216809da)을 모두 수행한다.
...
<a id="452ecefcb105173d"></a>
### 원격 GOLDILOCKS 환경 설정

[사용자 등록 및 권한 설정](#b585f79e4f9a0ce4)을 수행한다.

<a id="d4649fbda6e7a71a"></a>
...
<a id="9862481223b29618"></a>
## Cluster 환경에서 CYCLONE 운영

<a id="e8803789397dda89"></a>
### 준비사항
...
<a id="032c66c9900bd0bd"></a>
### 운영

<a id="c8ff10dabd6fdbbe"></a>
#### 실행과 종료
...
<a id="4836359935be5208"></a>
### 수행

<a id="e5b1a7ba6f5d8b85"></a>
#### 환경 설정 파일
...
<a id="78e890de3a647c74"></a>
#### 실행 방법

<a id="26ddd8f98c941038"></a>
##### Master에서 수행
...
<a id="b78be801e7c492f3"></a>
### SYNC

<a id="7183cb32f8130400"></a>
#### Master에서 수행
...
<a id="0a2ed38148326191"></a>
### 기타

--reset 옵션은 standalone 환경에서 쓰이는 것과 동일하게 사용할 수 있다.

<a id="5dd74f07e1a97dfb"></a>
## 모니터링 (CYMON)

CYMON (CYclone MONitor)은 CDC 이중화 툴인 CYCLONE을 모니터링하기 위한 툴이다. CDC 모니터링 정보를 master로 운영 중인 GOLDILOCKS에 주기적으로 갱신한다.

**실행파일**

<a id="46a778eee42a5359"></a>
| 파일 이름 | 구분 |
| --- | --- |
| cymon | cyclone 용 monitor |

<a id="e7bc1d966d93cfc2"></a>
### 환경 설정 파일
...
<a id="bb0b3fc6c2791da5"></a>
### 모니터링 내용

<a id="3dcfe63b11579646"></a>
#### CYMON
...
<a id="647f2acbe81b966f"></a>
#### 실행 옵션

**실행옵션**

<a id="d05306564f9689b1"></a>
| 옵션 | 설명 | 비고 |
| --- | --- | --- |
