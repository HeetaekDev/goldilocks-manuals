<a id="786ed009c87ba1fa"></a>

# 1. 시작하기

> 원본: [GOLDILOCKS 22c.1 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/22c_1/manual/ko/786ed009c87ba1fa)  
> 태그: `22c.1_10_tag`

[전체 목차](../README.md) · [2. 튜토리얼 →](2-튜토리얼.md)

<a id="eba05f554379d934"></a>
## 서문
...
- 본 문서는 GOLDILOCKS 22c.1 버전을 기준으로 작성되었다.
- 본 문서는 RedHat 계열 Linux 플랫폼을 기준으로 작성되었다.

<a id="40b00940d2c494fb"></a>
### 대상
...
<a id="c2481413817f4df2"></a>
![GOLDILOCKS architecture](../assets/images/7f749b7ab2fbf6d3.png)
...
- Client/ Server (C/S) model
    ...
    - Dedicated, shared 모드 설정은 [odbc.ini 파일](../part-05-developer-manual/31-odbc.md#6eb05a63d0c64f05), [Listener Configuration](../part-06-utility-manual/38-glsnr.md#4880ee914e2ccc06)을 참고한다.
...
<a id="863c2e18b7464198"></a>
![GOLDILOCKS cluster system architecture](../assets/images/927794876271aa77.png)

<a id="1c35a0c8d1cf548f"></a>
## GOLDILOCKS Cluster의 특징

<a id="e7e8d15cadb8a3bf"></a>
### Cluster 특장점
