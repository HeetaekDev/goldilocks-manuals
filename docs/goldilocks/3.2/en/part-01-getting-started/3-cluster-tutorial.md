<a id="ab57e5643dcbde1b"></a>

# 3. Cluster Tutorial

> Source: [GOLDILOCKS 3.2 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/en/ab57e5643dcbde1b)  
> Tag: `GOLDILOCKS_Venus_3_2_14_retagged`

[← 2. Tutorial](2-tutorial.md) · [Table of contents](../README.md) · [4. What's New →](4-what-s-new.md)

<a id="47186100a1f73c2b"></a>
...
[listener](../part-06-utility-manual/32-glsnr.md#8f33d71f4cb9fdd1)should be in operation if a user wants to start or end GOLDILOCKS cluster system in dedicated mode of C/S model(to use gsqlnet).
...
- [ALTER CLUSTER GROUP name ADD MEMBER](../part-03-sql-manual/16-sql-references.md#0f86518c60487e59)
- [CREATE CLUSTER GROUP](../part-03-sql-manual/16-sql-references.md#f8131b333b91edb7)
...
For more information about creating table, refer to [CREATE TABLE](../part-03-sql-manual/16-sql-references.md#72507f5467c281c9) and [Cluster Table and Shard](../part-03-sql-manual/14-cluster-objects.md#8af55f007265bd00).

When omitting the sharding strategy option, it is defined by [DEFAULT_SHARDING](../part-02-administration-manual/10-server-property.md#30cbcb4f35b1117e) property. The default value of DEFAULT_SHARDING is 0, and it creates cloned table.
...
- AT CLUSTER WIDE 
    ...
    - When adding a cluster group or cluster member, a user can rearranges clones by using [ALTER TABLE name REBALANCE](../part-03-sql-manual/16-sql-references.md#467720ee446849be) statement. 
- AT CLUSTER GROUP group_list 
    - It arranges clones in all cluster members of a defines cluster group.
    - When adding a cluster member to a defined cluster group, a user can rearranges clones by using [ALTER TABLE name REBALANCE](../part-03-sql-manual/16-sql-references.md#467720ee446849be) statement. 
...
Table rows are distributes to one of 24 shards based on hash value of id column, and 24 shards are equally arranged over the entire cluster system. For more information, refer to [Cluster Table and Shard](../part-03-sql-manual/14-cluster-objects.md#8af55f007265bd00).

<a id="e833c154660f9197"></a>
#### Range Sharding Strategy
...
<a id="57385fea789e9ae0"></a>
### Managing Index

<a id="010d457c0b5c176a"></a>
...
For more information, refer to [DEFAULT_GLOBAL_SECONDARY_INDEX_CREATION](../part-02-administration-manual/10-server-property.md#22707b2c9580c589).
