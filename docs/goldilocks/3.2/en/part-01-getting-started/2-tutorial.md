<a id="1f5e613868478b56"></a>

# 2. Tutorial

> Source: [GOLDILOCKS 3.2 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/en/1f5e613868478b56)  
...
> 
> 
> - MEM_DATA_TBS: It is the tablespace in which the user table/index is generated.
> 
> 
> 
...
<a id="9faabdc05b36579f"></a>
### Client Process

<a id="f4518a464b9b3345"></a>
#### Client/ Server Model
...
A user should run [listener](../part-06-utility-manual/32-glsnr.md#8f33d71f4cb9fdd1) before startup or shutdown the GOLDILOCKS instance in dedicated mode of C/S model.  
...
Startup phrase in the SUNDB instance has several phases as follows.
...
For more information about listener control, refer to [glsnr](../part-06-utility-manual/32-glsnr.md#8f33d71f4cb9fdd1).  
For more information about how to start or end cluster system refer to [Start and End of Cluster System](3-cluster-tutorial.md#3aaf36280aefd4da).

<a id="fc7cb155705ac6df"></a>
...
<a id="9eace0f96201f80d"></a>
### Release Platform

GOLDILOCKS is available in the following release platform.

<a id="cd6ddadb64b41613"></a>
<table class="table column_count_5"><caption>Release platform</caption><thead><tr><th class="to_center to_middle"><div>Platform</div></th><th class="to_center to_middle"><div>Platform name</div></th><th class="to_center to_middle"><div>OS</div></th><th class="to_center to_middle"><div>CPU</div></th><th class="to_center to_middle"><div>Remarks</div></th></tr></thead><tbody><tr><td class="to_left to_middle" rowspan="3"><div>Server 
...
>= gcc 4.1.2
>= java 1.4
&lt;= java 1.6</div></td></tr><tr><td class="to_middle"><div>hpux11.31-itanium-64</div></td><td class="to_middle"><div>HP-UX 11.31</div></td><td class="to_middle"><div>itanium</div></td><td class="to_middle"><div>&gt;= java 1.4
&lt;= java 1.6</div></td></tr><tr><td class="to_middle"><div>aix6-powerpc-64</div></td><td class="to_middle"><div>AIX 6.1</div></td><td class="to_middle"><div>powerpc</div></td><td class="to_middle"><div>&gt;= java 1.4
<= java 1.6</div></td></tr><tr><td class="to_left to_middle" rowspan="7"><div>Client 
platform</div></td><td class="to_middle"><div>linux-x86_64</div></td><td class="to_middle"><div>linux</div></td><td class="to_middle"><div>x86_64</div></td><td class="to_middle"><div>>= linux kernel 2.6
>= glibc 2.1
>= gcc 4.1.2
>= java 1.4
&lt;= java 1.6</div></td></tr><tr><td class="to_middle"><div>linux-x86_32</div></td><td class="to_middle"><div>linux</div></td><td class="to_middle"><div>x86_32</div></td><td class="to_middle"><div>&gt;= Linux kernel 2.6
>= glibc 2.1
>= gcc 4.1.2
>= java 1.4
&lt;= java 1.6</div></td></tr><tr><td class="to_middle"><div>hpux11.31-itanium-64</div></td><td class="to_middle"><div>HP-UX 11.31</div></td><td class="to_middle"><div>itanium</div></td><td class="to_middle"><div>&gt;= java 1.4
&lt;= java 1.6</div></td></tr><tr><td class="to_middle"><div>hpux11.31-itanium-32</div></td><td class="to_middle"><div>HP-UX 11.31</div></td><td class="to_middle"><div>itanium</div></td><td class="to_middle"><div>&gt;= java 1.4
&lt;= java 1.6</div></td></tr><tr><td class="to_middle"><div>aix6-powerpc-64</div></td><td class="to_middle"><div>AIX 6.1</div></td><td class="to_middle"><div>powerpc</div></td><td class="to_middle"><div>&gt;= java 1.4
<= java 1.6</div></td></tr><tr><td class="to_middle"><div>windows-x86-64</div></td><td class="to_middle"><div>Windows</div></td><td class="to_middle"><div>PENTINUM x86</div></td><td class="to_middle"><div>java 1.6</div></td></tr><tr><td class="to_middle"><div>windows-x86-32</div></td><td class="to_middle"><div>Windows</div></td><td class="to_middle"><div>PENTINUM x86</div></td><td class="to_middle"><div>java 1.6</div></td></tr></tbody></table>

<a id="a947929e890062e2"></a>
### System Requirements
...
| goldilocks4.jar | O | O | O | C/S-only JDBC library (java 1.4) |
| goldilocks5.jar | O | O | O | C/S-only JDBC library (java 1.5) |
...
<a id="8dab932d2718b7ef"></a>
| File name | Description |
| --- | --- |
| README | Read me |

<a id="1626d64bfef2d1d3"></a>
...
<a id="5fb97ea9193091f8"></a>
#### Kernel Parameters

<a id="0c59ce1b92f4afde"></a>
##### Shared Memory
...
For more information about directory created by decompression, refer to [GOLDILOCKS Package Configuration](#b4bbb0b5f642c98a)

<a id="aadb24b6af9bdfbc"></a>
...
<a id="c02a28a1f1ef8859"></a>
#### Tablespace

Database is divided into multiple tablespaces with logical structure, which contain tables and indexes. Tablespace is implemented as a set of one or more shared memories, and it is a tool to manage the space of loading data. When a user enquires V$TABLESPACE table, tablespace information on current database will be outputted.

GOLDILOCKS supports the following tablespaces by default.

<a id="0f5747af10988cdb"></a>
<table class="table column_count_3"><caption>Tablespaces of GOLDILOCKS </caption><thead><tr><th class="to_center"><div>Owner</div></th><th class="to_center"><div>Name</div></th><th class="to_center"><div>Description</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="5"><div>SYSTEM</div></td><td class="to_middle"><div>DICTIONARY_TBS</div></td><td class="to_middle"><div>Default dictionary tables are stored in this tabespace to operate database.</div></td></tr><tr><td class="to_middle"><div>MEM_UNDO_TBS</div></td><td class="to_middle"><div>Undo segments and transaction information are stored in this table space.</div></td></tr><tr><td class="to_middle"><div>MEM_DATA_TBS</div></td><td class="to_middle"><div>If a user does not specify a tablespace when creating schema object, the data table is stored in this tablespace by default.</div></td></tr><tr><td class="to_middle"><div>MEM_TEMP_TBS</div></td><td class="to_middle"><div>Indexes which does not specified tablespace name, and temporary tables which are used by queries are created in the tablespace. Indexes are rebuilt when restarting instance because logging does not occur.</div></td></tr><tr><td class="to_middle"><div>MEM_TRANS_TBS</div></td><td class="to_middle"><div>It is used to recover global transaction in cluster system. It is created only when it is configured as cluster system.</div></td></tr><tr><td class="to_middle"><div>USER</div></td><td class="to_middle"><div>User-defined</div></td><td class="to_middle"><div>User defines this tablespace to collect specific tables to a specific tablespace and manage them.</div></td></tr></tbody></table>

<a id="c83165346e8da156"></a>
##### Tablespace Types
...
<a id="2446dd316e0101c4"></a>
## Managing Schema Object

<a id="1f76bb75b45e3c2c"></a>
### Schema Object
...
Table data can be stored and retrieved being distributed to multiple nodes according to the user's desiring distribution policy when using GOLDILOCKS configuring it as cluster system. For more information, refer to [Managing Table](3-cluster-tutorial.md#30a330896baef175)

<a id="1774b500bed528c3"></a>
### Managing Index

This chapter describes index overview and creating/deleting index.

<a id="126adf987427a61b"></a>
#### Overview
...
For more information, refer to [Global Sequence](3-cluster-tutorial.md#e3492a4adbb7a019).

<a id="40831145eb864c99"></a>
## Managing User

<a id="6eea94f8000335b0"></a>
### Creating User
...
- DEFAULT 	TABLESPACE tablespace_name 	
    ...
    - If DEFAULT 		TABLESPACE clause is omitted, it is specified as the default 		data tablespace (MEM_DATA_TBS) which is defined when creating DATABASE (&lt;database 		definition&gt;).
- TEMPORARY 	TABLESPACE tablespace_name 	
    ...
    - If TEMPORARY 	TABLESPACE clause is omitted, it specifies as the default temporary tablespace (MEM_TEMP_TBS) which is defined when creating DATABASE (&lt;database 		definition&gt;).
...
- &lt;alter index tablespace&gt;
    ...
    - It assigns INDEX TABLESPACE tablespace_name
        - When assigning the data tablespace, it should be the LOGGING index.
        - When assigning the temporary tablespace, it should be the NOLOGGING index.
    - INDEX TABLESPACE NULL
        - It does not assign the index tablespace.

<a id="7b65c5af09b9f059"></a>
## GOLDILOCKS Property
...
<a id="922ec69f794a4150"></a>
### Properties When Creating Database

**Properties when creating database**

<a id="f2b19debc7446f9b"></a>
| Name | Description |
| --- | --- |
...
<a id="40d65be5c41ac77f"></a>
## GOLDILOCKS Utility

<a id="c97c40b6066ba9e1"></a>
### gcreatedb
...
<a id="f897b2e083dbb831"></a>
| Argument | Description |
| --- | --- |
| export 	\| import | It declares whether to downlad the contents of existing table to data_file_name, or to upload existing data in data_file_name to a specified tabe in control_file_name. |
