<a id="c82d9a6259d3acfb"></a>

# 19. PSM Control Statements

> Source: [GOLDILOCKS 3.2 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/en/c82d9a6259d3acfb)  
> Tag: `GOLDILOCKS_Venus_3_2_14_retagged`

[← 18. PSM DataTypes](18-psm-datatypes.md) · [Table of contents](../README.md) · [20. PSM Cursor Statements →](20-psm-cursor-statements.md)

<a id="5e7672b01eb73314"></a>
## Assignment

It inserts the calculation value of the right expression into the left variable by using assignment operators (':=').

<a id="9b46f2174af8b84f"></a>
### Assignment Target
...
- Variable (Refer to [PSM DataTypes](18-psm-datatypes.md#fc4c07f6fbc6efb4).)
- User defined type
- Cursor
...
- Control Statements (Refer to [PSM Control Statements](#c82d9a6259d3acfb).)
- Cursor Statements (Refer to [PSM Cursor Statements](20-psm-cursor-statements.md#43f4f9a3f0cfdd0d).)
- SQL Statements (static/ dynamic) (Refer to [Using SQLs In PSM](22-using-sqls-in-psm.md#43a04d4d888c370c).)

<a id="d4ac612e6cb63374"></a>
...
For more information about declaration of user defined exception, built-in handler types or installing a handler, refer to [Error Handling](#87b3976d043e5c18).

<a id="f354de9294fd01b8"></a>
## NULL Statement

It is used to specify a statement which does not have any role in PSM such as no-op.  
For more information, refer to [NULL Statement](23-psm-language-element-references.md#a4d67d4521fb5529).
...
For more information, refer to [IF Statement](23-psm-language-element-references.md#e1ad89c3f3094655).
...
For more information, refer to [CASE Statement](23-psm-language-element-references.md#727ec69ff2109c7b).
...
For more information, refer to [Basic LOOP Statement](23-psm-language-element-references.md#6b50d1aa237bd79e).
...
For more information, refer to [EXIT Statement](23-psm-language-element-references.md#a731ceab668854e0).
...
<a id="83846470c7ede4da"></a>
### FOR Loop

FOR loop statement repeatedly performs a series of statements as many times as the number of integers of the given scope.  
For more information, refer to [FOR LOOP Statement](23-psm-language-element-references.md#b5afa65ada57870e).

A user creates an index variable with the name specified next to FOR keyword, and it sets the beginning value specified on the left side of a scope operator ('..') which is next to IN keyword as an initial value. Then, it performs a series of statements by increasing by 1 per each loop until it becomes as same as the end value specified on the right side of a scope operator.
...
When REVERSE keyword is specified in front of the scope, then it performs loop by reducing the value of an index variable by 1.
...
<a id="f18cc4273128effe"></a>
### WHILE Loop

WHILE loop statement repeatedly performs a series of statements while the given condition is TRUE.  
For more information, refer to [WHILE LOOP Statement](23-psm-language-element-references.md#29967ced3a732acb).
...
For more information, refer to [GOTO Statement](23-psm-language-element-references.md#af558f11d17a2a2a).
...
For more information, refer to [CONTINUE Statement](23-psm-language-element-references.md#faa14b048c02a9d8).
...
For more information, refer to [EXCEPTION Handling](#f404c909d7fd3ea7), [SQLCODE Function](23-psm-language-element-references.md#8eeb557805b4b907), [SQLERRM Function](23-psm-language-element-references.md#b5843de956f7afb7).

<a id="32af9f01d4e06ba7"></a>
### Cursor Attributes
...
<a id="7da8b27f84915b21"></a>
| Type | Definer | Error code | Name | Raise implicitly | Raise explicitly |
| --- | --- | --- | --- | --- | --- |
| Pre-defined | Database | O | O | O | Optionally |
| User defined | User | User-defined | User defined | X | O |

> For more information about a predefined exception or a user defined exception provided by GOLDILOCKS, refer to [Exception Declaration](23-psm-language-element-references.md#ff6694cbaab4485d).

<a id="11b68da81c5cf05b"></a>
...
<a id="5bb13a15a4c87c6f"></a>
#### User Defined Exception

A user defined exception is an exception used by setting an exception name and an error-code by a user except for a pre-defined. User defined exception can not implicitly occur, but a user should execute it by explicitly using a RAISE statment.
