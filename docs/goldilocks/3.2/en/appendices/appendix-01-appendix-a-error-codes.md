<a id="d5399243d9bea147"></a>

# Appendix A. Error Codes

> Source: [GOLDILOCKS 3.2 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/en/d5399243d9bea147)  
> Tag: `GOLDILOCKS_Venus_3_2_14_retagged`

[← 45. LOGMIRROR](../part-07-replication/45-logmirror.md) · [Table of contents](../README.md) · [Appendix B. Wait Event →](appendix-02-appendix-b-wait-event.md)

GOLDILOCKS provides user error codes as follows. The error messages can be viewed with [V$ERROR_CODE](../part-02-administration-manual/9-database-information.md#f733591483a03b84).

<a id="63a738993d12a113"></a>
## OS Related Error
...
<a id="037f47be4b79773d"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
| 51000 | HY000 | overflow fd |

<a id="ffc86e2a7bfd81de"></a>
...
<a id="9a58b62838cca5e7"></a>
| Error code | SQLSTATE | Message |
| --- | --- | --- |
| 57000 | HY000 | sample error |

<a id="b23e0049164d57f2"></a>
