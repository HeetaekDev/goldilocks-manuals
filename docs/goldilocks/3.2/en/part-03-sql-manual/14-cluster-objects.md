<a id="2cca1a94bb533f8e"></a>

# 14. Cluster Objects

> Source: [GOLDILOCKS 3.2 User Manual (en)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/en/2cca1a94bb533f8e)  
...
<a id="c444200caa3e97bf"></a>
## Cluster System

<a id="1f015c59b30d4ed2"></a>
### Cluster System Related Statements

For more information, refer to the followings.

- Expanding a cluster system
    - [CREATE CLUSTER GROUP](16-sql-references.md#f8131b333b91edb7)
    - [ALTER CLUSTER GROUP name ADD MEMBER](16-sql-references.md#0f86518c60487e59)

- Controlling an inactive cluster member
    - [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](16-sql-references.md#e511a40b370e1420)
    - [ALTER SYSTEM JOIN DATABASE](16-sql-references.md#93365f06a2e0defc)

- Rebalancing data
    - [ALTER DATABASE REBALANCE](16-sql-references.md#6bf45492d225c752)
    - [ALTER TABLE name REBALANCE](16-sql-references.md#467720ee446849be)

Information which is related to a cluster system can be retrieved through the following views.

<a id="884e9022dffbd65e"></a>
<table class="table column_count_3"><caption>Cluster system related information</caption><thead><tr><th class="to_center"><div>Schema</div></th><th class="to_center"><div>View</div></th><th class="to_center"><div>Description</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#2e454976e81594fd">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Object information of a cluster group and a cluster member which configure a cluster</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78c5e9414da63f44">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Comment information of a cluster group and a cluster member</div></td></tr><tr><td class="to_middle"><div>PERFORMANCE_VIEW_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#007dfbfed60d6971">V$CLUSTER_MEMBER</a></div></td><td class="to_middle"><div>Status information of a cluster member</div></td></tr></tbody></table>

<a id="2c57255e5ae282ef"></a>
...
<a id="ec5f733e589c0eb9"></a>
![3 x 2 cluster system](../assets/images/608e6a8e77d9f5e7.png)
...
<a id="759df054dc23c85b"></a>
![Concepts of sharding and duplicating by the cluster](../assets/images/f20699b64b318b5c.png)
...
<a id="30e0eae7ad015250"></a>
![Cluster availability](../assets/images/e3a32f3c5ce920be.png)
...
- [ALTER SYSTEM JOIN DATABASE](16-sql-references.md#93365f06a2e0defc) statement is used to make the broken cluster member to participate in a cluster system again.

- [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](16-sql-references.md#e511a40b370e1420) statement is used to drop the broken cluster member from the cluster system.

- [ALTER CLUSTER GROUP name ADD MEMBER](16-sql-references.md#0f86518c60487e59) statement is used to add a cluster member to a cluster group for the high availability.

- [ALTER DATABASE REBALANCE](16-sql-references.md#6bf45492d225c752) statement and [ALTER TABLE name REBALANCE](16-sql-references.md#467720ee446849be) statement are used to rebalance data to a newly added cluster member.

<a id="81103c4fcf577687"></a>
...
<a id="8325e80400428ffc"></a>
![Expanding cluster system](../assets/images/07e81f2e15403988.png)
...
<a id="8427362d2b016c7d"></a>
## Cluster Group

<a id="fcbcedb6fbfcf054"></a>
...
- Creating a cluster group: [CREATE CLUSTER GROUP](16-sql-references.md#f8131b333b91edb7)
- Dropping a cluster group: [DROP CLUSTER GROUP](16-sql-references.md#7335700144f62a07)
- Altering a cluster group: [ALTER CLUSTER GROUP name ADD MEMBER](16-sql-references.md#0f86518c60487e59)

Information which is related to a cluster group can be retrieved through the following views.

<a id="4c90ec994ff53ff0"></a>
<table class="table column_count_3"><caption>Cluster group related information</caption><thead><tr><th class="to_center"><div>Schema</div></th><th class="to_center"><div>View</div></th><th class="to_center"><div>Description</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#2e454976e81594fd">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Object information of a cluster group and a cluster member which configure the cluster</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78c5e9414da63f44">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Comment information of a cluster group and a cluster member</div></td></tr></tbody></table>

<a id="64087c1ad9a49e01"></a>
### Concepts of Cluster Group

At least one cluster group should be created to run the cluster system.

<a id="28b48b64f67428a6"></a>
#### Creating Cluster Group

The first created cluster group should include itself as a cluster member. For more information about creating a cluster group, refer to [CREATE CLUSTER GROUP](16-sql-references.md#f8131b333b91edb7).
...
<a id="c9e276917e7ef925"></a>
#### Dropping Cluster Group

The cluster group participating in a cluster system and providing a service can be dropped for various reasons. For more information about dropping the cluster group, refer to [DROP CLUSTER GROUP](16-sql-references.md#7335700144f62a07).
...
<a id="b365883a7191d4b2"></a>
## Cluster Member

<a id="85c419ad25d812f3"></a>
### Cluster Member Related Statements

For more information, refer to the followings.

- Adding a cluster member: [ALTER CLUSTER GROUP name ADD MEMBER](16-sql-references.md#0f86518c60487e59)
- Dropping a cluster member: [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](16-sql-references.md#e511a40b370e1420)
- Controlling a cluster member
    - [ALTER SYSTEM JOIN DATABASE](16-sql-references.md#93365f06a2e0defc)
    - [ALTER CLUSTER GROUP name OFFLINE MEMBER](16-sql-references.md#f8eaa3124c5d9541)
    - [ALTER DATABASE RESET LOCAL CLUSTER MEMBER](16-sql-references.md#dc9924209ee5d22d)

Information which is related to a cluster member can be retrieved through the following views.

<a id="27d89293b89b86b3"></a>
<table class="table column_count_3"><caption>Cluster member related information</caption><thead><tr><th class="to_center"><div>Schema</div></th><th class="to_center"><div>View</div></th><th class="to_center"><div>Description</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="2"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#2e454976e81594fd">DBA_CLUSTER</a></div></td><td class="to_middle"><div>Object information of a cluster group and a cluster member which configure a cluster</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78c5e9414da63f44">DBA_CLUSTER_COMMENTS</a></div></td><td class="to_middle"><div>Comment information of a cluster group and a cluster member</div></td></tr><tr><td class="to_middle"><div>PERFORMANCE_VIEW_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#007dfbfed60d6971">V$CLUSTER_MEMBER</a></div></td><td class="to_middle"><div>Status information of a cluster member</div></td></tr></tbody></table>

<a id="1de3bb0e96f7a582"></a>
...
Perform [ALTER CLUSTER GROUP name ADD MEMBER](16-sql-references.md#0f86518c60487e59) statement to add a new cluster member to a cluster group.
...
- For rebalancing the entire data: Refer to [ALTER DATABASE REBALANCE](16-sql-references.md#6bf45492d225c752).
- For rebalancing only a part of the table: Refer to [ALTER TABLE name REBALANCE](16-sql-references.md#467720ee446849be).
...
To make the cluster member with an error to participate in the cluster system again, then perform [ALTER SYSTEM JOIN DATABASE](16-sql-references.md#93365f06a2e0defc) statement after connecting to the cluster member and driving up to the LOCAL OPEN phase.

Even when a part of cluster members are not driven or the cluster system is driven while the network is disconnected, perform [ALTER SYSTEM JOIN DATABASE](16-sql-references.md#93365f06a2e0defc) statement after driving up the cluster member to the LOCAL OPEN phase.

If the cluster member device with an error can not be restored, then drop that cluster member by performing [ALTER DATABASE DROP INACTIVE CLUSTER MEMBERS](16-sql-references.md#e511a40b370e1420) statement in the cluster system.

The cluster member dropped from the cluster system still includes the previous information, and it can not participate in the cluster system again. Perform [ALTER DATABASE RESET LOCAL CLUSTER MEMBER](16-sql-references.md#dc9924209ee5d22d) statement to reset the cluster member to when it is before participating in the cluster system.
...
<a id="e5320ab8711f31b4"></a>
## Cluster Location

<a id="33d4b72caf5ab4cc"></a>
...
- Creating a cluster location: [CREATE CLUSTER LOCATION](16-sql-references.md#648735809e94071b)
- Dropping a cluster location: [DROP CLUSTER LOCATION](16-sql-references.md#7866e0152d6dec9e)
- Altering a cluster location: [ALTER CLUSTER LOCATION](16-sql-references.md#ca28514ab71c220c)
...
<a id="89f9c69f58b15fe1"></a>
| Schema | View | Description |
| --- | --- | --- |
| PERFORMANCE_VIEW_SCHEMA | [V$CLUSTER_LOCATION](../part-02-administration-manual/9-database-information.md#450b610303917bc0) | Information of cluster location |

<a id="8432de2662b2c4ab"></a>
...
- When the cluster location information is lost due to the deleted location control file: [CREATE CLUSTER LOCATION](16-sql-references.md#648735809e94071b)
- When the previously registered connection information of the cluster member is altered, which means that the hardware or the connected ip and port is altered: [ALTER CLUSTER LOCATION](16-sql-references.md#ca28514ab71c220c)

<a id="8af55f007265bd00"></a>
## Cluster Table and Shard

<a id="58627f5b8870870e"></a>
### Shard Related Statements

For more information about definition and rebalance of the shard, refer to the followings.

- Definition of a shard: &lt;table sharding strategy&gt; clause of [CREATE TABLE](16-sql-references.md#72507f5467c281c9).
- Rebalancing a shard: [ALTER TABLE name REBALANCE](16-sql-references.md#467720ee446849be)

Information which is related to a shard in a cluster table can be retrieved through the following views.

<a id="f5fb345aa377b1ea"></a>
<table class="table column_count_3"><caption>Shard in a cluster table related information </caption><thead><tr><th class="to_center"><div>Schema</div></th><th class="to_center"><div>View</div></th><th class="to_center"><div>Description</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="8"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#cd31ac4e60fd16b6">ALL_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>Information of user accessible cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#8161b82714901b27">ALL_SHARD_KEY_COLUMNS</a></div></td><td class="to_middle"><div>Shard key column information of user accessible cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#78b2f71fa82841ea">ALL_TAB_PLACE</a></div></td><td class="to_middle"><div>Placement information of user accessible cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#518fba2d1495fd31">ALL_TAB_SHARDS</a></div></td><td class="to_middle"><div>Shard information of user accessible cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#4a22c4894367c71a">USER_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>Information of user owned cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#698e229fd0ca9e86">USER_SHARD_KEY_COLUMNS</a></div></td><td class="to_middle"><div>Shard key column information of user owned cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#117d945fca2fdc74">USER_TAB_PLACE</a></div></td><td class="to_middle"><div>Placement information of user owned cluster table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#0ce67f24a6acdcfb">USER_TAB_SHARDS</a></div></td><td class="to_middle"><div>Shard information of user owned cluster table</div></td></tr></tbody></table>

<a id="bd536d94276f8792"></a>
### Cluster Table Type
...
A sharded table horizontally divides rows and manages them in shard unit, the sharding strategy is defined by using the SHARDING BY clause in [CREATE TABLE](16-sql-references.md#72507f5467c281c9) statement. The row set classified by the sharding strategy is called as shard.

Each shard is placed in a cluster group according to the placement strategy defined by a user. A shard can automatically be placed by using AT CLUSTER WIDE of [CREATE TABLE](16-sql-references.md#72507f5467c281c9), or a cluster group to place a shard can be specified by using AT CLUSTER GROUP clause. When a shard is automatically placed by using AT CLUSTER WIDE, [ALTER TABLE name REBALANCE](16-sql-references.md#467720ee446849be) is performed after creating the cluster group by using [CREATE CLUSTER GROUP](16-sql-references.md#f8131b333b91edb7). However, when specifying a cluster group to allocate a shard using AT CLUSTER GROUP, the shard is not placed in the newly created cluster group.
...
<a id="09a48f7d2b2819bf"></a>
![Cluster-wide cloned table](../assets/images/de71cfc9431fe5c9.png)
...
<a id="93da298079441fd8"></a>
![Group-specific cloned table](../assets/images/651b7ed3a4464914.png)

<a id="fbae1c51b4b7117a"></a>
### Hash-sharded table
...
<a id="d88da5ed0954d4f8"></a>
![Cluster-wide hash-sharded table](../assets/images/2b762128bf8c15f7.jpg)
...
<a id="fd5580b8eb32ca60"></a>
![Group-specific hash-sharded table](../assets/images/7b7ad1e66a8a4b3f.jpg)

<a id="b38e2897bd86a2d4"></a>
### Range-sharded Table
...
<a id="b6ffdffbf293c5ad"></a>
![Cluster-wide range-sharded table](../assets/images/1fd1a450c8a4df15.jpg)
...
<a id="0cfa61e139ff6818"></a>
![Group-specific range-sharded table](../assets/images/03ce0ff697d831c2.png)

<a id="d0fb5abdfb6eafa8"></a>
### List-sharded Table
...
<a id="9bf957b1593935dd"></a>
![Cluster-wide list-sharded table](../assets/images/e6911adb95aa6754.jpg)
...
<a id="34acbe96411c3cbc"></a>
![Group-specific list-sharded table](../assets/images/eb996628ca436bdf.jpg)

<a id="fab3e3bc2e65b34b"></a>
### Rebalancing Cluster Table

Rebalance the data of the cluster table by using [ALTER TABLE name REBALANCE](16-sql-references.md#467720ee446849be) statement.
...
<a id="5c5155e2d8551c4e"></a>
![Rebalancing the region table defined by AT CLUSTER WIDE](../assets/images/e2995bc48d78bb57.png)
...
<a id="a2862719ca839016"></a>
![Rebalancing the nation table defined by AT CLUSTER GROUP](../assets/images/f421f9d52375e188.png)

Information about the table placement can be retrieved through the following views.

- [USER_TAB_PLACE](../part-02-administration-manual/9-database-information.md#117d945fca2fdc74)
- [ALL_TAB_PLACE](../part-02-administration-manual/9-database-information.md#78b2f71fa82841ea)
...
<a id="3a8aff408d642772"></a>
![Rebalancing shards due to the increase of groups](../assets/images/e785d251c2854556.png)
...
- [USER_TAB_SHARDS](../part-02-administration-manual/9-database-information.md#0ce67f24a6acdcfb)
- [ALL_TAB_SHARDS](../part-02-administration-manual/9-database-information.md#518fba2d1495fd31)
...
<a id="0dd161605506f7a3"></a>
## Global Secondary Index

<a id="2a260ea047ac7231"></a>
...
- Creating a global secondary index: [ALTER TABLE name ADD GLOBAL SECONDARY INDEX](16-sql-references.md#a391d93da4c7cda3)
- Dropping a global secondary index: [ALTER TABLE name DROP GLOBAL SECONDARY INDEX](16-sql-references.md#099238b02dbd2f4d)
- Altering a global secondary index: [ALTER TABLE name ALTER GLOBAL SECONDARY INDEX](16-sql-references.md#8204dcffccd1aa15)

Information related to a global secondary index can be retrieved through the following views.

<a id="ff70f6b325cd022d"></a>
<table class="table column_count_3"><caption>Global secondary index related information</caption><thead><tr><th class="to_center"><div>Schema</div></th><th class="to_center"><div>View</div></th><th class="to_center"><div>Description</div></th></tr></thead><tbody><tr><td class="to_middle" rowspan="6"><div>DICTIONARY_SCHEMA</div></td><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#cd31ac4e60fd16b6">ALL_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>Existence of a global secondary index in user accessible table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#373812a70198333f">ALL_GLOBAL_SECONDARY_INDEXES</a></div></td><td class="to_middle"><div>Object information of user accessible global secondary index</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#badafc04f36d2a87">ALL_GSI_PLACE</a></div></td><td class="to_middle"><div>Placement information of user accessible global secondary index</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#4a22c4894367c71a">USER_CLUSTER_TABLES</a></div></td><td class="to_middle"><div>Existence of a global secondary index in user owned table</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#d13941ce4a27e2fd">USER_GLOBAL_SECONDARY_INDEXES</a></div></td><td class="to_middle"><div>Object information of user owned global secondary index</div></td></tr><tr><td class="to_middle"><div><a class="reference" href="../part-02-administration-manual/9-database-information.md#ac948a5e7ed1eb5c">USER_GSI_PLACE</a></div></td><td class="to_middle"><div>Placement information of user owned global secondary index</div></td></tr></tbody></table>

<a id="0e5b3b0b7a5af8e7"></a>
...
The GRID value of the record is not altered even when the record is update, and it is not altered even when the shard key is altered and transferred to another shard.
...
<a id="ad5d27847cabcc2d"></a>
![Structure of a global secondary index](../assets/images/5d8802a9ef6fc420.png)
