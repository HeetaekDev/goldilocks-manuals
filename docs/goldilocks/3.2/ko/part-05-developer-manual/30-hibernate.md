<a id="285a06f705a82a37"></a>

# 30. Hibernate

> 원본: [GOLDILOCKS 3.2 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/ko/285a06f705a82a37)  
> 태그: `GOLDILOCKS_Venus_3_2_14_retagged`

[← 29. PyDBC](29-pydbc.md) · [전체 목차](../README.md) · [31. gcreatedb →](../part-06-utility-manual/31-gcreatedb.md)

<a id="b87b616508d0b8a7"></a>
## 개요
...
<a id="a16934dc7efad40b"></a>
## 연동

<a id="1ecca619466bc4d9"></a>
### 다운로드
...
<a id="df4f31abfe9a72b4"></a>
### GoldilocksDialect 클래스 연동

Hibernate를 연동하려면 다운로드 받은 Hibernate jar 파일에 이식해야 한다. 다음과 같이 GoldilocksDialect.class와 GoldilocksDialect$1.class 파일을 Hibernate jar 파일에 포함시킬 수 있다.

1. Hibernate jar 파일의 압축을 푼다.
2. 압축이 풀린 org/hibernate/dialect 디렉토리로 GoldilocksDialect.class와 GoldilocksDialect$1.class 파일을 이동시킨다.
3. Hibernate jar 파일로 다시 압축한다.
4. 새로 생성한 jar 파일을 classpath에 추가한다.
