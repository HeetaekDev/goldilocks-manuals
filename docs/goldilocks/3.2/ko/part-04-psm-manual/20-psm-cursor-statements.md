<a id="6f2dba85390de5e4"></a>

# 20. PSM Cursor Statements

> 원본: [GOLDILOCKS 3.2 User Manual (ko)](https://manual.sunjesoft.co.kr/goldilocks/3_2_x/manual/ko/6f2dba85390de5e4)  
> 태그: `GOLDILOCKS_Venus_3_2_14_retagged`

[← 19. PSM Control Statements](19-psm-control-statements.md) · [전체 목차](../README.md) · [21. Using PSM Subprograms →](21-using-psm-subprograms.md)

<a id="ec07b6b888e439f0"></a>
## Declaration
...
Cursor에 정의된 SQL 문을 run-time 시점에 PSM 변수 등을 참조하여 수행해야 할 경우, cursor의 parameter로 정의할 수 있다.
...
자세한 내용은 [OPEN Statement](23-psm-language-element-references.md#70cbb007421a6edc)를 참조한다.

<a id="9eb30d9deca05cb0"></a>
## FETCH
...
자세한 내용은 [FETCH Statement](23-psm-language-element-references.md#594c76c9a93d727b)를 참조한다.

<a id="ea5b7a4084eb9c52"></a>
## CLOSE
...
자세한 내용은 [CLOSE Statement](23-psm-language-element-references.md#e7fbe6f6f64c9346)를 참조한다.

<a id="98e17af9cbac9448"></a>
...
자세한 내용은 [Cursor Variable Declaration](23-psm-language-element-references.md#e6d4ef5813d5c256)을 참조한다.

<a id="b6d05a36b8173e8e"></a>
...
자세한 내용은 [OPEN FOR Statement](23-psm-language-element-references.md#e42e171c8ed8be7c), [CLOSE Statement](23-psm-language-element-references.md#e7fbe6f6f64c9346)를 참조한다.

<a id="30b7c8b8e320c7bb"></a>
### Fetching Data With Cursor Variables

Explicit cursor와 동일하게 fetch statement를 통해 데이터베이스에서 처리된 결과를 PSM 변수로 저장할 수 있다.  
자세한 내용은 [FETCH Statement](23-psm-language-element-references.md#594c76c9a93d727b)를 참조한다.

<a id="201a743825a4454a"></a>
